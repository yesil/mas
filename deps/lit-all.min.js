...
class m extends HTMLElement {
    ...
    $(t, i, s = y) {
        ...
        if (void 0 !== n && !0 === s.reflect) {
            const o = (
                void 0 !== (null === (e = s.converter) || void 0 === e ? void 0 : e.toAttribute) ? s.converter : f
            ...
            if (1 === e.nodeType) {
                ...
                if (z.test(e.tagName)) {
                    ...
                    if (i > 0) {
                        ...
                        for (let s = 0; s < i; s++) e.append(t[s], A()), q.nextNode(), l.push({ type: 2, index: ++n });
                        e.append(t[i], A());
                    }
                }
                ...
                if (e.data === x) l.push({ type: 2, index: n });
                    ...
                    let t = -1;
                    for (; -1 !== (t = e.data.indexOf(T, t + 1)); ) l.push({ type: 7, index: n }), (t += T.length - 1);
                }
            n++;
        }
    }
...
class Y {
    ...
    M(t) {
        ...
        const {
            ...
            n = (null !== (i = null == t ? void 0 : t.creationScope) && void 0 !== i ? i : C).importNode(s, !0);
        q.currentNode = n;
        let o = q.nextNode(),
            r = 0,
            l = 0,
...
class Q {
    ...
    R(t) {
        this._$AH !== W && k(this._$AH) ? (this._$AA.nextSibling.data = t) : this.V(C.createTextNode(t)), (this._$AH = t);
    }
    O(t) {
        var i;
        ...
        if ((null === (i = this._$AH) || void 0 === i ? void 0 : i._$AD) === n) this._$AH.U(s);
        else {
    ...
    j(t) {
        ...
        let s,
            e = 0;
        for (const n of t)
            e === i.length ? i.push((s = new Q(this.L(A()), this.L(A()), this, this.options))) : (s = i[e]), s._$AI(n), e++;
...
class X {
    ...
    _$AI(t, i = this, s, e) {
        ...
        let o = !1;
        if (void 0 === n) (t = K(this, t, i, 0)), (o = !k(t) || (t !== this._$AH && t !== D)), o && (this._$AH = t);
        else {
            const e = t;
            let r, l;
...
class et extends X {
    ...
    _$AI(t, i = this) {
        var s;
        if ((t = null !== (s = K(this, t, i, 0)) && void 0 !== s ? s : W) === D) return;
        const e = this._$AH,
            n = (t === W && e !== W) || t.capture !== e.capture || t.once !== e.once || t.passive !== e.passive,
            o = t !== W && (e === W || n);
...
const ot = { H: S, B: T, D: x, q: 1, J: G, W: Y, Z: P, F: K, G: Q, K: X, X: st, Y: et, tt, it: nt },
    rt = w.litHtmlPolyfillSupport;
...
(dt.finalized = !0),
    (dt._$litElement$ = !0),
    null === (ht = globalThis.litElementHydrateSupport) || void 0 === ht || ht.call(globalThis, { LitElement: dt });
...
const ft = !1,
    ...
    bt = { HTML: 1, SVG: 2 },
    mt = (t, i) => (void 0 === i ? void 0 !== (null == t ? void 0 : t._$litType$) : (null == t ? void 0 : t._$litType$) === i),
    gt = (t) => {
        var i;
        return null != (null === (i = null == t ? void 0 : t._$litType$) || void 0 === i ? void 0 : i.h);
    },
    wt = (t) => void 0 !== (null == t ? void 0 : t._$litDirective$),
    _t = (t) => (null == t ? void 0 : t._$litDirective$),
    ...
    Tt = (t, i, s) => {
        ...
        if (void 0 === s) {
            const i = n.insertBefore(St(), o),
                e = n.insertBefore(St(), o);
    ...
    Pt = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 },
    Ut =
        (t) =>
 ...
 */ const Rt = (t, i) => {
        ...
        for (const t of n) null === (e = (s = t)._$AO) || void 0 === e || e.call(s, i, !1), Rt(t, i);
        return !0;
    },
    Nt = (t) => {
        let i, s;
...
function jt(t, i = !1, s = 0) {
    ...
    if (void 0 !== n && 0 !== n.size)
        if (i)
            if (Array.isArray(e)) for (let t = s; t < e.length; t++) Rt(e[t], !1), Nt(e[t]);
            else null != e && (Rt(e, !1), Nt(e));
        else Rt(this, t);
}
const zt = (t) => {
    var i, s, e, n;
...
class Ht extends Vt {
    ...
    setValue(t) {
        if ($t(this.et)) this.et._$AI(t, this);
        else {
 ...
 */ class Dt extends Ht {
    ...
    update(t, [i, s]) {
        if ((this.isConnected || this.disconnected(), i === this.ct)) return;
        this.ct = i;
        let e = 0;
...
const Wt = Ut(Dt),
    ...
    Ft = Ut(
        class extends Vt {
            ...
            update(t, [i]) {
                const s = mt(this.vt) ? qt(this.vt) : null,
                    e = mt(i) ? qt(i) : null;
    ...
    Jt = Ut(
        ...
        class extends Vt {
            constructor(t) {
                ...
                if (
                    (super(t),
                    1 !== t.type || 'class' !== t.name || (null === (i = t.strings) || void 0 === i ? void 0 : i.length) > 2)
                )
                    throw Error(
            ...
            update(t, [i]) {
                ...
                if (void 0 === this.ft) {
                    ...
                    for (const t in i) i[t] && !(null === (s = this.yt) || void 0 === s ? void 0 : s.has(t)) && this.ft.add(t);
                    return this.render(i);
                }
    ...
    Yt = Ut(
        class extends Vt {
            ...
            update(t, [i, s]) {
                if (Array.isArray(i)) {
                    if (Array.isArray(this.bt) && this.bt.length === i.length && i.every((t, i) => t === this.bt[i])) return D;
                } else if (this.bt === i) return D;
    ...
    ii = Ut(
        ...
        class extends Vt {
            constructor(t) {
                ...
                if (!$t(t)) throw Error('`live` bindings can only contain a single expression');
            }
            render(t) {
                return t;
            }
            update(t, [i]) {
                ...
                if (3 === t.type) {
                    ...
                    if (!!i === s.hasAttribute(e)) return D;
                } else if (1 === t.type && s.getAttribute(e) === i + '') return D;
                return Ct(t), i;
            }
        },
    );
    ...
    li = Ut(
        class extends Ht {
            ...
            update(t, [i]) {
                ...
                const e = i !== this.ot;
                return (
                    e && void 0 !== this.ot && this.gt(void 0),
                    (e || this.wt !== this._t) &&
                        ((this.ot = i),
    ...
    ui = Ut(
        class extends Vt {
            ...
            update(t, [i, s, e]) {
                var n;
                const o = At(t),
                    { values: r, keys: l } = this.St(i, s, e);
                if (!Array.isArray(o)) return (this.Tt = l), r;
                const h = null !== (n = this.Tt) && void 0 !== n ? n : (this.Tt = []),
                    u = [];
                let c,
                    d,
                    a = 0,
                ...
                for (; a <= v && f <= p; )
                    if (null === o[a]) a++;
                    ...
                    else if (h[a] === l[f]) (u[f] = xt(o[a], r[f])), a++, f++;
                    else if (h[v] === l[p]) (u[p] = xt(o[v], r[p])), v--, p--;
                    else if (h[a] === l[p]) (u[p] = xt(o[a], r[p])), Tt(t, u[p + 1], o[a]), a++, p--;
                    else if (h[v] === l[f]) (u[f] = xt(o[v], r[f])), Tt(t, o[a], o[v]), v--, f++;
                        ...
                        if (c.has(h[v])) {
                            ...
                            if (null === s) {
                                const i = Tt(t, o[a]);
                                xt(i, r[f]), (u[f] = i);
                            } else (u[f] = xt(s, r[f])), Tt(t, o[a], s), (o[i] = null);
                            f++;
                        } else kt(o[v]), v--;
                    else kt(o[a]), a++;
                for (; f <= p; ) {
    ...
    ai = Ut(
        class extends Vt {
            constructor(t) {
                ...
                if (
                    (super(t),
                    1 !== t.type || 'style' !== t.name || (null === (i = t.strings) || void 0 === i ? void 0 : i.length) > 2)
                )
                    throw Error(
            ...
            render(t) {
                return Object.keys(t).reduce((i, s) => {
                    ...
                    return null == e
                        ? i
                        : i +
                              `${(s = s.includes('-') ? s : s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g, '-$&').toLowerCase())}:${e};`;
                }, '');
            }
            update(t, [i]) {
                ...
                if (void 0 === this.xt) {
                    this.xt = new Set();
                    for (const t in i) this.xt.add(t);
                    return this.render(i);
                }
                this.xt.forEach((t) => {
...
const bi = Ut(yi),
    mi = (t) => !yt(t) && 'function' == typeof t.then,
    gi = 1073741823;
/**
 * @license
 * Copyright 2017 Google LLC
 ...
 */ const Si = Symbol.for(''),
    Ti = (t) => {
        if ((null == t ? void 0 : t.r) === Si) return null == t ? void 0 : t._$litStatic$;
    },
    xi = (t) => ({ _$litStatic$: t, r: Si }),
    Ei = (t, ...i) => ({
    ...
    Ai =
        ...
        (i, ...s) => {
            ...
            let h,
                ...
                c = !1;
            for (; u < e; ) {
                for (h = i[u]; u < e && void 0 !== ((o = s[u]), (n = Ti(o))); ) (h += n + i[++u]), (c = !0);
...
export {
    ...
    Dt as AsyncReplaceDirective,
    n as CSSResult,
    Vt as Directive,
    dt as LitElement,
    Pt as PartType,
    m as ReactiveElement,
    bt as TemplateResultType,
    fi as UnsafeHTMLDirective,
    wi as UntilDirective,
