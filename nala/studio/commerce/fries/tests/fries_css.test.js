...
test.describe('M@S Studio Commerce Fries card test suite', () => {
    ...
    test(`${features[0].name},${features[0].tags}`, async ({
        ...
        await test.step('step-2: Validate fries card CSS', async () => {
            ...
            expect(
                await webUtil.verifyCSS(friesCard, fries.cssProp.card),
            ).toBeTruthy();
        });
    });
    ...
    test(`${features[2].name},${features[2].tags}`, async ({
        ...
        await test.step('step-2: Validate fries card CSS', async () => {
            ...
            expect(
                await webUtil.verifyCSS(
                    friesCard.locator(fries.description),
                    fries.cssProp.description,
                ),
            ).toBeTruthy();
        });
    });
