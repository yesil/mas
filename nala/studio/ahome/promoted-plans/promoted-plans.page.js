export default class PromotedPlansPage {
    constructor(page) {
        ...
        this.freeTrialButton = page.locator('div[slot="cta"] button[data-analytics-id="free-trial"]');
        this.buyNowButton = page.locator('div[slot="cta"] button[data-analytics-id="buy-now"]');
        this.cardBorderGradient = page.locator('merch-card[gradient-border="true"]');
    }
}
