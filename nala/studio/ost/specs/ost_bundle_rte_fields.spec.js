    ...
    features: [
        {
            ...
            path: '/studio.html',
            data: { field: 'title', fieldGroup: 'title', secondProduct: 'Illustrator' },
        ...
        },
        {
            ...
            path: '/studio.html',
            data: { field: 'prices', fieldGroup: 'prices', secondProduct: 'Illustrator' },
            tags: '@mas-studio @ost @ost-e2e @ost-bundle-rte-fields',
        },
        {
            tcid: '2',
            ...
            path: '/studio.html',
            data: { field: 'promoText', fieldGroup: 'promoText', secondProduct: 'Illustrator' },
            tags: '@mas-studio @ost @ost-e2e @ost-bundle-rte-fields',
        },
        {
            tcid: '3',
            ...
            path: '/studio.html',
            data: { field: 'description', fieldGroup: 'description', secondProduct: 'Illustrator' },
            tags: '@mas-studio @ost @ost-e2e @ost-bundle-rte-fields',
        },
        {
            tcid: '4',
            ...
            path: '/studio.html',
            data: { field: 'callout', fieldGroup: 'callout', secondProduct: 'Illustrator' },
            tags: '@mas-studio @ost @ost-e2e @ost-bundle-rte-fields',
        },
        {
            tcid: '5',
            ...
            path: '/studio.html',
            data: { field: 'ctas', fieldGroup: 'ctas', secondProduct: 'Illustrator' },
            tags: '@mas-studio @ost @ost-e2e @ost-bundle-rte-fields',
        },
    ],
};
