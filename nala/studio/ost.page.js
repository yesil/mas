export default class OSTPage {
    constructor(page) {
        ...
        this.priceOptical = page.locator('//div[contains(@data-type, "priceOptical")]');
        this.priceStrikethrough = page.locator('//div[contains(@data-type, "priceStrikethrough")]');
        ...
        this.ctaTextMenu = page.locator('button:near(label:text("Cta text"))').first();
        this.promoField = page.locator('//input[contains(@class, "spectrum-Textfield-input")]');
        this.promoLabel = page.locator('//span[contains(@class, "spectrum-Badge-label")]');
        this.checkoutLinkUse = page.locator('button:near(h4:text("Checkout URL"))').first();
