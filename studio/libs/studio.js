...
\f\r"'\`<>=]|("|')|))|$)`,"g"),$e=/'/g,_e=/"/g,Se=/^(?:script|style|textarea|title)$/i,we=n=>(t,...e)=>({_$litType$:n,strings:t,values:e}),f=we(1),Es=we(2),U=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),ye=new WeakMap,k=P.createTreeWalker(P,129,null,!1);function Ce(n,t){if(!Array.isArray(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return ve!==void 0?ve.createHTML(t):t}var Ze=(n,t)=>{let e=n.length-1,s=[],i,r=t===2?"<svg>":"",o=j;for(let l=0;l<e;l++){let a=n[l],c,h,d=-1,u=0;for(;u<a.length&&(o.lastIndex=u,h=o.exec(a),h!==null);)u=o.lastIndex,o===j?h[1]==="!--"?o=fe:h[1]!==void 0?o=ge:h[2]!==void 0?(Se.test(h[2])&&(i=RegExp("</"+h[2],"g")),o=x):h[3]!==void 0&&(o=x):o===x?h[0]===">"?(o=i??j,d=-1):h[1]===void 0?d=-2:(d=o.lastIndex-h[2].length,c=h[1],o=h[3]===void 0?x:h[3]==='"'?_e:$e):o===_e||o===$e?o=x:o===fe||o===ge?o=j:(o=x,i=void 0);let m=o===x&&n[l+1].startsWith("/>")?" ":"";r+=o===j?a+Je:d>=0?(s.push(c),a.slice(0,d)+Nt+a.slice(d)+A+m):a+A+(d===-2?(s.push(void 0),l):m)}return[Ce(n,r+(n[e]||"<?>")+(t===2?"</svg>":"")),s]},q=class n{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let r=0,o=0,l=t.length-1,a=this.parts,[c,h]=Ze(t,e);if(this.el=n.createElement(c,s),k.currentNode=this.el.content,e===2){let d=this.el.content,u=d.firstChild;u.remove(),d.append(...u.childNodes)}for(;(i=k.nextNode())!==null&&a.length<l;){if(i.nodeType===1){if(i.hasAttributes()){let d=[];for(let u of i.getAttributeNames())if(u.endsWith(Nt)||u.startsWith(A)){let m=h[o++];if(d.push(u),m!==void 0){let pt=i.getAttribute(m.toLowerCase()+Nt).split(A),$=/([.?@])?(.*)/.exec(m);a.push({type:1,index:r,name:$[2],strings:pt,ctor:$[1]==="."?Rt:$[1]==="?"?Lt:$[1]==="@"?Mt:M})}else a.push({type:6,index:r})}for(let u of d)i.removeAttribute(u)}if(Se.test(i.tagName)){let d=i.textContent.split(A),u=d.length-1;if(u>0){i.textContent=R?R.emptyScript:"";for(let m=0;m<u;m++)i.append(d[m],z()),k.nextNode(),a.push({type:2,index:++r});i.append(d[u],z())}}}else if(i.nodeType===8)if(i.data===be)a.push({type:2,index:r});else{let d=-1;for(;(d=i.data.indexOf(A,d+1))!==-1;)a.push({type:7,index:r}),d+=A.length-1}r++}}static createElement(t,e){let s=P.createElement("template");return s.innerHTML=t,s}};function L(n,t,e=n,s){var i,r,o,l;if(t===U)return t;let a=s!==void 0?(i=e._$Co)===null||i===void 0?void 0:i[s]:e._$Cl,c=V(t)?void 0:t._$litDirective$;return a?.constructor!==c&&((r=a?._$AO)===null||r===void 0||r.call(a,!1),c===void 0?a=void 0:(a=new c(n),a._$AT(n,e,s)),s!==void 0?((o=(l=e)._$Co)!==null&&o!==void 0?o:l._$Co=[])[s]=a:e._$Cl=a),a!==void 0&&(t=L(n,a._$AS(n,t.values),a,s)),t}var Dt=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var e;let{el:{content:s},parts:i}=this._$AD,r=((e=t?.creationScope)!==null&&e!==void 0?e:P).importNode(s,!0);k.currentNode=r;let o=k.nextNode(),l=0,a=0,c=i[0];for(;c!==void 0;){if(l===c.index){let h;c.type===2?h=new W(o,o.nextSibling,this,t):c.type===1?h=new c.ctor(o,c.name,c.strings,this,t):c.type===6&&(h=new Ft(o,this,t)),this._$AV.push(h),c=i[++a]}l!==c?.index&&(o=k.nextNode(),l++)}return k.currentNode=P,r}v(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},W=class n{constructor(t,e,s,i){var r;this.type=2,this._$AH=p,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cp=(r=i?.isConnected)===null||r===void 0||r}get _$AU(){var t,e;return(e=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&e!==void 0?e:this._$Cp}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=L(this,t,e),V(t)?t===p||t==null||t===""?(this._$AH!==p&&this._$AR(),this._$AH=p):t!==this._$AH&&t!==U&&this._(t):t._$litType$!==void 0?this.g(t):t.nodeType!==void 0?this.$(t):Ge(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==p&&V(this._$AH)?this._$AA.nextSibling.data=t:this.$(P.createTextNode(t)),this._$AH=t}g(t){var e;let{values:s,_$litType$:i}=t,r=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=q.createElement(Ce(i.h,i.h[0]),this.options)),i);if(((e=this._$AH)===null||e===void 0?void 0:e._$AD)===r)this._$AH.v(s);else{let o=new Dt(r,this),l=o.u(this.options);o.v(s),this.$(l),this._$AH=o}}_$AC(t){let e=ye.get(t.strings);return e===void 0&&ye.set(t.strings,e=new q(t)),e}T(t){Ee(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,i=0;for(let r of t)i===e.length?e.push(s=new n(this.k(z()),this.k(z()),this,this.options)):s=e[i],s._$AI(r),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,e);t&&t!==this._$AB;){let i=t.nextSibling;t.remove(),t=i}}setConnected(t){var e;this._$AM===void 0&&(this._$Cp=t,(e=this._$AP)===null||e===void 0||e.call(this,t))}},M=class{constructor(t,e,s,i,r){this.type=1,this._$AH=p,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=p}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,s,i){let r=this.strings,o=!1;if(r===void 0)t=L(this,t,e,0),o=!V(t)||t!==this._$AH&&t!==U,o&&(this._$AH=t);else{let l=t,a,c;for(t=r[0],a=0;a<r.length-1;a++)c=L(this,l[s+a],e,a),c===U&&(c=this._$AH[a]),o||(o=!V(c)||c!==this._$AH[a]),c===p?t=p:t!==p&&(t+=(c??"")+r[a+1]),this._$AH[a]=c}o&&!i&&this.j(t)}j(t){t===p?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},Rt=class extends M{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===p?void 0:t}},Xe=R?R.emptyScript:"",Lt=class extends M{constructor(){super(...arguments),this.type=4}j(t){t&&t!==p?this.element.setAttribute(this.name,Xe):this.element.removeAttribute(this.name)}},Mt=class extends M{constructor(t,e,s,i,r){super(t,e,s,i,r),this.type=5}_$AI(t,e=this){var s;if((t=(s=L(this,t,e,0))!==null&&s!==void 0?s:p)===U)return;let i=this._$AH,r=t===p&&i!==p||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,o=t!==p&&(i===p||r);r&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,s;typeof this._$AH=="function"?this._$AH.call((s=(e=this.options)===null||e===void 0?void 0:e.host)!==null&&s!==void 0?s:this.element,t):this._$AH.handleEvent(t)}},Ft=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){L(this,t)}};var Ae=at.litHtmlPolyfillSupport;Ae?.(q,W),((Ot=at.litHtmlVersions)!==null&&Ot!==void 0?Ot:at.litHtmlVersions=[]).push("2.8.0");var Te=(n,t,e)=>{var s,i;let r=(s=e?.renderBefore)!==null&&s!==void 0?s:t,o=r._$litPart$;if(o===void 0){let l=(i=e?.renderBefore)!==null&&i!==void 0?i:null;r._$litPart$=o=new W(t.insertBefore(z(),l),l,void 0,e??{})}return o._$AI(n),o};var It,Bt;var g=class extends _{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;let s=super.createRenderRoot();return(t=(e=this.renderOptions).renderBefore)!==null&&t!==void 0||(e.renderBefore=s.firstChild),s}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Te(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!1)}render(){return U}};g.finalized=!0,g._$litElement$=!0,(It=globalThis.litElementHydrateSupport)===null||It===void 0||It.call(globalThis,{LitElement:g});var xe=globalThis.litElementPolyfillSupport;xe?.({LitElement:g});((Bt=globalThis.litElementVersions)!==null&&Bt!==void 0?Bt:globalThis.litElementVersions=[]).push("3.3.3");var ke="submit";var Pe="hashchange";function Qe(n=window.location.hash){let t=[],e=n.replace(/^#/,"").split("&");for(let s of e){let[i,r=""]=s.split("=");i&&t.push([i,decodeURIComponent(r.replace(/\+/g," "))])}return Object.fromEntries(t)}function jt(n){let t=new URLSearchParams(window.location.hash.slice(1));Object.entries(n).forEach(([i,r])=>{r?t.set(i,r):t.delete(i)}),t.sort();let e=t.toString();if(e===window.location.hash)return;let s=window.scrollY||document.documentElement.scrollTop;window.location.hash=e,window.scrollTo(0,s)}function Ue(n){let t=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let e=Qe(window.location.hash);n(e)};return t(),window.addEventListener(Pe,t),()=>{window.removeEventListener(Pe,t)}}var Oe={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},He=n=>(...t)=>({_$litDirective$:n,values:t}),lt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this._$Ct=t,this._$AM=e,this._$Ci=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var K=class extends lt{constructor(t){if(super(t),this.et=v,t.type!==Oe.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===v||t==null)return this.ft=void 0,this.et=t;if(t===T)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;let e=[t];return e.raw=e,this.ft={_$litType$:this.constructor.resultType,strings:e,values:[]}}};K.directiveName="unsafeHTML",K.resultType=1;var ct=He(K);var ts="/conf/mas/settings/dam/cfm/models/card",ht=class extends g{createRenderRoot(){return this}render(){if(this.fragment.model.path!==ts)return p;let t=Object.fromEntries(this.fragment.fields.map(e=>[e.name,e]));return f` <p>${this.fragment.path}</p>
            ...
            <sp-field-group horizontal id="horizontal">
                ...
                >
            </sp-field-group>`}updateFragment(t){this.dispatchEvent(new CustomEvent("update-fragment",{detail:t}))}};b(ht,"properties",{fragment:{type:Object}});customElements.define("merch-card-editor",ht);var zt="[data-wcs-osi]",Vt=class extends HTMLElement{constructor(){super(...arguments);b(this,"editor",null);b(this,"savedBookmark",null)}connectedCallback(){this.addEventListener("editor-action-click",this.handleEditorActionClick),window.tinymce.init({target:this,toolbar:"bold italic underline | link openlink unlink | ost",plugins:"link",license_key:"gpl",promotion:!1,branding:!1,extended_valid_elements:"a[is|href|class],span[is|class]",content_style:".price-strikethrough { text-decoration: line-through;}",setup:e=>{this.editor=e,e.on("blur",async s=>{this.savedBookmark=e.selection.getBookmark(2),[...e.contentDocument.querySelectorAll("p")].forEach(l=>{l.innerText.trim()===""&&l.remove()}),[...e.contentDocument.querySelectorAll("a")].forEach(l=>{Object.keys(l.dataset).forEach(a=>{/mce/.test(a)&&delete l.dataset[a]})});let i=[...e.contentDocument.querySelectorAll(zt)];console.log("elements",i),i.forEach(l=>{l.dataset.wcsOsi&&(l.tagName==="A"?l.setAttribute("is","checkout-link"):l.tagName==="SPAN"&&l.setAttribute("is","inline-price"))}),e.contentDocument.body.innerHTML=`${e.contentDocument.body.innerHTML}`,i=[...e.contentDocument.querySelectorAll(zt)],i.forEach(l=>{l.isInlinePrice&&(l.innerHTML=""),l.isCheckoutLink&&l.setAttribute("href",""),l.removeAttribute("class"),l.removeAttribute("contenteditable")}),es(e.contentDocument.body);let r=e.contentDocument.body.innerHTML;i.forEach(l=>{l.setAttribute("contenteditable","false"),l.render?.()});let o=new CustomEvent("blur",{bubbles:!0,composed:!0,detail:{value:r}});this.dispatchEvent(o)}),e.on("init",s=>{let i=document.querySelector('script[src$="mas.js"]')?.src??document.getElementById("mas-src").content;if(!i)return;let r=e.contentDocument.createElement("script");r.src=i,r.setAttribute("type","module"),e.contentDocument.head.appendChild(r);let o=e.contentDocument.createElement("script");o.innerHTML="window.process = { env: {} };",e.contentDocument.head.appendChild(o)}),e.on("SetContent",s=>{[...e.contentDocument.querySelectorAll("a[is],span[is]")].forEach(i=>{i.setAttribute("contenteditable","false")})}),e.ui.registry.addIcon("star-icon",`<svg xmlns="http://www.w3.org/2000/svg" height="18" viewBox="0 0 18 18" width="18">
  <title>Star</title>
...
</svg>`),e.ui.registry.addButton("ost",{icon:"star-icon",tooltip:"Open Offer Selector Tool",onAction:()=>{let s=new CustomEvent("ost-open",{bubbles:!0,composed:!0});this.dispatchEvent(s)}}),e.on("dblclick",s=>{s.preventDefault(),s.stopImmediatePropagation();let i=s.target.closest(zt);if(i){let r=new CustomEvent("ost-open",{bubbles:!0,composed:!0,detail:{clickedElement:i}});this.dispatchEvent(r)}})}})}disconnectedCallback(){this.removeEventListener("editor-action-click",this.handleEditorActionClick)}appendContent(e,s){s&&s.remove(),this.editor&&(this.savedBookmark&&(this.editor.focus(),this.editor.selection.moveToBookmark(this.savedBookmark)),this.editor.insertContent(e))}};function es(n){let t=document.createTreeWalker(n,NodeFilter.SHOW_COMMENT,null,!1),e=[],s;for(;s=t.nextNode();)e.push(s);e.forEach(i=>i.parentNode.removeChild(i))}customElements.define("rte-editor",Vt);var dt,De,Re,O,Le={"buy-now":"Buy now","free-trial":"Free trial","start-free-trial":"Start free trial","get-started":"Get started","choose-a-plan":"Choose a plan","learn-more":"Learn more","change-plan-team-plans":"Change Plan Team Plans",upgrade:"Upgrade","change-plan-team-payment":"Change Plan Team Payment","take-the-quiz":"Take the quiz","see-more":"See more","upgrade-now":"Upgrade now"},ss=["ccd-action","ah"],Ne={aosApiKey:"wcms-commerce-ims-user-prod",checkoutClientId:"creative",country:"US",environment:"PROD",landscape:"PUBLISHED",language:"en",searchParameters:{},searchOfferSelectorId:null,defaultPlaceholderOptions:{displayRecurrence:!0,displayPerUnit:!0,displayTax:!1,displayOldPrice:!1,forceTaxExclusive:!0},wcsApiKey:"wcms-commerce-ims-ro-user-cc",ctaTextOption:{ctaTexts:Object.entries(Le).map(([n,t])=>({id:n,name:t})),getDefaultText(){return this.ctaTexts[0].id},getTexts(){return this.ctaTexts},getSelectedText(n){let t=n.get("text");return t&&this.ctaTexts.find(e=>e.id===t)?t:this.getDefaultText()}}},is=(n,t,e,s,i)=>{if(!!t?.startsWith("checkout")){let o=document.createElement("a",{is:"checkout-link"});o.setAttribute("data-checkout-workflow",s.workflow),o.setAttribute("data-checkout-workflow-step",s.workflowStep??"segmentation"),o.setAttribute("data-promotion-code",i??""),o.setAttribute("data-quantity","1"),o.setAttribute("data-wcs-osi",n),o.href="#";let l=document.createElement("span"),a=s.ctaText??"buy-now";return ss.includes(Re)&&(a=Le[a]),l.textContent=a,o.appendChild(l),o}else{let o=document.createElement("span",{is:"inline-price"});return o.setAttribute("data-display-per-unit",s.displayPerUnit??"false"),o.setAttribute("data-quantity",e.ordering.max_quantity??"1"),o.setAttribute("data-template",t),o.setAttribute("data-wcs-osi",n),o.innerHTML="&nbsp;",o}};function ns(n,t,e,s,i){let r=is(n,t,e,s,i);console.log(`Use Link: ${r.outerHTML}`),O?O.outerHTML=r.outerHTML:De.appendContent(r.outerHTML),rs()}var Me=()=>document.getElementById("ostDialog"),os=()=>{Me().open=!0},rs=()=>{Me().open=!1};function Fe(){return f`
        <sp-overlay id="ostDialog" type="modal">
            <sp-dialog-wrapper dismissable underlay>
                <div id="ost"></div>
            </sp-dialog-wrapper>
        </overlay-trigger>
    `}function Ie(n,t,e){De=t,Re=e,O=n.detail?.clickedElement;let s;if(!dt||O){dt=document.getElementById("ost");let i=localStorage.getItem("masAccessToken")??window.adobeid.authorize(),r=new URLSearchParams,o={...Ne.defaultPlaceholderOptions};O&&(s=O.getAttribute("data-wcs-osi"),Object.assign(o,O.dataset)),window.ost.openOfferSelectorTool({...Ne,rootElement:dt,zIndex:20,aosAccessToken:i,searchParameters:r,searchOfferSelectorId:s,defaultPlaceholderOptions:o,onSelect:ns})}dt&&os()}var as="load-start",ls="load-end",ut=class extends g{constructor(){super(),this.newFragment=null,this.root="/content/dam/mas",this.variant="all",this.searchText="",this.path=""}connectedCallback(){super.connectedCallback(),this.registerListeners(),this.startDeeplink()}registerListeners(){this.addEventListener(as,()=>this.updateDeeplink()),this.addEventListener(ls,()=>this.requestUpdate()),this.addEventListener("open-fragment",t=>this.handleOpenFragment(t))}disconnectedCallback(){super.disconnectedCallback(),this.deeplinkDisposer&&this.deeplinkDisposer()}updateDeeplink(){let t={...this.source?.search};t.path===this.root&&(t.path=""),jt(t)}updated(t){(t.has("searchText")||t.has("path")||t.has("variant"))&&this.source?.sendSearch()}get search(){return this.querySelector("sp-search")}get picker(){return this.querySelector("sp-picker")}get source(){return this.querySelector("aem-fragments")}get fragment(){return this.source?.fragment}createRenderRoot(){return this}get selectFragmentDialog(){return f`
        ...
        `}get fragmentEditorToolbar(){return f`<div id="actions">
            <sp-action-group
