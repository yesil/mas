...
var h = (o, e, t) =>
    e in o
        ? A(o, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
        : (o[e] = t);
var n = (o, e, t) => h(o, typeof e != 'symbol' ? e + '' : e, t),
    T = (o, e, t) => e.has(o) || r('Cannot ' + t);
var a = (o, e, t) => (
        T(o, e, 'read from private field'), t ? t.call(o) : e.get(o)
    ),
    _ = (o, e, t) =>
        e.has(o)
            ...
            : e instanceof WeakSet
              ? e.add(o)
              : e.set(o, t);
import { LitElement as l, css as C, html as S } from '/deps/lit-all.min.js';
var x = Object.freeze({
        MONTH: 'MONTH',
        YEAR: 'YEAR',
        TWO_YEARS: 'TWO_YEARS',
...
var s,
    E = class extends l {
        ...
        connectedCallback() {
            this.style.setProperty('--mod-checkbox-font-size', '12px'),
                ...
                this.updateComplete.then(() => {
                    this.querySelectorAll('[is="inline-price"]').forEach(
                        async (t) => {
                            await t.onceSettled(),
        ...
        render() {
            if (this.planType && !a(this, s).matches)
                return S`
            <sp-checkbox
                size="s"
...
(s = new WeakMap()),
    ...
    n(E, 'properties', {
        checked: { type: Boolean, attribute: 'checked', reflect: !0 },
        planType: { type: String, attribute: 'plan-type', reflect: !0 },
    });
window.customElements.define('merch-stock', E);
export { E as MerchStock };
