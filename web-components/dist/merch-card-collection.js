var fn=Object.defineProperty;var vn=e=>{throw TypeError(e)};var Dc=(e,r,t)=>r in e?fn(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var zc=(e,r)=>{for(var t in r)fn(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>Dc(e,typeof r!="symbol"?r+"":r,t),Sa=(e,r,t)=>r.has(e)||vn("Cannot "+t);var v=(e,r,t)=>(Sa(e,r,"read from private field"),t?t.call(e):r.get(e)),A=(e,r,t)=>r.has(e)?vn("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),E=(e,r,t,a)=>(Sa(e,r,"write to private field"),a?a.call(e,t):r.set(e,t),t),G=(e,r,t)=>(Sa(e,r,"access private method"),t);import{html as De,LitElement as Cc,css as Tc,unsafeCSS as Ac,nothing as ye}from"./lit-all.min.js";var z="(max-width: 767px)",Q="(max-width: 1199px)",M="(min-width: 768px)",P="(min-width: 1200px)",ne="(min-width: 1600px)",Ke="(min-width: 1280px)",xn="(min-width: 1440px)",bn={matchMobile:window.matchMedia(z),matchDesktop:window.matchMedia(`${P} and (not ${ne})`),matchDesktopOrUp:window.matchMedia(P),matchLargeDesktop:window.matchMedia(ne),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},k=bn;function Rr(){return bn.isDesktop}var Vt=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var yn="hashchange";function Aa(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let a of t){let[i,n=""]=a.split("=");i&&r.push([i,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function jt(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([i,n])=>{n?r.set(i,n):r.delete(i)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let a=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,a)}function Ca(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=Aa(window.location.hash);e(t)};return r(),window.addEventListener(yn,r),()=>{window.removeEventListener(yn,r)}}var Ja={};zc(Ja,{AUP_CHECKOUT_CLIENT_IDS:()=>Ka,CLASS_NAME_FAILED:()=>Da,CLASS_NAME_HIDDEN:()=>Fc,CLASS_NAME_PENDING:()=>za,CLASS_NAME_RESOLVED:()=>Ha,CheckoutWorkflow:()=>Jc,CheckoutWorkflowStep:()=>le,Commitment:()=>Xe,ERROR_MESSAGE_BAD_REQUEST:()=>Fa,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Xc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Ba,EVENT_AEM_ERROR:()=>Oa,EVENT_AEM_LOAD:()=>Na,EVENT_COMPARE_CHART_REHYDRATE:()=>Yc,EVENT_EXPANDED_GROUPS_CHANGE:()=>Kc,EVENT_MAS_ERROR:()=>Ia,EVENT_MAS_READY:()=>Ir,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>La,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>_a,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>fe,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Ma,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>Wt,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Pa,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>Or,EVENT_MERCH_OFFER_READY:()=>$c,EVENT_MERCH_OFFER_SELECT_READY:()=>Gc,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>oe,EVENT_MERCH_SEARCH_CHANGE:()=>Wc,EVENT_MERCH_SIDENAV_SELECT:()=>Ra,EVENT_MERCH_STOCK_CHANGE:()=>Vc,EVENT_MERCH_STORAGE_CHANGE:()=>jc,EVENT_OFFER_SELECTED:()=>qc,EVENT_TYPE_FAILED:()=>Ua,EVENT_TYPE_READY:()=>Nr,EVENT_TYPE_RESOLVED:()=>se,Env:()=>we,FF_ANNUAL_PRICE:()=>pt,FF_DEFAULTS:()=>Le,HEADER_X_REQUEST_ID:()=>Yt,LOG_NAMESPACE:()=>$a,Landscape:()=>Be,MARK_DURATION_SUFFIX:()=>Qa,MARK_START_SUFFIX:()=>Xa,MERCH_CARD_LOAD_TIMEOUT:()=>Ta,MODAL_TYPE_3_IN_1:()=>Ee,NAMESPACE:()=>Hc,PARAM_AOS_API_KEY:()=>Qc,PARAM_ENV:()=>qa,PARAM_LANDSCAPE:()=>Va,PARAM_MAS_PREVIEW:()=>Ga,PARAM_WCS_API_KEY:()=>Zc,PLACEHOLDER_PLAN_TYPE_TEXT:()=>al,PROVIDER_ENVIRONMENT:()=>Ya,SELECTOR_MAS_CHECKOUT_LINK:()=>wn,SELECTOR_MAS_ELEMENT:()=>ka,SELECTOR_MAS_INLINE_PRICE:()=>F,SELECTOR_MAS_SP_BUTTON:()=>Uc,SELECTOR_MAS_UPT_LINK:()=>En,SORT_ORDER:()=>xe,STATE_FAILED:()=>ve,STATE_PENDING:()=>Fe,STATE_RESOLVED:()=>ce,SUPPORTED_COUNTRIES:()=>Za,TAG_NAME_SERVICE:()=>Bc,TEMPLATE_PRICE:()=>el,TEMPLATE_PRICE_ANNUAL:()=>rl,TEMPLATE_PRICE_LEGAL:()=>Y,TEMPLATE_PRICE_STRIKETHROUGH:()=>tl,TRIAL_ANALYTICS_IDS:()=>Sn,Term:()=>me,WCS_PROD_URL:()=>ja,WCS_STAGE_URL:()=>Wa});var Xe=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),me=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),Hc="merch",Ta=2e4,Fc="hidden",Nr="wcms:commerce:ready",Bc="mas-commerce-service",F='span[is="inline-price"][data-wcs-osi]',wn='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',Uc="sp-button[data-wcs-osi]",En='a[is="upt-link"]',ka=`${F},${wn},${En}`,Sn=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]),$c="merch-offer:ready",Gc="merch-offer-select:ready",_a="merch-card:action-menu-toggle",qc="merch-offer:selected",Vc="merch-stock:change",jc="merch-storage:change",oe="merch-quantity-selector:change",Or="merch-card-quantity:change",La="merch-modal:addon-and-quantity-update",Wc="merch-search:change",Pa="merch-card-collection:sort",fe="merch-card-collection:literals-changed",Wt="merch-card-collection:sidenav-attached",Ma="merch-card-collection:showmore",Ra="merch-sidenav:select",Na="aem:load",Oa="aem:error",Ir="mas:ready",Ia="mas:error",Yc="mas-compare-chart:rehydrate",Kc="expanded-groups-change",Da="placeholder-failed",za="placeholder-pending",Ha="placeholder-resolved",Fa="Bad WCS request",Ba="Commerce offer not found",Xc="Literals URL not provided",Ua="mas:failed",se="mas:resolved",$a="mas/commerce",Ga="mas.preview",qa="commerce.env",Va="commerce.landscape",Qc="commerce.aosKey",Zc="commerce.wcsKey",ja="https://www.adobe.com/web_commerce_artifact",Wa="https://www.stage.adobe.com/web_commerce_artifact_stage",ve="failed",Fe="pending",ce="resolved",Be={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},Yt="X-Request-Id",le=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),Jc="UCv3",we=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),Ya={PRODUCTION:"PRODUCTION"},Ee={TWP:"twp",D2P:"d2p",CRM:"crm"},Ka=new Set(["creative","mini_plans","doc_cloud","acom_bc"]),Xa=":start",Qa=":duration",el="price",tl="price-strikethrough",rl="annual",Y="legal",al="plan-type-text",Le="mas-ff-defaults",pt="mas-ff-annual-price",xe={alphabetical:"alphabetical",authored:"authored"},Za=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var il="mas-commerce-service";function An(e,r){let t;return function(){let a=this,i=arguments;clearTimeout(t),t=setTimeout(()=>e.apply(a,i),r)}}var Kt=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function Se(e,r={},t=null,a=null){let i=a?document.createElement(e,{is:a}):document.createElement(e);t instanceof HTMLElement?i.appendChild(t):i.innerHTML=t;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function Dr(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function ti(){return window.matchMedia("(max-width: 1024px)").matches}var ei=new Map,nl=0;function Cn(e,r){let t=++nl,a=r,i=performance.now(),n,o=()=>{ri(t),e()},s=()=>{i=performance.now(),n=setTimeout(o,a)},c=()=>{document.visibilityState==="hidden"?(clearTimeout(n),a-=performance.now()-i):s()};return ei.set(t,()=>{clearTimeout(n),document.removeEventListener("visibilitychange",c)}),document.addEventListener("visibilitychange",c),document.visibilityState!=="hidden"&&s(),t}function ri(e){let r=ei.get(e);r&&(r(),ei.delete(e))}function Xt(){return document.getElementsByTagName(il)?.[0]}function Qt(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}var ol=["adobe.com","adobeioruntime.net","aem.live","aem.page"],sl=["localhost","127.0.0.1"];function Tn(e){try{let r=new URL(e);return sl.includes(r.hostname)?r.protocol==="http:"||r.protocol==="https:":r.protocol!=="https:"?!1:ol.some(t=>r.hostname===t||r.hostname.endsWith(`.${t}`))}catch{return!1}}import{html as zr,nothing as cl}from"./lit-all.min.js";var mt,Zt=class Zt{constructor(r){g(this,"card");A(this,mt);this.card=r,this.insertVariantStyle()}getContainer(){return E(this,mt,v(this,mt)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),v(this,mt)}insertVariantStyle(){let r=this.constructor.name;if(!Zt.styleMap[r]){Zt.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let a=`--consonant-merch-card-${this.card.variant}-${t}-height`,i=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(a))||0;i>o&&n.style.setProperty(a,`${i}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let a=this.card.variant,i=Array.from(t.querySelectorAll(`merch-card[variant="${a}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${a}-${o}-height`;t.style.getPropertyValue(s)&&t.style.removeProperty(s)}let n=new Map;for(let o of i){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of r){let l=`--consonant-merch-card-${a}-${s}-height`,d=o.map(h=>h.style.getPropertyValue(l)),m=0,p=o.map(h=>{h.style.removeProperty(l);let u=c(h);if(!u)return u;let f=Math.max(0,parseInt(window.getComputedStyle(u).height)||0);return f>m&&(m=f),u});o.forEach((h,u)=>{p[u]?.tagName!=="HR"&&(m>0?h.style.setProperty(l,`${m}px`):d[u]&&h.style.setProperty(l,d[u]))})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),zr`
            <div
                id="badge"
        ...
        `}get cardImage(){return zr` <div class="image">
            <slot name="bg-image"></slot>
            ${this.badge}
        </div>`}getGlobalCSS(){return""}get theme(){return document.querySelector("sp-theme")}get evergreen(){return this.card.classList.contains("intro-pricing")}get promoBottom(){return this.card.classList.contains("promo-bottom")}get headingSelector(){return'[slot="heading-xs"]'}get secureLabel(){return this.card.secureLabel?zr`<span class="secure-transaction-label"
                  >${this.card.secureLabel}</span
              >`:cl}get secureLabelFooter(){return zr`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length>0)){let r=Promise.allSettled(this.card.prices.map(i=>i.onceSettled?.()||Promise.resolve())),t,a=new Promise(i=>{t=setTimeout(i,Ta)});await Promise.race([r,a]),clearTimeout(t)}}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return Jt(this.card.variant)}};mt=new WeakMap,g(Zt,"styleMap",{});var w=Zt;import{html as ai,css as ll}from"./lit-all.min.js";var kn=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
            ...
            <slot></slot>`}getGlobalCSS(){return kn}setAriaExpanded(t,a){t.setAttribute("aria-expanded",a)}connectedCallbackHook(){this.card.addEventListener("mouseenter",this.showActionMenuOnHover),this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.addEventListener("focusin",this.showActionMenuOnHover),this.card.addEventListener("focusout",this.handleCardFocusOut),this.card.addEventListener("keydown",this.handleKeyDown)}disconnectedCallbackHook(){this.card.removeEventListener("mouseenter",this.showActionMenuOnHover),this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.removeEventListener("focusin",this.showActionMenuOnHover),this.card.removeEventListener("focusout",this.handleCardFocusOut),this.card.removeEventListener("keydown",this.handleKeyDown)}};g(ut,"variantStyle",ll`
    ...
    `);import{html as er,css as dl}from"./lit-all.min.js";var Ln=`
:root {
...
`;var Pn={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},Qe=class extends w{constructor(r){super(r)}getGlobalCSS(){return Ln}renderLayout(){return er`<div class="image">
                <slot name="bg-image"></slot>
            ...
            <div class="body">
                ...
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
                ${this.promoBottom?er`<slot name="body-xs"></slot
                          ><slot name="promo-text"></slot>`:er`<slot name="promo-text"></slot
                          ><slot name="body-xs"></slot>`}
            </div>
            ${this.evergreen?er`
                      <div
    ...
    `);import{html as Rn}from"./lit-all.min.js";var Mn=`
:root {
...
`;var Hr=class extends w{constructor(r){super(r)}getGlobalCSS(){return Mn}renderLayout(){return Rn` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":Rn`<hr />`} ${this.secureLabelFooter}`}};import{html as Ue,css as hl,unsafeCSS as On}from"./lit-all.min.js";var Nn=`
  :root {
...
`;var pl=32,ii={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"};function tr(e,r,t,a){e.settings?.displayAnnual&&r?.options[a]?t.dataset[a]="false":r?.options[a]&&(r.dataset[a]="false")}var gt=class extends w{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?Ue`<slot name="secure-transaction-label">
    ...
    `);import{html as Fr,css as ml,unsafeCSS as ni,nothing as ul}from"./lit-all.min.js";var In=`
  :root {
...
`;var gl=32,fl=0,vl=()=>`mweb-list-${fl+=1}`,xl=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"],bl=8,ci={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Ae,Ze,vt,xt,bt,$e,oi,si,ft=class extends w{constructor(t){super(t);A(this,$e);A(this,Ae);A(this,Ze);A(this,vt);A(this,xt,0);A(this,bt);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>Fr` <footer>
        ...
        </div>`);this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){this.card.addEventListener(oe,this.updatePriceQuantity),E(this,xt,this.card.getBoundingClientRect().width),E(this,Ze,new ResizeObserver(()=>{let t=this.card.getBoundingClientRect().width;t!==v(this,xt)&&(E(this,xt,t),clearTimeout(v(this,vt)),E(this,vt,setTimeout(()=>this.reconcileBreakpoint(),150)))})),v(this,Ze).observe(this.card)}disconnectedCallbackHook(){this.card.removeEventListener(oe,this.updatePriceQuantity),clearTimeout(v(this,vt)),v(this,Ze)?.disconnect(),E(this,Ze,null),v(this,Ae)?.disconnect(),E(this,Ae,null)}reconcileBreakpoint(){k.isMobile?(this.resetSyncedHeights(),this.removeEmptyRows()):G(this,$e,si).call(this)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}syncHeights(){if(k.isMobile)return;if(this.card.getBoundingClientRect().width<=2){v(this,Ae)||(E(this,Ae,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,Ae)?.disconnect(),E(this,Ae,null),this.syncHeights())})),v(this,Ae).observe(this.card));return}let t=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"];this.syncRowHeights(t.map(a=>({name:a,getElement:i=>i.querySelector(`[slot="${a}"]`)}))),this.adjustMiniCompareFooterRows()}priceOptionsProvider(t,a){let i=ci.prices.slot;if(t.closest(`[slot="${i}"]`)){if(t.dataset.template===Y){a.displayPlanType=this.card?.settings?.displayPlanType??!1;return}(t.dataset.template==="strikethrough"||t.dataset.template==="price"&&!t.closest?.("merch-card")?.settings?.displayAnnual)&&(a.displayPerUnit=!1)}}getGlobalCSS(){return In}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="footer-rows"] ul');!t||!t.children||[...t.children].forEach((a,i)=>{let n=Math.max(gl,parseFloat(window.getComputedStyle(a).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(i+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(i+1),`${n}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(a=>{let i=a.querySelector(".footer-row-cell-description");i&&!i.textContent.trim()&&a.remove()})}setupToggle(){let t=this.card.querySelector('[slot="body-xs"]'),a=t?.querySelector("p"),i=t?.querySelector("ul");if(!a||!i||t.querySelector(".footer-rows-title"))return;let n=a.textContent.trim(),o=this.card.querySelector("h3")?.id,s=o?`${o}-list`:vl();i.id=s,i.classList.add("checkmark-copy-container");let c=Se("h4",{class:"footer-rows-title"},n),l=Se("button",{class:"toggle-icon","aria-label":n,"aria-expanded":"false","aria-controls":s});E(this,bt,{toggleBtn:l,listEl:i}),c.append(l),c.addEventListener("click",()=>{k.isMobile&&this.setListOpen(!this.isListOpen)}),a.replaceWith(c)}get isListOpen(){return v(this,bt)?.listEl.classList.contains("open")??!1}setListOpen(t){let{toggleBtn:a,listEl:i}=v(this,bt);i.classList.toggle("open",t),a.classList.toggle("expanded",t),a.setAttribute("aria-expanded",String(t))}get legalDisplayDot(){return!1}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${F}[data-template="price"]`)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPlanType&&(t.dataset.displayPlanType="false"),tr(this.card,t,a,"displayTax"),tr(this.card,t,a,"displayPerUnit"),a.setAttribute("data-template","legal"),t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled()}catch{}}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?ul:Fr`<slot name="icons"></slot>`}renderLayout(){return Fr`
            ${this.badge}
            <div class="body">
                <div class="body-main">
                    ${this.icons}
        ...
        `}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),this.setupToggle(),k.isMobile&&this.removeEmptyRows(),await super.postCardUpdateHook(),k.isMobile||await G(this,$e,si).call(this)}resetSyncedHeights(){let t=this.getContainer();if(!t)return;let a=this.card.variant,i=G(this,$e,oi).call(this,t);for(let n of xl){let o=`--consonant-merch-card-${a}-${n}-height`;t.style.removeProperty(o),i.forEach(s=>s.style.removeProperty(o))}for(let n=1;n<=bl;n+=1)t.style.removeProperty(this.getRowMinHeightPropertyName(n))}};Ae=new WeakMap,Ze=new WeakMap,vt=new WeakMap,xt=new WeakMap,bt=new WeakMap,$e=new WeakSet,oi=function(t){return t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)},si=async function(){let t=this.getContainer();if(!t)return;let a=Array.from(G(this,$e,oi).call(this,t));this.card===a[0]&&(await Promise.all(a.map(i=>i.updateComplete)),await new Promise(i=>setTimeout(i,100)),requestAnimationFrame(()=>{this.resetSyncedHeights(),this.syncHeights()}))},g(ft,"variantStyle",ml`
        ...
        @media screen and ${ni(P)} {
            :host([variant='mini-compare-chart-mweb']) footer {
                padding: 0;
            }
        }

        @media screen and ${ni(M)} {
            :host([variant='mini-compare-chart-mweb'])
                .price-wrapping
                > slot[name='subtitle'] {
                min-height: var(
    ...
    `);import{html as rr,css as yl,nothing as Br}from"./lit-all.min.js";var Dn=`
:root {
...
`;var Ur={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},zn={...(function(){let{whatsIncluded:e,size:r,...t}=Ur;return t})(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Hn={...(function(){let{subtitle:e,whatsIncluded:r,size:t,quantitySelect:a,...i}=Ur;return i})()},Ce,Te,de=class extends w{constructor(t){super(t);A(this,Ce);A(this,Te);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,a){t.dataset.template===Y&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Dn}adjustSlotPlacement(t,a,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),d=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!a.includes(s)){if(o?.classList.toggle("wide-footer",k.isDesktopOrUp),!i&&c){if(l)c.remove();else{let m=d.querySelector(`[data-placeholder-for="${t}"]`);m?m.replaceWith(c):d.appendChild(c)}return}if(i&&l){let m=document.createElement("div");if(m.setAttribute("data-placeholder-for",t),m.classList.add("slot-placeholder"),!c){let p=l.cloneNode(!0);o.prepend(p)}l.replaceWith(m)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],k.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],k.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){v(this,Ce)||(E(this,Ce,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,Ce)?.disconnect(),E(this,Ce,null),this.syncHeights())})),v(this,Ce).observe(this.card));return}let t=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(t.map(a=>({name:a,getElement:i=>i.querySelector(`[slot="${a}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let a=this.card.querySelector('[slot="body-xs"]');if(!a)return;let i=a.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),a.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=Qt(d));let m=this.card.querySelector('[slot="subtitle"]');m&&(l+=Qt(m));let p=this.card.querySelector('[slot="heading-m"]');p&&(l+=8+Qt(p));for(let u of a.childNodes){if(u.classList.contains("spacer"))break;l+=Qt(u)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${F}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?rr`<div class="divider"></div>`:Br}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],a=this.card.querySelector(`[slot="heading-m"] ${F}[data-template="price"]`);a&&t.push(a);let i=t.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?rr`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};Ce=new WeakMap,Te=new WeakMap,g(de,"variantStyle",yl`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),g(de,"collectionOptions",{customHeaderArea:t=>t.sidenav?rr`<slot name="resultsText"></slot>`:Br,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let a=()=>{let i=t.querySelectorAll("merch-card");for(let o of i)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!k.isDesktop)return;let n=0;for(let o of i){if(o.style.display==="none")continue;let s=o.getAttribute("size"),c=s==="wide"?2:s==="super-wide"?3:1;c===2&&n%3===2&&(o.setAttribute("data-size",s),o.removeAttribute("size"),c=1),n+=c}};k.matchDesktop.addEventListener("change",a),t.addEventListener(fe,a),t.onUnmount.push(()=>{k.matchDesktop.removeEventListener("change",a),t.removeEventListener(fe,a)})}});import{html as Pe,css as wl,unsafeCSS as Bn,nothing as $r}from"./lit-all.min.js";var Fn=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let t=r.querySelector("strong, b, p");t&&(k.isMobile?t.style.display="none":t.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?k.isMobile?Pe`
        ...
        `:Pe`
            ...
            `:$r}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?Pe`<slot name="icons"></slot>`:$r}get secureLabelFooter(){return Pe`<footer>
            ...
            <slot></slot>`}};g(Ge,"variantStyle",wl`
    ...
    `),g(Ge,"collectionOptions",{customHeaderArea:r=>r.sidenav?Pe`<slot name="resultsText"></slot>`:$r,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:r=>{let t=()=>{let a=r.querySelectorAll("merch-card");if(a.forEach(n=>{n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"))}),!k.isDesktop)return;let i=0;a.forEach(n=>{if(n.style.display==="none")return;let o=n.getAttribute("size"),s=o==="wide"?2:o==="super-wide"?3:1;s===2&&i%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),s=1),i+=s})};k.matchDesktop.addEventListener("change",t),r.addEventListener(fe,t),r.onUnmount.push(()=>{k.matchDesktop.removeEventListener("change",t),r.removeEventListener(fe,t)})}});import{html as Me,css as El,nothing as yt,unsafeCSS as ar}from"./lit-all.min.js";var Un=`
:root {
...
`;var[Pm,Mm,$n,Gn,qn,Vn]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var qr="pro",di=`--consonant-merch-card-${qr}-top-card-height`,Gr=[{prop:`--consonant-merch-card-${qr}-mnemonic-height`,selector:".mnemonic"},{prop:`--consonant-merch-card-${qr}-name-description-height`,selector:".name-description"}],jn=`--consonant-merch-card-${qr}-strike-reserve`,hi='[slot="heading-m"] :is(.price-strikethrough, .price-promo-strikethrough, [data-template="strikethrough"])',Sl="(min-width: 768px)",Wn={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},eduDisclaimer:{tag:"div",slot:"edu-disclaimer"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"},hideTransparent:!0,disableWhenBackgroundColor:"dark"},allowedBorderColors:[],style:"consonant"},Re,Je,sr,cr,K,Yn,ir,Kn,nr,pi,Vr,jr=class jr extends w{constructor(t){super(t);A(this,K);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);A(this,Re,null);A(this,Je,null);A(this,sr,()=>this.resyncOnReflow());g(this,"lastSyncKey",null);A(this,cr,({detail:t})=>{let a=t?.quantity==null?null:String(t.quantity);a==null||a===this.licenseQty||this.licenseOptions?.includes(a)&&(this.licenseQty=a,this.card.requestUpdate())});g(this,"toggleExpanded",t=>{t.preventDefault();let a=!this.expanded;for(let i of G(this,K,Yn).call(this)){let n=i.variantLayout;n instanceof jr&&(n.expanded=a,i._proExpanded=a,i.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?G(this,K,pi).call(this):G(this,K,nr).call(this),this.card.requestUpdate()});A(this,Vr,t=>{let a=this.licenseOptions;if(!a?.length)return;let i=a.length-1;switch(t.key){case Gn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%a.length:G(this,K,nr).call(this);break;case $n:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+a.length)%a.length:G(this,K,nr).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=i;break;case qn:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(a[this.licenseHighlightedIndex]);return}G(this,K,nr).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),G(this,K,pi).call(this);break;case Vn:this.licenseOpen&&this.selectLicenseQty(a[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,G(this,K,ir).call(this);let a=this.quantitySelectEl;a&&(a.selectedValue=Number(t),a.dispatchEvent(new CustomEvent(oe,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=t._proExpanded??!1}getGlobalCSS(){return Un}priceOptionsProvider(t,a){t.dataset.template===Y&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),a.dataset.displayPerUnit="false",t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),a.addEventListener(se,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]');if(!t?.textContent?.trim())return;let i=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),n=i?.querySelector(".price-plan-type");if(!n)return;n.innerHTML=t.innerHTML;let o=i.querySelector(".price-tax-inclusivity:not(.disabled)");o?.textContent&&!/\s$/.test(o.textContent)&&(o.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasEduDisclaimer(){return!this.card?.settings?.hideEduDisclaimer}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${F}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}async postCardUpdateHook(){this.adjustEduWhatsIncluded(),await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}adjustEduWhatsIncluded(){if(this.card.size!=="edu")return;let t=this.card.querySelector('[slot="whats-included"]');if(!t||t.querySelector(".whats-included-title"))return;let a=t.querySelector(".whats-included-label");if(!a)return;let i=document.createElement("h4");i.className="whats-included-title",i.innerHTML=a.innerHTML,a.replaceWith(i);let{whatsIncludedLabel:n,eduDisclaimer:o}=this.card.placeholders??{},s=document.createElement("p");if(s.className="whats-included-label",s.textContent=n??"",i.after(s),t.querySelectorAll(".section h4:not(.whats-included-title)").forEach(c=>{let l=document.createElement("p");l.innerHTML=c.innerHTML,c.replaceWith(l)}),o){let c=document.createElement("div");c.className="whats-included-disclaimer",c.innerHTML=o,t.append(c)}}async waitForContentFonts(){let t=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(t.map(a=>{let i=window.getComputedStyle(a),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,a.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1){this.clearSyncedHeights(this.card);return}await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let t=this.getContainer();if(!t||this.card.getBoundingClientRect().width<=2)return;let a=this.card.variant,i=di,n=[...t.querySelectorAll(`merch-card[variant="${a}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1);if(!window.matchMedia(Sl).matches){n.forEach(c=>this.clearSyncedHeights(c));return}let o=new Map;for(let c of n){let l=o.get(c.offsetTop)??[];l.push(c),o.set(c.offsetTop,l)}let s=(c,l)=>c.reduce((d,m)=>{let p=l(m);return p?Math.max(d,parseInt(getComputedStyle(p).height)||0):d},0);for(let c of o.values()){if(c.forEach(p=>this.clearSyncedHeights(p)),c.length<2)continue;let l=c.map(p=>p.querySelector(hi)&&parseInt(getComputedStyle(p.querySelector(hi)).height)||0),d=Math.max(0,...l);d>0&&c.forEach((p,h)=>{let u=d-l[h];u>0&&p.style.setProperty(jn,`${u}px`)});for(let p of Gr){let h=s(c,u=>u.shadowRoot?.querySelector(p.selector));h>0&&c.forEach(u=>u.style.setProperty(p.prop,`${h}px`))}let m=s(c,p=>p.shadowRoot?.querySelector(".top-card"));m>0&&c.forEach(p=>p.style.setProperty(i,`${m}px`))}}clearSyncedHeights(t){t.style.removeProperty(di),t.style.removeProperty(jn),Gr.forEach(a=>t.style.removeProperty(a.prop))}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=(n,o=this.card)=>Math.round(o?.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(t),a('[slot="body-xs"]'),a(hi),a('[slot="heading-m"] span[is="inline-price"]'),a('[slot="heading-m"] :is(.price-legal, [data-template="legal"])'),a(".license-zone",this.card.shadowRoot),a(".add-on",this.card.shadowRoot)].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(Or,v(this,cr)),this.card.addEventListener(oe,this.updatePriceQuantity),this.card.addEventListener(se,v(this,sr)),typeof ResizeObserver>"u"))return;E(this,Je,new ResizeObserver(()=>this.resyncOnReflow())),v(this,Je).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,Je).observe(t)}disconnectedCallbackHook(){this.card?.removeEventListener(oe,this.updatePriceQuantity),this.card?.removeEventListener(se,v(this,sr)),G(this,K,ir).call(this),v(this,Je)?.disconnect(),this.card?.removeEventListener(Or,v(this,cr))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let a=parseInt(t.getAttribute("min"),10),i=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(a)||Number.isNaN(i)||i<a||n<1)return null;let o=[];for(let s=a;s<=i;s+=n)o.push(String(s));return o}licenseLabel(t){let a=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=a.split("|").map(o=>o.trim());return Number(t)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let a=this.quantitySelectEl?.getAttribute("default-value");return a!=null&&t.includes(a)?a:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Me`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,a=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(a));return Me`
            <div class="license-select" ?data-open=${i}>
                <div
                    ...
                    aria-activedescendant=${i?`license-option-${this.licenseHighlightedIndex}`:yt}
        ...
        `}renderLayout(){let t=!!this.expanded;return Me`
            ...
            <slot></slot>
        `}};Re=new WeakMap,Je=new WeakMap,sr=new WeakMap,cr=new WeakMap,K=new WeakSet,Yn=function(){let t=this.card.offsetTop,a=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===t);return a.length?a:[this.card]},ir=function(){v(this,Re)&&(document.removeEventListener("mousedown",v(this,Re)),E(this,Re,null))},Kn=function(){let t=this.licenseOptions?.indexOf(this.currentLicenseValue);return t>0?t:0},nr=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=G(this,K,Kn).call(this),v(this,Re)||(E(this,Re,t=>{t.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),G(this,K,ir).call(this))}),document.addEventListener("mousedown",v(this,Re)))},pi=function(){this.licenseOpen=!1,G(this,K,ir).call(this)},Vr=new WeakMap,g(jr,"variantStyle",El`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
        ...
        :host([variant='pro']) .mnemonic {
            ...
            align-items: center;
            gap: 12px;
            min-height: var(${ar(Gr[0].prop)}, auto);
        }
        ...
        :host([variant='pro']) .name-description {
            ...
            flex: 0 0 auto;
            min-height: var(${ar(Gr[1].prop)}, auto);
        }
    ...
    `);var or=jr;import{html as mi,css as Al}from"./lit-all.min.js";var Xn=`
:root {
...
`;var Qn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ke,wt=class extends w{constructor(t){super(t);A(this,ke);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Xn}priceOptionsProvider(t,a){t.dataset.template===Y&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(a.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a))}renderLayout(){return mi` ${this.badge}
    ...
    `);import{html as Cl,css as Tl}from"./lit-all.min.js";var Zn=`
...
`;var Jn={cardName:{attribute:"name"},mnemonics:{size:"l"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],title:{tag:"h3",slot:"heading-s"},prices:{tag:"p",slot:"heading-xs"},planType:!0,promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},style:"consonant"},Et=class extends w{getGlobalCSS(){return Zn}priceOptionsProvider(r,t){r.dataset.template===Y&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.card.querySelector(`[slot="heading-xs"] ${F}[data-template="price"]`);if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}async postCardUpdateHook(){this.card.isConnected&&(this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}renderLayout(){return Cl` ${this.badge}
            <div class="body">
                <slot name="icons"></slot>
                <slot name="badge"></slot>
                <slot name="heading-s"></slot>
            ...
            <slot></slot>`}};g(Et,"variantStyle",Tl`
    ...
    `);import{html as ui,css as kl}from"./lit-all.min.js";var eo=`
:root {
...
`;var to={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},St=class extends w{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===Y&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return eo}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${F}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return ui`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
                ${this.promoBottom?"":ui`<slot name="promo-text"></slot
                          ><slot name="callout-content"></slot>`}
                <slot name="body-xs"></slot>
                ${this.promoBottom?ui`<slot name="promo-text"></slot
                          ><slot name="callout-content"></slot>`:""}
    ...
    `);import{html as _l,css as Ll}from"./lit-all.min.js";var ro=`
...
`;var ao={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},At=class extends w{constructor(r){super(r)}getGlobalCSS(){return ro}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return _l`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as gi,css as Pl}from"./lit-all.min.js";var io=`
:root {
...
`;var no={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Ct=class extends w{constructor(t){super(t);g(this,"legal")}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return io}priceOptionsProvider(t,a){a.displayPlanType=this.card?.settings?.displayPlanType??!1}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${F}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayPlanType="false",a.dataset.template="legal",a.dataset.displayPerUnit="false",a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return gi`${this.cardImage}
            ...
            ${this.evergreen?gi`
                  ...
                  `:gi`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};g(Ct,"variantStyle",Pl`
    ...
    `);import{html as so,css as Ml}from"./lit-all.min.js";var oo=`
:root {
...
`;var fi={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Tt=class extends w{getGlobalCSS(){return oo}get aemFragmentMapping(){return fi}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return so`<div
    ...
    `);import{html as lo,css as Rl}from"./lit-all.min.js";var co=`
:root {
...
`;var vi={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},lr=class lr extends w{getGlobalCSS(){return co}get aemFragmentMapping(){return vi}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return lo`<div
        ...
        >
            ...
            <slot></slot>
        `}};g(lr,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),g(lr,"variantStyle",Rl`
    ...
    `);var dr=lr;import{html as hr,nothing as po}from"./lit-all.min.js";import{css as Nl,unsafeCSS as Ol}from"./lit-all.min.js";var ho=["headless","marquee","faq","banner-blade"],kt=(e,r="")=>ho.map(t=>`merch-card[variant='${t}'] [slot='${e}']${r}`).join(`,
`),xi=e=>ho.map(r=>`merch-card[variant='${r}'] ${e}`).join(`,
`),qe=`
...
${kt("callout-content"," > p")},
${kt("callout-content"," > div")},
${kt("callout-content"," > div > div")} {
    background: transparent;
    padding: 0;
    border-radius: 0;
    width: auto;
...
${xi(".headless-cta-item")} {
    display: inline-flex;
    align-items: center;
}
${xi(".headless-cta-variant-label")} {
    font-size: 0.75em;
...
${xi(".headless-cta-item:not(:last-child)::after")} {
    content: ', ';
}
`;function Ve(e){let r=Ol(e);return Nl`
        :host([variant='${r}']) {
            border: none;
            background: transparent;
            box-shadow: none;
    ...
    `}var mo={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"},customFields:{tag:"div",slot:"custom-fields"}},Il=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],_t=class extends w{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){let r=[...this.card.querySelectorAll('[slot^="custom-field-"]')];return hr`
        ...
        `}};g(_t,"variantStyle",Ve("headless"));import{css as Dl,html as zl}from"./lit-all.min.js";var uo=`
...
`;var go={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Lt=class extends w{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return uo}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,a){a.literals={...a.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},a.space=!0,a.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${F}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",a.dataset.template="legal",a.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return zl`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Hl,css as Fl}from"./lit-all.min.js";var fo=`
...
`;var bi={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Bl=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Wr,vo,Pt=class extends w{constructor(t){super(t);A(this,Wr);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return fo}get aemFragmentMapping(){return bi}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,G(this,Wr,vo).call(this))}renderLayout(){return Hl`
            <div class="card">
            ...
            <slot></slot>
        `}};Wr=new WeakSet,vo=function(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;Bl.forEach(({key:a,selector:i})=>this.updateCardElementMinHeight(t.querySelector(i),a))},g(Pt,"variantStyle",Fl`
    ...
    `);import{html as Ul,css as $l}from"./lit-all.min.js";var xo=`
...
`;var yi={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Mt=class extends w{getGlobalCSS(){return xo}get aemFragmentMapping(){return yi}renderLayout(){return Ul`
    ...
    `);import{html as wi,nothing as Gl}from"./lit-all.min.js";var bo={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"p",slot:"short-description"},prices:{tag:"p",slot:"prices"},ctas:{slot:"footer",size:"m"}},ql=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Product description"},{slot:"short-description",label:"Short Description"},{slot:"prices",label:"Product price"},{slot:"footer",label:"CTAs"}],Rt=class extends w{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){return wi`
            <div class="headless">
                ${ql.map(({slot:r,label:t})=>wi`
                        <div class="headless-row">
        ...
        `}};g(Rt,"variantStyle",Ve("marquee"));import{html as yo}from"./lit-all.min.js";var wo={cardName:{attribute:"name"},prices:{tag:"p",slot:"prices"},description:{tag:"div",slot:"body-xs",editorLabel:"FAQ answer 1"},shortDescription:{tag:"p",slot:"short-description",editorLabel:"FAQ answer 2"},callout:{tag:"div",slot:"callout-content",editorLabel:"FAQ answer 3"}},Vl=[{slot:"prices",label:"Product price"},{slot:"body-xs",label:"FAQ answer 1"},{slot:"short-description",label:"FAQ answer 2"},{slot:"callout-content",label:"FAQ answer 3"}],Nt=class extends w{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){return yo`
            <div class="headless">
                ${Vl.map(({slot:r,label:t})=>yo`
                        <div class="headless-row">
                            <span class="headless-label">${t}</span>
                            <span class="headless-value">
                                <slot name="${r}"></slot>
        ...
        `}};g(Nt,"variantStyle",Ve("faq"));import{html as Eo}from"./lit-all.min.js";var So={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"}},jl=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Description"},{slot:"footer",label:"CTAs"}],Ot=class extends w{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){return Eo`
            <div class="headless">
                ${jl.map(({slot:r,label:t})=>Eo`
                        <div class="headless-row">
                            <span class="headless-label">${t}</span>
                            <span class="headless-value" data-slot="${r}">
                                <slot name="${r}"></slot>
        ...
        `}};g(Ot,"variantStyle",Ve("banner-blade"));import{html as Wl,css as Yl}from"./lit-all.min.js";var Ao=`
...
`;var Co=M,To=[{name:"heading-s",getElement:e=>e.querySelector('[slot="heading-s"]')},{name:"body-xs",getElement:e=>e.querySelector('[slot="body-xs"]')},{name:"price",getElement:e=>e.shadowRoot?.querySelector(".price")}],ko={cardName:{attribute:"name"},mnemonics:{size:"s"},badge:{tag:"div",slot:"badge"},title:{tag:"h3",slot:"heading-s"},prices:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},ctas:{slot:"footer",size:"m"},planType:!0,style:"consonant"},Ne,pr,It=class extends w{constructor(){super(...arguments);A(this,Ne,null);A(this,pr,()=>this.resyncOnReflow());g(this,"lastSyncKey",null)}getGlobalCSS(){return Ao}get headingSelector(){return'[slot="heading-s"]'}priceOptionsProvider(t,a){t.dataset.template===Y&&(a.displayPlanType=this.card?.settings?.displayPlanType??!0)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.card.querySelector(`[slot="heading-xs"] ${F}:not([data-template="legal"])`);if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),this.legalHost().appendChild(a),await a.onceSettled()}catch{}}legalHost(){let t=this.card.querySelector('p[slot="legal"]');return t||(t=document.createElement("p"),t.setAttribute("slot","legal"),this.card.appendChild(t)),t}async postCardUpdateHook(){this.card.isConnected&&(this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook(),this.flagPriceRow(),window.matchMedia(Co).matches&&requestAnimationFrame(()=>this.syncHeights()))}syncHeights(){this.card.getBoundingClientRect().width<=2||window.matchMedia(Co).matches&&this.syncRowHeights(To)}flagPriceRow(){this.card.toggleAttribute("no-price",!this.card.querySelector('[slot="heading-xs"]'))}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=[Math.round(t),...To.map(({getElement:i})=>Math.round(i(this.card)?.getBoundingClientRect().height||0))].join(":");a!==this.lastSyncKey&&(this.lastSyncKey=a,this.syncHeights())}connectedCallbackHook(){if(this.card.addEventListener(se,v(this,pr)),typeof ResizeObserver>"u")return;E(this,Ne,new ResizeObserver(()=>this.resyncOnReflow())),v(this,Ne).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,Ne).observe(t);let a=this.card.querySelector('[slot="short-description"]');a&&v(this,Ne).observe(a)}disconnectedCallbackHook(){this.card.removeEventListener(se,v(this,pr)),v(this,Ne)?.disconnect(),E(this,Ne,null)}renderLayout(){return Wl` <div class="header">
                <slot name="icons"></slot>
                <slot name="badge"></slot>
            </div>
            <div class="panel">
            ...
            <slot></slot>`}};Ne=new WeakMap,pr=new WeakMap,g(It,"variantStyle",Yl`
    ...
    `);var _o=new Map;var B=(e,r,t=null,a=null,i)=>{_o.set(e,{class:r,fragmentMapping:t,style:a,collectionOptions:i})};B("catalog",ut,_n,ut.variantStyle);B("image",Qe);B("inline-heading",Hr);B("mini-compare-chart",gt,ii,gt.variantStyle);B("mini-compare-chart-mweb",ft,ci,ft.variantStyle);B("plans",de,Ur,de.variantStyle,de.collectionOptions);B("plans-students",de,Hn,de.variantStyle,de.collectionOptions);B("plans-education",de,zn,de.variantStyle,de.collectionOptions);B("plans-v2",Ge,li,Ge.variantStyle,Ge.collectionOptions);B("pro",or,Wn,or.variantStyle);B("product",wt,Qn,wt.variantStyle);B("brand-concierge-product",Et,Jn,Et.variantStyle);B("segment",St,to,St.variantStyle);B("media",At,ao,At.variantStyle);B("headless",_t,mo,_t.variantStyle);B("special-offers",Ct,no,Ct.variantStyle);B("simplified-pricing-express",Tt,fi,Tt.variantStyle);B("full-pricing-express",dr,vi,dr.variantStyle);B("mini",Lt,go,Lt.variantStyle);B("image",Qe,Pn,Qe.variantStyle);B("compare-chart-column",Pt,bi,Pt.variantStyle);B("fries",Mt,yi,Mt.variantStyle);B("marquee",Rt,bo,Rt.variantStyle);B("faq",Nt,wo,Nt.variantStyle);B("banner-blade",Ot,So,Ot.variantStyle);B("product-pricing",It,ko,It.variantStyle);function Jt(e){return _o.get(e)?.fragmentMapping}var Po=e=>{let r=e.replace(/^mas:/,"").split("/");return r.length<2?[null,null]:[r[0],r[r.length-1]]},Lo=(e,r)=>{let t=r?.tagLabels?.[e]||e;return t.startsWith("coll-tag-filter")?e.charAt(0).toUpperCase()+e.slice(1):t},Mo=(e,r,t)=>{let a=new Map;for(let n of e){let[o,s]=Po(n);!o||!s||(a.has(o)||a.set(o,[]),a.get(o).push({name:s,label:Lo(s,t)}))}let i=a.size===1;return[...a.entries()].map(([n,o])=>({title:i&&r?r:Lo(n,t),label:n,deeplink:n,checkboxes:o}))},Ro=(e,r)=>(e??[]).map(Po).filter(([t,a])=>t&&a&&r.has(t)).map(([t,a])=>`${t}:${a}`),No=(e,r,t)=>r.every(a=>{let i=(t[a.deeplink]||"").split(",").filter(Boolean);return i.length?i.some(n=>e.includes(`${a.deeplink}:${n}`)):!0});var Oo="tacocat.js";var Ei=(e,r)=>String(e??"").toLowerCase()==String(r??"").toLowerCase(),Io=e=>`${e??""}`.replace(/[&<>'"]/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[r]??r)??"";function U(e,r={},{metadata:t=!0,search:a=!0,storage:i=!0}={}){let n;if(a&&n==null){let o=new URLSearchParams(window.location.search),s=Dt(a)?a:e;n=o.get(s)}if(i&&n==null){let o=Dt(i)?i:e;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(t&&n==null){let o=Xl(Dt(t)?t:e);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[e]}var Kl=e=>typeof e=="boolean",Yr=e=>typeof e=="function",Kr=e=>typeof e=="number",Do=e=>e!=null&&typeof e=="object";var Dt=e=>typeof e=="string",Si=e=>Dt(e)&&e,zt=e=>Kr(e)&&Number.isFinite(e)&&e>0;function Xr(e,r=t=>t==null||t===""){return e!=null&&Object.entries(e).forEach(([t,a])=>{r(a)&&delete e[t]}),e}function _(e,r){if(Kl(e))return e;let t=String(e);return t==="1"||t==="true"?!0:t==="0"||t==="false"?!1:r}function mr(e,r,t){let a=Object.values(r);return a.find(i=>Ei(i,e))??t??a[0]}function Xl(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,t,a)=>`${t}-${a}`).replace(/\W+/gu,"-").toLowerCase()}function zo(e,r=1){return Kr(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:r}var Ql=Date.now(),Ai=()=>`(+${Date.now()-Ql}ms)`,Qr=new Set,Zl=_(U("tacocat.debug",{},{metadata:!1}),!1);function Ho(e){let r=`[${Oo}/${e}]`,t=(o,s,...c)=>o?!0:(i(s,...c),!1),a=Zl?(o,...s)=>{console.debug(`${r} ${o}`,...s,Ai())}:()=>{},i=(o,...s)=>{let c=`${r} ${o}`;Qr.forEach(([l])=>l(c,...s))};return{assert:t,debug:a,error:i,warn:(o,...s)=>{let c=`${r} ${o}`;Qr.forEach(([,l])=>l(c,...s))}}}function Jl(e,r){let t=[e,r];return Qr.add(t),()=>{Qr.delete(t)}}Jl((e,...r)=>{console.error(e,...r,Ai())},(e,...r)=>{console.warn(e,...r,Ai())});var ed="no promo",Fo="promo-tag",td="yellow",rd="neutral",ad=(e,r,t)=>{let a=n=>n||ed,i=t?` (was "${a(r)}")`:"";return`${a(e)}${i}`},Zr="cancel-context",Jr=(e,r)=>{let t=e===Zr,a=!t&&e?.length>0,i=(a||t)&&(r&&r!=e||!r&&!t),n=i&&a||!i&&!!r,o=n?e||r:void 0;return{effectivePromoCode:o,overridenPromoCode:e,className:n?Fo:`${Fo} no-promo`,text:ad(o,r,i),variant:n?td:rd,isOverriden:i}};var Ci;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(Ci||(Ci={}));var pe;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(pe||(pe={}));var ue;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(ue||(ue={}));var Ti;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(Ti||(Ti={}));var ki;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(ki||(ki={}));var _i;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(_i||(_i={}));var Li;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(Li||(Li={}));var Pi="ABM",Mi="PUF",Ri="M2M",Ni="PERPETUAL",Oi="P3Y",id="TAX_INCLUSIVE_DETAILS",nd="TAX_EXCLUSIVE",Bo={ABM:Pi,PUF:Mi,M2M:Ri,PERPETUAL:Ni,P3Y:Oi},yf={[Pi]:{commitment:pe.YEAR,term:ue.MONTHLY},[Mi]:{commitment:pe.YEAR,term:ue.ANNUAL},[Ri]:{commitment:pe.MONTH,term:ue.MONTHLY},[Ni]:{commitment:pe.PERPETUAL,term:void 0},[Oi]:{commitment:pe.THREE_MONTHS,term:ue.P3Y}},Uo="Value is not an offer",ea=e=>{if(typeof e!="object")return Uo;let{commitment:r,term:t}=e,a=od(r,t);return{...e,planType:a}};var od=(e,r)=>{switch(e){case void 0:return Uo;case"":return"";case pe.YEAR:return r===ue.MONTHLY?Pi:r===ue.ANNUAL?Mi:"";case pe.MONTH:return r===ue.MONTHLY?Ri:"";case pe.PERPETUAL:return Ni;case pe.TERM_LICENSE:return r===ue.P3Y?Oi:"";default:return""}};function $o(e){let{priceDetails:r}=e,{price:t,priceWithoutDiscount:a,priceWithoutTax:i,priceWithoutDiscountAndTax:n,taxDisplay:o}=r;if(o!==id)return e;let s={...e,priceDetails:{...r,price:i??t,priceWithoutDiscount:n??a,taxDisplay:nd}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var et={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Go=1e3;function sd(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function qo(e){if(e==null)return;let r=typeof e;if(r==="function")return e.name?`function ${e.name}`:"function";if(r==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:a,originatingRequest:i,status:n}=e;return[a,n,i].filter(Boolean).join(" ")}let t=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!et.serializableTypes.includes(t))return t}return e}function cd(e,r){if(!et.ignoredProperties.includes(e))return qo(r)}var Ii={append(e){if(e.level!=="error")return;let{message:r,params:t}=e,a=[],i=[],n=r;t.forEach(l=>{l!=null&&(sd(l)?a:i).push(l)}),a.length&&(n+=` ${a.map(qo).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${et.delimiter}page=${o}${s}`;c.length>Go&&(c=`${c.slice(0,Go)}<trunc>`),n+=c,i.length&&(n+=`${et.delimiter}facts=`,n+=JSON.stringify(i,cd)),window.lana?.log(n,et)}};function ta(e){Object.assign(et,Object.fromEntries(Object.entries(e).filter(([r,t])=>r in et&&t!==""&&t!==null&&t!==void 0&&!Number.isNaN(t))))}var Vo={LOCAL:"local",PROD:"prod",STAGE:"stage"},Di={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},zi=new Set,Hi=new Set,jo=new Map,Wo={append({level:e,message:r,params:t,timestamp:a,source:i}){console[e](`${a}ms [${i}] %c${r}`,"font-weight: bold;",...t)}},Yo={filter:({level:e})=>e!==Di.DEBUG},ld={filter:()=>!1};function dd(e,r,t,a,i){return{level:e,message:r,namespace:t,get params(){return a.length===1&&Yr(a[0])&&(a=a[0](),Array.isArray(a)||(a=[a])),a},source:i,timestamp:performance.now().toFixed(3)}}function hd(e){[...Hi].every(r=>r(e))&&zi.forEach(r=>r(e))}function Ko(e){let r=(jo.get(e)??0)+1;jo.set(e,r);let t=`${e} #${r}`,a={id:t,namespace:e,module:i=>Ko(`${a.namespace}/${i}`),updateConfig:ta};return Object.values(Di).forEach(i=>{a[i]=(n,...o)=>hd(dd(i,n,e,o,t))}),Object.seal(a)}function ra(...e){e.forEach(r=>{let{append:t,filter:a}=r;Yr(a)&&Hi.add(a),Yr(t)&&zi.add(t)})}function pd(e={}){let{name:r}=e,t=_(U("commerce.debug",{search:!0,storage:!0}),r===Vo.LOCAL);return ra(t?Wo:Yo),r===Vo.PROD&&ra(Ii),re}function md(){zi.clear(),Hi.clear()}var re={...Ko($a),Level:Di,Plugins:{consoleAppender:Wo,debugFilter:Yo,quietFilter:ld,lanaAppender:Ii},init:pd,reset:md,use:ra};var ud="mas-commerce-service",gd=re.module("utilities"),fd={requestId:Yt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function ur(e,{country:r,forceTaxExclusive:t}){let a;if(e.length<2)a=e;else{let i=r==="GB"?"EN":"MULT";e.sort((n,o)=>n.language===i?-1:o.language===i?1:0),e.sort((n,o)=>!n.term&&o.term?-1:n.term&&!o.term?1:0),a=[e[0]]}return t&&(a=a.map($o)),a}var Xo=(e,r)=>{let t=e.reduce((a,i)=>a+(r(i)||0),0);return t>0?Math.round(t*100)/100:void 0};function Fi(e){if(!e||e.length===0)return null;if(e.length===1)return e[0];let[r,...t]=e;for(let s of t){let c=[["commitment","commitment types"],["term","terms"],["priceDetails.formatString","currency formats"]];for(let[l,d]of c){let m=l.includes(".")?r.priceDetails?.formatString:r[l],p=l.includes(".")?s.priceDetails?.formatString:s[l];p!==m&&gd.warn(`Offers have different ${d}, summing may produce unexpected results`,{expected:m,actual:p})}}let a=[["price",s=>s.priceDetails?.price],["priceWithoutDiscount",s=>s.priceDetails?.priceWithoutDiscount],["priceWithoutTax",s=>s.priceDetails?.priceWithoutTax],["priceWithoutDiscountAndTax",s=>s.priceDetails?.priceWithoutDiscountAndTax]],i={};for(let[s,c]of a){let l=Xo(e,c);l!==void 0&&(i[s]=l)}let n=e.some(s=>s.priceDetails?.annualized),o;if(n){let s=[["annualizedPrice",c=>c.priceDetails?.annualized?.annualizedPrice],["annualizedPriceWithoutTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutTax],["annualizedPriceWithoutDiscount",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscount],["annualizedPriceWithoutDiscountAndTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscountAndTax]];o={};for(let[c,l]of s){let d=Xo(e,l);d!==void 0&&(o[c]=d)}}return{...r,offerSelectorIds:e.flatMap(s=>s.offerSelectorIds||[]),priceDetails:{...r.priceDetails,...i,...o&&{annualized:o}}}}var aa=e=>window.setTimeout(e);function Ht(e,r=1){if(e==null)return[r];let t=(Array.isArray(e)?e:String(e).split(",")).map(zo).filter(zt);return t.length||(t=[r]),t}function vd(e){return e==null?[]:Array.isArray(e)?e:String(e).split(",").map(r=>r.trim())}function ia(e,r){let t=vd(r);if(e==null)return{wcsOsi:[],promotionCodes:t};let a=Array.isArray(e)?e:String(e).split(",");if(t.length<=1)return{wcsOsi:a.filter(Si),promotionCodes:t};let i=[],n=[];return a.forEach((o,s)=>{Si(o)&&(i.push(o),n.push(t[s]??""))}),{wcsOsi:i,promotionCodes:n}}function ae(){return document.getElementsByTagName(ud)?.[0]}function Qo(e){let r={};if(!e?.headers)return r;let t=e.headers;for(let[a,i]of Object.entries(fd)){let n=t.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[a]=n)}return r}var Ft=class e extends Error{constructor(r,t,a){if(super(r,{cause:a}),this.name="MasError",t.response){let i=t.response.headers?.get(Yt);i&&(t.requestId=i),t.response.status&&(t.status=t.response.status,t.statusText=t.response.statusText),t.response.url&&(t.url=t.response.url)}delete t.response,this.context=t,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let r=Object.entries(this.context||{}).map(([a,i])=>`${a}: ${JSON.stringify(i)}`).join(", "),t=`${this.name}: ${this.message}`;return r&&(t+=` (${r})`),this.cause&&(t+=`
Caused by: ${this.cause}`),t}};var xd={[ve]:Da,[Fe]:za,[ce]:Ha},bd={[ve]:Ua,[ce]:se},gr,je=class{constructor(r){A(this,gr);g(this,"changes",new Map);g(this,"connected",!1);g(this,"error");g(this,"log");g(this,"options");g(this,"promises",[]);g(this,"state",Fe);g(this,"timer",null);g(this,"value");g(this,"version",0);g(this,"wrapperElement");this.wrapperElement=r,this.log=re.module("mas-element")}update(){[ve,Fe,ce].forEach(r=>{this.wrapperElement.classList.toggle(xd[r],r===this.state)})}notify(){(this.state===ce||this.state===ve)&&(this.state===ce?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===ve&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]);let r=this.error;this.error instanceof Ft&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(bd[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,t,a){this.changes.set(r,a),this.requestUpdate()}connectedCallback(){E(this,gr,ae()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:t,state:a}=this;return ce===a?Promise.resolve(this.wrapperElement):ve===a?Promise.reject(r):new Promise((i,n)=>{t.push({resolve:i,reject:n})})}toggleResolved(r,t,a){return r!==this.version?!1:(a!==void 0&&(this.options=a),this.state=ce,this.value=t,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:t}),aa(()=>this.notify()),!0)}toggleFailed(r,t,a){if(r!==this.version)return!1;a!==void 0&&(this.options=a),this.error=t,this.state=ve,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${t.message}`,{element:this.wrapperElement,...t.context,...v(this,gr)?.duration}),aa(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=Fe,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!ae()||this.timer)return;let{error:t,options:a,state:i,value:n,version:o}=this;this.state=Fe,this.timer=aa(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||r)try{await this.wrapperElement.render?.()===!1&&this.state===Fe&&this.version===o&&(this.state=i,this.error=t,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,a)}})}};gr=new WeakMap;function Zo(e={}){return Object.entries(e).forEach(([r,t])=>{(t==null||t===""||t?.length===0)&&delete e[r]}),e}function na(e,r={}){let{tag:t,is:a}=e,i=document.createElement(t,{is:a});return i.setAttribute("is",a),Object.assign(i.dataset,Zo(r)),i}function Jo(e,r={}){return e instanceof HTMLElement?(Object.assign(e.dataset,Zo(r)),e):null}function yd(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var at,tt=class tt extends HTMLAnchorElement{constructor(){super();g(this,"masElement",new je(this));A(this,at);this.setAttribute("is",tt.is)}get isUptLink(){return!0}initializeWcsData(t,a){this.setAttribute("data-wcs-osi",t),a&&this.setAttribute("data-promotion-code",a)}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),E(this,at,Xt()),v(this,at)&&(this.log=v(this,at).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),E(this,at,void 0)}requestUpdate(t=!1){this.masElement.requestUpdate(t)}onceSettled(){return this.masElement.onceSettled()}async render(){let t=Xt();if(!t)return!1;this.dataset.imsCountry||t.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let a=t.collectCheckoutOptions({},this);if(!a.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(a),n=t.resolveOfferSelectors(a);try{let[[o]]=await Promise.all(n),{country:s,language:c,env:l}=a,d=`locale=${c}_${s}&country=${s}&offer_id=${o.offerId}`,m=this.getAttribute("data-promotion-code");m&&(d+=`&promotion_code=${encodeURIComponent(m)}`),this.href=`${yd(l)}?${d}`,this.masElement.toggleResolved(i,o,a)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${a.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,s,a),!1}}static createFrom(t){let a=new tt;for(let i of t.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?a.setAttribute("class",i.value.replace("upt-link","").trim()):a.setAttribute(i.name,i.value));return a.innerHTML=t.innerHTML,a.setAttribute("tabindex",0),a}};at=new WeakMap,g(tt,"is","upt-link"),g(tt,"tag","a"),g(tt,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var rt=tt;window.customElements.get(rt.is)||window.customElements.define(rt.is,rt,{extends:rt.tag});function es(e){return e&&(e==="bizpro"&&(e="pro"),e==="pro"||e.startsWith("plans")?"plans":e)}var wd="p_draft_landscape",Ed="/store/",Sd=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["addonProductArrangementCode","ao"],["offerType","ot"],["marketSegment","ms"]]),Bi=new Set(["af","ai","ao","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),Ad=["env","workflowStep","clientId","country"],Cd=["/tw/","/hk_zh/"];function Td(e){let r=e??"";return Cd.some(t=>r.startsWith(t))}function kd(){if(typeof window>"u")return!1;let e=[window.location.pathname];try{window.parent!==window&&e.push(window.parent.location.pathname)}catch{}return e.some(Td)}function fr(e){if(!kd())return e instanceof URL?e.toString():String(e);let r;try{r=e instanceof URL?e:new URL(e)}catch{return String(e)}r.searchParams.set("lang","zh-Hant");for(let t of[...r.searchParams.keys()])/^items\[\d+]\[lang]$/.test(t)&&r.searchParams.set(t,"zh-Hant");return r.toString()}var ts=new Set(["gid","gtoken","notifauditid","cohortid","productname","sdid","attimer","gcsrc","gcprog","gcprogcat","gcpagetype","mv","mv2"]),rs=e=>Sd.get(e)??e;function oa(e,r,t){for(let[a,i]of Object.entries(e)){let n=rs(a);i!=null&&t.has(n)&&r.set(n,i)}}function _d(e){return e===Ya.PRODUCTION?"https://commerce.adobe.com":"https://commerce-stg.adobe.com"}function Ld(e,r){for(let t in e){let a=e[t];for(let[i,n]of Object.entries(a)){if(n==null)continue;let o=rs(i);r.set(`items[${t}][${o}]`,n)}}}function Pd({url:e,modal:r,is3in1:t}){if(!t||!e?.searchParams)return e;e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl");let a=e.searchParams.get("af");return e.searchParams.set("af",[a,"uc_new_user_iframe","uc_new_system_close"].filter(Boolean).join(",")),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",r===Ee.CRM?"creative":"mini_plans"),e}function Md(e){let r=e.indexOf("?");return r===-1?e:e.slice(0,r)}function Rd(e){let r=new URLSearchParams(window.location.search),t={};ts.forEach(a=>{let i=r.get(a);i!==null&&(t[a]=Md(i))}),Object.keys(t).length>0&&oa(t,e.searchParams,ts)}function as(e){Nd(e);let{env:r,items:t,workflowStep:a,marketSegment:i,customerSegment:n,offerType:o,productArrangementCode:s,landscape:c,modal:l,is3in1:d,preselectPlan:m,...p}=e,h=new URL(_d(r));if(h.pathname=`${Ed}${a}`,a!==le.SEGMENTATION&&a!==le.CHANGE_PLAN_TEAM_PLANS&&Ld(t,h.searchParams),oa({...p},h.searchParams,Bi),Rd(h),c===Be.DRAFT&&oa({af:wd},h.searchParams,Bi),a===le.SEGMENTATION){let u={marketSegment:i,offerType:o,customerSegment:n,productArrangementCode:s,quantity:t?.[0]?.quantity,addonProductArrangementCode:s?t?.find(f=>f.productArrangementCode!==s)?.productArrangementCode:t?.[1]?.productArrangementCode};m?.toLowerCase()==="edu"?h.searchParams.set("ms","EDU"):m?.toLowerCase()==="team"&&h.searchParams.set("cs","TEAM"),oa(u,h.searchParams,Bi),h.searchParams.get("ot")==="PROMOTION"&&h.searchParams.delete("ot"),h=Pd({url:h,modal:l,is3in1:d})}return fr(h)}function Nd(e){for(let r of Ad)if(!e[r])throw new Error(`Argument "checkoutData" is not valid, missing: ${r}`);if(e.workflowStep!==le.SEGMENTATION&&e.workflowStep!==le.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}var Od=2e4;function Id(e,r,t){let a,i=new Promise((n,o)=>{a=setTimeout(()=>o(new Error(`AUP host timed out: ${r}`)),t)});return Promise.race([e,i]).finally(()=>clearTimeout(a))}function is({checkoutClientId:e,modal:r}){return e!=="doc_cloud"&&Object.values(Ee).includes(r)?r===Ee.CRM?"creative":"mini_plans":e}function sa(e,r,t,a=is(r)){return Ka.has(a)&&e.length>0&&!t&&!r.perpetual&&!e.some(i=>i.commitment==="PERPETUAL")}function Dd(e,r,t){let a=is(r);if(!sa(e,r,t,a))return;let[i]=e,n={clientId:a,clientType:"web",co:r.country,pa:i.productArrangementCode,cs:r.cs,ms:r.ms},o=r.preselectPlan?.toLowerCase();o==="edu"&&(n.ms="EDU"),o==="team"&&(n.cs="TEAM");let s=i.productArrangement?.productCode;s&&(n.pc=s);for(let d of["svar","customerIntent","sid"])r[d]&&(n[d]=r[d]);let c=new URL("https://commerce.adobe.com");c.searchParams.set("lang",r.language);let l={lang:new URL(fr(c)).searchParams.get("lang"),nr:"stable",ctxrturl:r.ctxrturl??window.location.href,ot:i.offerType,items:e.map(({offerId:d},m)=>{let p=r.q??r.quantity?.[m]??r.quantity?.[0];return p==null?d:`${d}|${p}`}).join(",")};for(let[d,m]of Object.entries({step:r.checkoutWorkflowStep,apc:r.promotionCode,ao:r.addonProductArrangementCode,code:r.authCode,soSu:r["so.su"],soCa:r["so.ca"],soVa:r["so.va"],soTr:r["so.tr"],contextGuid:r["context.guid"],dcwatc:r.DCWATC}))m!=null&&(l[d]=m);for(let d of["step","apc","ao","ctx","ijt","otac","nglwfdata","appctxid","soSu","soCa","soVa","soTr","promoid","sdid","trackingid","mv","mv2","contextGuid","ai","sc","th","lo","gsp","spint","mal","csm","af","rf","usid","dcwatc","cf","rtc","ccli","csc","referrer","code","ew","pp","token","mat","pcid"])r[d]!=null&&(l[d]=r[d]);return{intent:i.offerType==="TRIAL"?"try":"buy",context:n,params:l,enableRenderIn:"iframe"}}async function ns(e,r,t,a,i=Od,n=!1){let o=Dd(r,t,n);if(!o)return!1;let s=await Id(e.getOrchestratorContext(),"getOrchestratorContext",i);if(typeof s?.launchWorkflowInModal!="function")return!1;let c,l;if(a){let m=s.clientMessageHandler;l=(p,h,u)=>{let f=h?.data?.actions;return p==="System"&&h?.subType==="AppClosed"&&Array.isArray(f)&&(c=f.find(x=>x?.required&&x.actionMessage?.type==="System"&&x.actionMessage?.subType==="ReportState")?.actionMessage.data?.commerce?.cart),typeof m=="function"?m(p,h,u):u(p,h)}}re.module("aup-select").debug("Launching workflow:",o);let d=await(l?s.launchWorkflowInModal(o,l):s.launchWorkflowInModal(o));return d?.status==="cancel"&&Array.isArray(c)&&c.every(m=>typeof m?.productArrangementCode=="string")&&c.some(m=>m?.productArrangementCode===o.context.pa)&&a?.(c),d?.status!=="no-workflow-found"}var zd=/[0-9\-+#]/,Hd=/[^\d\-+#]/g;function os(e){return e.search(zd)}function Fd(e="#.##"){let r={},t=e.length,a=os(e);r.prefix=a>0?e.substring(0,a):"";let i=os(e.split("").reverse().join("")),n=t-i,o=e.substring(n,n+1),s=n+(o==="."||o===","?1:0);r.suffix=i>0?e.substring(s,t):"",r.mask=e.substring(a,s),r.maskHasNegativeSign=r.mask.charAt(0)==="-",r.maskHasPositiveSign=r.mask.charAt(0)==="+";let c=r.mask.match(Hd);return r.decimal=c&&c[c.length-1]||".",r.separator=c&&c[1]&&c[0]||",",c=r.mask.split(r.decimal),r.integer=c[0],r.fraction=c[1],r}function Bd(e,r,t){let a=!1,i={value:e};e<0&&(a=!0,i.value=-i.value),i.sign=a?"-":"",i.value=Number(i.value).toFixed(r.fraction&&r.fraction.length),i.value=Number(i.value).toString();let n=r.fraction&&r.fraction.lastIndexOf("0"),[o="0",s=""]=i.value.split(".");return(!s||s&&s.length<=n)&&(s=n<0?"":(+`0.${s}`).toFixed(n+1).replace("0.","")),i.integer=o,i.fraction=s,Ud(i,r),(i.result==="0"||i.result==="")&&(a=!1,i.sign=""),!a&&r.maskHasPositiveSign?i.sign="+":a&&r.maskHasPositiveSign?i.sign="-":a&&(i.sign=t&&t.enforceMaskSign&&!r.maskHasNegativeSign?"":"-"),i}function Ud(e,r){e.result="";let t=r.integer.split(r.separator),a=t.join(""),i=a&&a.indexOf("0");if(i>-1)for(;e.integer.length<a.length-i;)e.integer=`0${e.integer}`;else Number(e.integer)===0&&(e.integer="");let n=t[1]&&t[t.length-1].length;if(n){let o=e.integer.length,s=o%n;for(let c=0;c<o;c++)e.result+=e.integer.charAt(c),!((c-s+1)%n)&&c<o-n&&(e.result+=r.separator)}else e.result=e.integer;return e.result+=r.fraction&&e.fraction?r.decimal+e.fraction:"",e}function $d(e,r,t={}){if(!e||isNaN(Number(r)))return r;let a=Fd(e),i=Bd(r,a,t);return a.prefix+i.sign+i.result+a.suffix}var ss=$d;var cs=".",Gd=",",ds=/^\s+/,hs=/\s+$/,ls="&nbsp;",Ui=e=>e*12,nt=(e,r,t=1)=>{if(!e)return!1;let{start:a,end:i,displaySummary:{amount:n,duration:o,minProductQuantity:s=1,outcomeType:c}={}}=e;if(!(n&&o&&c)||t<s)return!1;let l=r?new Date(r):new Date;if(!a||!i)return!1;let d=new Date(a),m=new Date(i);return l>=d&&l<=m},it={MONTH:"MONTH",YEAR:"YEAR"},qd={[me.ANNUAL]:12,[me.MONTHLY]:1,[me.THREE_YEARS]:36,[me.TWO_YEARS]:24},$i=(e,r)=>({accept:e,round:r}),Vd=[$i(({divisor:e,price:r})=>r%e==0,({divisor:e,price:r})=>r/e),$i(({usePrecision:e})=>e,({divisor:e,price:r})=>Math.round(r/e*100)/100),$i(()=>!0,({divisor:e,price:r})=>Math.ceil(Math.floor(r*100/e)/100))],Gi={[Xe.YEAR]:{[me.MONTHLY]:it.MONTH,[me.ANNUAL]:it.YEAR},[Xe.MONTH]:{[me.MONTHLY]:it.MONTH}},jd=(e,r)=>e.indexOf(`'${r}'`)===0,Wd=(e,r=!0)=>{let t=e.replace(/'.*?'/,"").trim(),a=ms(t);return!!a?r||(t=t.replace(/[,\.]0+/,a)):t=t.replace(/\s?(#.*0)(?!\s)?/,`$&${Kd(e)}`),t},Yd=e=>{let r=Xd(e),t=jd(e,r),a=e.replace(/'.*?'/,""),i=ds.test(a)||hs.test(a);return{currencySymbol:r,isCurrencyFirst:t,hasCurrencySpace:i}},ps=e=>e.replace(ds,ls).replace(hs,ls),Kd=e=>e.match(/#(.?)#/)?.[1]===cs?Gd:cs,Xd=e=>e.match(/'(.*?)'/)?.[1]??"",ms=e=>e.match(/0(.?)0/)?.[1]??"";function Bt({formatString:e,price:r,usePrecision:t,isIndianPrice:a=!1},i,n=o=>o){let{currencySymbol:o,isCurrencyFirst:s,hasCurrencySpace:c}=Yd(e),l=t?ms(e):"",d=Wd(e,t),m=t?2:0,p=n(r,{currencySymbol:o}),h=a?p.toLocaleString("hi-IN",{minimumFractionDigits:m,maximumFractionDigits:m}):ss(d,p),u=t?h.lastIndexOf(l):h.length,f=h.substring(0,u),x=h.substring(u+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,h).replace(/SYMBOL/,o),currencySymbol:o,decimals:x,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:i}}var us=e=>{let{commitment:r,term:t,usePrecision:a}=e,i=qd[t]??1;return Bt(e,i>1?it.MONTH:Gi[r]?.[t],n=>{let o={divisor:i,price:n,usePrecision:a},{round:s}=Vd.find(({accept:c})=>c(o));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(o)}`);return s(o)})},gs=({commitment:e,term:r,...t})=>Bt(t,Gi[e]?.[r]),fs=e=>{let{commitment:r,instant:t,price:a,originalPrice:i,priceWithoutDiscount:n,promotion:o,quantity:s=1,term:c}=e;if(r===Xe.YEAR&&c===me.MONTHLY){if(!o)return Bt(e,it.YEAR,Ui);let{displaySummary:{outcomeType:l,duration:d}={}}=o;switch(l){case"PERCENTAGE_DISCOUNT":if(nt(o,t,s)){let m=parseInt(d.replace("P","").replace("M",""));if(isNaN(m))return Ui(a);let p=i*m,h=n*(12-m),u=Math.round((p+h)*100)/100;return Bt({...e,price:u},it.YEAR)}default:return Bt(e,it.YEAR,()=>Ui(n??a))}}return Bt(e,Gi[r]?.[c])};var ca="download",la="upgrade",vs={e:"EDU",t:"TEAM"},qi=!1;function xs(e,r={},t=""){let a=ae();if(!a)return null;let{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:m,quantity:p,wcsOsi:h,extraOptions:u,analyticsId:f}=a.collectCheckoutOptions(r),x=na(e,{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:r.promotionCode===Zr?Zr:m,quantity:p,wcsOsi:h,extraOptions:u,analyticsId:f});return t&&(x.innerHTML=`<span style="pointer-events: none;">${t}</span>`),x}function bs(e){return class extends e{constructor(){super(...arguments);g(this,"checkoutActionHandler");g(this,"aupHandler");g(this,"masElement",new je(this))}attributeChangedCallback(a,i,n){this.masElement.attributeChangedCallback(a,i,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler),this.addEventListener("auxclick",this.handleAupModifiedClick),this.updateCheckoutUrl()}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler),this.removeEventListener("auxclick",this.handleAupModifiedClick)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get marketSegment(){let a=this.options?.ms??this.value?.[0]?.marketSegments?.[0];return vs[a]??a}get customerSegment(){let a=this.options?.cs??this.value?.[0]?.customerSegment;return vs[a]??a}get is3in1Modal(){return Object.values(Ee).includes(this.getAttribute("data-modal"))}get isOpen3in1Modal(){let a=document.querySelector("meta[name=mas-ff-3in1]");return this.is3in1Modal&&(!a||a.content!=="off")}requestUpdate(a=!1){return this.masElement.requestUpdate(a)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(a={}){let i=ae();if(!i)return!1;this.dataset.imsCountry||i.imsCountryPromise.then(h=>{h&&(this.dataset.imsCountry=h)}),a.imsCountry=null;let n=i.collectCheckoutOptions(a,this);if(!n.wcsOsi.length)return!1;let o;try{o=JSON.parse(n.extraOptions??"{}")}catch(h){this.masElement.log?.error("cannot parse exta checkout options",h)}let s=this.masElement.togglePending(n);this.setCheckoutUrl("");let c=i.resolveOfferSelectors(n),l=await Promise.all(c);l=l.map(h=>ur(h,n));let d=l.flat().find(h=>h.promotion);!nt(d?.promotion,d?.promotion?.displaySummary?.instant,n.quantity[0])&&n.promotionCode&&delete n.promotionCode,n.country=this.dataset.imsCountry||n.country;let p=await i.buildCheckoutAction?.(l.flat(),{...o,...n},this);return this.renderOffers(l.flat(),n,{},p,s)}renderOffers(a,i,n={},o=void 0,s=void 0){let c=ae();if(!c)return!1;if(i={...JSON.parse(this.dataset.extraOptions??"{}"),...i,...n},s??(s=this.masElement.togglePending(i)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),this.aupHandler=void 0,this.classList.remove(ca,la),o){this.masElement.toggleResolved(s,a,i);let{url:d,text:m,className:p,handler:h,aupHandler:u}=o;d&&this.setCheckoutUrl(fr(d)),m&&(this.firstElementChild.innerHTML=m),p&&this.classList.add(...p.split(" ")),h&&(this.setCheckoutUrl(this.isOpen3in1Modal?c.buildCheckoutURL(a,i):"#"),this.checkoutActionHandler=h.bind(this)),typeof u=="function"&&(this.aupHandler=u.bind(this)),this.updateCheckoutUrl()}if(a.length){if(this.masElement.toggleResolved(s,a,i)){if(!this.classList.contains(ca)&&!this.classList.contains(la)){let d=c.buildCheckoutURL(a,i);this.setCheckoutUrl(i.modal==="true"?"#":d)}return!0}}else{let d=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,d,i))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(a){this.checkoutUrl=a,this.updateCheckoutUrl()}updateCheckoutUrl(a=ae()?.settings?.aupSelect){if(this.checkoutUrl===void 0)return;let i=a&&this.checkoutUrl&&this.masElement.state===ce&&!this.classList.contains(ca)&&!this.hasAttribute("download")&&(!this.target||this.target==="_self")&&sa(this.value,this.options,this.classList.contains(la));return this.setAttribute(this.isCheckoutLink?"href":"data-href",i?"#":this.checkoutUrl),i}handleAupModifiedClick(a){return(a.metaKey||a.ctrlKey||a.shiftKey||a.altKey||a.button!==0)&&this.updateCheckoutUrl()?(a.preventDefault(),!0):!1}handleAupCheckout(a){if(this.handleAupModifiedClick(a))return!0;if(this.updateCheckoutUrl(!1),setTimeout(()=>this.updateCheckoutUrl(),0),a.defaultPrevented||a.button!==0||a.metaKey||a.ctrlKey||a.shiftKey||a.altKey||this.classList.contains(ca)||this.hasAttribute("download")||this.target&&this.target!=="_self")return!1;let i=window.aupsdk;if(this.masElement.state!==ce||!ae()?.settings.aupSelect||typeof i?.getOrchestratorContext!="function")return!1;let{aupHandler:n,checkoutActionHandler:o,href:s,value:c}=this,l=this.closest("merch-card"),d=this.getAttribute("data-modal-id"),m={...this.options,cs:this.customerSegment,ms:this.marketSegment},p=this.classList.contains(la);if(!sa(c,m,p))return!1;if(this.updateCheckoutUrl(),a.preventDefault(),qi)return!0;let h=()=>{if(o)return o(a);s&&(window.location.href=s)},u=x=>{if(n)try{n({type:x,element:this})}catch(b){this.masElement.log?.error(`AUP checkout ${x} handler failed`,b)}},f;return qi=!0,u("open"),this.aupCheckoutPromise=ns(i,c,m,l&&d?x=>{f=x}:void 0,void 0,p).catch(x=>(this.masElement.log?.error("AUP checkout launch failed",x),!1)).then(async x=>{if(u("close"),!x)try{return await h()}catch(b){this.masElement.log?.error("AUP checkout fallback failed",b);return}if(f)try{let b=c[0].productArrangementCode;if(this.masElement.state!==ce||this.value[0]?.productArrangementCode!==b)return;let S=[...l.querySelectorAll('merch-addon [is="inline-price"]')];if(l.addonCheckbox&&(!S.length||S.some(C=>C.masElement.state!==ce||!C.value?.length)))return;let y=S.flatMap(C=>C.value),T=f.filter(C=>C.productArrangementCode===b||y.some(O=>O.productArrangementCode===C.productArrangementCode));l.dispatchEvent(new CustomEvent(La,{detail:{id:d,items:T,productArrangementCode:b}}))}catch(b){this.masElement.log?.warn("AUP checkout cart synchronization failed",b)}}).finally(()=>{qi=!1}),!0}clickHandler(a){}updateOptions(a={}){let i=ae();if(!i)return!1;let{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:m,promotionCode:p,quantity:h,wcsOsi:u}=i.collectCheckoutOptions(a);return Jo(this,{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:m,promotionCode:p,quantity:h,wcsOsi:u}),!0}}}var vr=class vr extends bs(HTMLAnchorElement){static createCheckoutLink(r={},t=""){return xs(vr,r,t)}get isCheckoutLink(){return!0}clickHandler(r){if(!this.handleAupCheckout(r)&&this.checkoutActionHandler){this.checkoutActionHandler?.(r);return}}};g(vr,"is","checkout-link"),g(vr,"tag","a");var Oe=vr;window.customElements.get(Oe.is)||window.customElements.define(Oe.is,Oe,{extends:Oe.tag});var I=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflowStep:le.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,displayPlanType:!1,env:we.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:Be.PUBLISHED});function ys({settings:e,providers:r}){function t(n,o){let{checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:m,quantity:p,preselectPlan:h,env:u}=e,f={checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:m,quantity:p,preselectPlan:h,env:u};if(o)for(let He of r.checkout)He(o,f);let{checkoutMarketSegment:x,checkoutWorkflowStep:b=c,imsCountry:S,country:y=S??l,language:T=d,quantity:C=p,entitlement:O,upgrade:$,modal:j,perpetual:X,promotionCode:ee=m,wcsOsi:H,extraOptions:D,...te}=Object.assign(f,o?.dataset??{},n??{}),Z=mr(b,le,I.checkoutWorkflowStep),{wcsOsi:ze,promotionCodes:ge}=ia(H,ee),dt=ge.map(He=>Jr(He).effectivePromoCode);return f=Xr({...te,extraOptions:D,checkoutClientId:s,checkoutMarketSegment:x,country:y,quantity:Ht(C,I.quantity),checkoutWorkflowStep:Z,language:T,entitlement:_(O),upgrade:_($),modal:j,perpetual:_(X),promotionCode:dt[0],promotionCodes:dt,wcsOsi:ze,preselectPlan:h}),f}function a(n,o){if(!Array.isArray(n)||!n.length||!o)return"";let{env:s,landscape:c}=e,{checkoutClientId:l,checkoutMarketSegment:d,checkoutWorkflowStep:m,country:p,promotionCode:h,quantity:u,preselectPlan:f,ms:x,cs:b,...S}=t(o),y=document.querySelector("meta[name=mas-ff-3in1]"),T=Object.values(Ee).includes(o.modal)&&(!y||y.content!=="off"),C=window.frameElement||T?"if":"fp",[{productArrangementCode:O,marketSegments:[$],customerSegment:j,offerType:X}]=n,ee=x??$??d,H=b??j;f?.toLowerCase()==="edu"?ee="EDU":f?.toLowerCase()==="team"&&(H="TEAM");let D={is3in1:T,checkoutPromoCode:h,clientId:l,context:C,country:p,env:s,items:[],marketSegment:ee,customerSegment:H,offerType:X,productArrangementCode:O,workflowStep:m,landscape:c,...S},te=u[0]>1?u[0]:void 0;if(n.length===1){let{offerId:Z}=n[0];D.items.push({id:Z,quantity:te})}else D.items.push(...n.map(({offerId:Z,productArrangementCode:ze})=>({id:Z,quantity:te,...T?{productArrangementCode:ze}:{}})));return as(D)}let{createCheckoutLink:i}=Oe;return{CheckoutLink:Oe,CheckoutWorkflowStep:le,buildCheckoutURL:a,collectCheckoutOptions:t,createCheckoutLink:i}}var Qd="ims_country_code";function Zd(){if(typeof document>"u")return null;let e=document.cookie.match(new RegExp(`(?:^|;\\s*)${Qd}=([^;]*)`));if(!e)return null;let r;try{r=decodeURIComponent(e[1])}catch{return null}return r.trim().toUpperCase()||null}function Jd({interval:e=200,maxAttempts:r=25}={}){let t=re.module("ims");return new Promise(a=>{t.debug("Waiting for IMS to be ready");let i=0;function n(){window.adobeIMS?.initialized?a():++i>r?(t.debug("Timeout"),a()):setTimeout(n,e)}n()})}function eh(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function th(){let e=Zd();return e&&re.module("ims").debug("Got user country from cookie:",e),Promise.resolve(e)}function ws(){let e=Jd();return{imsReadyPromise:e,imsSignedInPromise:eh(e),imsCountryPromise:th()}}var Es=window.masPriceLiterals;function Ss(e){if(Array.isArray(Es)){let r;switch(e.locale){case"id_ID":r="in";break;case"zh_TW":r="zh-hant";break;case"zh_HK":r="zh-hant";break;default:r=e.language}let t=i=>Es.find(n=>Ei(n.lang,i)),a=t(r)??t(I.language);if(a)return Object.freeze(a)}return{}}var Vi=function(e,r){return Vi=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,a){t.__proto__=a}||function(t,a){for(var i in a)Object.prototype.hasOwnProperty.call(a,i)&&(t[i]=a[i])},Vi(e,r)};function xr(e,r){if(typeof r!="function"&&r!==null)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");Vi(e,r);function t(){this.constructor=e}e.prototype=r===null?Object.create(r):(t.prototype=r.prototype,new t)}var R=function(){return R=Object.assign||function(r){for(var t,a=1,i=arguments.length;a<i;a++){t=arguments[a];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(r[n]=t[n])}return r},R.apply(this,arguments)};function da(e,r,t){if(t||arguments.length===2)for(var a=0,i=r.length,n;a<i;a++)(n||!(a in r))&&(n||(n=Array.prototype.slice.call(r,0,a)),n[a]=r[a]);return e.concat(n||Array.prototype.slice.call(r))}var L;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(L||(L={}));var q;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(q||(q={}));var ot;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(ot||(ot={}));function ji(e){return e.type===q.literal}function As(e){return e.type===q.argument}function ha(e){return e.type===q.number}function pa(e){return e.type===q.date}function ma(e){return e.type===q.time}function ua(e){return e.type===q.select}function ga(e){return e.type===q.plural}function Cs(e){return e.type===q.pound}function fa(e){return e.type===q.tag}function va(e){return!!(e&&typeof e=="object"&&e.type===ot.number)}function br(e){return!!(e&&typeof e=="object"&&e.type===ot.dateTime)}var Wi=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var rh=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function Ts(e){var r={};return e.replace(rh,function(t){var a=t.length;switch(t[0]){case"G":r.era=a===4?"long":a===5?"narrow":"short";break;case"y":r.year=a===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":r.month=["numeric","2-digit","short","long","narrow"][a-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":r.day=["numeric","2-digit"][a-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":r.weekday=a===4?"short":a===5?"narrow":"short";break;case"e":if(a<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"c":if(a<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"a":r.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":r.hourCycle="h12",r.hour=["numeric","2-digit"][a-1];break;case"H":r.hourCycle="h23",r.hour=["numeric","2-digit"][a-1];break;case"K":r.hourCycle="h11",r.hour=["numeric","2-digit"][a-1];break;case"k":r.hourCycle="h24",r.hour=["numeric","2-digit"][a-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":r.minute=["numeric","2-digit"][a-1];break;case"s":r.second=["numeric","2-digit"][a-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":r.timeZoneName=a<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),r}var ks=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function Ms(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var r=e.split(ks).filter(function(p){return p.length>0}),t=[],a=0,i=r;a<i.length;a++){var n=i[a],o=n.split("/");if(o.length===0)throw new Error("Invalid number skeleton");for(var s=o[0],c=o.slice(1),l=0,d=c;l<d.length;l++){var m=d[l];if(m.length===0)throw new Error("Invalid number skeleton")}t.push({stem:s,options:c})}return t}function ah(e){return e.replace(/^(.*?)-/,"")}var _s=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,Rs=/^(@+)?(\+|#+)?[rs]?$/g,ih=/(\*)(0+)|(#+)(0+)|(0+)/g,Ns=/^(0+)$/;function Ls(e){var r={};return e[e.length-1]==="r"?r.roundingPriority="morePrecision":e[e.length-1]==="s"&&(r.roundingPriority="lessPrecision"),e.replace(Rs,function(t,a,i){return typeof i!="string"?(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length):i==="+"?r.minimumSignificantDigits=a.length:a[0]==="#"?r.maximumSignificantDigits=a.length:(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length+(typeof i=="string"?i.length:0)),""}),r}function Os(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function nh(e){var r;if(e[0]==="E"&&e[1]==="E"?(r={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(r={notation:"scientific"},e=e.slice(1)),r){var t=e.slice(0,2);if(t==="+!"?(r.signDisplay="always",e=e.slice(2)):t==="+?"&&(r.signDisplay="exceptZero",e=e.slice(2)),!Ns.test(e))throw new Error("Malformed concise eng/scientific notation");r.minimumIntegerDigits=e.length}return r}function Ps(e){var r={},t=Os(e);return t||r}function Is(e){for(var r={},t=0,a=e;t<a.length;t++){var i=a[t];switch(i.stem){case"percent":case"%":r.style="percent";continue;case"%x100":r.style="percent",r.scale=100;continue;case"currency":r.style="currency",r.currency=i.options[0];continue;case"group-off":case",_":r.useGrouping=!1;continue;case"precision-integer":case".":r.maximumFractionDigits=0;continue;case"measure-unit":case"unit":r.style="unit",r.unit=ah(i.options[0]);continue;case"compact-short":case"K":r.notation="compact",r.compactDisplay="short";continue;case"compact-long":case"KK":r.notation="compact",r.compactDisplay="long";continue;case"scientific":r=R(R(R({},r),{notation:"scientific"}),i.options.reduce(function(c,l){return R(R({},c),Ps(l))},{}));continue;case"engineering":r=R(R(R({},r),{notation:"engineering"}),i.options.reduce(function(c,l){return R(R({},c),Ps(l))},{}));continue;case"notation-simple":r.notation="standard";continue;case"unit-width-narrow":r.currencyDisplay="narrowSymbol",r.unitDisplay="narrow";continue;case"unit-width-short":r.currencyDisplay="code",r.unitDisplay="short";continue;case"unit-width-full-name":r.currencyDisplay="name",r.unitDisplay="long";continue;case"unit-width-iso-code":r.currencyDisplay="symbol";continue;case"scale":r.scale=parseFloat(i.options[0]);continue;case"integer-width":if(i.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");i.options[0].replace(ih,function(c,l,d,m,p,h){if(l)r.minimumIntegerDigits=d.length;else{if(m&&p)throw new Error("We currently do not support maximum integer digits");if(h)throw new Error("We currently do not support exact integer digits")}return""});continue}if(Ns.test(i.stem)){r.minimumIntegerDigits=i.stem.length;continue}if(_s.test(i.stem)){if(i.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");i.stem.replace(_s,function(c,l,d,m,p,h){return d==="*"?r.minimumFractionDigits=l.length:m&&m[0]==="#"?r.maximumFractionDigits=m.length:p&&h?(r.minimumFractionDigits=p.length,r.maximumFractionDigits=p.length+h.length):(r.minimumFractionDigits=l.length,r.maximumFractionDigits=l.length),""});var n=i.options[0];n==="w"?r=R(R({},r),{trailingZeroDisplay:"stripIfInteger"}):n&&(r=R(R({},r),Ls(n)));continue}if(Rs.test(i.stem)){r=R(R({},r),Ls(i.stem));continue}var o=Os(i.stem);o&&(r=R(R({},r),o));var s=nh(i.stem);s&&(r=R(R({},r),s))}return r}var yr={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function Ds(e,r){for(var t="",a=0;a<e.length;a++){var i=e.charAt(a);if(i==="j"){for(var n=0;a+1<e.length&&e.charAt(a+1)===i;)n++,a++;var o=1+(n&1),s=n<2?1:3+(n>>1),c="a",l=oh(r);for((l=="H"||l=="k")&&(s=0);s-- >0;)t+=c;for(;o-- >0;)t=l+t}else i==="J"?t+="H":t+=i}return t}function oh(e){var r=e.hourCycle;if(r===void 0&&e.hourCycles&&e.hourCycles.length&&(r=e.hourCycles[0]),r)switch(r){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var t=e.language,a;t!=="root"&&(a=e.maximize().region);var i=yr[a||""]||yr[t||""]||yr["".concat(t,"-001")]||yr["001"];return i[0]}var Yi,sh=new RegExp("^".concat(Wi.source,"*")),ch=new RegExp("".concat(Wi.source,"*$"));function N(e,r){return{start:e,end:r}}var lh=!!String.prototype.startsWith,dh=!!String.fromCodePoint,hh=!!Object.fromEntries,ph=!!String.prototype.codePointAt,mh=!!String.prototype.trimStart,uh=!!String.prototype.trimEnd,gh=!!Number.isSafeInteger,fh=gh?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},Xi=!0;try{zs=Us("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Xi=((Yi=zs.exec("a"))===null||Yi===void 0?void 0:Yi[0])==="a"}catch{Xi=!1}var zs,Hs=lh?function(r,t,a){return r.startsWith(t,a)}:function(r,t,a){return r.slice(a,a+t.length)===t},Qi=dh?String.fromCodePoint:function(){for(var r=[],t=0;t<arguments.length;t++)r[t]=arguments[t];for(var a="",i=r.length,n=0,o;i>n;){if(o=r[n++],o>1114111)throw RangeError(o+" is not a valid code point");a+=o<65536?String.fromCharCode(o):String.fromCharCode(((o-=65536)>>10)+55296,o%1024+56320)}return a},Fs=hh?Object.fromEntries:function(r){for(var t={},a=0,i=r;a<i.length;a++){var n=i[a],o=n[0],s=n[1];t[o]=s}return t},Bs=ph?function(r,t){return r.codePointAt(t)}:function(r,t){var a=r.length;if(!(t<0||t>=a)){var i=r.charCodeAt(t),n;return i<55296||i>56319||t+1===a||(n=r.charCodeAt(t+1))<56320||n>57343?i:(i-55296<<10)+(n-56320)+65536}},vh=mh?function(r){return r.trimStart()}:function(r){return r.replace(sh,"")},xh=uh?function(r){return r.trimEnd()}:function(r){return r.replace(ch,"")};function Us(e,r){return new RegExp(e,r)}var Zi;Xi?(Ki=Us("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Zi=function(r,t){var a;Ki.lastIndex=t;var i=Ki.exec(r);return(a=i[1])!==null&&a!==void 0?a:""}):Zi=function(r,t){for(var a=[];;){var i=Bs(r,t);if(i===void 0||Gs(i)||wh(i))break;a.push(i),t+=i>=65536?2:1}return Qi.apply(void 0,a)};var Ki,$s=(function(){function e(r,t){t===void 0&&(t={}),this.message=r,this.position={offset:0,line:1,column:1},this.ignoreTag=!!t.ignoreTag,this.locale=t.locale,this.requiresOtherClause=!!t.requiresOtherClause,this.shouldParseSkeletons=!!t.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(r,t,a){for(var i=[];!this.isEOF();){var n=this.char();if(n===123){var o=this.parseArgument(r,a);if(o.err)return o;i.push(o.val)}else{if(n===125&&r>0)break;if(n===35&&(t==="plural"||t==="selectordinal")){var s=this.clonePosition();this.bump(),i.push({type:q.pound,location:N(s,this.clonePosition())})}else if(n===60&&!this.ignoreTag&&this.peek()===47){if(a)break;return this.error(L.UNMATCHED_CLOSING_TAG,N(this.clonePosition(),this.clonePosition()))}else if(n===60&&!this.ignoreTag&&Ji(this.peek()||0)){var o=this.parseTag(r,t);if(o.err)return o;i.push(o.val)}else{var o=this.parseLiteral(r,t);if(o.err)return o;i.push(o.val)}}}return{val:i,err:null}},e.prototype.parseTag=function(r,t){var a=this.clonePosition();this.bump();var i=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:q.literal,value:"<".concat(i,"/>"),location:N(a,this.clonePosition())},err:null};if(this.bumpIf(">")){var n=this.parseMessage(r+1,t,!0);if(n.err)return n;var o=n.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!Ji(this.char()))return this.error(L.INVALID_TAG,N(s,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return i!==l?this.error(L.UNMATCHED_CLOSING_TAG,N(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:q.tag,value:i,children:o,location:N(a,this.clonePosition())},err:null}:this.error(L.INVALID_TAG,N(s,this.clonePosition())))}else return this.error(L.UNCLOSED_TAG,N(a,this.clonePosition()))}else return this.error(L.INVALID_TAG,N(a,this.clonePosition()))},e.prototype.parseTagName=function(){var r=this.offset();for(this.bump();!this.isEOF()&&yh(this.char());)this.bump();return this.message.slice(r,this.offset())},e.prototype.parseLiteral=function(r,t){for(var a=this.clonePosition(),i="";;){var n=this.tryParseQuote(t);if(n){i+=n;continue}var o=this.tryParseUnquoted(r,t);if(o){i+=o;continue}var s=this.tryParseLeftAngleBracket();if(s){i+=s;continue}break}var c=N(a,this.clonePosition());return{val:{type:q.literal,value:i,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!bh(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(r){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(r==="plural"||r==="selectordinal")break;return null;default:return null}this.bump();var t=[this.char()];for(this.bump();!this.isEOF();){var a=this.char();if(a===39)if(this.peek()===39)t.push(39),this.bump();else{this.bump();break}else t.push(a);this.bump()}return Qi.apply(void 0,t)},e.prototype.tryParseUnquoted=function(r,t){if(this.isEOF())return null;var a=this.char();return a===60||a===123||a===35&&(t==="plural"||t==="selectordinal")||a===125&&r>0?null:(this.bump(),Qi(a))},e.prototype.parseArgument=function(r,t){var a=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(L.EXPECT_ARGUMENT_CLOSING_BRACE,N(a,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(L.EMPTY_ARGUMENT,N(a,this.clonePosition()));var i=this.parseIdentifierIfPossible().value;if(!i)return this.error(L.MALFORMED_ARGUMENT,N(a,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(L.EXPECT_ARGUMENT_CLOSING_BRACE,N(a,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:q.argument,value:i,location:N(a,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(L.EXPECT_ARGUMENT_CLOSING_BRACE,N(a,this.clonePosition())):this.parseArgumentOptions(r,t,i,a);default:return this.error(L.MALFORMED_ARGUMENT,N(a,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var r=this.clonePosition(),t=this.offset(),a=Zi(this.message,t),i=t+a.length;this.bumpTo(i);var n=this.clonePosition(),o=N(r,n);return{value:a,location:o}},e.prototype.parseArgumentOptions=function(r,t,a,i){var n,o=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(L.EXPECT_ARGUMENT_TYPE,N(o,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var d=this.clonePosition(),m=this.parseSimpleArgStyleIfPossible();if(m.err)return m;var p=xh(m.val);if(p.length===0)return this.error(L.EXPECT_ARGUMENT_STYLE,N(this.clonePosition(),this.clonePosition()));var h=N(d,this.clonePosition());l={style:p,styleLocation:h}}var u=this.tryParseArgumentClose(i);if(u.err)return u;var f=N(i,this.clonePosition());if(l&&Hs(l?.style,"::",0)){var x=vh(l.style.slice(2));if(s==="number"){var m=this.parseNumberSkeletonFromString(x,l.styleLocation);return m.err?m:{val:{type:q.number,value:a,location:f,style:m.val},err:null}}else{if(x.length===0)return this.error(L.EXPECT_DATE_TIME_SKELETON,f);var b=x;this.locale&&(b=Ds(x,this.locale));var p={type:ot.dateTime,pattern:b,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?Ts(b):{}},S=s==="date"?q.date:q.time;return{val:{type:S,value:a,location:f,style:p},err:null}}}return{val:{type:s==="number"?q.number:s==="date"?q.date:q.time,value:a,location:f,style:(n=l?.style)!==null&&n!==void 0?n:null},err:null}}case"plural":case"selectordinal":case"select":{var y=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(L.EXPECT_SELECT_ARGUMENT_OPTIONS,N(y,R({},y)));this.bumpSpace();var T=this.parseIdentifierIfPossible(),C=0;if(s!=="select"&&T.value==="offset"){if(!this.bumpIf(":"))return this.error(L.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,N(this.clonePosition(),this.clonePosition()));this.bumpSpace();var m=this.tryParseDecimalInteger(L.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,L.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(m.err)return m;this.bumpSpace(),T=this.parseIdentifierIfPossible(),C=m.val}var O=this.tryParsePluralOrSelectOptions(r,s,t,T);if(O.err)return O;var u=this.tryParseArgumentClose(i);if(u.err)return u;var $=N(i,this.clonePosition());return s==="select"?{val:{type:q.select,value:a,options:Fs(O.val),location:$},err:null}:{val:{type:q.plural,value:a,options:Fs(O.val),offset:C,pluralType:s==="plural"?"cardinal":"ordinal",location:$},err:null}}default:return this.error(L.INVALID_ARGUMENT_TYPE,N(o,c))}},e.prototype.tryParseArgumentClose=function(r){return this.isEOF()||this.char()!==125?this.error(L.EXPECT_ARGUMENT_CLOSING_BRACE,N(r,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var r=0,t=this.clonePosition();!this.isEOF();){var a=this.char();switch(a){case 39:{this.bump();var i=this.clonePosition();if(!this.bumpUntil("'"))return this.error(L.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,N(i,this.clonePosition()));this.bump();break}case 123:{r+=1,this.bump();break}case 125:{if(r>0)r-=1;else return{val:this.message.slice(t.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(t.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(r,t){var a=[];try{a=Ms(r)}catch{return this.error(L.INVALID_NUMBER_SKELETON,t)}return{val:{type:ot.number,tokens:a,location:t,parsedOptions:this.shouldParseSkeletons?Is(a):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(r,t,a,i){for(var n,o=!1,s=[],c=new Set,l=i.value,d=i.location;;){if(l.length===0){var m=this.clonePosition();if(t!=="select"&&this.bumpIf("=")){var p=this.tryParseDecimalInteger(L.EXPECT_PLURAL_ARGUMENT_SELECTOR,L.INVALID_PLURAL_ARGUMENT_SELECTOR);if(p.err)return p;d=N(m,this.clonePosition()),l=this.message.slice(m.offset,this.offset())}else break}if(c.has(l))return this.error(t==="select"?L.DUPLICATE_SELECT_ARGUMENT_SELECTOR:L.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,d);l==="other"&&(o=!0),this.bumpSpace();var h=this.clonePosition();if(!this.bumpIf("{"))return this.error(t==="select"?L.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:L.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,N(this.clonePosition(),this.clonePosition()));var u=this.parseMessage(r+1,t,a);if(u.err)return u;var f=this.tryParseArgumentClose(h);if(f.err)return f;s.push([l,{value:u.val,location:N(h,this.clonePosition())}]),c.add(l),this.bumpSpace(),n=this.parseIdentifierIfPossible(),l=n.value,d=n.location}return s.length===0?this.error(t==="select"?L.EXPECT_SELECT_ARGUMENT_SELECTOR:L.EXPECT_PLURAL_ARGUMENT_SELECTOR,N(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!o?this.error(L.MISSING_OTHER_CLAUSE,N(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(r,t){var a=1,i=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(a=-1);for(var n=!1,o=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)n=!0,o=o*10+(s-48),this.bump();else break}var c=N(i,this.clonePosition());return n?(o*=a,fh(o)?{val:o,err:null}:this.error(t,c)):this.error(r,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var r=this.position.offset;if(r>=this.message.length)throw Error("out of bound");var t=Bs(this.message,r);if(t===void 0)throw Error("Offset ".concat(r," is at invalid UTF-16 code unit boundary"));return t},e.prototype.error=function(r,t){return{val:null,err:{kind:r,message:this.message,location:t}}},e.prototype.bump=function(){if(!this.isEOF()){var r=this.char();r===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=r<65536?1:2)}},e.prototype.bumpIf=function(r){if(Hs(this.message,r,this.offset())){for(var t=0;t<r.length;t++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(r){var t=this.offset(),a=this.message.indexOf(r,t);return a>=0?(this.bumpTo(a),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(r){if(this.offset()>r)throw Error("targetOffset ".concat(r," must be greater than or equal to the current offset ").concat(this.offset()));for(r=Math.min(r,this.message.length);;){var t=this.offset();if(t===r)break;if(t>r)throw Error("targetOffset ".concat(r," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&Gs(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var r=this.char(),t=this.offset(),a=this.message.charCodeAt(t+(r>=65536?2:1));return a??null},e})();function Ji(e){return e>=97&&e<=122||e>=65&&e<=90}function bh(e){return Ji(e)||e===47}function yh(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function Gs(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function wh(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function en(e){e.forEach(function(r){if(delete r.location,ua(r)||ga(r))for(var t in r.options)delete r.options[t].location,en(r.options[t].value);else ha(r)&&va(r.style)||(pa(r)||ma(r))&&br(r.style)?delete r.style.location:fa(r)&&en(r.children)})}function qs(e,r){r===void 0&&(r={}),r=R({shouldParseSkeletons:!0,requiresOtherClause:!0},r);var t=new $s(e,r).parse();if(t.err){var a=SyntaxError(L[t.err.kind]);throw a.location=t.err.location,a.originalMessage=t.err.message,a}return r?.captureLocation||en(t.val),t.val}function wr(e,r){var t=r&&r.cache?r.cache:kh,a=r&&r.serializer?r.serializer:Th,i=r&&r.strategy?r.strategy:Sh;return i(e,{cache:t,serializer:a})}function Eh(e){return e==null||typeof e=="number"||typeof e=="boolean"}function Vs(e,r,t,a){var i=Eh(a)?a:t(a),n=r.get(i);return typeof n>"u"&&(n=e.call(this,a),r.set(i,n)),n}function js(e,r,t){var a=Array.prototype.slice.call(arguments,3),i=t(a),n=r.get(i);return typeof n>"u"&&(n=e.apply(this,a),r.set(i,n)),n}function tn(e,r,t,a,i){return t.bind(r,e,a,i)}function Sh(e,r){var t=e.length===1?Vs:js;return tn(e,this,t,r.cache.create(),r.serializer)}function Ah(e,r){return tn(e,this,js,r.cache.create(),r.serializer)}function Ch(e,r){return tn(e,this,Vs,r.cache.create(),r.serializer)}var Th=function(){return JSON.stringify(arguments)};function rn(){this.cache=Object.create(null)}rn.prototype.get=function(e){return this.cache[e]};rn.prototype.set=function(e,r){this.cache[e]=r};var kh={create:function(){return new rn}},xa={variadic:Ah,monadic:Ch};var st;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(st||(st={}));var Er=(function(e){xr(r,e);function r(t,a,i){var n=e.call(this,t)||this;return n.code=a,n.originalMessage=i,n}return r.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},r})(Error);var an=(function(e){xr(r,e);function r(t,a,i,n){return e.call(this,'Invalid values for "'.concat(t,'": "').concat(a,'". Options are "').concat(Object.keys(i).join('", "'),'"'),st.INVALID_VALUE,n)||this}return r})(Er);var Ws=(function(e){xr(r,e);function r(t,a,i){return e.call(this,'Value for "'.concat(t,'" must be of type ').concat(a),st.INVALID_VALUE,i)||this}return r})(Er);var Ys=(function(e){xr(r,e);function r(t,a){return e.call(this,'The intl string context variable "'.concat(t,'" was not provided to the string "').concat(a,'"'),st.MISSING_VALUE,a)||this}return r})(Er);var ie;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(ie||(ie={}));function _h(e){return e.length<2?e:e.reduce(function(r,t){var a=r[r.length-1];return!a||a.type!==ie.literal||t.type!==ie.literal?r.push(t):a.value+=t.value,r},[])}function Lh(e){return typeof e=="function"}function Sr(e,r,t,a,i,n,o){if(e.length===1&&ji(e[0]))return[{type:ie.literal,value:e[0].value}];for(var s=[],c=0,l=e;c<l.length;c++){var d=l[c];if(ji(d)){s.push({type:ie.literal,value:d.value});continue}if(Cs(d)){typeof n=="number"&&s.push({type:ie.literal,value:t.getNumberFormat(r).format(n)});continue}var m=d.value;if(!(i&&m in i))throw new Ys(m,o);var p=i[m];if(As(d)){(!p||typeof p=="string"||typeof p=="number")&&(p=typeof p=="string"||typeof p=="number"?String(p):""),s.push({type:typeof p=="string"?ie.literal:ie.object,value:p});continue}if(pa(d)){var h=typeof d.style=="string"?a.date[d.style]:br(d.style)?d.style.parsedOptions:void 0;s.push({type:ie.literal,value:t.getDateTimeFormat(r,h).format(p)});continue}if(ma(d)){var h=typeof d.style=="string"?a.time[d.style]:br(d.style)?d.style.parsedOptions:a.time.medium;s.push({type:ie.literal,value:t.getDateTimeFormat(r,h).format(p)});continue}if(ha(d)){var h=typeof d.style=="string"?a.number[d.style]:va(d.style)?d.style.parsedOptions:void 0;h&&h.scale&&(p=p*(h.scale||1)),s.push({type:ie.literal,value:t.getNumberFormat(r,h).format(p)});continue}if(fa(d)){var u=d.children,f=d.value,x=i[f];if(!Lh(x))throw new Ws(f,"function",o);var b=Sr(u,r,t,a,i,n),S=x(b.map(function(C){return C.value}));Array.isArray(S)||(S=[S]),s.push.apply(s,S.map(function(C){return{type:typeof C=="string"?ie.literal:ie.object,value:C}}))}if(ua(d)){var y=d.options[p]||d.options.other;if(!y)throw new an(d.value,p,Object.keys(d.options),o);s.push.apply(s,Sr(y.value,r,t,a,i));continue}if(ga(d)){var y=d.options["=".concat(p)];if(!y){if(!Intl.PluralRules)throw new Er(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,st.MISSING_INTL_API,o);var T=t.getPluralRules(r,{type:d.pluralType}).select(p-(d.offset||0));y=d.options[T]||d.options.other}if(!y)throw new an(d.value,p,Object.keys(d.options),o);s.push.apply(s,Sr(y.value,r,t,a,i,p-(d.offset||0)));continue}}return _h(s)}function Ph(e,r){return r?R(R(R({},e||{}),r||{}),Object.keys(e).reduce(function(t,a){return t[a]=R(R({},e[a]),r[a]||{}),t},{})):e}function Mh(e,r){return r?Object.keys(e).reduce(function(t,a){return t[a]=Ph(e[a],r[a]),t},R({},e)):e}function nn(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function Rh(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:wr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.NumberFormat).bind.apply(r,da([void 0],t,!1)))},{cache:nn(e.number),strategy:xa.variadic}),getDateTimeFormat:wr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.DateTimeFormat).bind.apply(r,da([void 0],t,!1)))},{cache:nn(e.dateTime),strategy:xa.variadic}),getPluralRules:wr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.PluralRules).bind.apply(r,da([void 0],t,!1)))},{cache:nn(e.pluralRules),strategy:xa.variadic})}}var Ks=(function(){function e(r,t,a,i){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==ie.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return Sr(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Mh(e.formats,a),this.formatters=i&&i.formatters||Rh(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=qs,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e})();var Xs=Ks;var Ar={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}",discountLabel:"{discount}%"},Nh=Ho("ConsonantTemplates/price"),Oh=/<\/?[^>]+(>|$)/g,V={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},_e={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},on="TAX_EXCLUSIVE",Ih=e=>Do(e)?Object.entries(e).filter(([,r])=>Dt(r)||Kr(r)||r===!0).reduce((r,[t,a])=>`${r} ${t}${a===!0?"":`="${Io(a)}"`}`,""):"",W=(e,r,t,a=!1)=>`<span class="${e}${r?"":` ${V.disabled}`}"${Ih(t)}>${a?ps(r):r??""}</span>`;function Dh(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(a,i)}),e}function zh(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(a,i)}),e}function be(e,r,t,a){let i=e[t];if(i==null)return"";let n=i.includes("<"),o=i.includes("<a ");try{i=o?Dh(i):i,i=n?i.replace(Oh,""):i;let s=new Xs(i,r).format(a);return o?zh(s):s}catch{return Nh.error("Failed to format literal:",i),""}}function Hh(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:a,decimals:i,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:m},p={}){let h=W(V.currencySymbol,a),u=W(V.currencySpace,o?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=h+u),f+=W(V.integer,s),f+=W(V.decimalsDelimiter,n),f+=W(V.decimals,i),c||(f+=u+h),f+=W(V.recurrence,l,null,!0),f+=W(V.unitType,d,null,!0),f+=W(V.taxInclusivity,m,!0),W(e,f,{...p})}var J=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:a=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:m,literals:p={},quantity:h=1,space:u=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:b,formatString:S,price:y,priceWithoutDiscount:T,taxDisplay:C,taxTerm:O,term:$,usePrecision:j,promotion:X}={},ee={})=>{Object.entries({country:o,formatString:S,language:m,price:y}).forEach(([Oc,Ic])=>{if(Ic==null)throw new Error(`Argument "${Oc}" is missing for osi ${b?.toString()}, country ${o}, language ${m}`)});let H={...Ar,...p},D=`${m.toLowerCase()}-${o.toUpperCase()}`,te;X&&!f&&T?te=e||a?y:T:t&&T?te=T:te=y;let Z=r?us:gs;i&&(Z=fs);let{accessiblePrice:ze,recurrenceTerm:ge,...dt}=Z({commitment:x,formatString:S,instant:n,isIndianPrice:o==="IN",originalPrice:y,priceWithoutDiscount:T,price:r?y:te,promotion:X,quantity:h,term:$,usePrecision:j}),He="",wa="",Ea="";_(c)&&ge&&(Ea=be(H,D,_e.recurrenceLabel,{recurrenceTerm:ge}));let Pr="";_(l)&&(u&&(Pr+=" "),Pr+=be(H,D,_e.perUnitLabel,{perUnit:"LICENSE"}));let Mr="";_(d)&&O&&(u&&(Mr+=" "),Mr+=be(H,D,C===on?_e.taxExclusiveLabel:_e.taxInclusiveLabel,{taxTerm:O})),t&&(He=be(H,D,_e.strikethroughAriaLabel,{strikethroughPrice:He})),e&&(wa=be(H,D,_e.alternativePriceAriaLabel,{alternativePrice:wa}));let Ye=V.container;if(r&&(Ye+=` ${V.containerOptical}`),t&&(Ye+=` ${V.containerStrikethrough}`),a&&(Ye+=` ${V.containerPromoStrikethrough}`),e&&(Ye+=` ${V.containerAlternative}`),i&&(Ye+=` ${V.containerAnnual}`),_(s))return Hh(Ye,{...dt,accessibleLabel:He,altAccessibleLabel:wa,recurrenceLabel:Ea,perUnitLabel:Pr,taxInclusivityLabel:Mr},ee);let{currencySymbol:un,decimals:Lc,decimalsDelimiter:Pc,hasCurrencySpace:gn,integer:Mc,isCurrencyFirst:Rc}=dt,ht=[Mc,Pc,Lc];Rc?(ht.unshift(gn?"\xA0":""),ht.unshift(un)):(ht.push(gn?"\xA0":""),ht.push(un)),ht.push(Ea,Pr,Mr);let Nc=ht.join("");return W(Ye,Nc,ee)},Qs=()=>(e,r,t)=>{let a=nt(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||_(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||a);return`${n?`${J({displayStrikethrough:!0})({isPromoApplied:a,...e,displayPerUnit:!1,displayTax:!1},r,t)}${e.wrapClauses?" ":"&nbsp;"}`:""}${J({isAlternativePrice:n})({isPromoApplied:a,...e},r,t)}`},Zs=()=>(e,r,t)=>{let{instant:a}=e;try{a||(a=new URLSearchParams(document.location.search).get("instant")),a&&(a=new Date(a))}catch{a=void 0}let i=nt(r.promotion,a,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:i};if(!i)return J()(e,{...r,price:r.priceWithoutDiscount},t)+W(V.containerAnnualPrefix," (")+J({displayAnnual:!0,instant:a})(n,{...r,price:r.priceWithoutDiscount},t)+W(V.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||_(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${s?`${J({displayStrikethrough:!0})(n,r,t)}${e.wrapClauses?" ":"&nbsp;"}`:""}${J({isAlternativePrice:s})({isPromoApplied:i,...e},r,t)}${W(V.containerAnnualPrefix," (")}${J({displayAnnual:!0,instant:a})(n,r,t)}${W(V.containerAnnualSuffix,")")}`},Js=()=>(e,r,t)=>{let a={...e,displayTax:!1,displayPerUnit:!1};return`${J({isAlternativePrice:e.displayOldPrice})(e,r,t)}${W(V.containerAnnualPrefix," (")}${J({displayAnnual:!0})(a,r,t)}${W(V.containerAnnualSuffix,")")}`};var Cr={...V,containerLegal:"price-legal",planType:"price-plan-type"},ba={..._e,planTypeLabel:"planTypeLabel"};function Fh(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:a},i={},n=!0){let o="";return o+=W(Cr.unitType,r,null,!0),t&&a&&n&&(t+=t.endsWith(".")?" ":". "),o+=W(Cr.taxInclusivity,t,!0),o+=W(Cr.planType,a,null),W(e,o,{...i})}var ec=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:a=!1,displayDot:i=!0,planTypeCase:n,language:o,literals:s={}}={},{taxDisplay:c,taxTerm:l,planType:d}={},m={})=>{let p={...Ar,...s},h=`${o.toLowerCase()}-${e.toUpperCase()}`,u="";_(r)&&(u=be(p,h,ba.perUnitLabel,{perUnit:"LICENSE"}));let f="";e==="US"&&o==="en"&&(t=!1),_(t)&&l&&(f=be(p,h,c===on?ba.taxExclusiveLabel:ba.taxInclusiveLabel,{taxTerm:l}));let x="";_(a)&&d&&(x=be(p,h,ba.planTypeLabel,{planType:d})),x&&n&&(x=(n==="lower"?x[0].toLowerCase():x[0].toUpperCase())+x.slice(1));let b=Cr.container;return b+=` ${Cr.containerLegal}`,Fh(b,{perUnitLabel:u,taxInclusivityLabel:f,planTypeLabel:x},m,i)};var tc=J(),rc=Qs(),ac=J({displayOptical:!0}),ic=J({displayStrikethrough:!0}),nc=J({displayPromoStrikethrough:!0}),oc=J({displayAnnual:!0}),sc=J({displayOptical:!0,isAlternativePrice:!0}),cc=J({isAlternativePrice:!0}),lc=Js(),dc=Zs(),hc=ec;var Bh={..._e,discountLabel:"discountLabel"},Uh=(e,r)=>{if(!r&&zt(e))return 0;if(!(!zt(e)||!zt(r)))return Math.floor((r-e)/r*100)},pc=()=>(e,r)=>{let{country:t,language:a,literals:i={}}=e??{},{price:n,priceWithoutDiscount:o}=r,s=Uh(n,o);if(s===void 0)return'<span class="no-discount"></span>';let c={...Ar,...i},l=a&&t?`${a.toLowerCase()}-${t.toUpperCase()}`:"en-US";return`<span class="discount">${be(c,l,Bh.discountLabel,{discount:s,remainingPercent:100-s})}</span>`};var mc=pc();var uc="INDIVIDUAL_COM",cn="TEAM_COM",gc="INDIVIDUAL_EDU",ln="TEAM_EDU",$h=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh","KE_en","GH_en","TZ_en","AM_en","AZ_en","GE_en","MD_en","KZ_en","KG_en","TJ_en","UZ_en","OM_en","BH_en"],Gh={[uc]:[],[cn]:[],[gc]:[],[ln]:[]},qh={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},Vh=[uc,cn,gc,ln],jh=e=>[cn,ln].includes(e);function sn(e,r,t,a){if(e[r])return e[r];let i=`${r}_${t}`;if(e[i])return e[i];let n;if(a)n=e.find(o=>o.startsWith(`${r}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${r}_`));n=o?e[o]:null}return n}var Wh=(e,r,t,a)=>{let i=`${t}_${a}`,n=sn(qh,e,r,!1);if(n){let o=Vh.indexOf(i);return n[o]}return jh(i)},Yh=(e,r,t,a)=>{if(sn($h,e,r,!0))return!0;let i=Gh[`${t}_${a}`];return i?sn(i,e,r,!0)?!0:I.displayTax:I.displayTax},dn=async(e,r,t,a)=>{let i=Yh(e,r,t,a);return{displayTax:i,forceTaxExclusive:i?Wh(e,r,t,a):I.forceTaxExclusive}},Tr=class Tr extends HTMLSpanElement{constructor(){super();g(this,"masElement",new je(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let a=ae();if(!a)return null;let{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:m,promotionCode:p,quantity:h,alternativePrice:u,template:f,wcsOsi:x}=a.collectPriceOptions(t);return na(Tr,{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:m,promotionCode:p,quantity:h,alternativePrice:u,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ve}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let a=ae();if(!a)return!1;let i=a.collectPriceOptions(t,this),n={...a.settings,...i};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=a.resolveOfferSelectors(n),c=await Promise.all(s),l=c.map(h=>{let u=ur(h,n);return u?.length?u[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,m=Fi(l);if(a.featureFlags[Le]||n[Le]){if(i.displayPerUnit===void 0&&(n.displayPerUnit=m.customerSegment!=="INDIVIDUAL"),i.displayTax===void 0||i.forceTaxExclusive===void 0){let{country:h,language:u}=n,[f=""]=m.marketSegments,x=await dn(h,u,m.customerSegment,f);i.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),i.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(b=>{let S=ur(b,n);return S?.length?S[0]:null}))}}else i.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(a.featureFlags[pt]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,u]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:u.priceDetails?.price}};return this.renderOffers([f],n,o)}let p=Fi(d);return this.renderOffers([p],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(t,a,i=void 0){if(!this.isConnected)return;let n=ae();if(!n)return!1;if(i??(i=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(i,t,a)){this.innerHTML=n.buildPriceHTML(t,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,o,this.options))return this.innerHTML="",!0}return!1}};g(Tr,"is","inline-price"),g(Tr,"tag","span");var Ie=Tr;window.customElements.get(Ie.is)||window.customElements.define(Ie.is,Ie,{extends:Ie.tag});function fc({literals:e,providers:r,settings:t}){function a(o,s=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(s&&r?.price)for(let X of r.price)X(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:m,displayTax:p,displayPlanType:h,forceTaxExclusive:u,perpetual:f,displayAnnual:x,promotionCode:b,quantity:S,alternativePrice:y,wcsOsi:T,...C}=Object.assign(c,s?.dataset??{},o??{}),{wcsOsi:O,promotionCodes:$}=ia(T,b),j=$.map(X=>Jr(X).effectivePromoCode);return c=Xr(Object.assign({...c,...C,displayOldPrice:_(l),displayPerUnit:_(d),displayRecurrence:_(m),displayTax:_(p),displayPlanType:_(h),forceTaxExclusive:_(u),perpetual:_(f),displayAnnual:_(x),promotionCode:j[0],promotionCodes:j,quantity:Ht(S,I.quantity),alternativePrice:_(y),wcsOsi:O})),c}function i(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=mc;break;case"strikethrough":l=ic;break;case"promo-strikethrough":l=nc;break;case"annual":l=oc;break;case"legal":l=hc;break;default:s.template==="optical"&&s.alternativePrice?l=sc:s.template==="optical"?l=ac:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode&&o[0].promotion?dc:lc:s.alternativePrice?l=cc:l=s.promotionCode&&o[0].promotion?rc:tc}let[d]=o;return d={...d,...d.priceDetails},l({...t,...s},d)}let n=Ie.createInlinePrice;return{InlinePrice:Ie,buildPriceHTML:i,collectPriceOptions:a,createInlinePrice:n}}function Kh({locale:e=void 0,country:r=void 0,language:t=void 0}={}){t??(t=e?.split("_")?.[0]||I.language);let a=!!(r||e?.split("_")?.[1]);return r??(r=e?.split("_")?.[1]||I.country),r==="PR"&&(r="US"),e??(e=`${t}_${r}`),{locale:e,country:r,language:t,hasExplicitCountry:a}}function vc(e={},r){let t=r.featureFlags[Le],{commerce:a={}}=e,i=we.PRODUCTION,n=ja,o=U("checkoutClientId",a)??I.checkoutClientId,s=mr(U("checkoutWorkflowStep",a),le,I.checkoutWorkflowStep),c=_(U("displayOldPrice",a),I.displayOldPrice),l=I.displayPerUnit,d=_(U("displayRecurrence",a),I.displayRecurrence),m=_(U("displayTax",a),I.displayTax),p=_(U("displayPlanType",a),I.displayPlanType),h=_(U("entitlement",a),I.entitlement),u=_(U("modal",a),I.modal),f=_(U("forceTaxExclusive",a),I.forceTaxExclusive),x=U("promotionCode",a)??I.promotionCode,b=Ht(U("quantity",a)),S=U("wcsApiKey",a)??I.wcsApiKey,y=a?.env==="stage",T=Be.PUBLISHED;["true",""].includes(a.allowOverride)&&(y=(U(qa,a,{metadata:!1})?.toLowerCase()??a?.env)==="stage",T=mr(U(Va,a),Be,T)),y&&(i=we.STAGE,n=Wa);let O=U(Ga)??e.preview,$=typeof O<"u"&&O!=="off"&&O!=="false",j={};$&&(j={preview:$});let X=U("mas-io-url")??e.masIOUrl,ee=Tn(X)?X:`https://www${i===we.STAGE?".stage":""}.adobe.com/mas/io`,H=U("preselect-plan")??void 0,D=U("instant")??e.instant;return{...Kh(e),...j,aupSelect:U("aup-select",{"aup-select":r.getAttribute("aup-select")},{search:!0,storage:!1})==="on",displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:m,displayPlanType:p,entitlement:h,extraOptions:I.extraOptions,modal:u,env:i,forceTaxExclusive:f,promotionCode:x,quantity:b,alternativePrice:I.alternativePrice,wcsApiKey:S,wcsURL:n,landscape:T,masIOUrl:ee,...H&&{preselectPlan:H},...D&&{instant:D}}}async function xc(e,r={},t=2,a=100){let i;for(let n=0;n<=t;n++)try{let o=await fetch(e,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,a*(n+1)))}throw i}var hn="wcs";function bc({settings:e}){let r=re.module(hn),{env:t,wcsApiKey:a}=e,i=new Map,n=new Map,o,s=new Map;async function c(u,f,x=!0){let b=ae(),S=Ba;r.debug("Fetching:",u);let y="",T;if(u.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let C=new Map(f),[O]=u.offerSelectorIds,$=Date.now()+Math.random().toString(36).substring(2,7),j=`${hn}:${O}:${$}${Xa}`,X=`${hn}:${O}:${$}${Qa}`,ee;try{if(performance.mark(j),y=new URL(e.wcsURL),y.searchParams.set("offer_selector_ids",O),y.searchParams.set("country",u.country),y.searchParams.set("locale",u.locale),y.searchParams.set("landscape",t===we.STAGE?"ALL":e.landscape),y.searchParams.set("api_key",a),u.language&&y.searchParams.set("language",u.language),u.promotionCode&&y.searchParams.set("promotion_code",u.promotionCode),u.currency&&y.searchParams.set("currency",u.currency),T=await xc(y.toString(),{credentials:"omit"}),T.ok){let H=[];try{let D=await T.json();r.debug("Fetched:",u,D),H=D.resolvedOffers??[]}catch(D){r.error(`Error parsing JSON: ${D.message}`,{...D.context,...b?.duration})}H=H.map(ea),f.forEach(({resolve:D},te)=>{let Z=H.filter(({offerSelectorIds:ze})=>ze.includes(te)).flat();Z.length&&(C.delete(te),f.delete(te),D(Z))})}else S=Fa}catch(H){S=`Network error: ${H.message}`}finally{ee=performance.measure(X,j),performance.clearMarks(j),performance.clearMeasures(X)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let H=Qo(T);f.forEach(D=>{D.reject(new Ft(S,{...u,...H,response:T,measure:Dr(ee),...b?.duration}))})}}function l(){clearTimeout(o);let u=[...n.values()];n.clear(),u.forEach(({options:f,promises:x})=>c(f,x))}function d(u){if(!u||typeof u!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===we.STAGE?"stage":"prod",x=u[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[b,S]of Object.entries(x))i.set(b,Promise.resolve(S.map(ea)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function m(){let u=i.size;s=new Map(i),i.clear(),r.debug(`Moved ${u} cache entries to stale cache`)}function p(u,f,x){let b=u!=="GB"&&!x?"MULT":"en",S=Za.includes(u)?u:I.country;return{validCountry:S,validLanguage:b,locale:`${f}_${S}`}}function h({country:u,language:f,perpetual:x=!1,promotionCode:b="",promotionCodes:S,wcsOsi:y=[]}){let{validCountry:T,validLanguage:C,locale:O}=p(u,f,x),$=Array.isArray(S)&&S.length?S:[b];return y.map((j,X)=>{let ee=$.length===1?$[0]:$[X]??"",H=[T,C,ee].filter(Z=>Z).join("-").toLowerCase(),D=`${j}-${H}`;if(i.has(D))return i.get(D);let te=new Promise((Z,ze)=>{let ge=n.get(H);ge||(ge={options:{country:T,locale:O,...C==="MULT"&&{language:C},offerSelectorIds:[]},promises:new Map},n.set(H,ge)),ee&&(ge.options.promotionCode=ee),ge.options.offerSelectorIds.push(j),ge.promises.set(j,{resolve:Z,reject:ze}),l()}).catch(Z=>{if(s.has(D))return s.get(D);throw Z});return i.set(D,te),te})}return{Commitment:Xe,PlanType:Bo,Term:me,applyPlanType:ea,resolveOfferSelectors:h,flushWcsCacheInternal:m,prefillWcsCache:d,normalizeCountryLanguageAndLocale:p}}var yc="mas-commerce-service",wc="mas-commerce-service:start",Ec="mas-commerce-service:ready",kr,Ut,ct,Sc,mn,pn=class extends HTMLElement{constructor(){super(...arguments);A(this,ct);A(this,kr);A(this,Ut);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(a,i,n)=>{let o=await t?.(a,i,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return v(this,Ut)||E(this,Ut,{[Le]:G(this,ct,mn).call(this,Le),[pt]:G(this,ct,mn).call(this,pt)}),v(this,Ut)}activate(){let t=v(this,ct,Sc),a=vc(t,this);ta(t.lana);let i=re.init(t.hostEnv).module("service");i.debug("Activating:",t);let o={price:Ss(a)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:a};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...ys(c),...ws(c),...fc(c),...bc(c),...Ja,Log:re,resolvePriceTaxFlags:dn,get defaults(){return I},get log(){return re},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return a}})),i.debug("Activated:",{literals:o,settings:a});let l=new CustomEvent(Nr,{bubbles:!0,cancelable:!1,detail:this});performance.mark(Ec),E(this,kr,performance.measure(Ec,wc)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(wc),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(ka).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Dr(v(this,kr))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:i})=>i>this.lastLoggingTime).filter(({transferSize:i,duration:n,responseStatus:o})=>i===0&&n===0&&o<200||o>=400),a=Array.from(new Map(t.map(i=>[i.name,i])).values());if(a.some(({name:i})=>/(\/fragment\?|web_commerce_artifact)/.test(i))){let i=a.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:i,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};kr=new WeakMap,Ut=new WeakMap,ct=new WeakSet,Sc=function(){let t=this.getAttribute("env")??"prod",a={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(i=>{let n=this.getAttribute(i);n&&(a[i]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(i=>{let n=this.getAttribute(i);if(n!=null){let o=i.replace(/-([a-z])/g,s=>s[1].toUpperCase());a.commerce[o]=n}}),a},mn=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||U(t))};window.customElements.get(yc)||window.customElements.define(yc,pn);var kc="merch-card-collection",Xh=3e4,Qh={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},Zh={plans:!0},Jh=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),ep=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(a=>t.types.includes(a)))):e,tp=(e,r)=>{let t=r.tagGroups;if(!t?.length)return e;let a=Aa();return e.filter(i=>No((i.getAttribute("filter-tags")||"").split(",").filter(Boolean),t,a))},rp=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),ap=(e,{filter:r})=>e.sort((t,a)=>a.filters[r]?.order==null||isNaN(a.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-a.filters[r].order),ip=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,We,Gt,lt,Lr,ya,_c,$t=class extends Cc{constructor(){super();A(this,ya);A(this,We,{});A(this,Gt);A(this,lt);A(this,Lr);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[],this.resizeHandlerDebounced=An(this.resizeHandler.bind(this),300)}resizeHandler(){this.firstChild?.variantLayout?.resizeHandler?.()}render(){return De` <slot></slot>
            ${this.footer}`}checkReady(){if(!this.querySelector("aem-fragment"))return Promise.resolve(!0);let a,i=new Promise(o=>{a=Cn(()=>o(!1),Xh)}),n=Promise.race([this.hydrationReady,i]);return n.finally(()=>ri(a)),n}updated(t){if(!this.querySelector("merch-card"))return;let a=window.scrollY||document.documentElement.scrollTop,i=[...this.children].filter(l=>l.tagName==="MERCH-CARD"&&!l.failed);if(i.length===0)return;t.has("singleApp")&&this.singleApp&&i.forEach(l=>{l.updateFilters(l.name===this.singleApp)});let n=this.sort===xe.alphabetical?rp:ap,s=[Jh,ep,tp,ip,n].reduce((l,d)=>d(l,this),i).map((l,d)=>[l,d]);if(this.resultCount=s.length,this.page&&this.limit){let l=this.page*this.limit;this.hasMore=s.length>l,s=s.filter(([,d])=>d<l)}let c=new Map(s.reverse());for(let l of c.keys())this.prepend(l);i.forEach(l=>{c.has(l)?(l.size=l.filters[this.filter]?.size,l.style.removeProperty("display"),l.requestUpdate()):(l.style.display="none",l.size=void 0)}),window.scrollTo(0,a),this.updateComplete.then(()=>{this.dispatchLiteralsChanged(),this.sidenav&&!this.literalsHandlerAttached&&(this.sidenav.addEventListener(Ra,()=>{this.dispatchLiteralsChanged()}),this.literalsHandlerAttached=!0)})}dispatchLiteralsChanged(){this.dispatchEvent(new CustomEvent(fe,{detail:{resultCount:this.resultCount,searchTerm:this.search,filter:this.sidenav?.filters?.selectedText}}))}buildOverrideMap(){E(this,We,{}),this.overrides?.split(",").forEach(t=>{let[a,i]=t?.split(":");a&&i&&(v(this,We)[a]=i)})}connectedCallback(){super.connectedCallback(),E(this,Gt,Xt()),v(this,Gt)&&E(this,lt,v(this,Gt).Log.module(kc)),E(this,Lr,customElements.get("merch-card")),this.buildOverrideMap(),this.init(),window.addEventListener("resize",this.resizeHandlerDebounced)}async init(){await this.hydrate(),this.sidenav=this.parentElement.querySelector("merch-sidenav"),this.filtered?(this.filter=this.filtered,this.page=1):this.startDeeplink(),this.tagGroups?.length&&(this.stopFilterDeeplink=Ca(()=>this.requestUpdate())),this.initializePlaceholders()}disconnectedCallback(){super.disconnectedCallback(),this.stopDeeplink?.(),this.stopFilterDeeplink?.();for(let t of this.onUnmount)t();window.removeEventListener("resize",this.resizeHandlerDebounced)}initializeHeader(){let t=document.createElement("merch-card-collection-header");t.collection=this,t.classList.add(this.variant),this.parentElement.insertBefore(t,this),this.header=t,this.querySelectorAll("[placeholder]").forEach(i=>{let n=i.getAttribute("slot");this.header.placeholderKeys.includes(n)&&this.header.append(i)})}initializePlaceholders(){let t=this.data?.placeholders||{};!t.searchText&&this.data?.sidenavSettings?.searchText&&(t.searchText=this.data.sidenavSettings.searchText);for(let a of Object.keys(t)){let i=t[a],n=i.includes("<p>")?"div":"p",o=document.createElement(n);o.setAttribute("slot",a),o.setAttribute("placeholder",""),o.innerHTML=i,this.append(o)}}attachSidenav(t,a=!0){if(!t)return;a&&this.parentElement.prepend(t),this.sidenav=t,this.sidenav.variant=this.variant,this.sidenav.classList.add(this.variant),Zh[this.variant]&&this.sidenav.setAttribute("autoclose",""),this.initializeHeader(),this.dispatchEvent(new CustomEvent(Wt));let i=v(this,Lr)?.getCollectionOptions(this.variant)?.onSidenavAttached;i&&i(this)}async hydrate(){if(this.hydrating)return!1;let t=this.querySelector("aem-fragment");if(!t)return;this.id=t.getAttribute("fragment"),this.hydrating=!0;let a;this.hydrationReady=new Promise(s=>{a=s});let i=this;function n(s){let c;return s.fields?.tagFilters?.length&&(c=Mo(s.fields.tagFilters,s.fields.tagFiltersTitle,s.settings)),{searchText:s.fields?.searchText,tagFilters:c,linksTitle:s.fields?.linksTitle,link:s.fields?.link,linkText:s.fields?.linkText,linkIcon:s.fields?.linkIcon}}function o(s,c){let l={cards:[],hierarchy:[],placeholders:s.placeholders,sidenavSettings:n(s)};function d(m,p){for(let h of p){if(h.fieldName==="variations")continue;if(h.fieldName==="cards"){if(l.cards.findIndex(y=>y.id===h.identifier)!==-1)continue;if(!s.references[h.identifier]?.value){v(i,lt)?.error(`Reference not found for card: ${h.identifier}`);continue}l.cards.push(s.references[h.identifier].value);continue}let u=s.references[h.identifier]?.value,f=h.referencesTree,x=c[h.identifier];if(x){let y=document.querySelector(`aem-fragment[fragment="${x}"]`)?.rawData;if(y?.fields)u=y,f=y.referencesTree,s.references={...s.references,...y.references};else{v(i,lt)?.error(`Override fragment ${x} not found or invalid:`);continue}}if(!u?.fields)continue;let{fields:b}=u,S={label:b.label||"",icon:b.icon,iconLight:b.iconLight,queryLabel:b.queryLabel,cards:b.cards?b.cards.map(y=>c[y]||y):[],collections:[]};b.defaultchild&&(S.defaultchild=c[b.defaultchild]||b.defaultchild),m.push(S),d(S.collections,f)}}return d(l.hierarchy,s.referencesTree),l.hierarchy.length===0&&(i.filtered="all"),l}t.addEventListener(Oa,s=>{G(this,ya,_c).call(this,"Error loading AEM fragment",s.detail),this.hydrating=!1,t.remove()}),t.addEventListener(Na,async s=>{this.limit=27,this.data=o(s.detail,v(this,We)),this.tagGroups=this.data.sidenavSettings?.tagFilters??null,s.detail.variationId&&this.setAttribute("variation-id",s.detail.variationId);let{cards:c,hierarchy:l}=this.data,d=l.length===0&&s.detail.fields?.defaultchild?v(this,We)[s.detail.fields.defaultchild]||s.detail.fields.defaultchild:null;t.cache.add(...c);let m=(u,f)=>{for(let x of u)if(x.defaultchild===f||x.collections&&m(x.collections,f))return!0;return!1};for(let u of c){let y=function(C){for(let O of C){let $=O.cards.indexOf(x);if($===-1)continue;let j=O.queryLabel??O?.label?.toLowerCase()??"";f.filters[j]={order:$+1,size:u.fields.size},y(O.collections)}},f=document.createElement("merch-card"),x=v(this,We)[u.id]||u.id;f.setAttribute("consonant",""),f.setAttribute("style","");let b=u.fields.tags?.filter(C=>C.startsWith("mas:types/")).map(C=>C.split("/")[1]).join(",");if(b&&f.setAttribute("types",b),this.tagGroups){let C=new Set(this.tagGroups.map($=>$.deeplink)),O=Ro(u.fields.tags,C);O.length&&f.setAttribute("filter-tags",O.join(","))}Jt(u.fields.variant)?.supportsDefaultChild&&(d?x===d:m(l,x))&&f.setAttribute("data-default-card","true"),y(l);let T=document.createElement("aem-fragment");T.setAttribute("fragment",x),f.append(T),Object.keys(f.filters).length===0&&(f.filters={all:{order:c.indexOf(u)+1,size:u.fields.size}}),this.append(f)}let p="",h=es(c[0]?.fields?.variant);this.variant=h,h==="plans"&&(c.length===2||c.length===3)&&!c.some(u=>u.fields?.size?.includes("wide"))||(h==="segment"||h==="product")&&(c.length===2||c.length===3)?p=c.length===2?"TwoColumns":"ThreeColumns":(h==="mini-compare-chart"||h==="mini-compare-chart-mweb")&&c.length<=2&&(p=c.length===1?"":"TwoColumns"),h&&this.classList.add("merch-card-collection",h,...Qh[`${h}${p}`]||[]),this.displayResult=!0,this.hydrating=!1,t.remove(),a(!0)}),await this.hydrationReady}get footer(){if(!this.filtered)return De`<div id="footer">
        ...
        </sp-button>`}sortChanged(t){t.target.value===xe.authored?jt({sort:void 0}):jt({sort:t.target.value}),this.dispatchEvent(new CustomEvent(Pa,{bubbles:!0,composed:!0,detail:{value:t.target.value}}))}async showMore(){this.dispatchEvent(new CustomEvent(Ma,{bubbles:!0,composed:!0}));let t=this.page+1;jt({page:t}),this.page=t,await this.updateComplete}startDeeplink(){this.stopDeeplink=Ca(({category:t,filter:a,types:i,sort:n,search:o,single_app:s,page:c})=>{a=a||t,!this.filtered&&a&&a!==this.filter&&setTimeout(()=>{jt({page:void 0}),this.page=1},1),this.filtered||(this.filter=a??this.filter),this.types=i??"",this.search=o??"",this.singleApp=s,this.sort=n,this.page=Number(c)||1})}openFilters(t){this.sidenav?.showModal(t)}};We=new WeakMap,Gt=new WeakMap,lt=new WeakMap,Lr=new WeakMap,ya=new WeakSet,_c=function(t,a={},i=!0){v(this,lt)?.error(`merch-card-collection: ${t}`,a),this.failed=!0,i&&this.dispatchEvent(new CustomEvent(Ia,{detail:{...a,message:t},bubbles:!0,composed:!0}))},g($t,"properties",{id:{type:String,attribute:"id",reflect:!0},displayResult:{type:Boolean,attribute:"display-result"},filter:{type:String,attribute:"filter",reflect:!0},filtered:{type:String,attribute:"filtered",reflect:!0},hasMore:{type:Boolean},limit:{type:Number,attribute:"limit"},overrides:{type:String},page:{type:Number,attribute:"page",reflect:!0},resultCount:{type:Number},search:{type:String,attribute:"search",reflect:!0},sidenav:{type:Object},singleApp:{type:String,attribute:"single-app",reflect:!0},sort:{type:String,attribute:"sort",default:xe.authored,reflect:!0},types:{type:String,attribute:"types",reflect:!0}}),g($t,"styles",Tc`
        #footer {
            grid-column: 1 / -1;
    ...
    `);$t.SortOrder=xe;customElements.define(kc,$t);var np={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},op=(e,r,t)=>{e.querySelectorAll(`[data-placeholder="${r}"]`).forEach(i=>{i.innerText=t||""})},sp={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},cp={catalog:"l"},he,qt,_r=class extends Cc{constructor(){super();A(this,he);A(this,qt);g(this,"tablet",new Vt(this,M));g(this,"desktop",new Vt(this,P));this.collection=null,E(this,he,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(fe,this.updateLiterals),this.collection?.addEventListener(Wt,this.handleSidenavAttached),E(this,qt,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(fe,this.updateLiterals),this.collection?.removeEventListener(Wt,this.handleSidenavAttached)}willUpdate(){v(this,he).search=this.getVisibility("search"),v(this,he).filter=this.getVisibility("filter"),v(this,he).sort=this.getVisibility("sort"),v(this,he).result=this.getVisibility("result"),v(this,he).custom=this.getVisibility("custom")}parseVisibilityOptions(t,a){if(!t||!Object.hasOwn(t,a))return null;let i=t[a];return i===!1?!1:i===!0?!0:i.includes(this.currentMedia)}getVisibility(t){let a=v(this,qt)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,i=this.parseVisibilityOptions(a,t);return i!==null?i:this.parseVisibilityOptions(sp,t)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!v(this,he).search)return ye;let t=Kt(this,"searchText");return t?De`
            <merch-search deeplink="search" id="search">
                <sp-search
                    id="search-bar"
                    placeholder="${t}"
                    .size=${cp[this.variant]}
                    aria-label="${t}"
                ></sp-search>
            </merch-search>
        `:ye}get filterAction(){return v(this,he).filter?this.sidenav?De`
            <sp-action-button
                id="filter"
                variant="secondary"
                treatment="outline"
            ...
            ></sp-action-button>
        `:ye:ye}get sortAction(){if(!v(this,he).sort)return ye;let t=Kt(this,"sortText");if(!t)return;let a=Kt(this,"popularityText"),i=Kt(this,"alphabeticallyText");if(!(a&&i))return;let n=this.collection?.sort===xe.alphabetical;return De`
            <sp-action-menu
                id="sort"
                size="m"
        ...
        `}get resultSlotName(){let t=`${this.search?"search":"filters"}${this.isMobile||this.isTablet?"Mobile":""}`;return np[t][Math.min(this.resultCount,2)]}get resultLabel(){if(!v(this,he).result)return ye;if(!this.sidenav)return ye;let t=this.search?"search":"filter",a=this.resultCount?this.resultCount===1?"single":"multiple":"none";return De` <div
            id="result"
            aria-live="polite"
            type=${t}
            quantity=${a}
        ...
        </div>`}get customArea(){if(!v(this,he).custom)return ye;let t=v(this,qt)?.getCollectionOptions(this.collection?.variant)?.customHeaderArea;if(!t)return ye;let a=t(this.collection);return!a||a===ye?ye:De`<div id="custom" role="heading" aria-level="2">
            ${a}
        </div>`}openFilters(t){this.sidenav.showModal(t)}updateLiterals(t){Object.keys(t.detail).forEach(a=>{op(this,a,t.detail[a])}),this.requestUpdate()}handleSidenavAttached(){this.requestUpdate()}render(){return De`
            <sp-theme color="light" scale="medium">
                <div id="header">
                    ${this.searchAction}${this.filterAction}${this.sortAction}${this.resultLabel}${this.customArea}
                </div>
            </sp-theme>
        `}get placeholderKeys(){return["searchText","filtersText","sortText","popularityText","alphabeticallyText","noResultText","resultText","resultsText","resultMobileText","resultsMobileText","noSearchResultsText","searchResultText","searchResultsText","noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]}};he=new WeakMap,qt=new WeakMap,g(_r,"styles",Tc`
        :host {
    ...
    `);customElements.define("merch-card-collection-header",_r);export{$t as MerchCardCollection,_r as default};
