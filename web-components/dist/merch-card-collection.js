var on=Object.defineProperty;var sn=e=>{throw TypeError(e)};var yc=(e,r,t)=>r in e?on(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var wc=(e,r)=>{for(var t in r)on(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>yc(e,typeof r!="symbol"?r+"":r,t),ba=(e,r,t)=>r.has(e)||sn("Cannot "+t);var v=(e,r,t)=>(ba(e,r,"read from private field"),t?t.call(e):r.get(e)),C=(e,r,t)=>r.has(e)?sn("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),A=(e,r,t,a)=>(ba(e,r,"write to private field"),a?a.call(e,t):r.set(e,t),t),B=(e,r,t)=>(ba(e,r,"access private method"),t);import{html as De,LitElement as lc,css as dc,unsafeCSS as cc,nothing as we}from"./lit-all.min.js";var D="(max-width: 767px)",Q="(max-width: 1199px)",R="(min-width: 768px)",L="(min-width: 1200px)",ne="(min-width: 1600px)",$t="(min-width: 1280px)",cn={matchMobile:window.matchMedia(D),matchDesktop:window.matchMedia(`${L} and (not ${ne})`),matchDesktopOrUp:window.matchMedia(L),matchLargeDesktop:window.matchMedia(ne),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},T=cn;function _r(){return cn.isDesktop}var Gt=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var ln="hashchange";function Ec(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let a of t){let[i,n=""]=a.split("=");i&&r.push([i,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function qt(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([i,n])=>{n?r.set(i,n):r.delete(i)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let a=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,a)}function dn(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=Ec(window.location.hash);e(t)};return r(),window.addEventListener(ln,r),()=>{window.removeEventListener(ln,r)}}var ja={};wc(ja,{CLASS_NAME_FAILED:()=>Pa,CLASS_NAME_HIDDEN:()=>Sc,CLASS_NAME_PENDING:()=>Ma,CLASS_NAME_RESOLVED:()=>Ra,CheckoutWorkflow:()=>Hc,CheckoutWorkflowStep:()=>ce,Commitment:()=>Xe,ERROR_MESSAGE_BAD_REQUEST:()=>Na,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Ic,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Oa,EVENT_AEM_ERROR:()=>_a,EVENT_AEM_LOAD:()=>ka,EVENT_COMPARE_CHART_REHYDRATE:()=>Nc,EVENT_EXPANDED_GROUPS_CHANGE:()=>Oc,EVENT_MAS_ERROR:()=>La,EVENT_MAS_READY:()=>Mr,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>Aa,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Ea,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>fe,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Ca,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>Vt,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Sa,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>Pr,EVENT_MERCH_OFFER_READY:()=>kc,EVENT_MERCH_OFFER_SELECT_READY:()=>_c,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>oe,EVENT_MERCH_SEARCH_CHANGE:()=>Rc,EVENT_MERCH_SIDENAV_SELECT:()=>Ta,EVENT_MERCH_STOCK_CHANGE:()=>Pc,EVENT_MERCH_STORAGE_CHANGE:()=>Mc,EVENT_OFFER_SELECTED:()=>Lc,EVENT_TYPE_FAILED:()=>Ia,EVENT_TYPE_READY:()=>Lr,EVENT_TYPE_RESOLVED:()=>ve,Env:()=>Ee,FF_ANNUAL_PRICE:()=>he,FF_DEFAULTS:()=>Pe,HEADER_X_REQUEST_ID:()=>jt,LOG_NAMESPACE:()=>Da,Landscape:()=>Be,MARK_DURATION_SUFFIX:()=>qa,MARK_START_SUFFIX:()=>Ga,MERCH_CARD_LOAD_TIMEOUT:()=>ya,MODAL_TYPE_3_IN_1:()=>Ae,NAMESPACE:()=>Ac,PARAM_AOS_API_KEY:()=>Dc,PARAM_ENV:()=>Ha,PARAM_LANDSCAPE:()=>Fa,PARAM_MAS_PREVIEW:()=>za,PARAM_WCS_API_KEY:()=>zc,PLACEHOLDER_PLAN_TYPE_TEXT:()=>$c,PROVIDER_ENVIRONMENT:()=>$a,SELECTOR_MAS_CHECKOUT_LINK:()=>hn,SELECTOR_MAS_ELEMENT:()=>wa,SELECTOR_MAS_INLINE_PRICE:()=>G,SELECTOR_MAS_SP_BUTTON:()=>Tc,SELECTOR_MAS_UPT_LINK:()=>pn,SORT_ORDER:()=>be,STATE_FAILED:()=>xe,STATE_PENDING:()=>Fe,STATE_RESOLVED:()=>se,SUPPORTED_COUNTRIES:()=>Va,TAG_NAME_SERVICE:()=>Cc,TEMPLATE_PRICE:()=>Fc,TEMPLATE_PRICE_ANNUAL:()=>Uc,TEMPLATE_PRICE_LEGAL:()=>J,TEMPLATE_PRICE_STRIKETHROUGH:()=>Bc,TRIAL_ANALYTICS_IDS:()=>mn,Term:()=>me,WCS_PROD_URL:()=>Ba,WCS_STAGE_URL:()=>Ua});var Xe=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),me=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),Ac="merch",ya=2e4,Sc="hidden",Lr="wcms:commerce:ready",Cc="mas-commerce-service",G='span[is="inline-price"][data-wcs-osi]',hn='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',Tc="sp-button[data-wcs-osi]",pn='a[is="upt-link"]',wa=`${G},${hn},${pn}`,mn=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]),kc="merch-offer:ready",_c="merch-offer-select:ready",Ea="merch-card:action-menu-toggle",Lc="merch-offer:selected",Pc="merch-stock:change",Mc="merch-storage:change",oe="merch-quantity-selector:change",Pr="merch-card-quantity:change",Aa="merch-modal:addon-and-quantity-update",Rc="merch-search:change",Sa="merch-card-collection:sort",fe="merch-card-collection:literals-changed",Vt="merch-card-collection:sidenav-attached",Ca="merch-card-collection:showmore",Ta="merch-sidenav:select",ka="aem:load",_a="aem:error",Mr="mas:ready",La="mas:error",Nc="mas-compare-chart:rehydrate",Oc="expanded-groups-change",Pa="placeholder-failed",Ma="placeholder-pending",Ra="placeholder-resolved",Na="Bad WCS request",Oa="Commerce offer not found",Ic="Literals URL not provided",Ia="mas:failed",ve="mas:resolved",Da="mas/commerce",za="mas.preview",Ha="commerce.env",Fa="commerce.landscape",Dc="commerce.aosKey",zc="commerce.wcsKey",Ba="https://www.adobe.com/web_commerce_artifact",Ua="https://www.stage.adobe.com/web_commerce_artifact_stage",xe="failed",Fe="pending",se="resolved",Be={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},jt="X-Request-Id",ce=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),Hc="UCv3",Ee=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),$a={PRODUCTION:"PRODUCTION"},Ae={TWP:"twp",D2P:"d2p",CRM:"crm"},Ga=":start",qa=":duration",Fc="price",Bc="price-strikethrough",Uc="annual",J="legal",$c="plan-type-text",Pe="mas-ff-defaults",he="mas-ff-annual-price",be={alphabetical:"alphabetical",authored:"authored"},Va=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var Gc="mas-commerce-service";function un(e,r){let t;return function(){let a=this,i=arguments;clearTimeout(t),t=setTimeout(()=>e.apply(a,i),r)}}var Wt=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function Se(e,r={},t=null,a=null){let i=a?document.createElement(e,{is:a}):document.createElement(e);t instanceof HTMLElement?i.appendChild(t):i.innerHTML=t;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function Rr(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function Ya(){return window.matchMedia("(max-width: 1024px)").matches}var Wa=new Map,qc=0;function gn(e,r){let t=++qc,a=r,i=performance.now(),n,o=()=>{Xa(t),e()},s=()=>{i=performance.now(),n=setTimeout(o,a)},c=()=>{document.visibilityState==="hidden"?(clearTimeout(n),a-=performance.now()-i):s()};return Wa.set(t,()=>{clearTimeout(n),document.removeEventListener("visibilitychange",c)}),document.addEventListener("visibilitychange",c),document.visibilityState!=="hidden"&&s(),t}function Xa(e){let r=Wa.get(e);r&&(r(),Wa.delete(e))}function Yt(){return document.getElementsByTagName(Gc)?.[0]}function Xt(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}var Vc=["adobe.com","adobeioruntime.net","aem.live","aem.page"],jc=["localhost","127.0.0.1"];function fn(e){try{let r=new URL(e);return jc.includes(r.hostname)?r.protocol==="http:"||r.protocol==="https:":r.protocol!=="https:"?!1:Vc.some(t=>r.hostname===t||r.hostname.endsWith(`.${t}`))}catch{return!1}}import{html as Nr,nothing as Wc}from"./lit-all.min.js";var ht,Kt=class Kt{constructor(r){g(this,"card");C(this,ht);this.card=r,this.insertVariantStyle()}getContainer(){return A(this,ht,v(this,ht)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),v(this,ht)}insertVariantStyle(){let r=this.constructor.name;if(!Kt.styleMap[r]){Kt.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let a=`--consonant-merch-card-${this.card.variant}-${t}-height`,i=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(a))||0;i>o&&n.style.setProperty(a,`${i}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let a=this.card.variant,i=Array.from(t.querySelectorAll(`merch-card[variant="${a}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${a}-${o}-height`;t.style.getPropertyValue(s)&&t.style.removeProperty(s)}let n=new Map;for(let o of i){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of r){let l=`--consonant-merch-card-${a}-${s}-height`,d=o.map(h=>h.style.getPropertyValue(l)),u=0,m=o.map(h=>{h.style.removeProperty(l);let p=c(h);if(!p)return p;let f=Math.max(0,parseInt(window.getComputedStyle(p).height)||0);return f>u&&(u=f),p});o.forEach((h,p)=>{m[p]?.tagName!=="HR"&&(u>0?h.style.setProperty(l,`${u}px`):d[p]&&h.style.setProperty(l,d[p]))})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Nr`
            <div
                id="badge"
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
            ...
            <slot></slot>`}getGlobalCSS(){return vn}setAriaExpanded(t,a){t.setAttribute("aria-expanded",a)}connectedCallbackHook(){this.card.addEventListener("mouseenter",this.showActionMenuOnHover),this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.addEventListener("focusin",this.showActionMenuOnHover),this.card.addEventListener("focusout",this.handleCardFocusOut),this.card.addEventListener("keydown",this.handleKeyDown)}disconnectedCallbackHook(){this.card.removeEventListener("mouseenter",this.showActionMenuOnHover),this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.removeEventListener("focusin",this.showActionMenuOnHover),this.card.removeEventListener("focusout",this.handleCardFocusOut),this.card.removeEventListener("keydown",this.handleKeyDown)}};g(pt,"variantStyle",Yc`
    ...
    `);import{html as Qt,css as Xc}from"./lit-all.min.js";var bn=`
:root {
...
`;var yn={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},Ke=class extends w{constructor(r){super(r)}getGlobalCSS(){return bn}renderLayout(){return Qt`<div class="image">
                <slot name="bg-image"></slot>
    ...
    `);import{html as En}from"./lit-all.min.js";var wn=`
:root {
...
`;var Ir=class extends w{constructor(r){super(r)}getGlobalCSS(){return wn}renderLayout(){return En` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":En`<hr />`} ${this.secureLabelFooter}`}};import{html as Ue,css as bl,unsafeCSS as $n}from"./lit-all.min.js";var An=`
  :root {
...
`;var Sn="tacocat.js";var Qa=(e,r)=>String(e??"").toLowerCase()==String(r??"").toLowerCase(),Cn=e=>`${e??""}`.replace(/[&<>'"]/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[r]??r)??"";function F(e,r={},{metadata:t=!0,search:a=!0,storage:i=!0}={}){let n;if(a&&n==null){let o=new URLSearchParams(window.location.search),s=mt(a)?a:e;n=o.get(s)}if(i&&n==null){let o=mt(i)?i:e;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(t&&n==null){let o=Qc(mt(t)?t:e);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[e]}var Kc=e=>typeof e=="boolean",Dr=e=>typeof e=="function",zr=e=>typeof e=="number",Tn=e=>e!=null&&typeof e=="object";var mt=e=>typeof e=="string",Za=e=>mt(e)&&e,ut=e=>zr(e)&&Number.isFinite(e)&&e>0;function Hr(e,r=t=>t==null||t===""){return e!=null&&Object.entries(e).forEach(([t,a])=>{r(a)&&delete e[t]}),e}function k(e,r){if(Kc(e))return e;let t=String(e);return t==="1"||t==="true"?!0:t==="0"||t==="false"?!1:r}function Zt(e,r,t){let a=Object.values(r);return a.find(i=>Qa(i,e))??t??a[0]}function Qc(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,t,a)=>`${t}-${a}`).replace(/\W+/gu,"-").toLowerCase()}function kn(e,r=1){return zr(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:r}var Zc=Date.now(),Ja=()=>`(+${Date.now()-Zc}ms)`,Fr=new Set,Jc=k(F("tacocat.debug",{},{metadata:!1}),!1);function _n(e){let r=`[${Sn}/${e}]`,t=(o,s,...c)=>o?!0:(i(s,...c),!1),a=Jc?(o,...s)=>{console.debug(`${r} ${o}`,...s,Ja())}:()=>{},i=(o,...s)=>{let c=`${r} ${o}`;Fr.forEach(([l])=>l(c,...s))};return{assert:t,debug:a,error:i,warn:(o,...s)=>{let c=`${r} ${o}`;Fr.forEach(([,l])=>l(c,...s))}}}function el(e,r){let t=[e,r];return Fr.add(t),()=>{Fr.delete(t)}}el((e,...r)=>{console.error(e,...r,Ja())},(e,...r)=>{console.warn(e,...r,Ja())});var tl="no promo",Ln="promo-tag",rl="yellow",al="neutral",il=(e,r,t)=>{let a=n=>n||tl,i=t?` (was "${a(r)}")`:"";return`${a(e)}${i}`},Br="cancel-context",Ur=(e,r)=>{let t=e===Br,a=!t&&e?.length>0,i=(a||t)&&(r&&r!=e||!r&&!t),n=i&&a||!i&&!!r,o=n?e||r:void 0;return{effectivePromoCode:o,overridenPromoCode:e,className:n?Ln:`${Ln} no-promo`,text:il(o,r,i),variant:n?rl:al,isOverriden:i}};var ei;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(ei||(ei={}));var pe;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(pe||(pe={}));var ue;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(ue||(ue={}));var ti;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(ti||(ti={}));var ri;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(ri||(ri={}));var ai;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(ai||(ai={}));var ii;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(ii||(ii={}));var ni="ABM",oi="PUF",si="M2M",ci="PERPETUAL",li="P3Y",nl="TAX_INCLUSIVE_DETAILS",ol="TAX_EXCLUSIVE",Pn={ABM:ni,PUF:oi,M2M:si,PERPETUAL:ci,P3Y:li},Op={[ni]:{commitment:pe.YEAR,term:ue.MONTHLY},[oi]:{commitment:pe.YEAR,term:ue.ANNUAL},[si]:{commitment:pe.MONTH,term:ue.MONTHLY},[ci]:{commitment:pe.PERPETUAL,term:void 0},[li]:{commitment:pe.THREE_MONTHS,term:ue.P3Y}},Mn="Value is not an offer",$r=e=>{if(typeof e!="object")return Mn;let{commitment:r,term:t}=e,a=sl(r,t);return{...e,planType:a}};var sl=(e,r)=>{switch(e){case void 0:return Mn;case"":return"";case pe.YEAR:return r===ue.MONTHLY?ni:r===ue.ANNUAL?oi:"";case pe.MONTH:return r===ue.MONTHLY?si:"";case pe.PERPETUAL:return ci;case pe.TERM_LICENSE:return r===ue.P3Y?li:"";default:return""}};function Rn(e){let{priceDetails:r}=e,{price:t,priceWithoutDiscount:a,priceWithoutTax:i,priceWithoutDiscountAndTax:n,taxDisplay:o}=r;if(o!==nl)return e;let s={...e,priceDetails:{...r,price:i??t,priceWithoutDiscount:n??a,taxDisplay:ol}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var Qe={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Nn=1e3;function cl(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function On(e){if(e==null)return;let r=typeof e;if(r==="function")return e.name?`function ${e.name}`:"function";if(r==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:a,originatingRequest:i,status:n}=e;return[a,n,i].filter(Boolean).join(" ")}let t=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Qe.serializableTypes.includes(t))return t}return e}function ll(e,r){if(!Qe.ignoredProperties.includes(e))return On(r)}var di={append(e){if(e.level!=="error")return;let{message:r,params:t}=e,a=[],i=[],n=r;t.forEach(l=>{l!=null&&(cl(l)?a:i).push(l)}),a.length&&(n+=` ${a.map(On).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${Qe.delimiter}page=${o}${s}`;c.length>Nn&&(c=`${c.slice(0,Nn)}<trunc>`),n+=c,i.length&&(n+=`${Qe.delimiter}facts=`,n+=JSON.stringify(i,ll)),window.lana?.log(n,Qe)}};function Gr(e){Object.assign(Qe,Object.fromEntries(Object.entries(e).filter(([r,t])=>r in Qe&&t!==""&&t!==null&&t!==void 0&&!Number.isNaN(t))))}var In={LOCAL:"local",PROD:"prod",STAGE:"stage"},hi={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},pi=new Set,mi=new Set,Dn=new Map,zn={append({level:e,message:r,params:t,timestamp:a,source:i}){console[e](`${a}ms [${i}] %c${r}`,"font-weight: bold;",...t)}},Hn={filter:({level:e})=>e!==hi.DEBUG},dl={filter:()=>!1};function hl(e,r,t,a,i){return{level:e,message:r,namespace:t,get params(){return a.length===1&&Dr(a[0])&&(a=a[0](),Array.isArray(a)||(a=[a])),a},source:i,timestamp:performance.now().toFixed(3)}}function pl(e){[...mi].every(r=>r(e))&&pi.forEach(r=>r(e))}function Fn(e){let r=(Dn.get(e)??0)+1;Dn.set(e,r);let t=`${e} #${r}`,a={id:t,namespace:e,module:i=>Fn(`${a.namespace}/${i}`),updateConfig:Gr};return Object.values(hi).forEach(i=>{a[i]=(n,...o)=>pl(hl(i,n,e,o,t))}),Object.seal(a)}function qr(...e){e.forEach(r=>{let{append:t,filter:a}=r;Dr(a)&&mi.add(a),Dr(t)&&pi.add(t)})}function ml(e={}){let{name:r}=e,t=k(F("commerce.debug",{search:!0,storage:!0}),r===In.LOCAL);return qr(t?zn:Hn),r===In.PROD&&qr(di),ae}function ul(){pi.clear(),mi.clear()}var ae={...Fn(Da),Level:hi,Plugins:{consoleAppender:zn,debugFilter:Hn,quietFilter:dl,lanaAppender:di},init:ml,reset:ul,use:qr};var gl="mas-commerce-service",fl=ae.module("utilities"),vl={requestId:jt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function Jt(e,{country:r,forceTaxExclusive:t}){let a;if(e.length<2)a=e;else{let i=r==="GB"?"EN":"MULT";e.sort((n,o)=>n.language===i?-1:o.language===i?1:0),e.sort((n,o)=>!n.term&&o.term?-1:n.term&&!o.term?1:0),a=[e[0]]}return t&&(a=a.map(Rn)),a}var Bn=(e,r)=>{let t=e.reduce((a,i)=>a+(r(i)||0),0);return t>0?Math.round(t*100)/100:void 0};function ui(e){if(!e||e.length===0)return null;if(e.length===1)return e[0];let[r,...t]=e;for(let s of t){let c=[["commitment","commitment types"],["term","terms"],["priceDetails.formatString","currency formats"]];for(let[l,d]of c){let u=l.includes(".")?r.priceDetails?.formatString:r[l],m=l.includes(".")?s.priceDetails?.formatString:s[l];m!==u&&fl.warn(`Offers have different ${d}, summing may produce unexpected results`,{expected:u,actual:m})}}let a=[["price",s=>s.priceDetails?.price],["priceWithoutDiscount",s=>s.priceDetails?.priceWithoutDiscount],["priceWithoutTax",s=>s.priceDetails?.priceWithoutTax],["priceWithoutDiscountAndTax",s=>s.priceDetails?.priceWithoutDiscountAndTax]],i={};for(let[s,c]of a){let l=Bn(e,c);l!==void 0&&(i[s]=l)}let n=e.some(s=>s.priceDetails?.annualized),o;if(n){let s=[["annualizedPrice",c=>c.priceDetails?.annualized?.annualizedPrice],["annualizedPriceWithoutTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutTax],["annualizedPriceWithoutDiscount",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscount],["annualizedPriceWithoutDiscountAndTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscountAndTax]];o={};for(let[c,l]of s){let d=Bn(e,l);d!==void 0&&(o[c]=d)}}return{...r,offerSelectorIds:e.flatMap(s=>s.offerSelectorIds||[]),priceDetails:{...r.priceDetails,...i,...o&&{annualized:o}}}}var Vr=e=>window.setTimeout(e);function gt(e,r=1){if(e==null)return[r];let t=(Array.isArray(e)?e:String(e).split(",")).map(kn).filter(ut);return t.length||(t=[r]),t}function xl(e){return e==null?[]:Array.isArray(e)?e:String(e).split(",").map(r=>r.trim())}function jr(e,r){let t=xl(r);if(e==null)return{wcsOsi:[],promotionCodes:t};let a=Array.isArray(e)?e:String(e).split(",");if(t.length<=1)return{wcsOsi:a.filter(Za),promotionCodes:t};let i=[],n=[];return a.forEach((o,s)=>{Za(o)&&(i.push(o),n.push(t[s]??""))}),{wcsOsi:i,promotionCodes:n}}function q(){return document.getElementsByTagName(gl)?.[0]}function Un(e){let r={};if(!e?.headers)return r;let t=e.headers;for(let[a,i]of Object.entries(vl)){let n=t.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[a]=n)}return r}var yl=32,Gn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"};function er(e,r,t,a){e?.featureFlags[he]&&r.options[a]?t.dataset[a]="false":r.options[a]&&(r.dataset[a]="false")}var ft=class extends w{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?Ue`<slot name="secure-transaction-label">
                  <span class="secure-transaction-label"
                      >${this.card.secureLabel}</span
                  ></slot
              >`:Ue`<slot name="secure-transaction-label"></slot>`;return this.isNewVariant?Ue`<footer>
                ${t}
                <p class="action-area"><slot name="footer"></slot></p>
            </footer>`:Ue`<footer>${t}<slot name="footer"></slot></footer>`});this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){if(this.card.addEventListener(oe,this.updatePriceQuantity),this.legalAdjusted&&!this.legalObserver){let t=this.card.querySelector('[is="inline-price"][data-template="legal"]');t?(this.legalResolvedHandler=()=>this.adjustShortDescription(),t.addEventListener(ve,this.legalResolvedHandler),this.legalElement=t,this.legalObserver=new MutationObserver(()=>this.adjustShortDescription()),this.legalObserver.observe(t,{childList:!0,subtree:!0}),this.adjustShortDescription()):this.legalAdjusted=!1}this.visibilityObserver=new IntersectionObserver(([t])=>{t.boundingClientRect.height!==0&&t.isIntersecting&&(T.isMobile||requestAnimationFrame(()=>{let a=this.getContainer();if(!a)return;a.querySelectorAll('merch-card[variant="mini-compare-chart"]').forEach(n=>n.variantLayout?.syncHeights?.())}),this.visibilityObserver.disconnect())}),this.visibilityObserver.observe(this.card)}disconnectedCallbackHook(){if(this.card.removeEventListener(oe,this.updatePriceQuantity),this.visibilityObserver?.disconnect(),this.legalObserver?.disconnect(),this.legalObserver=null,this.legalElement&&this.legalResolvedHandler&&(this.legalElement.removeEventListener(ve,this.legalResolvedHandler),this.legalResolvedHandler=null,this.legalElement=null),this.calloutListenersAdded){document.removeEventListener("touchstart",this.handleCalloutTouch),document.removeEventListener("mouseover",this.handleCalloutMouse);let t=this.card.querySelector('[slot="callout-content"] .icon-button');t?.removeEventListener("focusin",this.handleCalloutFocusin),t?.removeEventListener("focusout",this.handleCalloutFocusout),t?.removeEventListener("keydown",this.handleCalloutKeydown),this.calloutListenersAdded=!1}}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}priceOptionsProvider(t,a){if(!this.isNewVariant)return;if(t.dataset.template===J){a.displayPlanType=this.card?.settings?.displayPlanType??!1;return}let i=q();(t.dataset.template==="strikethrough"||t.dataset.template==="price"&&!i.featureFlags[he])&&(a.displayPerUnit=!1)}getGlobalCSS(){return An}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2)return;this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".top-section"),"top-section");let t=["heading-m","heading-xs","subtitle","body-m","heading-m-price","body-xxs","price-commitment","quantity-select","offers","promo-text","callout-content","addon"];this.card.classList.contains("bullet-list")&&t.push("footer-rows"),t.forEach(i=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${i}"]`),i)),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer"),this.card.shadowRoot.querySelector(".mini-compare-chart-badge")?.textContent!==""&&this.getContainer().style.setProperty("--consonant-merch-card-mini-compare-chart-top-section-mobile-height","32px")}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let t;if(this.isNewVariant){let a=this.card.querySelector("merch-whats-included");if(!a)return;t=[...a.querySelectorAll('[slot="content"] merch-mnemonic-list')]}else{let a=this.card.querySelector('[slot="footer-rows"] ul');if(!a||!a.children)return;t=[...a.children]}t.length&&t.forEach((a,i)=>{let n=Math.max(yl,parseFloat(window.getComputedStyle(a).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(i+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(i+1),`${n}px`)})}removeEmptyRows(){this.isNewVariant?this.card.querySelectorAll('merch-whats-included [slot="content"] merch-mnemonic-list').forEach(a=>{if(a.hasAttribute("data-placeholder"))return;let i=a.querySelector('[slot="icon"]'),n=!!i?.querySelector(".sp-icon")||!!i?.querySelector('merch-icon[src]:not([src=""]), img[src]:not([src=""])'),s=a.querySelector('[slot="description"]')?.textContent?.replace(/\u00a0/g," ")?.trim()??"";!n&&!s&&a.remove()}):this.card.querySelectorAll(".footer-row-cell").forEach(a=>{if(a.hasAttribute("data-placeholder"))return;let i=a.querySelector(".footer-row-cell-description");i&&!i.textContent.trim()&&a.remove()})}padFooterRows(){let t=this.getContainer();if(!t)return;let a=t.querySelectorAll('merch-card[variant="mini-compare-chart"]');if(this.isNewVariant){let i=0;if(a.forEach(l=>{let d=l.querySelector("merch-whats-included");if(!d)return;let u=d.querySelectorAll('[slot="content"] merch-mnemonic-list:not([data-placeholder])');i=Math.max(i,u.length)}),i===0)return;let n=this.card.querySelector("merch-whats-included");if(!n)return;let o=n.querySelector('[slot="content"]');if(!o)return;o.querySelectorAll("merch-mnemonic-list[data-placeholder]").forEach(l=>l.remove());let s=o.querySelectorAll("merch-mnemonic-list").length,c=i-s;for(let l=0;l<c;l++){let d=document.createElement("merch-mnemonic-list");d.setAttribute("data-placeholder","");let u=document.createElement("div");u.setAttribute("slot","icon");let m=document.createElement("div");m.setAttribute("slot","description"),d.append(u,m),o.appendChild(d)}}else{let i=0;if(a.forEach(c=>{let l=c.querySelector('[slot="footer-rows"] ul');if(!l)return;let d=l.querySelectorAll("li.footer-row-cell:not([data-placeholder])");i=Math.max(i,d.length)}),i===0)return;let n=this.card.querySelector('[slot="footer-rows"] ul');if(!n)return;n.querySelectorAll("li.footer-row-cell[data-placeholder]").forEach(c=>c.remove());let o=n.querySelectorAll("li.footer-row-cell").length,s=i-o;for(let c=0;c<s;c++){let l=document.createElement("li");l.className="footer-row-cell",l.setAttribute("data-placeholder",""),n.appendChild(l)}}}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${G}[data-template="price"]`)}get headingMPriceSlot(){return this.card.shadowRoot?.querySelector('slot[name="heading-m-price"]')?.assignedElements()[0]}get isNewVariant(){return!!this.card.querySelector("merch-whats-included")}toggleAddon(t){let a=this.mainPrice,i=this.headingMPriceSlot;if(!a&&i){let n=t?.getAttribute("plan-type"),o=null;if(t&&n&&(o=t.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-m-price"]').forEach(s=>s.remove()),t.checked){if(o){let s=Se("p",{class:"addon-heading-m-price-addon",slot:"heading-m-price"},o.innerHTML);this.card.appendChild(s)}}else{let s=Se("p",{class:"card-heading",id:"free",slot:"heading-m-price"},"Free");this.card.appendChild(s)}}}showTooltip(t){t.classList.remove("hide-tooltip"),t.setAttribute("aria-expanded","true")}hideTooltip(t){t.classList.add("hide-tooltip"),t.setAttribute("aria-expanded","false")}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');if(!t||this.calloutListenersAdded)return;let a=t.title||t.dataset.tooltip;if(!a)return;t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"));let i=t.parentElement;if(i&&i.tagName==="P"){let n=document.createElement("div"),o=document.createElement("div");o.className="callout-row";let s=document.createElement("div");for(s.className="callout-text";i.firstChild&&i.firstChild!==t;)s.appendChild(i.firstChild);o.appendChild(s),o.appendChild(t),n.appendChild(o),i.replaceWith(n)}t.setAttribute("role","button"),t.setAttribute("tabindex","0"),t.setAttribute("aria-label",a),t.setAttribute("aria-expanded","false"),this.hideTooltip(t),this.handleCalloutTouch=n=>{n.target!==t?this.hideTooltip(t):t.classList.contains("hide-tooltip")?this.showTooltip(t):this.hideTooltip(t)},this.handleCalloutMouse=n=>{n.target!==t?this.hideTooltip(t):this.showTooltip(t)},this.handleCalloutFocusin=()=>{this.showTooltip(t)},this.handleCalloutFocusout=()=>{this.hideTooltip(t)},this.handleCalloutKeydown=n=>{n.key==="Escape"&&(this.hideTooltip(t),t.blur())},document.addEventListener("touchstart",this.handleCalloutTouch),document.addEventListener("mouseover",this.handleCalloutMouse),t.addEventListener("focusin",this.handleCalloutFocusin),t.addEventListener("focusout",this.handleCalloutFocusout),t.addEventListener("keydown",this.handleCalloutKeydown),this.calloutListenersAdded=!0}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;let a=this.mainPrice,i=this.card.planType;if(a&&(await a.onceSettled?.(),i=a.value?.[0]?.planType),!i)return;t.planType=i,this.card.querySelector("merch-addon[plan-type]")?.updateComplete.then(()=>{this.updateCardElementMinHeight(this.card.shadowRoot.querySelector('slot[name="addon"]'),"addon")})}async adjustLegal(){if(this.legalAdjusted||this.legalAdjusting)return;this.legalAdjusting=!0;let t;try{let a=q();await this.card.updateComplete,await customElements.whenDefined("inline-price");let i=this.mainPrice;if(!i||(await i.onceSettled(),!i?.options))return;t=i.cloneNode(!0),i.options.displayPlanType&&(i.dataset.displayPlanType="false"),er(a,i,t,"displayTax"),er(a,i,t,"displayPerUnit"),t.setAttribute("data-template","legal"),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),t.addEventListener(ve,this.legalResolvedHandler),this.legalElement=t),i.parentNode.insertBefore(t,i.nextSibling),this.legalAdjusted=!0,await t.onceSettled(),this.legalObserver=new MutationObserver(()=>this.adjustShortDescription()),this.legalObserver.observe(t,{childList:!0,subtree:!0})}catch{t?.parentNode&&(t.parentNode.removeChild(t),this.legalAdjusted=!1,this.legalResolvedHandler=null,this.legalElement=null)}finally{this.legalAdjusting=!1}}getOrCreateFallbackPlanType(){let t=this.headingMPriceSlot;if(!t)return null;let a=t.querySelector(".price-legal[data-fallback]");if(!a){a=document.createElement("span"),a.className="price price-legal",a.dataset.fallback="true";let i=document.createElement("span");i.className="price-plan-type disabled",a.appendChild(i),t.appendChild(a)}return a.querySelector(".price-plan-type")}adjustShortDescription(){let a=this.card.querySelector('[is="inline-price"][data-template="legal"]')?.querySelector(".price-plan-type"),i=this.headingMPriceSlot?.querySelector(".price-legal[data-fallback]"),n=i?.querySelector(".price-plan-type");if(a&&n){let l=n.querySelector("em");l&&!a.querySelector("em")&&a.appendChild(l),i.remove()}let o=this.card.querySelector('[slot="body-xxs"]');if(o){let l=o.textContent?.trim(),d=!!o.querySelector(".icon-button");(l||d)&&(this.shortDescriptionHTML=o.innerHTML,o.remove())}if(!this.shortDescriptionHTML)return;let s=a??this.getOrCreateFallbackPlanType();if(!s||s.querySelector("em"))return;let c=document.createElement("em");c.innerHTML=` ${this.shortDescriptionHTML}`,s.appendChild(c)}renderLayout(){return this.isNewVariant?Ue` <div class="top-section${this.badge?" badge":""}">
                <slot name="icons"></slot> ${this.badge}
                <slot name="badge"></slot>
            </div>
            <slot name="heading-m"></slot>
            ...
            <slot name="footer-rows"><slot name="body-s"></slot></slot>`:Ue` <div class="top-section${this.badge?" badge":""}">
                    <slot name="icons"></slot> ${this.badge}
                </div>
                <slot name="heading-m"></slot>
    ...
    `);import{html as Wr,css as wl,unsafeCSS as gi,nothing as El}from"./lit-all.min.js";var qn=`
  :root {
...
`;var Al=32,Sl=0,Cl=()=>`mweb-list-${Sl+=1}`,Tl=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"],kl=8,Vn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Ce,Ze,xt,bt,yt,$e,fi,vi,vt=class extends w{constructor(t){super(t);C(this,$e);C(this,Ce);C(this,Ze);C(this,xt);C(this,bt,0);C(this,yt);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>Wr` <footer>
        ...
        </footer>`);g(this,"getMiniCompareFooterRows",()=>Wr` <div class="footer-rows-container">
            <slot name="body-xs"></slot>
            <slot name="footer-rows"></slot>
        </div>`);this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){this.card.addEventListener(oe,this.updatePriceQuantity),A(this,bt,this.card.getBoundingClientRect().width),A(this,Ze,new ResizeObserver(()=>{let t=this.card.getBoundingClientRect().width;t!==v(this,bt)&&(A(this,bt,t),clearTimeout(v(this,xt)),A(this,xt,setTimeout(()=>this.reconcileBreakpoint(),150)))})),v(this,Ze).observe(this.card)}disconnectedCallbackHook(){this.card.removeEventListener(oe,this.updatePriceQuantity),clearTimeout(v(this,xt)),v(this,Ze)?.disconnect(),A(this,Ze,null),v(this,Ce)?.disconnect(),A(this,Ce,null)}reconcileBreakpoint(){T.isMobile?(this.resetSyncedHeights(),this.removeEmptyRows()):B(this,$e,vi).call(this)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}syncHeights(){if(T.isMobile)return;if(this.card.getBoundingClientRect().width<=2){v(this,Ce)||(A(this,Ce,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,Ce)?.disconnect(),A(this,Ce,null),this.syncHeights())})),v(this,Ce).observe(this.card));return}let t=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"];this.syncRowHeights(t.map(a=>({name:a,getElement:i=>i.querySelector(`[slot="${a}"]`)}))),this.adjustMiniCompareFooterRows()}priceOptionsProvider(t,a){if(t.dataset.template===J){a.displayPlanType=this.card?.settings?.displayPlanType??!1;return}let i=q();(t.dataset.template==="strikethrough"||t.dataset.template==="price"&&!i.featureFlags[he])&&(a.displayPerUnit=!1)}getGlobalCSS(){return qn}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="footer-rows"] ul');!t||!t.children||[...t.children].forEach((a,i)=>{let n=Math.max(Al,parseFloat(window.getComputedStyle(a).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(i+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(i+1),`${n}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(a=>{let i=a.querySelector(".footer-row-cell-description");i&&!i.textContent.trim()&&a.remove()})}setupToggle(){let t=this.card.querySelector('[slot="body-xs"]'),a=t?.querySelector("p"),i=t?.querySelector("ul");if(!a||!i||t.querySelector(".footer-rows-title"))return;let n=a.textContent.trim(),o=this.card.querySelector("h3")?.id,s=o?`${o}-list`:Cl();i.id=s,i.classList.add("checkmark-copy-container");let c=Se("h4",{class:"footer-rows-title"},n),l=Se("button",{class:"toggle-icon","aria-label":n,"aria-expanded":"false","aria-controls":s});A(this,yt,{toggleBtn:l,listEl:i}),c.append(l),c.addEventListener("click",()=>{T.isMobile&&this.setListOpen(!this.isListOpen)}),a.replaceWith(c)}get isListOpen(){return v(this,yt)?.listEl.classList.contains("open")??!1}setListOpen(t){let{toggleBtn:a,listEl:i}=v(this,yt);i.classList.toggle("open",t),a.classList.toggle("expanded",t),a.setAttribute("aria-expanded",String(t))}get legalDisplayDot(){return!1}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${G}[data-template="price"]`)}async adjustLegal(){if(!this.legalAdjusted)try{let t=q();this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let a=this.mainPrice;if(!a)return;let i=a.cloneNode(!0);if(await a.onceSettled(),!a?.options)return;a.options.displayPlanType&&(a.dataset.displayPlanType="false"),er(t,a,i,"displayTax"),er(t,a,i,"displayPerUnit"),i.setAttribute("data-template","legal"),a.parentNode.insertBefore(i,a.nextSibling),await i.onceSettled()}catch{}}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?El:Wr`<slot name="icons"></slot>`}renderLayout(){return Wr`
            ${this.badge}
            <div class="body">
                <div class="body-main">
                    ${this.icons}
        ...
        `}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),this.setupToggle(),T.isMobile&&this.removeEmptyRows(),await super.postCardUpdateHook(),T.isMobile||await B(this,$e,vi).call(this)}resetSyncedHeights(){let t=this.getContainer();if(!t)return;let a=this.card.variant,i=B(this,$e,fi).call(this,t);for(let n of Tl){let o=`--consonant-merch-card-${a}-${n}-height`;t.style.removeProperty(o),i.forEach(s=>s.style.removeProperty(o))}for(let n=1;n<=kl;n+=1)t.style.removeProperty(this.getRowMinHeightPropertyName(n))}};Ce=new WeakMap,Ze=new WeakMap,xt=new WeakMap,bt=new WeakMap,yt=new WeakMap,$e=new WeakSet,fi=function(t){return t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)},vi=async function(){let t=this.getContainer();if(!t)return;let a=Array.from(B(this,$e,fi).call(this,t));this.card===a[0]&&(await Promise.all(a.map(i=>i.updateComplete)),await new Promise(i=>setTimeout(i,100)),requestAnimationFrame(()=>{this.resetSyncedHeights(),this.syncHeights()}))},g(vt,"variantStyle",wl`
    ...
    `);import{html as tr,css as _l,nothing as Yr}from"./lit-all.min.js";var jn=`
:root {
...
`;var Xr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Wn={...(function(){let{whatsIncluded:e,size:r,...t}=Xr;return t})(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Yn={...(function(){let{subtitle:e,whatsIncluded:r,size:t,quantitySelect:a,...i}=Xr;return i})()},Te,ke,le=class extends w{constructor(t){super(t);C(this,Te);C(this,ke);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,a){t.dataset.template===J&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return jn}adjustSlotPlacement(t,a,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),d=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!a.includes(s)){if(o?.classList.toggle("wide-footer",T.isDesktopOrUp),!i&&c){if(l)c.remove();else{let u=d.querySelector(`[data-placeholder-for="${t}"]`);u?u.replaceWith(c):d.appendChild(c)}return}if(i&&l){let u=document.createElement("div");if(u.setAttribute("data-placeholder-for",t),u.classList.add("slot-placeholder"),!c){let m=l.cloneNode(!0);o.prepend(m)}l.replaceWith(u)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],T.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],T.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){v(this,Te)||(A(this,Te,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,Te)?.disconnect(),A(this,Te,null),this.syncHeights())})),v(this,Te).observe(this.card));return}let t=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(t.map(a=>({name:a,getElement:i=>i.querySelector(`[slot="${a}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let a=this.card.querySelector('[slot="body-xs"]');if(!a)return;let i=a.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),a.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=Xt(d));let u=this.card.querySelector('[slot="subtitle"]');u&&(l+=Xt(u));let m=this.card.querySelector('[slot="heading-m"]');m&&(l+=8+Xt(m));for(let p of a.childNodes){if(p.classList.contains("spacer"))break;l+=Xt(p)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${G}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?tr`<div class="divider"></div>`:Yr}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],a=this.card.querySelector(`[slot="heading-m"] ${G}[data-template="price"]`);a&&t.push(a);let i=t.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?tr`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};Te=new WeakMap,ke=new WeakMap,g(le,"variantStyle",_l`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),g(le,"collectionOptions",{customHeaderArea:t=>t.sidenav?tr`<slot name="resultsText"></slot>`:Yr,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let a=()=>{let i=t.querySelectorAll("merch-card");for(let o of i)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!T.isDesktop)return;let n=0;for(let o of i){if(o.style.display==="none")continue;let s=o.getAttribute("size"),c=s==="wide"?2:s==="super-wide"?3:1;c===2&&n%3===2&&(o.setAttribute("data-size",s),o.removeAttribute("size"),c=1),n+=c}};T.matchDesktop.addEventListener("change",a),t.addEventListener(fe,a),t.onUnmount.push(()=>{T.matchDesktop.removeEventListener("change",a),t.removeEventListener(fe,a)})}});import{html as Me,css as Ll,unsafeCSS as Kn,nothing as Kr}from"./lit-all.min.js";var Xn=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let t=r.querySelector("strong, b, p");t&&(T.isMobile?t.style.display="none":t.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?T.isMobile?Me`
        ...
        `:Me`
            ...
            <slot></slot>`}};g(Ge,"variantStyle",Ll`
    ...
    `),g(Ge,"collectionOptions",{customHeaderArea:r=>r.sidenav?Me`<slot name="resultsText"></slot>`:Kr,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:r=>{let t=()=>{let a=r.querySelectorAll("merch-card");if(a.forEach(n=>{n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"))}),!T.isDesktop)return;let i=0;a.forEach(n=>{if(n.style.display==="none")return;let o=n.getAttribute("size"),s=o==="wide"?2:o==="super-wide"?3:1;s===2&&i%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),s=1),i+=s})};T.matchDesktop.addEventListener("change",t),r.addEventListener(fe,t),r.onUnmount.push(()=>{T.matchDesktop.removeEventListener("change",t),r.removeEventListener(fe,t)})}});import{html as Re,css as Pl,nothing as wt,unsafeCSS as rr}from"./lit-all.min.js";var Zn=`
:root {
...
`;var[Om,Im,Jn,eo,to,ro]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Zr="pro",xi=`--consonant-merch-card-${Zr}-top-card-height`,Qr=[{prop:`--consonant-merch-card-${Zr}-mnemonic-height`,selector:".mnemonic"},{prop:`--consonant-merch-card-${Zr}-name-description-height`,selector:".name-description"}],ao=`--consonant-merch-card-${Zr}-strike-reserve`,bi='[slot="heading-m"] :is(.price-strikethrough, .price-promo-strikethrough, [data-template="strikethrough"])',Ml="(min-width: 768px)",io={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},eduDisclaimer:{tag:"div",slot:"edu-disclaimer"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"},hideTransparent:!0,disableWhenBackgroundColor:"dark"},allowedBorderColors:[],style:"consonant"},Ne,Je,or,sr,X,no,ar,oo,ir,yi,Jr,ea=class ea extends w{constructor(t){super(t);C(this,X);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);C(this,Ne,null);C(this,Je,null);C(this,or,()=>this.resyncOnReflow());g(this,"lastSyncKey",null);C(this,sr,({detail:t})=>{let a=t?.quantity==null?null:String(t.quantity);a==null||a===this.licenseQty||this.licenseOptions?.includes(a)&&(this.licenseQty=a,this.card.requestUpdate())});g(this,"toggleExpanded",t=>{t.preventDefault();let a=!this.expanded;for(let i of B(this,X,no).call(this)){let n=i.variantLayout;n instanceof ea&&(n.expanded=a,i._proExpanded=a,i.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?B(this,X,yi).call(this):B(this,X,ir).call(this),this.card.requestUpdate()});C(this,Jr,t=>{let a=this.licenseOptions;if(!a?.length)return;let i=a.length-1;switch(t.key){case eo:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%a.length:B(this,X,ir).call(this);break;case Jn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+a.length)%a.length:B(this,X,ir).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=i;break;case to:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(a[this.licenseHighlightedIndex]);return}B(this,X,ir).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),B(this,X,yi).call(this);break;case ro:this.licenseOpen&&this.selectLicenseQty(a[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,B(this,X,ar).call(this);let a=this.quantitySelectEl;a&&(a.selectedValue=Number(t),a.dispatchEvent(new CustomEvent(oe,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=t._proExpanded??!1}getGlobalCSS(){return Zn}priceOptionsProvider(t,a){t.dataset.template===J&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),a.dataset.displayPerUnit="false",t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),a.addEventListener(ve,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]');if(!t?.textContent?.trim())return;let i=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),n=i?.querySelector(".price-plan-type");if(!n)return;n.innerHTML=t.innerHTML;let o=i.querySelector(".price-tax-inclusivity:not(.disabled)");o?.textContent&&!/\s$/.test(o.textContent)&&(o.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasEduDisclaimer(){return!this.card?.settings?.hideEduDisclaimer}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${G}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}async postCardUpdateHook(){this.adjustEduWhatsIncluded(),await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}adjustEduWhatsIncluded(){if(this.card.size!=="edu")return;let t=this.card.querySelector('[slot="whats-included"]');if(!t||t.querySelector(".whats-included-title"))return;let a=t.querySelector(".whats-included-label");if(!a)return;let i=document.createElement("h4");i.className="whats-included-title",i.innerHTML=a.innerHTML,a.replaceWith(i);let{whatsIncludedLabel:n,eduDisclaimer:o}=this.card.placeholders??{},s=document.createElement("p");if(s.className="whats-included-label",s.textContent=n??"",i.after(s),t.querySelectorAll(".section h4:not(.whats-included-title)").forEach(c=>{let l=document.createElement("p");l.innerHTML=c.innerHTML,c.replaceWith(l)}),o){let c=document.createElement("div");c.className="whats-included-disclaimer",c.innerHTML=o,t.append(c)}}async waitForContentFonts(){let t=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(t.map(a=>{let i=window.getComputedStyle(a),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,a.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1){this.clearSyncedHeights(this.card);return}await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let t=this.getContainer();if(!t||this.card.getBoundingClientRect().width<=2)return;let a=this.card.variant,i=xi,n=[...t.querySelectorAll(`merch-card[variant="${a}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1);if(!window.matchMedia(Ml).matches){n.forEach(c=>this.clearSyncedHeights(c));return}let o=new Map;for(let c of n){let l=o.get(c.offsetTop)??[];l.push(c),o.set(c.offsetTop,l)}let s=(c,l)=>c.reduce((d,u)=>{let m=l(u);return m?Math.max(d,parseInt(getComputedStyle(m).height)||0):d},0);for(let c of o.values()){if(c.forEach(m=>this.clearSyncedHeights(m)),c.length<2)continue;let l=c.map(m=>m.querySelector(bi)&&parseInt(getComputedStyle(m.querySelector(bi)).height)||0),d=Math.max(0,...l);d>0&&c.forEach((m,h)=>{let p=d-l[h];p>0&&m.style.setProperty(ao,`${p}px`)});for(let m of Qr){let h=s(c,p=>p.shadowRoot?.querySelector(m.selector));h>0&&c.forEach(p=>p.style.setProperty(m.prop,`${h}px`))}let u=s(c,m=>m.shadowRoot?.querySelector(".top-card"));u>0&&c.forEach(m=>m.style.setProperty(i,`${u}px`))}}clearSyncedHeights(t){t.style.removeProperty(xi),t.style.removeProperty(ao),Qr.forEach(a=>t.style.removeProperty(a.prop))}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=(n,o=this.card)=>Math.round(o?.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(t),a('[slot="body-xs"]'),a(bi),a('[slot="heading-m"] span[is="inline-price"]'),a('[slot="heading-m"] :is(.price-legal, [data-template="legal"])'),a(".license-zone",this.card.shadowRoot),a(".add-on",this.card.shadowRoot)].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(Pr,v(this,sr)),this.card.addEventListener(oe,this.updatePriceQuantity),this.card.addEventListener(ve,v(this,or)),typeof ResizeObserver>"u"))return;A(this,Je,new ResizeObserver(()=>this.resyncOnReflow())),v(this,Je).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,Je).observe(t)}disconnectedCallbackHook(){this.card?.removeEventListener(oe,this.updatePriceQuantity),this.card?.removeEventListener(ve,v(this,or)),B(this,X,ar).call(this),v(this,Je)?.disconnect(),this.card?.removeEventListener(Pr,v(this,sr))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let a=parseInt(t.getAttribute("min"),10),i=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(a)||Number.isNaN(i)||i<a||n<1)return null;let o=[];for(let s=a;s<=i;s+=n)o.push(String(s));return o}licenseLabel(t){let a=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=a.split("|").map(o=>o.trim());return Number(t)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let a=this.quantitySelectEl?.getAttribute("default-value");return a!=null&&t.includes(a)?a:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return Re`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,a=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(a));return Re`
            <div class="license-select" ?data-open=${i}>
                <div
                    ...
                    aria-activedescendant=${i?`license-option-${this.licenseHighlightedIndex}`:wt}
        ...
        `}renderLayout(){let t=!!this.expanded;return Re`
            <div class="top-card">
                <div class="mnemonic">
                    <slot name="icons"></slot>
                    <slot name="subtitle"></slot>
                ...
                ${this.hasLicenseSelector||this.hasCallout||this.hasQuantitySelect?Re`<div class="license-zone">
                          ${this.renderLicenseSelector()}
                          ${this.hasCallout?Re`<div class="callout">
                                    <slot name="callout-content"></slot>
                                </div>`:wt}
                      </div>`:wt}
                ${this.hasAddOn?Re`<div class="add-on">
                          <slot name="addon"></slot>
                      </div>`:wt}
                <footer>
                    <slot name="footer"></slot>
            ...
            ${this.hasWhatsIncluded?Re`
                  ...
                  `:wt}
            ${this.hasEduDisclaimer?Re`<div class="edu-disclaimer">
                      <slot name="edu-disclaimer"></slot>
                  </div>`:wt}
            <slot></slot>
        `}};Ne=new WeakMap,Je=new WeakMap,or=new WeakMap,sr=new WeakMap,X=new WeakSet,no=function(){let t=this.card.offsetTop,a=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===t);return a.length?a:[this.card]},ar=function(){v(this,Ne)&&(document.removeEventListener("mousedown",v(this,Ne)),A(this,Ne,null))},oo=function(){let t=this.licenseOptions?.indexOf(this.currentLicenseValue);return t>0?t:0},ir=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=B(this,X,oo).call(this),v(this,Ne)||(A(this,Ne,t=>{t.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),B(this,X,ar).call(this))}),document.addEventListener("mousedown",v(this,Ne)))},yi=function(){this.licenseOpen=!1,B(this,X,ar).call(this)},Jr=new WeakMap,g(ea,"variantStyle",Pl`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
        ...
        :host([variant='pro']) .mnemonic {
            ...
            align-items: center;
            gap: 12px;
            min-height: var(${rr(Qr[0].prop)}, auto);
        }
        ...
        :host([variant='pro']) .name-description {
            ...
            flex: 0 0 auto;
            min-height: var(${rr(Qr[1].prop)}, auto);
        }
    ...
    `);var nr=ea;import{html as wi,css as Rl}from"./lit-all.min.js";var so=`
:root {
...
`;var co={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},_e,Et=class extends w{constructor(t){super(t);C(this,_e);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return so}priceOptionsProvider(t,a){t.dataset.template===J&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(a.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a))}renderLayout(){return wi` ${this.badge}
            <div class="body" aria-live="polite">
                <slot name="icons"></slot>
                <slot name="heading-xs"></slot>
                ${this.promoBottom?"":wi`<slot name="promo-text"></slot>`}
                <slot name="body-xs"></slot>
                <slot name="short-description"></slot>
                <slot name="addon"></slot>
                ${this.promoBottom?wi`<slot name="promo-text"></slot>`:""}
    ...
    `);import{html as Nl,css as Ol}from"./lit-all.min.js";var lo=`
...
`;var ho={cardName:{attribute:"name"},mnemonics:{size:"l"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],title:{tag:"h3",slot:"heading-s"},prices:{tag:"p",slot:"heading-xs"},planType:!0,promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},style:"consonant"},At=class extends w{getGlobalCSS(){return lo}priceOptionsProvider(r,t){r.dataset.template===J&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.card.querySelector(`[slot="heading-xs"] ${G}[data-template="price"]`);if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}async postCardUpdateHook(){this.card.isConnected&&(this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}renderLayout(){return Nl` ${this.badge}
            <div class="body">
                <slot name="icons"></slot>
                <slot name="badge"></slot>
                <slot name="heading-s"></slot>
            ...
            <slot></slot>`}};g(At,"variantStyle",Ol`
    ...
    `);import{html as Ei,css as Il}from"./lit-all.min.js";var po=`
:root {
...
`;var mo={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},St=class extends w{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===J&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return po}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${G}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return Ei`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as Dl,css as zl}from"./lit-all.min.js";var uo=`
...
`;var go={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Ct=class extends w{constructor(r){super(r)}getGlobalCSS(){return uo}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Dl`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as Ai,css as Hl}from"./lit-all.min.js";var fo=`
:root {
...
`;var vo={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Tt=class extends w{constructor(t){super(t);g(this,"legal")}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return fo}priceOptionsProvider(t,a){a.displayPlanType=this.card?.settings?.displayPlanType??!1}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${G}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayPlanType="false",a.dataset.template="legal",a.dataset.displayPerUnit="false",a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return Ai`${this.cardImage}
            <div class="body">
            ...
            ${this.evergreen?Ai`
                  ...
                  `:Ai`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};g(Tt,"variantStyle",Hl`
    ...
    `);import{html as bo,css as Fl}from"./lit-all.min.js";var xo=`
:root {
...
`;var Si={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},kt=class extends w{getGlobalCSS(){return xo}get aemFragmentMapping(){return Si}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return bo`<div
    ...
    `);import{html as wo,css as Bl}from"./lit-all.min.js";var yo=`
:root {
...
`;var Ci={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},cr=class cr extends w{getGlobalCSS(){return yo}get aemFragmentMapping(){return Ci}get headingSelector(){return'[slot="heading-xs"]'}get badge(){let r=this.card.querySelector('[slot="badge"]');return wo`<div
        ...
        >
            ...
            <slot></slot>
        `}};g(cr,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),g(cr,"variantStyle",Bl`
    ...
    `);var lr=cr;import{html as dr,nothing as Ao}from"./lit-all.min.js";import{css as Ul,unsafeCSS as $l}from"./lit-all.min.js";var Eo=["headless","marquee","faq","banner-blade"],_t=(e,r="")=>Eo.map(t=>`merch-card[variant='${t}'] [slot='${e}']${r}`).join(`,
`),Ti=e=>Eo.map(r=>`merch-card[variant='${r}'] ${e}`).join(`,
`),qe=`
...
${_t("callout-content"," > p")},
${_t("callout-content"," > div")},
${_t("callout-content"," > div > div")} {
    background: transparent;
    padding: 0;
    border-radius: 0;
    width: auto;
...
${Ti(".headless-cta-item")} {
    display: inline-flex;
    align-items: center;
}
${Ti(".headless-cta-variant-label")} {
    font-size: 0.75em;
...
${Ti(".headless-cta-item:not(:last-child)::after")} {
    content: ', ';
}
`;function Ve(e){let r=$l(e);return Ul`
        :host([variant='${r}']) {
            border: none;
            background: transparent;
            box-shadow: none;
    ...
    `}var So={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"},customFields:{tag:"div",slot:"custom-fields"}},Gl=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],Lt=class extends w{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){let r=[...this.card.querySelectorAll('[slot^="custom-field-"]')];return dr`
        ...
        `}};g(Lt,"variantStyle",Ve("headless"));import{css as ql,html as Vl}from"./lit-all.min.js";var Co=`
...
`;var To={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Pt=class extends w{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return Co}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,a){a.literals={...a.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},a.space=!0,a.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${G}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",a.dataset.template="legal",a.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return Vl`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as jl,css as Wl}from"./lit-all.min.js";var ko=`
...
`;var ki={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Yl=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],ta,_o,Mt=class extends w{constructor(t){super(t);C(this,ta);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return ko}get aemFragmentMapping(){return ki}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,B(this,ta,_o).call(this))}renderLayout(){return jl`
            <div class="card">
            ...
            <slot></slot>
        `}};ta=new WeakSet,_o=function(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;Yl.forEach(({key:a,selector:i})=>this.updateCardElementMinHeight(t.querySelector(i),a))},g(Mt,"variantStyle",Wl`
    ...
    `);import{html as Xl,css as Kl}from"./lit-all.min.js";var Lo=`
...
`;var _i={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Rt=class extends w{getGlobalCSS(){return Lo}get aemFragmentMapping(){return _i}renderLayout(){return Xl`
    ...
    `);import{html as Li,nothing as Ql}from"./lit-all.min.js";var Po={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"p",slot:"short-description"},prices:{tag:"p",slot:"prices"},ctas:{slot:"footer",size:"m"}},Zl=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Product description"},{slot:"short-description",label:"Short Description"},{slot:"prices",label:"Product price"},{slot:"footer",label:"CTAs"}],Nt=class extends w{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){return Li`
            <div class="headless">
                ${Zl.map(({slot:r,label:t})=>Li`
                        <div class="headless-row">
        ...
        `}};g(Nt,"variantStyle",Ve("marquee"));import{html as Mo}from"./lit-all.min.js";var Ro={cardName:{attribute:"name"},prices:{tag:"p",slot:"prices"},description:{tag:"div",slot:"body-xs",editorLabel:"FAQ answer 1"},shortDescription:{tag:"p",slot:"short-description",editorLabel:"FAQ answer 2"},callout:{tag:"div",slot:"callout-content",editorLabel:"FAQ answer 3"}},Jl=[{slot:"prices",label:"Product price"},{slot:"body-xs",label:"FAQ answer 1"},{slot:"short-description",label:"FAQ answer 2"},{slot:"callout-content",label:"FAQ answer 3"}],Ot=class extends w{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){return Mo`
            <div class="headless">
                ${Jl.map(({slot:r,label:t})=>Mo`
                        <div class="headless-row">
                            <span class="headless-label">${t}</span>
                            <span class="headless-value">
                                <slot name="${r}"></slot>
        ...
        `}};g(Ot,"variantStyle",Ve("faq"));import{html as No}from"./lit-all.min.js";var Oo={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"}},ed=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Description"},{slot:"footer",label:"CTAs"}],It=class extends w{constructor(r){super(r)}getGlobalCSS(){return qe}renderLayout(){return No`
            <div class="headless">
                ${ed.map(({slot:r,label:t})=>No`
                        <div class="headless-row">
                            <span class="headless-label">${t}</span>
                            <span class="headless-value" data-slot="${r}">
                                <slot name="${r}"></slot>
        ...
        `}};g(It,"variantStyle",Ve("banner-blade"));var Io=new Map;var U=(e,r,t=null,a=null,i)=>{Io.set(e,{class:r,fragmentMapping:t,style:a,collectionOptions:i})};U("catalog",pt,xn,pt.variantStyle);U("image",Ke);U("inline-heading",Ir);U("mini-compare-chart",ft,Gn,ft.variantStyle);U("mini-compare-chart-mweb",vt,Vn,vt.variantStyle);U("plans",le,Xr,le.variantStyle,le.collectionOptions);U("plans-students",le,Yn,le.variantStyle,le.collectionOptions);U("plans-education",le,Wn,le.variantStyle,le.collectionOptions);U("plans-v2",Ge,Qn,Ge.variantStyle,Ge.collectionOptions);U("pro",nr,io,nr.variantStyle);U("product",Et,co,Et.variantStyle);U("brand-concierge-product",At,ho,At.variantStyle);U("segment",St,mo,St.variantStyle);U("media",Ct,go,Ct.variantStyle);U("headless",Lt,So,Lt.variantStyle);U("special-offers",Tt,vo,Tt.variantStyle);U("simplified-pricing-express",kt,Si,kt.variantStyle);U("full-pricing-express",lr,Ci,lr.variantStyle);U("mini",Pt,To,Pt.variantStyle);U("image",Ke,yn,Ke.variantStyle);U("compare-chart-column",Mt,ki,Mt.variantStyle);U("fries",Rt,_i,Rt.variantStyle);U("marquee",Nt,Po,Nt.variantStyle);U("faq",Ot,Ro,Ot.variantStyle);U("banner-blade",It,Oo,It.variantStyle);function Or(e){return Io.get(e)?.fragmentMapping}var Dt=class e extends Error{constructor(r,t,a){if(super(r,{cause:a}),this.name="MasError",t.response){let i=t.response.headers?.get(jt);i&&(t.requestId=i),t.response.status&&(t.status=t.response.status,t.statusText=t.response.statusText),t.response.url&&(t.url=t.response.url)}delete t.response,this.context=t,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let r=Object.entries(this.context||{}).map(([a,i])=>`${a}: ${JSON.stringify(i)}`).join(", "),t=`${this.name}: ${this.message}`;return r&&(t+=` (${r})`),this.cause&&(t+=`
Caused by: ${this.cause}`),t}};var td={[xe]:Pa,[Fe]:Ma,[se]:Ra},rd={[xe]:Ia,[se]:ve},hr,je=class{constructor(r){C(this,hr);g(this,"changes",new Map);g(this,"connected",!1);g(this,"error");g(this,"log");g(this,"options");g(this,"promises",[]);g(this,"state",Fe);g(this,"timer",null);g(this,"value");g(this,"version",0);g(this,"wrapperElement");this.wrapperElement=r,this.log=ae.module("mas-element")}update(){[xe,Fe,se].forEach(r=>{this.wrapperElement.classList.toggle(td[r],r===this.state)})}notify(){(this.state===se||this.state===xe)&&(this.state===se?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===xe&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]);let r=this.error;this.error instanceof Dt&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(rd[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,t,a){this.changes.set(r,a),this.requestUpdate()}connectedCallback(){A(this,hr,q()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:t,state:a}=this;return se===a?Promise.resolve(this.wrapperElement):xe===a?Promise.reject(r):new Promise((i,n)=>{t.push({resolve:i,reject:n})})}toggleResolved(r,t,a){return r!==this.version?!1:(a!==void 0&&(this.options=a),this.state=se,this.value=t,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:t}),Vr(()=>this.notify()),!0)}toggleFailed(r,t,a){if(r!==this.version)return!1;a!==void 0&&(this.options=a),this.error=t,this.state=xe,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${t.message}`,{element:this.wrapperElement,...t.context,...v(this,hr)?.duration}),Vr(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=Fe,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!q()||this.timer)return;let{error:t,options:a,state:i,value:n,version:o}=this;this.state=Fe,this.timer=Vr(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||r)try{await this.wrapperElement.render?.()===!1&&this.state===Fe&&this.version===o&&(this.state=i,this.error=t,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,a)}})}};hr=new WeakMap;function Do(e={}){return Object.entries(e).forEach(([r,t])=>{(t==null||t===""||t?.length===0)&&delete e[r]}),e}function ra(e,r={}){let{tag:t,is:a}=e,i=document.createElement(t,{is:a});return i.setAttribute("is",a),Object.assign(i.dataset,Do(r)),i}function zo(e,r={}){return e instanceof HTMLElement?(Object.assign(e.dataset,Do(r)),e):null}function ad(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var rt,et=class et extends HTMLAnchorElement{constructor(){super();g(this,"masElement",new je(this));C(this,rt);this.setAttribute("is",et.is)}get isUptLink(){return!0}initializeWcsData(t,a){this.setAttribute("data-wcs-osi",t),a&&this.setAttribute("data-promotion-code",a)}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),A(this,rt,Yt()),v(this,rt)&&(this.log=v(this,rt).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),A(this,rt,void 0)}requestUpdate(t=!1){this.masElement.requestUpdate(t)}onceSettled(){return this.masElement.onceSettled()}async render(){let t=Yt();if(!t)return!1;this.dataset.imsCountry||t.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let a=t.collectCheckoutOptions({},this);if(!a.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(a),n=t.resolveOfferSelectors(a);try{let[[o]]=await Promise.all(n),{country:s,language:c,env:l}=a,d=`locale=${c}_${s}&country=${s}&offer_id=${o.offerId}`,u=this.getAttribute("data-promotion-code");u&&(d+=`&promotion_code=${encodeURIComponent(u)}`),this.href=`${ad(l)}?${d}`,this.masElement.toggleResolved(i,o,a)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${a.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,s,a),!1}}static createFrom(t){let a=new et;for(let i of t.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?a.setAttribute("class",i.value.replace("upt-link","").trim()):a.setAttribute(i.name,i.value));return a.innerHTML=t.innerHTML,a.setAttribute("tabindex",0),a}};rt=new WeakMap,g(et,"is","upt-link"),g(et,"tag","a"),g(et,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var tt=et;window.customElements.get(tt.is)||window.customElements.define(tt.is,tt,{extends:tt.tag});function Ho(e){return e&&(e==="bizpro"&&(e="pro"),e==="pro"||e.startsWith("plans")?"plans":e)}var id="p_draft_landscape",nd="/store/",od=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["addonProductArrangementCode","ao"],["offerType","ot"],["marketSegment","ms"]]),Pi=new Set(["af","ai","ao","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),sd=["env","workflowStep","clientId","country"],cd=["/tw/","/hk_zh/"];function ld(e){let r=e??"";return cd.some(t=>r.startsWith(t))}function dd(){if(typeof window>"u")return!1;let e=[window.location.pathname];try{window.parent!==window&&e.push(window.parent.location.pathname)}catch{}return e.some(ld)}function pr(e){if(!dd())return e instanceof URL?e.toString():String(e);let r;try{r=e instanceof URL?e:new URL(e)}catch{return String(e)}r.searchParams.set("lang","zh-Hant");for(let t of[...r.searchParams.keys()])/^items\[\d+]\[lang]$/.test(t)&&r.searchParams.set(t,"zh-Hant");return r.toString()}var Fo=new Set(["gid","gtoken","notifauditid","cohortid","productname","sdid","attimer","gcsrc","gcprog","gcprogcat","gcpagetype","mv","mv2"]),Bo=e=>od.get(e)??e;function aa(e,r,t){for(let[a,i]of Object.entries(e)){let n=Bo(a);i!=null&&t.has(n)&&r.set(n,i)}}function hd(e){return e===$a.PRODUCTION?"https://commerce.adobe.com":"https://commerce-stg.adobe.com"}function pd(e,r){for(let t in e){let a=e[t];for(let[i,n]of Object.entries(a)){if(n==null)continue;let o=Bo(i);r.set(`items[${t}][${o}]`,n)}}}function md({url:e,modal:r,is3in1:t}){if(!t||!e?.searchParams)return e;e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl");let a=e.searchParams.get("af");return e.searchParams.set("af",[a,"uc_new_user_iframe","uc_new_system_close"].filter(Boolean).join(",")),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",r===Ae.CRM?"creative":"mini_plans"),e}function ud(e){let r=e.indexOf("?");return r===-1?e:e.slice(0,r)}function gd(e){let r=new URLSearchParams(window.location.search),t={};Fo.forEach(a=>{let i=r.get(a);i!==null&&(t[a]=ud(i))}),Object.keys(t).length>0&&aa(t,e.searchParams,Fo)}function Uo(e){fd(e);let{env:r,items:t,workflowStep:a,marketSegment:i,customerSegment:n,offerType:o,productArrangementCode:s,landscape:c,modal:l,is3in1:d,preselectPlan:u,...m}=e,h=new URL(hd(r));if(h.pathname=`${nd}${a}`,a!==ce.SEGMENTATION&&a!==ce.CHANGE_PLAN_TEAM_PLANS&&pd(t,h.searchParams),aa({...m},h.searchParams,Pi),gd(h),c===Be.DRAFT&&aa({af:id},h.searchParams,Pi),a===ce.SEGMENTATION){let p={marketSegment:i,offerType:o,customerSegment:n,productArrangementCode:s,quantity:t?.[0]?.quantity,addonProductArrangementCode:s?t?.find(f=>f.productArrangementCode!==s)?.productArrangementCode:t?.[1]?.productArrangementCode};u?.toLowerCase()==="edu"?h.searchParams.set("ms","EDU"):u?.toLowerCase()==="team"&&h.searchParams.set("cs","TEAM"),aa(p,h.searchParams,Pi),h.searchParams.get("ot")==="PROMOTION"&&h.searchParams.delete("ot"),h=md({url:h,modal:l,is3in1:d})}return pr(h)}function fd(e){for(let r of sd)if(!e[r])throw new Error(`Argument "checkoutData" is not valid, missing: ${r}`);if(e.workflowStep!==ce.SEGMENTATION&&e.workflowStep!==ce.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}var vd=2e4;function xd(e,r,t){let a,i=new Promise((n,o)=>{a=setTimeout(()=>o(new Error(`AUP host timed out: ${r}`)),t)});return Promise.race([e,i]).finally(()=>clearTimeout(a))}function ia(e,r){return e.length>0&&!r.perpetual&&!e.some(t=>t.commitment==="PERPETUAL")}function bd(e,r){if(!ia(e,r))return;let[t]=e,a={clientId:r.checkoutClientId,clientType:"web",co:r.country,pa:t.productArrangementCode,cs:r.cs,ms:r.ms};a.clientId!=="doc_cloud"&&Object.values(Ae).includes(r.modal)&&(a.clientId=r.modal===Ae.CRM?"creative":"mini_plans");let i=r.preselectPlan?.toLowerCase();i==="edu"&&(a.ms="EDU"),i==="team"&&(a.cs="TEAM");let n=t.productArrangement?.productCode;n&&(a.pc=n);for(let c of["svar","customerIntent","sid"])r[c]&&(a[c]=r[c]);let o=new URL("https://commerce.adobe.com");o.searchParams.set("lang",r.language);let s={lang:new URL(pr(o)).searchParams.get("lang"),nr:"stable",ctxrturl:r.ctxrturl??window.location.href,ot:t.offerType,items:e.map(({offerId:c},l)=>{let d=r.q??r.quantity?.[l]??r.quantity?.[0];return d==null?c:`${c}|${d}`}).join(",")};for(let[c,l]of Object.entries({step:r.checkoutWorkflowStep,apc:r.promotionCode,ao:r.addonProductArrangementCode,code:r.authCode,soSu:r["so.su"],soCa:r["so.ca"],soVa:r["so.va"],soTr:r["so.tr"],contextGuid:r["context.guid"],dcwatc:r.DCWATC}))l!=null&&(s[c]=l);for(let c of["step","apc","ao","ctx","ijt","otac","nglwfdata","appctxid","soSu","soCa","soVa","soTr","promoid","sdid","trackingid","mv","mv2","contextGuid","ai","sc","th","lo","gsp","spint","mal","csm","af","rf","usid","dcwatc","cf","rtc","ccli","csc","referrer","code","ew","pp","token","mat","pcid"])r[c]!=null&&(s[c]=r[c]);return{intent:t.offerType==="TRIAL"?"try":"buy",context:a,params:s,enableRenderIn:"iframe"}}async function $o(e,r,t,a,i=vd){let n=bd(r,t);if(!n)return!1;let o=await xd(e.getOrchestratorContext(),"getOrchestratorContext",i);if(typeof o?.launchWorkflowInModal!="function")return!1;let s,c;if(a){let d=o.clientMessageHandler;c=(u,m,h)=>{let p=m?.data?.actions;return u==="System"&&m?.subType==="AppClosed"&&Array.isArray(p)&&(s=p.find(f=>f?.required&&f.actionMessage?.type==="System"&&f.actionMessage?.subType==="ReportState")?.actionMessage.data?.commerce?.cart),typeof d=="function"?d(u,m,h):h(u,m)}}ae.module("aup-select").debug("Launching workflow:",n);let l=await(c?o.launchWorkflowInModal(n,c):o.launchWorkflowInModal(n));return l?.status==="cancel"&&Array.isArray(s)&&s.every(d=>typeof d?.productArrangementCode=="string")&&s.some(d=>d?.productArrangementCode===n.context.pa)&&a?.(s),l?.status!=="no-workflow-found"}var yd=/[0-9\-+#]/,wd=/[^\d\-+#]/g;function Go(e){return e.search(yd)}function Ed(e="#.##"){let r={},t=e.length,a=Go(e);r.prefix=a>0?e.substring(0,a):"";let i=Go(e.split("").reverse().join("")),n=t-i,o=e.substring(n,n+1),s=n+(o==="."||o===","?1:0);r.suffix=i>0?e.substring(s,t):"",r.mask=e.substring(a,s),r.maskHasNegativeSign=r.mask.charAt(0)==="-",r.maskHasPositiveSign=r.mask.charAt(0)==="+";let c=r.mask.match(wd);return r.decimal=c&&c[c.length-1]||".",r.separator=c&&c[1]&&c[0]||",",c=r.mask.split(r.decimal),r.integer=c[0],r.fraction=c[1],r}function Ad(e,r,t){let a=!1,i={value:e};e<0&&(a=!0,i.value=-i.value),i.sign=a?"-":"",i.value=Number(i.value).toFixed(r.fraction&&r.fraction.length),i.value=Number(i.value).toString();let n=r.fraction&&r.fraction.lastIndexOf("0"),[o="0",s=""]=i.value.split(".");return(!s||s&&s.length<=n)&&(s=n<0?"":(+`0.${s}`).toFixed(n+1).replace("0.","")),i.integer=o,i.fraction=s,Sd(i,r),(i.result==="0"||i.result==="")&&(a=!1,i.sign=""),!a&&r.maskHasPositiveSign?i.sign="+":a&&r.maskHasPositiveSign?i.sign="-":a&&(i.sign=t&&t.enforceMaskSign&&!r.maskHasNegativeSign?"":"-"),i}function Sd(e,r){e.result="";let t=r.integer.split(r.separator),a=t.join(""),i=a&&a.indexOf("0");if(i>-1)for(;e.integer.length<a.length-i;)e.integer=`0${e.integer}`;else Number(e.integer)===0&&(e.integer="");let n=t[1]&&t[t.length-1].length;if(n){let o=e.integer.length,s=o%n;for(let c=0;c<o;c++)e.result+=e.integer.charAt(c),!((c-s+1)%n)&&c<o-n&&(e.result+=r.separator)}else e.result=e.integer;return e.result+=r.fraction&&e.fraction?r.decimal+e.fraction:"",e}function Cd(e,r,t={}){if(!e||isNaN(Number(r)))return r;let a=Ed(e),i=Ad(r,a,t);return a.prefix+i.sign+i.result+a.suffix}var qo=Cd;var Vo=".",Td=",",Wo=/^\s+/,Yo=/\s+$/,jo="&nbsp;",Mi=e=>e*12,it=(e,r,t=1)=>{if(!e)return!1;let{start:a,end:i,displaySummary:{amount:n,duration:o,minProductQuantity:s=1,outcomeType:c}={}}=e;if(!(n&&o&&c)||t<s)return!1;let l=r?new Date(r):new Date;if(!a||!i)return!1;let d=new Date(a),u=new Date(i);return l>=d&&l<=u},at={MONTH:"MONTH",YEAR:"YEAR"},kd={[me.ANNUAL]:12,[me.MONTHLY]:1,[me.THREE_YEARS]:36,[me.TWO_YEARS]:24},Ri=(e,r)=>({accept:e,round:r}),_d=[Ri(({divisor:e,price:r})=>r%e==0,({divisor:e,price:r})=>r/e),Ri(({usePrecision:e})=>e,({divisor:e,price:r})=>Math.round(r/e*100)/100),Ri(()=>!0,({divisor:e,price:r})=>Math.ceil(Math.floor(r*100/e)/100))],Ni={[Xe.YEAR]:{[me.MONTHLY]:at.MONTH,[me.ANNUAL]:at.YEAR},[Xe.MONTH]:{[me.MONTHLY]:at.MONTH}},Ld=(e,r)=>e.indexOf(`'${r}'`)===0,Pd=(e,r=!0)=>{let t=e.replace(/'.*?'/,"").trim(),a=Ko(t);return!!a?r||(t=t.replace(/[,\.]0+/,a)):t=t.replace(/\s?(#.*0)(?!\s)?/,`$&${Rd(e)}`),t},Md=e=>{let r=Nd(e),t=Ld(e,r),a=e.replace(/'.*?'/,""),i=Wo.test(a)||Yo.test(a);return{currencySymbol:r,isCurrencyFirst:t,hasCurrencySpace:i}},Xo=e=>e.replace(Wo,jo).replace(Yo,jo),Rd=e=>e.match(/#(.?)#/)?.[1]===Vo?Td:Vo,Nd=e=>e.match(/'(.*?)'/)?.[1]??"",Ko=e=>e.match(/0(.?)0/)?.[1]??"";function zt({formatString:e,price:r,usePrecision:t,isIndianPrice:a=!1},i,n=o=>o){let{currencySymbol:o,isCurrencyFirst:s,hasCurrencySpace:c}=Md(e),l=t?Ko(e):"",d=Pd(e,t),u=t?2:0,m=n(r,{currencySymbol:o}),h=a?m.toLocaleString("hi-IN",{minimumFractionDigits:u,maximumFractionDigits:u}):qo(d,m),p=t?h.lastIndexOf(l):h.length,f=h.substring(0,p),x=h.substring(p+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,h).replace(/SYMBOL/,o),currencySymbol:o,decimals:x,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:i}}var Qo=e=>{let{commitment:r,term:t,usePrecision:a}=e,i=kd[t]??1;return zt(e,i>1?at.MONTH:Ni[r]?.[t],n=>{let o={divisor:i,price:n,usePrecision:a},{round:s}=_d.find(({accept:c})=>c(o));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(o)}`);return s(o)})},Zo=({commitment:e,term:r,...t})=>zt(t,Ni[e]?.[r]),Jo=e=>{let{commitment:r,instant:t,price:a,originalPrice:i,priceWithoutDiscount:n,promotion:o,quantity:s=1,term:c}=e;if(r===Xe.YEAR&&c===me.MONTHLY){if(!o)return zt(e,at.YEAR,Mi);let{displaySummary:{outcomeType:l,duration:d}={}}=o;switch(l){case"PERCENTAGE_DISCOUNT":if(it(o,t,s)){let u=parseInt(d.replace("P","").replace("M",""));if(isNaN(u))return Mi(a);let m=i*u,h=n*(12-u),p=Math.round((m+h)*100)/100;return zt({...e,price:p},at.YEAR)}default:return zt(e,at.YEAR,()=>Mi(n??a))}}return zt(e,Ni[r]?.[c])};var na="download",es="upgrade",ts={e:"EDU",t:"TEAM"},Oi=!1;function rs(e,r={},t=""){let a=q();if(!a)return null;let{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:u,quantity:m,wcsOsi:h,extraOptions:p,analyticsId:f}=a.collectCheckoutOptions(r),x=ra(e,{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:r.promotionCode===Br?Br:u,quantity:m,wcsOsi:h,extraOptions:p,analyticsId:f});return t&&(x.innerHTML=`<span style="pointer-events: none;">${t}</span>`),x}function as(e){return class extends e{constructor(){super(...arguments);g(this,"checkoutActionHandler");g(this,"aupHandler");g(this,"masElement",new je(this))}attributeChangedCallback(a,i,n){this.masElement.attributeChangedCallback(a,i,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler),this.addEventListener("auxclick",this.handleAupModifiedClick),this.updateCheckoutUrl()}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler),this.removeEventListener("auxclick",this.handleAupModifiedClick)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get marketSegment(){let a=this.options?.ms??this.value?.[0]?.marketSegments?.[0];return ts[a]??a}get customerSegment(){let a=this.options?.cs??this.value?.[0]?.customerSegment;return ts[a]??a}get is3in1Modal(){return Object.values(Ae).includes(this.getAttribute("data-modal"))}get isOpen3in1Modal(){let a=document.querySelector("meta[name=mas-ff-3in1]");return this.is3in1Modal&&(!a||a.content!=="off")}requestUpdate(a=!1){return this.masElement.requestUpdate(a)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(a={}){let i=q();if(!i)return!1;this.dataset.imsCountry||i.imsCountryPromise.then(h=>{h&&(this.dataset.imsCountry=h)}),a.imsCountry=null;let n=i.collectCheckoutOptions(a,this);if(!n.wcsOsi.length)return!1;let o;try{o=JSON.parse(n.extraOptions??"{}")}catch(h){this.masElement.log?.error("cannot parse exta checkout options",h)}let s=this.masElement.togglePending(n);this.setCheckoutUrl("");let c=i.resolveOfferSelectors(n),l=await Promise.all(c);l=l.map(h=>Jt(h,n));let d=l.flat().find(h=>h.promotion);!it(d?.promotion,d?.promotion?.displaySummary?.instant,n.quantity[0])&&n.promotionCode&&delete n.promotionCode,n.country=this.dataset.imsCountry||n.country;let m=await i.buildCheckoutAction?.(l.flat(),{...o,...n},this);return this.renderOffers(l.flat(),n,{},m,s)}renderOffers(a,i,n={},o=void 0,s=void 0){let c=q();if(!c)return!1;if(i={...JSON.parse(this.dataset.extraOptions??"{}"),...i,...n},s??(s=this.masElement.togglePending(i)),this.checkoutActionHandler=void 0,this.aupHandler=void 0,o){this.classList.remove(na,es),this.masElement.toggleResolved(s,a,i);let{url:d,text:u,className:m,handler:h,aupHandler:p}=o;d&&this.setCheckoutUrl(pr(d)),u&&(this.firstElementChild.innerHTML=u),m&&this.classList.add(...m.split(" ")),h&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=h.bind(this)),typeof p=="function"&&(this.aupHandler=p.bind(this)),this.updateCheckoutUrl()}if(a.length){if(this.masElement.toggleResolved(s,a,i)){if(!this.classList.contains(na)&&!this.classList.contains(es)){let d=c.buildCheckoutURL(a,i);this.setCheckoutUrl(i.modal==="true"?"#":d)}return!0}}else{let d=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,d,i))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(a){this.checkoutUrl=a,this.updateCheckoutUrl()}updateCheckoutUrl(a=q()?.settings?.aupSelect){if(this.checkoutUrl===void 0)return;let i=a&&this.checkoutUrl&&this.masElement.state===se&&!this.classList.contains(na)&&!this.hasAttribute("download")&&(!this.target||this.target==="_self")&&ia(this.value,this.options);return this.setAttribute(this.isCheckoutLink?"href":"data-href",i?"#":this.checkoutUrl),i}handleAupModifiedClick(a){return(a.metaKey||a.ctrlKey||a.shiftKey||a.altKey||a.button!==0)&&this.updateCheckoutUrl()?(a.preventDefault(),!0):!1}handleAupCheckout(a){if(this.handleAupModifiedClick(a))return!0;if(this.updateCheckoutUrl(!1),setTimeout(()=>this.updateCheckoutUrl(),0),a.defaultPrevented||a.button!==0||a.metaKey||a.ctrlKey||a.shiftKey||a.altKey||this.classList.contains(na)||this.hasAttribute("download")||this.target&&this.target!=="_self")return!1;let i=window.aupsdk;if(this.masElement.state!==se||!q()?.settings.aupSelect||typeof i?.getOrchestratorContext!="function")return!1;let{aupHandler:n,checkoutActionHandler:o,href:s,value:c}=this,l=this.closest("merch-card"),d=this.getAttribute("data-modal-id"),u={...this.options,cs:this.customerSegment,ms:this.marketSegment};if(!ia(c,u))return!1;if(this.updateCheckoutUrl(),a.preventDefault(),Oi)return!0;let m=()=>{if(o)return o(a);s&&(window.location.href=s)},h=f=>{if(n)try{n({type:f,element:this})}catch(x){this.masElement.log?.error(`AUP checkout ${f} handler failed`,x)}},p;return Oi=!0,h("open"),this.aupCheckoutPromise=$o(i,c,u,l&&d?f=>{p=f}:void 0).catch(f=>(this.masElement.log?.error("AUP checkout launch failed",f),!1)).then(async f=>{if(h("close"),!f)try{return await m()}catch(x){this.masElement.log?.error("AUP checkout fallback failed",x);return}if(p)try{let x=c[0].productArrangementCode;if(this.masElement.state!==se||this.value[0]?.productArrangementCode!==x)return;let y=[...l.querySelectorAll('merch-addon [is="inline-price"]')];if(l.addonCheckbox&&(!y.length||y.some(E=>E.masElement.state!==se||!E.value?.length)))return;let S=y.flatMap(E=>E.value),b=p.filter(E=>E.productArrangementCode===x||S.some(O=>O.productArrangementCode===E.productArrangementCode));l.dispatchEvent(new CustomEvent(Aa,{detail:{id:d,items:b,productArrangementCode:x}}))}catch(x){this.masElement.log?.warn("AUP checkout cart synchronization failed",x)}}).finally(()=>{Oi=!1}),!0}clickHandler(a){}updateOptions(a={}){let i=q();if(!i)return!1;let{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:u,promotionCode:m,quantity:h,wcsOsi:p}=i.collectCheckoutOptions(a);return zo(this,{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:u,promotionCode:m,quantity:h,wcsOsi:p}),!0}}}var mr=class mr extends as(HTMLAnchorElement){static createCheckoutLink(r={},t=""){return rs(mr,r,t)}get isCheckoutLink(){return!0}clickHandler(r){if(!this.handleAupCheckout(r)&&this.checkoutActionHandler){this.checkoutActionHandler?.(r);return}}};g(mr,"is","checkout-link"),g(mr,"tag","a");var Oe=mr;window.customElements.get(Oe.is)||window.customElements.define(Oe.is,Oe,{extends:Oe.tag});var N=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflowStep:ce.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,displayPlanType:!1,env:Ee.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:Be.PUBLISHED});function is({settings:e,providers:r}){function t(n,o){let{checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:u,quantity:m,preselectPlan:h,env:p}=e,f={checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:u,quantity:m,preselectPlan:h,env:p};if(o)for(let He of r.checkout)He(o,f);let{checkoutMarketSegment:x,checkoutWorkflowStep:y=c,imsCountry:S,country:b=S??l,language:E=d,quantity:O=m,entitlement:z,upgrade:V,modal:W,perpetual:K,promotionCode:te=u,wcsOsi:H,extraOptions:I,...re}=Object.assign(f,o?.dataset??{},n??{}),Z=Zt(y,ce,N.checkoutWorkflowStep),{wcsOsi:ze,promotionCodes:ge}=jr(H,te),lt=ge.map(He=>Ur(He).effectivePromoCode);return f=Hr({...re,extraOptions:I,checkoutClientId:s,checkoutMarketSegment:x,country:b,quantity:gt(O,N.quantity),checkoutWorkflowStep:Z,language:E,entitlement:k(z),upgrade:k(V),modal:W,perpetual:k(K),promotionCode:lt[0],promotionCodes:lt,wcsOsi:ze,preselectPlan:h}),f}function a(n,o){if(!Array.isArray(n)||!n.length||!o)return"";let{env:s,landscape:c}=e,{checkoutClientId:l,checkoutMarketSegment:d,checkoutWorkflowStep:u,country:m,promotionCode:h,quantity:p,preselectPlan:f,ms:x,cs:y,...S}=t(o),b=document.querySelector("meta[name=mas-ff-3in1]"),E=Object.values(Ae).includes(o.modal)&&(!b||b.content!=="off"),O=window.frameElement||E?"if":"fp",[{productArrangementCode:z,marketSegments:[V],customerSegment:W,offerType:K}]=n,te=x??V??d,H=y??W;f?.toLowerCase()==="edu"?te="EDU":f?.toLowerCase()==="team"&&(H="TEAM");let I={is3in1:E,checkoutPromoCode:h,clientId:l,context:O,country:m,env:s,items:[],marketSegment:te,customerSegment:H,offerType:K,productArrangementCode:z,workflowStep:u,landscape:c,...S},re=p[0]>1?p[0]:void 0;if(n.length===1){let{offerId:Z}=n[0];I.items.push({id:Z,quantity:re})}else I.items.push(...n.map(({offerId:Z,productArrangementCode:ze})=>({id:Z,quantity:re,...E?{productArrangementCode:ze}:{}})));return Uo(I)}let{createCheckoutLink:i}=Oe;return{CheckoutLink:Oe,CheckoutWorkflowStep:ce,buildCheckoutURL:a,collectCheckoutOptions:t,createCheckoutLink:i}}var Od="ims_country_code";function Id(){if(typeof document>"u")return null;let e=document.cookie.match(new RegExp(`(?:^|;\\s*)${Od}=([^;]*)`));if(!e)return null;let r;try{r=decodeURIComponent(e[1])}catch{return null}return r.trim().toUpperCase()||null}function Dd({interval:e=200,maxAttempts:r=25}={}){let t=ae.module("ims");return new Promise(a=>{t.debug("Waiting for IMS to be ready");let i=0;function n(){window.adobeIMS?.initialized?a():++i>r?(t.debug("Timeout"),a()):setTimeout(n,e)}n()})}function zd(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function Hd(){let e=Id();return e&&ae.module("ims").debug("Got user country from cookie:",e),Promise.resolve(e)}function ns(){let e=Dd();return{imsReadyPromise:e,imsSignedInPromise:zd(e),imsCountryPromise:Hd()}}var os=window.masPriceLiterals;function ss(e){if(Array.isArray(os)){let r;switch(e.locale){case"id_ID":r="in";break;case"zh_TW":r="zh-hant";break;case"zh_HK":r="zh-hant";break;default:r=e.language}let t=i=>os.find(n=>Qa(n.lang,i)),a=t(r)??t(N.language);if(a)return Object.freeze(a)}return{}}var Ii=function(e,r){return Ii=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,a){t.__proto__=a}||function(t,a){for(var i in a)Object.prototype.hasOwnProperty.call(a,i)&&(t[i]=a[i])},Ii(e,r)};function ur(e,r){if(typeof r!="function"&&r!==null)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");Ii(e,r);function t(){this.constructor=e}e.prototype=r===null?Object.create(r):(t.prototype=r.prototype,new t)}var P=function(){return P=Object.assign||function(r){for(var t,a=1,i=arguments.length;a<i;a++){t=arguments[a];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(r[n]=t[n])}return r},P.apply(this,arguments)};function oa(e,r,t){if(t||arguments.length===2)for(var a=0,i=r.length,n;a<i;a++)(n||!(a in r))&&(n||(n=Array.prototype.slice.call(r,0,a)),n[a]=r[a]);return e.concat(n||Array.prototype.slice.call(r))}var _;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(_||(_={}));var $;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})($||($={}));var nt;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(nt||(nt={}));function Di(e){return e.type===$.literal}function cs(e){return e.type===$.argument}function sa(e){return e.type===$.number}function ca(e){return e.type===$.date}function la(e){return e.type===$.time}function da(e){return e.type===$.select}function ha(e){return e.type===$.plural}function ls(e){return e.type===$.pound}function pa(e){return e.type===$.tag}function ma(e){return!!(e&&typeof e=="object"&&e.type===nt.number)}function gr(e){return!!(e&&typeof e=="object"&&e.type===nt.dateTime)}var zi=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var Fd=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function ds(e){var r={};return e.replace(Fd,function(t){var a=t.length;switch(t[0]){case"G":r.era=a===4?"long":a===5?"narrow":"short";break;case"y":r.year=a===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":r.month=["numeric","2-digit","short","long","narrow"][a-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":r.day=["numeric","2-digit"][a-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":r.weekday=a===4?"short":a===5?"narrow":"short";break;case"e":if(a<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"c":if(a<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"a":r.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":r.hourCycle="h12",r.hour=["numeric","2-digit"][a-1];break;case"H":r.hourCycle="h23",r.hour=["numeric","2-digit"][a-1];break;case"K":r.hourCycle="h11",r.hour=["numeric","2-digit"][a-1];break;case"k":r.hourCycle="h24",r.hour=["numeric","2-digit"][a-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":r.minute=["numeric","2-digit"][a-1];break;case"s":r.second=["numeric","2-digit"][a-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":r.timeZoneName=a<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),r}var hs=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function gs(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var r=e.split(hs).filter(function(m){return m.length>0}),t=[],a=0,i=r;a<i.length;a++){var n=i[a],o=n.split("/");if(o.length===0)throw new Error("Invalid number skeleton");for(var s=o[0],c=o.slice(1),l=0,d=c;l<d.length;l++){var u=d[l];if(u.length===0)throw new Error("Invalid number skeleton")}t.push({stem:s,options:c})}return t}function Bd(e){return e.replace(/^(.*?)-/,"")}var ps=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,fs=/^(@+)?(\+|#+)?[rs]?$/g,Ud=/(\*)(0+)|(#+)(0+)|(0+)/g,vs=/^(0+)$/;function ms(e){var r={};return e[e.length-1]==="r"?r.roundingPriority="morePrecision":e[e.length-1]==="s"&&(r.roundingPriority="lessPrecision"),e.replace(fs,function(t,a,i){return typeof i!="string"?(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length):i==="+"?r.minimumSignificantDigits=a.length:a[0]==="#"?r.maximumSignificantDigits=a.length:(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length+(typeof i=="string"?i.length:0)),""}),r}function xs(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function $d(e){var r;if(e[0]==="E"&&e[1]==="E"?(r={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(r={notation:"scientific"},e=e.slice(1)),r){var t=e.slice(0,2);if(t==="+!"?(r.signDisplay="always",e=e.slice(2)):t==="+?"&&(r.signDisplay="exceptZero",e=e.slice(2)),!vs.test(e))throw new Error("Malformed concise eng/scientific notation");r.minimumIntegerDigits=e.length}return r}function us(e){var r={},t=xs(e);return t||r}function bs(e){for(var r={},t=0,a=e;t<a.length;t++){var i=a[t];switch(i.stem){case"percent":case"%":r.style="percent";continue;case"%x100":r.style="percent",r.scale=100;continue;case"currency":r.style="currency",r.currency=i.options[0];continue;case"group-off":case",_":r.useGrouping=!1;continue;case"precision-integer":case".":r.maximumFractionDigits=0;continue;case"measure-unit":case"unit":r.style="unit",r.unit=Bd(i.options[0]);continue;case"compact-short":case"K":r.notation="compact",r.compactDisplay="short";continue;case"compact-long":case"KK":r.notation="compact",r.compactDisplay="long";continue;case"scientific":r=P(P(P({},r),{notation:"scientific"}),i.options.reduce(function(c,l){return P(P({},c),us(l))},{}));continue;case"engineering":r=P(P(P({},r),{notation:"engineering"}),i.options.reduce(function(c,l){return P(P({},c),us(l))},{}));continue;case"notation-simple":r.notation="standard";continue;case"unit-width-narrow":r.currencyDisplay="narrowSymbol",r.unitDisplay="narrow";continue;case"unit-width-short":r.currencyDisplay="code",r.unitDisplay="short";continue;case"unit-width-full-name":r.currencyDisplay="name",r.unitDisplay="long";continue;case"unit-width-iso-code":r.currencyDisplay="symbol";continue;case"scale":r.scale=parseFloat(i.options[0]);continue;case"integer-width":if(i.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");i.options[0].replace(Ud,function(c,l,d,u,m,h){if(l)r.minimumIntegerDigits=d.length;else{if(u&&m)throw new Error("We currently do not support maximum integer digits");if(h)throw new Error("We currently do not support exact integer digits")}return""});continue}if(vs.test(i.stem)){r.minimumIntegerDigits=i.stem.length;continue}if(ps.test(i.stem)){if(i.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");i.stem.replace(ps,function(c,l,d,u,m,h){return d==="*"?r.minimumFractionDigits=l.length:u&&u[0]==="#"?r.maximumFractionDigits=u.length:m&&h?(r.minimumFractionDigits=m.length,r.maximumFractionDigits=m.length+h.length):(r.minimumFractionDigits=l.length,r.maximumFractionDigits=l.length),""});var n=i.options[0];n==="w"?r=P(P({},r),{trailingZeroDisplay:"stripIfInteger"}):n&&(r=P(P({},r),ms(n)));continue}if(fs.test(i.stem)){r=P(P({},r),ms(i.stem));continue}var o=xs(i.stem);o&&(r=P(P({},r),o));var s=$d(i.stem);s&&(r=P(P({},r),s))}return r}var fr={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function ys(e,r){for(var t="",a=0;a<e.length;a++){var i=e.charAt(a);if(i==="j"){for(var n=0;a+1<e.length&&e.charAt(a+1)===i;)n++,a++;var o=1+(n&1),s=n<2?1:3+(n>>1),c="a",l=Gd(r);for((l=="H"||l=="k")&&(s=0);s-- >0;)t+=c;for(;o-- >0;)t=l+t}else i==="J"?t+="H":t+=i}return t}function Gd(e){var r=e.hourCycle;if(r===void 0&&e.hourCycles&&e.hourCycles.length&&(r=e.hourCycles[0]),r)switch(r){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var t=e.language,a;t!=="root"&&(a=e.maximize().region);var i=fr[a||""]||fr[t||""]||fr["".concat(t,"-001")]||fr["001"];return i[0]}var Hi,qd=new RegExp("^".concat(zi.source,"*")),Vd=new RegExp("".concat(zi.source,"*$"));function M(e,r){return{start:e,end:r}}var jd=!!String.prototype.startsWith,Wd=!!String.fromCodePoint,Yd=!!Object.fromEntries,Xd=!!String.prototype.codePointAt,Kd=!!String.prototype.trimStart,Qd=!!String.prototype.trimEnd,Zd=!!Number.isSafeInteger,Jd=Zd?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},Bi=!0;try{ws=Cs("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Bi=((Hi=ws.exec("a"))===null||Hi===void 0?void 0:Hi[0])==="a"}catch{Bi=!1}var ws,Es=jd?function(r,t,a){return r.startsWith(t,a)}:function(r,t,a){return r.slice(a,a+t.length)===t},Ui=Wd?String.fromCodePoint:function(){for(var r=[],t=0;t<arguments.length;t++)r[t]=arguments[t];for(var a="",i=r.length,n=0,o;i>n;){if(o=r[n++],o>1114111)throw RangeError(o+" is not a valid code point");a+=o<65536?String.fromCharCode(o):String.fromCharCode(((o-=65536)>>10)+55296,o%1024+56320)}return a},As=Yd?Object.fromEntries:function(r){for(var t={},a=0,i=r;a<i.length;a++){var n=i[a],o=n[0],s=n[1];t[o]=s}return t},Ss=Xd?function(r,t){return r.codePointAt(t)}:function(r,t){var a=r.length;if(!(t<0||t>=a)){var i=r.charCodeAt(t),n;return i<55296||i>56319||t+1===a||(n=r.charCodeAt(t+1))<56320||n>57343?i:(i-55296<<10)+(n-56320)+65536}},eh=Kd?function(r){return r.trimStart()}:function(r){return r.replace(qd,"")},th=Qd?function(r){return r.trimEnd()}:function(r){return r.replace(Vd,"")};function Cs(e,r){return new RegExp(e,r)}var $i;Bi?(Fi=Cs("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),$i=function(r,t){var a;Fi.lastIndex=t;var i=Fi.exec(r);return(a=i[1])!==null&&a!==void 0?a:""}):$i=function(r,t){for(var a=[];;){var i=Ss(r,t);if(i===void 0||ks(i)||ih(i))break;a.push(i),t+=i>=65536?2:1}return Ui.apply(void 0,a)};var Fi,Ts=(function(){function e(r,t){t===void 0&&(t={}),this.message=r,this.position={offset:0,line:1,column:1},this.ignoreTag=!!t.ignoreTag,this.locale=t.locale,this.requiresOtherClause=!!t.requiresOtherClause,this.shouldParseSkeletons=!!t.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(r,t,a){for(var i=[];!this.isEOF();){var n=this.char();if(n===123){var o=this.parseArgument(r,a);if(o.err)return o;i.push(o.val)}else{if(n===125&&r>0)break;if(n===35&&(t==="plural"||t==="selectordinal")){var s=this.clonePosition();this.bump(),i.push({type:$.pound,location:M(s,this.clonePosition())})}else if(n===60&&!this.ignoreTag&&this.peek()===47){if(a)break;return this.error(_.UNMATCHED_CLOSING_TAG,M(this.clonePosition(),this.clonePosition()))}else if(n===60&&!this.ignoreTag&&Gi(this.peek()||0)){var o=this.parseTag(r,t);if(o.err)return o;i.push(o.val)}else{var o=this.parseLiteral(r,t);if(o.err)return o;i.push(o.val)}}}return{val:i,err:null}},e.prototype.parseTag=function(r,t){var a=this.clonePosition();this.bump();var i=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:$.literal,value:"<".concat(i,"/>"),location:M(a,this.clonePosition())},err:null};if(this.bumpIf(">")){var n=this.parseMessage(r+1,t,!0);if(n.err)return n;var o=n.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!Gi(this.char()))return this.error(_.INVALID_TAG,M(s,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return i!==l?this.error(_.UNMATCHED_CLOSING_TAG,M(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:$.tag,value:i,children:o,location:M(a,this.clonePosition())},err:null}:this.error(_.INVALID_TAG,M(s,this.clonePosition())))}else return this.error(_.UNCLOSED_TAG,M(a,this.clonePosition()))}else return this.error(_.INVALID_TAG,M(a,this.clonePosition()))},e.prototype.parseTagName=function(){var r=this.offset();for(this.bump();!this.isEOF()&&ah(this.char());)this.bump();return this.message.slice(r,this.offset())},e.prototype.parseLiteral=function(r,t){for(var a=this.clonePosition(),i="";;){var n=this.tryParseQuote(t);if(n){i+=n;continue}var o=this.tryParseUnquoted(r,t);if(o){i+=o;continue}var s=this.tryParseLeftAngleBracket();if(s){i+=s;continue}break}var c=M(a,this.clonePosition());return{val:{type:$.literal,value:i,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!rh(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(r){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(r==="plural"||r==="selectordinal")break;return null;default:return null}this.bump();var t=[this.char()];for(this.bump();!this.isEOF();){var a=this.char();if(a===39)if(this.peek()===39)t.push(39),this.bump();else{this.bump();break}else t.push(a);this.bump()}return Ui.apply(void 0,t)},e.prototype.tryParseUnquoted=function(r,t){if(this.isEOF())return null;var a=this.char();return a===60||a===123||a===35&&(t==="plural"||t==="selectordinal")||a===125&&r>0?null:(this.bump(),Ui(a))},e.prototype.parseArgument=function(r,t){var a=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(_.EXPECT_ARGUMENT_CLOSING_BRACE,M(a,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(_.EMPTY_ARGUMENT,M(a,this.clonePosition()));var i=this.parseIdentifierIfPossible().value;if(!i)return this.error(_.MALFORMED_ARGUMENT,M(a,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(_.EXPECT_ARGUMENT_CLOSING_BRACE,M(a,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:$.argument,value:i,location:M(a,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(_.EXPECT_ARGUMENT_CLOSING_BRACE,M(a,this.clonePosition())):this.parseArgumentOptions(r,t,i,a);default:return this.error(_.MALFORMED_ARGUMENT,M(a,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var r=this.clonePosition(),t=this.offset(),a=$i(this.message,t),i=t+a.length;this.bumpTo(i);var n=this.clonePosition(),o=M(r,n);return{value:a,location:o}},e.prototype.parseArgumentOptions=function(r,t,a,i){var n,o=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(_.EXPECT_ARGUMENT_TYPE,M(o,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var d=this.clonePosition(),u=this.parseSimpleArgStyleIfPossible();if(u.err)return u;var m=th(u.val);if(m.length===0)return this.error(_.EXPECT_ARGUMENT_STYLE,M(this.clonePosition(),this.clonePosition()));var h=M(d,this.clonePosition());l={style:m,styleLocation:h}}var p=this.tryParseArgumentClose(i);if(p.err)return p;var f=M(i,this.clonePosition());if(l&&Es(l?.style,"::",0)){var x=eh(l.style.slice(2));if(s==="number"){var u=this.parseNumberSkeletonFromString(x,l.styleLocation);return u.err?u:{val:{type:$.number,value:a,location:f,style:u.val},err:null}}else{if(x.length===0)return this.error(_.EXPECT_DATE_TIME_SKELETON,f);var y=x;this.locale&&(y=ys(x,this.locale));var m={type:nt.dateTime,pattern:y,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?ds(y):{}},S=s==="date"?$.date:$.time;return{val:{type:S,value:a,location:f,style:m},err:null}}}return{val:{type:s==="number"?$.number:s==="date"?$.date:$.time,value:a,location:f,style:(n=l?.style)!==null&&n!==void 0?n:null},err:null}}case"plural":case"selectordinal":case"select":{var b=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(_.EXPECT_SELECT_ARGUMENT_OPTIONS,M(b,P({},b)));this.bumpSpace();var E=this.parseIdentifierIfPossible(),O=0;if(s!=="select"&&E.value==="offset"){if(!this.bumpIf(":"))return this.error(_.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,M(this.clonePosition(),this.clonePosition()));this.bumpSpace();var u=this.tryParseDecimalInteger(_.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,_.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(u.err)return u;this.bumpSpace(),E=this.parseIdentifierIfPossible(),O=u.val}var z=this.tryParsePluralOrSelectOptions(r,s,t,E);if(z.err)return z;var p=this.tryParseArgumentClose(i);if(p.err)return p;var V=M(i,this.clonePosition());return s==="select"?{val:{type:$.select,value:a,options:As(z.val),location:V},err:null}:{val:{type:$.plural,value:a,options:As(z.val),offset:O,pluralType:s==="plural"?"cardinal":"ordinal",location:V},err:null}}default:return this.error(_.INVALID_ARGUMENT_TYPE,M(o,c))}},e.prototype.tryParseArgumentClose=function(r){return this.isEOF()||this.char()!==125?this.error(_.EXPECT_ARGUMENT_CLOSING_BRACE,M(r,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var r=0,t=this.clonePosition();!this.isEOF();){var a=this.char();switch(a){case 39:{this.bump();var i=this.clonePosition();if(!this.bumpUntil("'"))return this.error(_.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,M(i,this.clonePosition()));this.bump();break}case 123:{r+=1,this.bump();break}case 125:{if(r>0)r-=1;else return{val:this.message.slice(t.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(t.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(r,t){var a=[];try{a=gs(r)}catch{return this.error(_.INVALID_NUMBER_SKELETON,t)}return{val:{type:nt.number,tokens:a,location:t,parsedOptions:this.shouldParseSkeletons?bs(a):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(r,t,a,i){for(var n,o=!1,s=[],c=new Set,l=i.value,d=i.location;;){if(l.length===0){var u=this.clonePosition();if(t!=="select"&&this.bumpIf("=")){var m=this.tryParseDecimalInteger(_.EXPECT_PLURAL_ARGUMENT_SELECTOR,_.INVALID_PLURAL_ARGUMENT_SELECTOR);if(m.err)return m;d=M(u,this.clonePosition()),l=this.message.slice(u.offset,this.offset())}else break}if(c.has(l))return this.error(t==="select"?_.DUPLICATE_SELECT_ARGUMENT_SELECTOR:_.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,d);l==="other"&&(o=!0),this.bumpSpace();var h=this.clonePosition();if(!this.bumpIf("{"))return this.error(t==="select"?_.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:_.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,M(this.clonePosition(),this.clonePosition()));var p=this.parseMessage(r+1,t,a);if(p.err)return p;var f=this.tryParseArgumentClose(h);if(f.err)return f;s.push([l,{value:p.val,location:M(h,this.clonePosition())}]),c.add(l),this.bumpSpace(),n=this.parseIdentifierIfPossible(),l=n.value,d=n.location}return s.length===0?this.error(t==="select"?_.EXPECT_SELECT_ARGUMENT_SELECTOR:_.EXPECT_PLURAL_ARGUMENT_SELECTOR,M(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!o?this.error(_.MISSING_OTHER_CLAUSE,M(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(r,t){var a=1,i=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(a=-1);for(var n=!1,o=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)n=!0,o=o*10+(s-48),this.bump();else break}var c=M(i,this.clonePosition());return n?(o*=a,Jd(o)?{val:o,err:null}:this.error(t,c)):this.error(r,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var r=this.position.offset;if(r>=this.message.length)throw Error("out of bound");var t=Ss(this.message,r);if(t===void 0)throw Error("Offset ".concat(r," is at invalid UTF-16 code unit boundary"));return t},e.prototype.error=function(r,t){return{val:null,err:{kind:r,message:this.message,location:t}}},e.prototype.bump=function(){if(!this.isEOF()){var r=this.char();r===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=r<65536?1:2)}},e.prototype.bumpIf=function(r){if(Es(this.message,r,this.offset())){for(var t=0;t<r.length;t++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(r){var t=this.offset(),a=this.message.indexOf(r,t);return a>=0?(this.bumpTo(a),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(r){if(this.offset()>r)throw Error("targetOffset ".concat(r," must be greater than or equal to the current offset ").concat(this.offset()));for(r=Math.min(r,this.message.length);;){var t=this.offset();if(t===r)break;if(t>r)throw Error("targetOffset ".concat(r," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&ks(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var r=this.char(),t=this.offset(),a=this.message.charCodeAt(t+(r>=65536?2:1));return a??null},e})();function Gi(e){return e>=97&&e<=122||e>=65&&e<=90}function rh(e){return Gi(e)||e===47}function ah(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function ks(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function ih(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function qi(e){e.forEach(function(r){if(delete r.location,da(r)||ha(r))for(var t in r.options)delete r.options[t].location,qi(r.options[t].value);else sa(r)&&ma(r.style)||(ca(r)||la(r))&&gr(r.style)?delete r.style.location:pa(r)&&qi(r.children)})}function _s(e,r){r===void 0&&(r={}),r=P({shouldParseSkeletons:!0,requiresOtherClause:!0},r);var t=new Ts(e,r).parse();if(t.err){var a=SyntaxError(_[t.err.kind]);throw a.location=t.err.location,a.originalMessage=t.err.message,a}return r?.captureLocation||qi(t.val),t.val}function vr(e,r){var t=r&&r.cache?r.cache:dh,a=r&&r.serializer?r.serializer:lh,i=r&&r.strategy?r.strategy:oh;return i(e,{cache:t,serializer:a})}function nh(e){return e==null||typeof e=="number"||typeof e=="boolean"}function Ls(e,r,t,a){var i=nh(a)?a:t(a),n=r.get(i);return typeof n>"u"&&(n=e.call(this,a),r.set(i,n)),n}function Ps(e,r,t){var a=Array.prototype.slice.call(arguments,3),i=t(a),n=r.get(i);return typeof n>"u"&&(n=e.apply(this,a),r.set(i,n)),n}function Vi(e,r,t,a,i){return t.bind(r,e,a,i)}function oh(e,r){var t=e.length===1?Ls:Ps;return Vi(e,this,t,r.cache.create(),r.serializer)}function sh(e,r){return Vi(e,this,Ps,r.cache.create(),r.serializer)}function ch(e,r){return Vi(e,this,Ls,r.cache.create(),r.serializer)}var lh=function(){return JSON.stringify(arguments)};function ji(){this.cache=Object.create(null)}ji.prototype.get=function(e){return this.cache[e]};ji.prototype.set=function(e,r){this.cache[e]=r};var dh={create:function(){return new ji}},ua={variadic:sh,monadic:ch};var ot;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(ot||(ot={}));var xr=(function(e){ur(r,e);function r(t,a,i){var n=e.call(this,t)||this;return n.code=a,n.originalMessage=i,n}return r.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},r})(Error);var Wi=(function(e){ur(r,e);function r(t,a,i,n){return e.call(this,'Invalid values for "'.concat(t,'": "').concat(a,'". Options are "').concat(Object.keys(i).join('", "'),'"'),ot.INVALID_VALUE,n)||this}return r})(xr);var Ms=(function(e){ur(r,e);function r(t,a,i){return e.call(this,'Value for "'.concat(t,'" must be of type ').concat(a),ot.INVALID_VALUE,i)||this}return r})(xr);var Rs=(function(e){ur(r,e);function r(t,a){return e.call(this,'The intl string context variable "'.concat(t,'" was not provided to the string "').concat(a,'"'),ot.MISSING_VALUE,a)||this}return r})(xr);var ie;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(ie||(ie={}));function hh(e){return e.length<2?e:e.reduce(function(r,t){var a=r[r.length-1];return!a||a.type!==ie.literal||t.type!==ie.literal?r.push(t):a.value+=t.value,r},[])}function ph(e){return typeof e=="function"}function br(e,r,t,a,i,n,o){if(e.length===1&&Di(e[0]))return[{type:ie.literal,value:e[0].value}];for(var s=[],c=0,l=e;c<l.length;c++){var d=l[c];if(Di(d)){s.push({type:ie.literal,value:d.value});continue}if(ls(d)){typeof n=="number"&&s.push({type:ie.literal,value:t.getNumberFormat(r).format(n)});continue}var u=d.value;if(!(i&&u in i))throw new Rs(u,o);var m=i[u];if(cs(d)){(!m||typeof m=="string"||typeof m=="number")&&(m=typeof m=="string"||typeof m=="number"?String(m):""),s.push({type:typeof m=="string"?ie.literal:ie.object,value:m});continue}if(ca(d)){var h=typeof d.style=="string"?a.date[d.style]:gr(d.style)?d.style.parsedOptions:void 0;s.push({type:ie.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(la(d)){var h=typeof d.style=="string"?a.time[d.style]:gr(d.style)?d.style.parsedOptions:a.time.medium;s.push({type:ie.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(sa(d)){var h=typeof d.style=="string"?a.number[d.style]:ma(d.style)?d.style.parsedOptions:void 0;h&&h.scale&&(m=m*(h.scale||1)),s.push({type:ie.literal,value:t.getNumberFormat(r,h).format(m)});continue}if(pa(d)){var p=d.children,f=d.value,x=i[f];if(!ph(x))throw new Ms(f,"function",o);var y=br(p,r,t,a,i,n),S=x(y.map(function(O){return O.value}));Array.isArray(S)||(S=[S]),s.push.apply(s,S.map(function(O){return{type:typeof O=="string"?ie.literal:ie.object,value:O}}))}if(da(d)){var b=d.options[m]||d.options.other;if(!b)throw new Wi(d.value,m,Object.keys(d.options),o);s.push.apply(s,br(b.value,r,t,a,i));continue}if(ha(d)){var b=d.options["=".concat(m)];if(!b){if(!Intl.PluralRules)throw new xr(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,ot.MISSING_INTL_API,o);var E=t.getPluralRules(r,{type:d.pluralType}).select(m-(d.offset||0));b=d.options[E]||d.options.other}if(!b)throw new Wi(d.value,m,Object.keys(d.options),o);s.push.apply(s,br(b.value,r,t,a,i,m-(d.offset||0)));continue}}return hh(s)}function mh(e,r){return r?P(P(P({},e||{}),r||{}),Object.keys(e).reduce(function(t,a){return t[a]=P(P({},e[a]),r[a]||{}),t},{})):e}function uh(e,r){return r?Object.keys(e).reduce(function(t,a){return t[a]=mh(e[a],r[a]),t},P({},e)):e}function Yi(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function gh(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:vr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.NumberFormat).bind.apply(r,oa([void 0],t,!1)))},{cache:Yi(e.number),strategy:ua.variadic}),getDateTimeFormat:vr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.DateTimeFormat).bind.apply(r,oa([void 0],t,!1)))},{cache:Yi(e.dateTime),strategy:ua.variadic}),getPluralRules:vr(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.PluralRules).bind.apply(r,oa([void 0],t,!1)))},{cache:Yi(e.pluralRules),strategy:ua.variadic})}}var Ns=(function(){function e(r,t,a,i){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==ie.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return br(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=uh(e.formats,a),this.formatters=i&&i.formatters||gh(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=_s,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e})();var Os=Ns;var yr={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}",discountLabel:"{discount}%"},fh=_n("ConsonantTemplates/price"),vh=/<\/?[^>]+(>|$)/g,j={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Le={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Xi="TAX_EXCLUSIVE",xh=e=>Tn(e)?Object.entries(e).filter(([,r])=>mt(r)||zr(r)||r===!0).reduce((r,[t,a])=>`${r} ${t}${a===!0?"":`="${Cn(a)}"`}`,""):"",Y=(e,r,t,a=!1)=>`<span class="${e}${r?"":` ${j.disabled}`}"${xh(t)}>${a?Xo(r):r??""}</span>`;function bh(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(a,i)}),e}function yh(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(a,i)}),e}function ye(e,r,t,a){let i=e[t];if(i==null)return"";let n=i.includes("<"),o=i.includes("<a ");try{i=o?bh(i):i,i=n?i.replace(vh,""):i;let s=new Os(i,r).format(a);return o?yh(s):s}catch{return fh.error("Failed to format literal:",i),""}}function wh(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:a,decimals:i,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:u},m={}){let h=Y(j.currencySymbol,a),p=Y(j.currencySpace,o?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=h+p),f+=Y(j.integer,s),f+=Y(j.decimalsDelimiter,n),f+=Y(j.decimals,i),c||(f+=p+h),f+=Y(j.recurrence,l,null,!0),f+=Y(j.unitType,d,null,!0),f+=Y(j.taxInclusivity,u,!0),Y(e,f,{...m})}var ee=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:a=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:u,literals:m={},quantity:h=1,space:p=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:y,formatString:S,price:b,priceWithoutDiscount:E,taxDisplay:O,taxTerm:z,term:V,usePrecision:W,promotion:K}={},te={})=>{Object.entries({country:o,formatString:S,language:u,price:b}).forEach(([xc,bc])=>{if(bc==null)throw new Error(`Argument "${xc}" is missing for osi ${y?.toString()}, country ${o}, language ${u}`)});let H={...yr,...m},I=`${u.toLowerCase()}-${o.toUpperCase()}`,re;K&&!f&&E?re=e||a?b:E:t&&E?re=E:re=b;let Z=r?Qo:Zo;i&&(Z=Jo);let{accessiblePrice:ze,recurrenceTerm:ge,...lt}=Z({commitment:x,formatString:S,instant:n,isIndianPrice:o==="IN",originalPrice:b,priceWithoutDiscount:E,price:r?b:re,promotion:K,quantity:h,term:V,usePrecision:W}),He="",va="",xa="";k(c)&&ge&&(xa=ye(H,I,Le.recurrenceLabel,{recurrenceTerm:ge}));let Tr="";k(l)&&(p&&(Tr+=" "),Tr+=ye(H,I,Le.perUnitLabel,{perUnit:"LICENSE"}));let kr="";k(d)&&z&&(p&&(kr+=" "),kr+=ye(H,I,O===Xi?Le.taxExclusiveLabel:Le.taxInclusiveLabel,{taxTerm:z})),t&&(He=ye(H,I,Le.strikethroughAriaLabel,{strikethroughPrice:He})),e&&(va=ye(H,I,Le.alternativePriceAriaLabel,{alternativePrice:va}));let Ye=j.container;if(r&&(Ye+=` ${j.containerOptical}`),t&&(Ye+=` ${j.containerStrikethrough}`),a&&(Ye+=` ${j.containerPromoStrikethrough}`),e&&(Ye+=` ${j.containerAlternative}`),i&&(Ye+=` ${j.containerAnnual}`),k(s))return wh(Ye,{...lt,accessibleLabel:He,altAccessibleLabel:va,recurrenceLabel:xa,perUnitLabel:Tr,taxInclusivityLabel:kr},te);let{currencySymbol:an,decimals:mc,decimalsDelimiter:uc,hasCurrencySpace:nn,integer:gc,isCurrencyFirst:fc}=lt,dt=[gc,uc,mc];fc?(dt.unshift(nn?"\xA0":""),dt.unshift(an)):(dt.push(nn?"\xA0":""),dt.push(an)),dt.push(xa,Tr,kr);let vc=dt.join("");return Y(Ye,vc,te)},Is=()=>(e,r,t)=>{let a=it(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||k(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||a);return`${n?`${ee({displayStrikethrough:!0})({isPromoApplied:a,...e,displayPerUnit:!1,displayTax:!1},r,t)}${e.wrapClauses?" ":"&nbsp;"}`:""}${ee({isAlternativePrice:n})({isPromoApplied:a,...e},r,t)}`},Ds=()=>(e,r,t)=>{let{instant:a}=e;try{a||(a=new URLSearchParams(document.location.search).get("instant")),a&&(a=new Date(a))}catch{a=void 0}let i=it(r.promotion,a,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:i};if(!i)return ee()(e,{...r,price:r.priceWithoutDiscount},t)+Y(j.containerAnnualPrefix," (")+ee({displayAnnual:!0,instant:a})(n,{...r,price:r.priceWithoutDiscount},t)+Y(j.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||k(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${s?`${ee({displayStrikethrough:!0})(n,r,t)}${e.wrapClauses?" ":"&nbsp;"}`:""}${ee({isAlternativePrice:s})({isPromoApplied:i,...e},r,t)}${Y(j.containerAnnualPrefix," (")}${ee({displayAnnual:!0,instant:a})(n,r,t)}${Y(j.containerAnnualSuffix,")")}`},zs=()=>(e,r,t)=>{let a={...e,displayTax:!1,displayPerUnit:!1};return`${ee({isAlternativePrice:e.displayOldPrice})(e,r,t)}${Y(j.containerAnnualPrefix," (")}${ee({displayAnnual:!0})(a,r,t)}${Y(j.containerAnnualSuffix,")")}`};var wr={...j,containerLegal:"price-legal",planType:"price-plan-type"},ga={...Le,planTypeLabel:"planTypeLabel"};function Eh(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:a},i={},n=!0){let o="";return o+=Y(wr.unitType,r,null,!0),t&&a&&n&&(t+=t.endsWith(".")?" ":". "),o+=Y(wr.taxInclusivity,t,!0),o+=Y(wr.planType,a,null),Y(e,o,{...i})}var Hs=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:a=!1,displayDot:i=!0,planTypeCase:n,language:o,literals:s={}}={},{taxDisplay:c,taxTerm:l,planType:d}={},u={})=>{let m={...yr,...s},h=`${o.toLowerCase()}-${e.toUpperCase()}`,p="";k(r)&&(p=ye(m,h,ga.perUnitLabel,{perUnit:"LICENSE"}));let f="";e==="US"&&o==="en"&&(t=!1),k(t)&&l&&(f=ye(m,h,c===Xi?ga.taxExclusiveLabel:ga.taxInclusiveLabel,{taxTerm:l}));let x="";k(a)&&d&&(x=ye(m,h,ga.planTypeLabel,{planType:d})),x&&n&&(x=(n==="lower"?x[0].toLowerCase():x[0].toUpperCase())+x.slice(1));let y=wr.container;return y+=` ${wr.containerLegal}`,Eh(y,{perUnitLabel:p,taxInclusivityLabel:f,planTypeLabel:x},u,i)};var Fs=ee(),Bs=Is(),Us=ee({displayOptical:!0}),$s=ee({displayStrikethrough:!0}),Gs=ee({displayPromoStrikethrough:!0}),qs=ee({displayAnnual:!0}),Vs=ee({displayOptical:!0,isAlternativePrice:!0}),js=ee({isAlternativePrice:!0}),Ws=zs(),Ys=Ds(),Xs=Hs;var Ah={...Le,discountLabel:"discountLabel"},Sh=(e,r)=>{if(!r&&ut(e))return 0;if(!(!ut(e)||!ut(r)))return Math.floor((r-e)/r*100)},Ks=()=>(e,r)=>{let{country:t,language:a,literals:i={}}=e??{},{price:n,priceWithoutDiscount:o}=r,s=Sh(n,o);if(s===void 0)return'<span class="no-discount"></span>';let c={...yr,...i},l=a&&t?`${a.toLowerCase()}-${t.toUpperCase()}`:"en-US";return`<span class="discount">${ye(c,l,Ah.discountLabel,{discount:s,remainingPercent:100-s})}</span>`};var Qs=Ks();var Zs="INDIVIDUAL_COM",Qi="TEAM_COM",Js="INDIVIDUAL_EDU",Zi="TEAM_EDU",Ch=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh","KE_en","GH_en","TZ_en","AM_en","AZ_en","GE_en","MD_en","KZ_en","KG_en","TJ_en","UZ_en","OM_en","BH_en"],Th={[Zs]:[],[Qi]:[],[Js]:[],[Zi]:[]},kh={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},_h=[Zs,Qi,Js,Zi],Lh=e=>[Qi,Zi].includes(e);function Ki(e,r,t,a){if(e[r])return e[r];let i=`${r}_${t}`;if(e[i])return e[i];let n;if(a)n=e.find(o=>o.startsWith(`${r}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${r}_`));n=o?e[o]:null}return n}var Ph=(e,r,t,a)=>{let i=`${t}_${a}`,n=Ki(kh,e,r,!1);if(n){let o=_h.indexOf(i);return n[o]}return Lh(i)},Mh=(e,r,t,a)=>{if(Ki(Ch,e,r,!0))return!0;let i=Th[`${t}_${a}`];return i?Ki(i,e,r,!0)?!0:N.displayTax:N.displayTax},Ji=async(e,r,t,a)=>{let i=Mh(e,r,t,a);return{displayTax:i,forceTaxExclusive:i?Ph(e,r,t,a):N.forceTaxExclusive}},Er=class Er extends HTMLSpanElement{constructor(){super();g(this,"masElement",new je(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let a=q();if(!a)return null;let{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:u,promotionCode:m,quantity:h,alternativePrice:p,template:f,wcsOsi:x}=a.collectPriceOptions(t);return ra(Er,{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:u,promotionCode:m,quantity:h,alternativePrice:p,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===xe}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let a=q();if(!a)return!1;let i=a.collectPriceOptions(t,this),n={...a.settings,...i};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=a.resolveOfferSelectors(n),c=await Promise.all(s),l=c.map(h=>{let p=Jt(h,n);return p?.length?p[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,u=ui(l);if(a.featureFlags[Pe]||n[Pe]){if(i.displayPerUnit===void 0&&(n.displayPerUnit=u.customerSegment!=="INDIVIDUAL"),i.displayTax===void 0||i.forceTaxExclusive===void 0){let{country:h,language:p}=n,[f=""]=u.marketSegments,x=await Ji(h,p,u.customerSegment,f);i.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),i.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(y=>{let S=Jt(y,n);return S?.length?S[0]:null}))}}else i.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(a.featureFlags[he]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,p]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:p.priceDetails?.price}};return this.renderOffers([f],n,o)}let m=ui(d);return this.renderOffers([m],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(t,a,i=void 0){if(!this.isConnected)return;let n=q();if(!n)return!1;if(i??(i=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(i,t,a)){this.innerHTML=n.buildPriceHTML(t,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,o,this.options))return this.innerHTML="",!0}return!1}};g(Er,"is","inline-price"),g(Er,"tag","span");var Ie=Er;window.customElements.get(Ie.is)||window.customElements.define(Ie.is,Ie,{extends:Ie.tag});function ec({literals:e,providers:r,settings:t}){function a(o,s=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(s&&r?.price)for(let K of r.price)K(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:u,displayTax:m,displayPlanType:h,forceTaxExclusive:p,perpetual:f,displayAnnual:x,promotionCode:y,quantity:S,alternativePrice:b,wcsOsi:E,...O}=Object.assign(c,s?.dataset??{},o??{}),{wcsOsi:z,promotionCodes:V}=jr(E,y),W=V.map(K=>Ur(K).effectivePromoCode);return c=Hr(Object.assign({...c,...O,displayOldPrice:k(l),displayPerUnit:k(d),displayRecurrence:k(u),displayTax:k(m),displayPlanType:k(h),forceTaxExclusive:k(p),perpetual:k(f),displayAnnual:k(x),promotionCode:W[0],promotionCodes:W,quantity:gt(S,N.quantity),alternativePrice:k(b),wcsOsi:z})),c}function i(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=Qs;break;case"strikethrough":l=$s;break;case"promo-strikethrough":l=Gs;break;case"annual":l=qs;break;case"legal":l=Xs;break;default:s.template==="optical"&&s.alternativePrice?l=Vs:s.template==="optical"?l=Us:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode&&o[0].promotion?Ys:Ws:s.alternativePrice?l=js:l=s.promotionCode&&o[0].promotion?Bs:Fs}let[d]=o;return d={...d,...d.priceDetails},l({...t,...s},d)}let n=Ie.createInlinePrice;return{InlinePrice:Ie,buildPriceHTML:i,collectPriceOptions:a,createInlinePrice:n}}function Rh({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||N.language),r??(r=e?.split("_")?.[1]||N.country),r==="PR"&&(r="US"),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function tc(e={},r){let t=r.featureFlags[Pe],{commerce:a={}}=e,i=Ee.PRODUCTION,n=Ba,o=F("checkoutClientId",a)??N.checkoutClientId,s=Zt(F("checkoutWorkflowStep",a),ce,N.checkoutWorkflowStep),c=k(F("displayOldPrice",a),N.displayOldPrice),l=N.displayPerUnit,d=k(F("displayRecurrence",a),N.displayRecurrence),u=k(F("displayTax",a),N.displayTax),m=k(F("displayPlanType",a),N.displayPlanType),h=k(F("entitlement",a),N.entitlement),p=k(F("modal",a),N.modal),f=k(F("forceTaxExclusive",a),N.forceTaxExclusive),x=F("promotionCode",a)??N.promotionCode,y=gt(F("quantity",a)),S=F("wcsApiKey",a)??N.wcsApiKey,b=a?.env==="stage",E=Be.PUBLISHED;["true",""].includes(a.allowOverride)&&(b=(F(Ha,a,{metadata:!1})?.toLowerCase()??a?.env)==="stage",E=Zt(F(Fa,a),Be,E)),b&&(i=Ee.STAGE,n=Ua);let z=F(za)??e.preview,V=typeof z<"u"&&z!=="off"&&z!=="false",W={};V&&(W={preview:V});let K=F("mas-io-url")??e.masIOUrl,te=fn(K)?K:`https://www${i===Ee.STAGE?".stage":""}.adobe.com/mas/io`,H=F("preselect-plan")??void 0,I=F("instant")??e.instant;return{...Rh(e),...W,aupSelect:F("aup-select",{"aup-select":r.getAttribute("aup-select")},{search:!0,storage:!1})==="on",displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:u,displayPlanType:m,entitlement:h,extraOptions:N.extraOptions,modal:p,env:i,forceTaxExclusive:f,promotionCode:x,quantity:y,alternativePrice:N.alternativePrice,wcsApiKey:S,wcsURL:n,landscape:E,masIOUrl:te,...H&&{preselectPlan:H},...I&&{instant:I}}}async function rc(e,r={},t=2,a=100){let i;for(let n=0;n<=t;n++)try{let o=await fetch(e,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,a*(n+1)))}throw i}var en="wcs";function ac({settings:e}){let r=ae.module(en),{env:t,wcsApiKey:a}=e,i=new Map,n=new Map,o,s=new Map;async function c(p,f,x=!0){let y=q(),S=Oa;r.debug("Fetching:",p);let b="",E;if(p.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let O=new Map(f),[z]=p.offerSelectorIds,V=Date.now()+Math.random().toString(36).substring(2,7),W=`${en}:${z}:${V}${Ga}`,K=`${en}:${z}:${V}${qa}`,te;try{if(performance.mark(W),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",z),b.searchParams.set("country",p.country),b.searchParams.set("locale",p.locale),b.searchParams.set("landscape",t===Ee.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",a),p.language&&b.searchParams.set("language",p.language),p.promotionCode&&b.searchParams.set("promotion_code",p.promotionCode),p.currency&&b.searchParams.set("currency",p.currency),E=await rc(b.toString(),{credentials:"omit"}),E.ok){let H=[];try{let I=await E.json();r.debug("Fetched:",p,I),H=I.resolvedOffers??[]}catch(I){r.error(`Error parsing JSON: ${I.message}`,{...I.context,...y?.duration})}H=H.map($r),f.forEach(({resolve:I},re)=>{let Z=H.filter(({offerSelectorIds:ze})=>ze.includes(re)).flat();Z.length&&(O.delete(re),f.delete(re),I(Z))})}else S=Na}catch(H){S=`Network error: ${H.message}`}finally{te=performance.measure(K,W),performance.clearMarks(W),performance.clearMeasures(K)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let H=Un(E);f.forEach(I=>{I.reject(new Dt(S,{...p,...H,response:E,measure:Rr(te),...y?.duration}))})}}function l(){clearTimeout(o);let p=[...n.values()];n.clear(),p.forEach(({options:f,promises:x})=>c(f,x))}function d(p){if(!p||typeof p!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===Ee.STAGE?"stage":"prod",x=p[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[y,S]of Object.entries(x))i.set(y,Promise.resolve(S.map($r)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function u(){let p=i.size;s=new Map(i),i.clear(),r.debug(`Moved ${p} cache entries to stale cache`)}function m(p,f,x){let y=p!=="GB"&&!x?"MULT":"en",S=Va.includes(p)?p:N.country;return{validCountry:S,validLanguage:y,locale:`${f}_${S}`}}function h({country:p,language:f,perpetual:x=!1,promotionCode:y="",promotionCodes:S,wcsOsi:b=[]}){let{validCountry:E,validLanguage:O,locale:z}=m(p,f,x),V=Array.isArray(S)&&S.length?S:[y];return b.map((W,K)=>{let te=V.length===1?V[0]:V[K]??"",H=[E,O,te].filter(Z=>Z).join("-").toLowerCase(),I=`${W}-${H}`;if(i.has(I))return i.get(I);let re=new Promise((Z,ze)=>{let ge=n.get(H);ge||(ge={options:{country:E,locale:z,...O==="MULT"&&{language:O},offerSelectorIds:[]},promises:new Map},n.set(H,ge)),te&&(ge.options.promotionCode=te),ge.options.offerSelectorIds.push(W),ge.promises.set(W,{resolve:Z,reject:ze}),l()}).catch(Z=>{if(s.has(I))return s.get(I);throw Z});return i.set(I,re),re})}return{Commitment:Xe,PlanType:Pn,Term:me,applyPlanType:$r,resolveOfferSelectors:h,flushWcsCacheInternal:u,prefillWcsCache:d,normalizeCountryLanguageAndLocale:m}}var ic="mas-commerce-service",nc="mas-commerce-service:start",oc="mas-commerce-service:ready",Ar,Ht,st,sc,rn,tn=class extends HTMLElement{constructor(){super(...arguments);C(this,st);C(this,Ar);C(this,Ht);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(a,i,n)=>{let o=await t?.(a,i,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return v(this,Ht)||A(this,Ht,{[Pe]:B(this,st,rn).call(this,Pe),[he]:B(this,st,rn).call(this,he)}),v(this,Ht)}activate(){let t=v(this,st,sc),a=tc(t,this);Gr(t.lana);let i=ae.init(t.hostEnv).module("service");i.debug("Activating:",t);let o={price:ss(a)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:a};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...is(c),...ns(c),...ec(c),...ac(c),...ja,Log:ae,resolvePriceTaxFlags:Ji,get defaults(){return N},get log(){return ae},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return a}})),i.debug("Activated:",{literals:o,settings:a});let l=new CustomEvent(Lr,{bubbles:!0,cancelable:!1,detail:this});performance.mark(oc),A(this,Ar,performance.measure(oc,nc)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(nc),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(wa).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Rr(v(this,Ar))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:i})=>i>this.lastLoggingTime).filter(({transferSize:i,duration:n,responseStatus:o})=>i===0&&n===0&&o<200||o>=400),a=Array.from(new Map(t.map(i=>[i.name,i])).values());if(a.some(({name:i})=>/(\/fragment\?|web_commerce_artifact)/.test(i))){let i=a.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:i,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Ar=new WeakMap,Ht=new WeakMap,st=new WeakSet,sc=function(){let t=this.getAttribute("env")??"prod",a={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(i=>{let n=this.getAttribute(i);n&&(a[i]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(i=>{let n=this.getAttribute(i);if(n!=null){let o=i.replace(/-([a-z])/g,s=>s[1].toUpperCase());a.commerce[o]=n}}),a},rn=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||F(t))};window.customElements.get(ic)||window.customElements.define(ic,tn);var hc="merch-card-collection",Nh=3e4,Oh={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},Ih={plans:!0},Dh=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),zh=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(a=>t.types.includes(a)))):e,Hh=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),Fh=(e,{filter:r})=>e.sort((t,a)=>a.filters[r]?.order==null||isNaN(a.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-a.filters[r].order),Bh=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,We,Bt,ct,Cr,fa,pc,Ft=class extends lc{constructor(){super();C(this,fa);C(this,We,{});C(this,Bt);C(this,ct);C(this,Cr);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[],this.resizeHandlerDebounced=un(this.resizeHandler.bind(this),300)}resizeHandler(){this.firstChild?.variantLayout?.resizeHandler?.()}render(){return De` <slot></slot>
            ${this.footer}`}checkReady(){if(!this.querySelector("aem-fragment"))return Promise.resolve(!0);let a,i=new Promise(o=>{a=gn(()=>o(!1),Nh)}),n=Promise.race([this.hydrationReady,i]);return n.finally(()=>Xa(a)),n}updated(t){if(!this.querySelector("merch-card"))return;let a=window.scrollY||document.documentElement.scrollTop,i=[...this.children].filter(l=>l.tagName==="MERCH-CARD"&&!l.failed);if(i.length===0)return;t.has("singleApp")&&this.singleApp&&i.forEach(l=>{l.updateFilters(l.name===this.singleApp)});let n=this.sort===be.alphabetical?Hh:Fh,s=[Dh,zh,Bh,n].reduce((l,d)=>d(l,this),i).map((l,d)=>[l,d]);if(this.resultCount=s.length,this.page&&this.limit){let l=this.page*this.limit;this.hasMore=s.length>l,s=s.filter(([,d])=>d<l)}let c=new Map(s.reverse());for(let l of c.keys())this.prepend(l);i.forEach(l=>{c.has(l)?(l.size=l.filters[this.filter]?.size,l.style.removeProperty("display"),l.requestUpdate()):(l.style.display="none",l.size=void 0)}),window.scrollTo(0,a),this.updateComplete.then(()=>{this.dispatchLiteralsChanged(),this.sidenav&&!this.literalsHandlerAttached&&(this.sidenav.addEventListener(Ta,()=>{this.dispatchLiteralsChanged()}),this.literalsHandlerAttached=!0)})}dispatchLiteralsChanged(){this.dispatchEvent(new CustomEvent(fe,{detail:{resultCount:this.resultCount,searchTerm:this.search,filter:this.sidenav?.filters?.selectedText}}))}buildOverrideMap(){A(this,We,{}),this.overrides?.split(",").forEach(t=>{let[a,i]=t?.split(":");a&&i&&(v(this,We)[a]=i)})}connectedCallback(){super.connectedCallback(),A(this,Bt,Yt()),v(this,Bt)&&A(this,ct,v(this,Bt).Log.module(hc)),A(this,Cr,customElements.get("merch-card")),this.buildOverrideMap(),this.init(),window.addEventListener("resize",this.resizeHandlerDebounced)}async init(){await this.hydrate(),this.sidenav=this.parentElement.querySelector("merch-sidenav"),this.filtered?(this.filter=this.filtered,this.page=1):this.startDeeplink(),this.initializePlaceholders()}disconnectedCallback(){super.disconnectedCallback(),this.stopDeeplink?.();for(let t of this.onUnmount)t();window.removeEventListener("resize",this.resizeHandlerDebounced)}initializeHeader(){let t=document.createElement("merch-card-collection-header");t.collection=this,t.classList.add(this.variant),this.parentElement.insertBefore(t,this),this.header=t,this.querySelectorAll("[placeholder]").forEach(i=>{let n=i.getAttribute("slot");this.header.placeholderKeys.includes(n)&&this.header.append(i)})}initializePlaceholders(){let t=this.data?.placeholders||{};!t.searchText&&this.data?.sidenavSettings?.searchText&&(t.searchText=this.data.sidenavSettings.searchText);for(let a of Object.keys(t)){let i=t[a],n=i.includes("<p>")?"div":"p",o=document.createElement(n);o.setAttribute("slot",a),o.setAttribute("placeholder",""),o.innerHTML=i,this.append(o)}}attachSidenav(t,a=!0){if(!t)return;a&&this.parentElement.prepend(t),this.sidenav=t,this.sidenav.variant=this.variant,this.sidenav.classList.add(this.variant),Ih[this.variant]&&this.sidenav.setAttribute("autoclose",""),this.initializeHeader(),this.dispatchEvent(new CustomEvent(Vt));let i=v(this,Cr)?.getCollectionOptions(this.variant)?.onSidenavAttached;i&&i(this)}async hydrate(){if(this.hydrating)return!1;let t=this.querySelector("aem-fragment");if(!t)return;this.id=t.getAttribute("fragment"),this.hydrating=!0;let a;this.hydrationReady=new Promise(s=>{a=s});let i=this;function n(s){let c;return s.fields?.checkboxGroups?c=s.fields.checkboxGroups:s.fields?.tagFilters&&(c=[{title:s.fields?.tagFiltersTitle,label:"types",deeplink:"types",checkboxes:s.fields.tagFilters.map(l=>{let d=l.split("/").pop(),u=s.settings?.tagLabels?.[d]||d;return u=u.startsWith("coll-tag-filter")?d.charAt(0).toUpperCase()+d.slice(1):u,{name:d,label:u}})}]),{searchText:s.fields?.searchText,tagFilters:c,linksTitle:s.fields?.linksTitle,link:s.fields?.link,linkText:s.fields?.linkText,linkIcon:s.fields?.linkIcon}}function o(s,c){let l={cards:[],hierarchy:[],placeholders:s.placeholders,sidenavSettings:n(s)};function d(u,m){for(let h of m){if(h.fieldName==="variations")continue;if(h.fieldName==="cards"){if(l.cards.findIndex(b=>b.id===h.identifier)!==-1)continue;if(!s.references[h.identifier]?.value){v(i,ct)?.error(`Reference not found for card: ${h.identifier}`);continue}l.cards.push(s.references[h.identifier].value);continue}let p=s.references[h.identifier]?.value,f=h.referencesTree,x=c[h.identifier];if(x){let b=document.querySelector(`aem-fragment[fragment="${x}"]`)?.rawData;if(b?.fields)p=b,f=b.referencesTree,s.references={...s.references,...b.references};else{v(i,ct)?.error(`Override fragment ${x} not found or invalid:`);continue}}if(!p?.fields)continue;let{fields:y}=p,S={label:y.label||"",icon:y.icon,iconLight:y.iconLight,queryLabel:y.queryLabel,cards:y.cards?y.cards.map(b=>c[b]||b):[],collections:[]};y.defaultchild&&(S.defaultchild=c[y.defaultchild]||y.defaultchild),u.push(S),d(S.collections,f)}}return d(l.hierarchy,s.referencesTree),l.hierarchy.length===0&&(i.filtered="all"),l}t.addEventListener(_a,s=>{B(this,fa,pc).call(this,"Error loading AEM fragment",s.detail),this.hydrating=!1,t.remove()}),t.addEventListener(ka,async s=>{this.limit=27,this.data=o(s.detail,v(this,We)),s.detail.variationId&&this.setAttribute("variation-id",s.detail.variationId);let{cards:c,hierarchy:l}=this.data,d=l.length===0&&s.detail.fields?.defaultchild?v(this,We)[s.detail.fields.defaultchild]||s.detail.fields.defaultchild:null;t.cache.add(...c);let u=(p,f)=>{for(let x of p)if(x.defaultchild===f||x.collections&&u(x.collections,f))return!0;return!1};for(let p of c){let b=function(O){for(let z of O){let V=z.cards.indexOf(x);if(V===-1)continue;let W=z.queryLabel??z?.label?.toLowerCase()??"";f.filters[W]={order:V+1,size:p.fields.size},b(z.collections)}},f=document.createElement("merch-card"),x=v(this,We)[p.id]||p.id;f.setAttribute("consonant",""),f.setAttribute("style","");let y=p.fields.tags?.filter(O=>O.startsWith("mas:types/")).map(O=>O.split("/")[1]).join(",");y&&f.setAttribute("types",y),Or(p.fields.variant)?.supportsDefaultChild&&(d?x===d:u(l,x))&&f.setAttribute("data-default-card","true"),b(l);let E=document.createElement("aem-fragment");E.setAttribute("fragment",x),f.append(E),Object.keys(f.filters).length===0&&(f.filters={all:{order:c.indexOf(p)+1,size:p.fields.size}}),this.append(f)}let m="",h=Ho(c[0]?.fields?.variant);this.variant=h,h==="plans"&&(c.length===2||c.length===3)&&!c.some(p=>p.fields?.size?.includes("wide"))||(h==="segment"||h==="product")&&(c.length===2||c.length===3)?m=c.length===2?"TwoColumns":"ThreeColumns":(h==="mini-compare-chart"||h==="mini-compare-chart-mweb")&&c.length<=2&&(m=c.length===1?"":"TwoColumns"),h&&this.classList.add("merch-card-collection",h,...Oh[`${h}${m}`]||[]),this.displayResult=!0,this.hydrating=!1,t.remove(),a(!0)}),await this.hydrationReady}get footer(){if(!this.filtered)return De`<div id="footer">
            <sp-theme color="light" scale="medium">
                ${this.showMoreButton}
            </sp-theme>
        </div>`}get showMoreButton(){if(this.hasMore)return De`<sp-button
            variant="secondary"
            treatment="outline"
            style="order: 1000;"
            @click="${this.showMore}"
        ...
        </sp-button>`}sortChanged(t){t.target.value===be.authored?qt({sort:void 0}):qt({sort:t.target.value}),this.dispatchEvent(new CustomEvent(Sa,{bubbles:!0,composed:!0,detail:{value:t.target.value}}))}async showMore(){this.dispatchEvent(new CustomEvent(Ca,{bubbles:!0,composed:!0}));let t=this.page+1;qt({page:t}),this.page=t,await this.updateComplete}startDeeplink(){this.stopDeeplink=dn(({category:t,filter:a,types:i,sort:n,search:o,single_app:s,page:c})=>{a=a||t,!this.filtered&&a&&a!==this.filter&&setTimeout(()=>{qt({page:void 0}),this.page=1},1),this.filtered||(this.filter=a??this.filter),this.types=i??"",this.search=o??"",this.singleApp=s,this.sort=n,this.page=Number(c)||1})}openFilters(t){this.sidenav?.showModal(t)}};We=new WeakMap,Bt=new WeakMap,ct=new WeakMap,Cr=new WeakMap,fa=new WeakSet,pc=function(t,a={},i=!0){v(this,ct)?.error(`merch-card-collection: ${t}`,a),this.failed=!0,i&&this.dispatchEvent(new CustomEvent(La,{detail:{...a,message:t},bubbles:!0,composed:!0}))},g(Ft,"properties",{id:{type:String,attribute:"id",reflect:!0},displayResult:{type:Boolean,attribute:"display-result"},filter:{type:String,attribute:"filter",reflect:!0},filtered:{type:String,attribute:"filtered",reflect:!0},hasMore:{type:Boolean},limit:{type:Number,attribute:"limit"},overrides:{type:String},page:{type:Number,attribute:"page",reflect:!0},resultCount:{type:Number},search:{type:String,attribute:"search",reflect:!0},sidenav:{type:Object},singleApp:{type:String,attribute:"single-app",reflect:!0},sort:{type:String,attribute:"sort",default:be.authored,reflect:!0},types:{type:String,attribute:"types",reflect:!0}}),g(Ft,"styles",dc`
        #footer {
            grid-column: 1 / -1;
    ...
    `);Ft.SortOrder=be;customElements.define(hc,Ft);var Uh={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},$h=(e,r,t)=>{e.querySelectorAll(`[data-placeholder="${r}"]`).forEach(i=>{i.innerText=t||""})},Gh={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},qh={catalog:"l"},de,Ut,Sr=class extends lc{constructor(){super();C(this,de);C(this,Ut);g(this,"tablet",new Gt(this,R));g(this,"desktop",new Gt(this,L));this.collection=null,A(this,de,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(fe,this.updateLiterals),this.collection?.addEventListener(Vt,this.handleSidenavAttached),A(this,Ut,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(fe,this.updateLiterals),this.collection?.removeEventListener(Vt,this.handleSidenavAttached)}willUpdate(){v(this,de).search=this.getVisibility("search"),v(this,de).filter=this.getVisibility("filter"),v(this,de).sort=this.getVisibility("sort"),v(this,de).result=this.getVisibility("result"),v(this,de).custom=this.getVisibility("custom")}parseVisibilityOptions(t,a){if(!t||!Object.hasOwn(t,a))return null;let i=t[a];return i===!1?!1:i===!0?!0:i.includes(this.currentMedia)}getVisibility(t){let a=v(this,Ut)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,i=this.parseVisibilityOptions(a,t);return i!==null?i:this.parseVisibilityOptions(Gh,t)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!v(this,de).search)return we;let t=Wt(this,"searchText");return t?De`
            <merch-search deeplink="search" id="search">
                <sp-search
                    id="search-bar"
                    placeholder="${t}"
                    .size=${qh[this.variant]}
                    aria-label="${t}"
                ></sp-search>
            </merch-search>
        `:we}get filterAction(){return v(this,de).filter?this.sidenav?De`
            <sp-action-button
                id="filter"
                variant="secondary"
                treatment="outline"
            ...
            ></sp-action-button>
        `:we:we}get sortAction(){if(!v(this,de).sort)return we;let t=Wt(this,"sortText");if(!t)return;let a=Wt(this,"popularityText"),i=Wt(this,"alphabeticallyText");if(!(a&&i))return;let n=this.collection?.sort===be.alphabetical;return De`
            <sp-action-menu
                id="sort"
                size="m"
                @change="${this.collection?.sortChanged}"
                selects="single"
                value="${n?be.alphabetical:be.authored}"
            >
                <span slot="label-only"
                    >${t}:
                    ${n?i:a}</span
                >
                <sp-menu-item value="${be.authored}"
                    >${a}</sp-menu-item
                >
                <sp-menu-item value="${be.alphabetical}"
                    >${i}</sp-menu-item
                >
            </sp-action-menu>
        `}get resultSlotName(){let t=`${this.search?"search":"filters"}${this.isMobile||this.isTablet?"Mobile":""}`;return Uh[t][Math.min(this.resultCount,2)]}get resultLabel(){if(!v(this,de).result)return we;if(!this.sidenav)return we;let t=this.search?"search":"filter",a=this.resultCount?this.resultCount===1?"single":"multiple":"none";return De` <div
            id="result"
            aria-live="polite"
            type=${t}
            quantity=${a}
        ...
        </div>`}get customArea(){if(!v(this,de).custom)return we;let t=v(this,Ut)?.getCollectionOptions(this.collection?.variant)?.customHeaderArea;if(!t)return we;let a=t(this.collection);return!a||a===we?we:De`<div id="custom" role="heading" aria-level="2">
            ${a}
        </div>`}openFilters(t){this.sidenav.showModal(t)}updateLiterals(t){Object.keys(t.detail).forEach(a=>{$h(this,a,t.detail[a])}),this.requestUpdate()}handleSidenavAttached(){this.requestUpdate()}render(){return De`
            <sp-theme color="light" scale="medium">
                <div id="header">
