var ki=Object.defineProperty;var Hi=e=>{throw TypeError(e)};var po=(e,t,r)=>t in e?ki(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var mo=(e,t)=>{for(var r in t)ki(e,r,{get:t[r],enumerable:!0})};var g=(e,t,r)=>po(e,typeof t!="symbol"?t+"":t,r),ur=(e,t,r)=>t.has(e)||Hi("Cannot "+r);var T=(e,t,r)=>(ur(e,t,"read from private field"),r?r.call(e):t.get(e)),$=(e,t,r)=>t.has(e)?Hi("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),z=(e,t,r,i)=>(ur(e,t,"write to private field"),i?i.call(e,r):t.set(e,r),r),Lt=(e,t,r)=>(ur(e,t,"access private method"),r);import{html as ue,LitElement as eo,css as to,unsafeCSS as Ja,nothing as se}from"../../deps/lit-all.min.js";var K="(max-width: 767px)",ne="(max-width: 1199px)",H="(min-width: 768px)",N="(min-width: 1200px)",ge="(min-width: 1600px)";function Rt(){return window.matchMedia(K)}function Mt(){return window.matchMedia(N)}function Nt(){return Rt().matches}function Ot(){return Mt().matches}var et=class{constructor(t,r){this.key=Symbol("match-media-key"),this.matches=!1,this.host=t,this.host.addController(this),this.media=window.matchMedia(r),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),t.addController(this)}hostConnected(){var t;(t=this.media)==null||t.addEventListener("change",this.onChange)}hostDisconnected(){var t;(t=this.media)==null||t.removeEventListener("change",this.onChange)}onChange(t){this.matches!==t.matches&&(this.matches=t.matches,this.host.requestUpdate(this.key,!this.matches))}};var Di="hashchange";function uo(e=window.location.hash){let t=[],r=e.replace(/^#/,"").split("&");for(let i of r){let[n,a=""]=i.split("=");n&&t.push([n,decodeURIComponent(a.replace(/\+/g," "))])}return Object.fromEntries(t)}function tt(e){let t=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([n,a])=>{a?t.set(n,a):t.delete(n)}),t.sort();let r=t.toString();if(r===window.location.hash)return;let i=window.scrollY||document.documentElement.scrollTop;window.location.hash=r,window.scrollTo(0,i)}function Bi(e){let t=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let r=uo(window.location.hash);e(r)};return t(),window.addEventListener(Di,t),()=>{window.removeEventListener(Di,t)}}var Fr={};mo(Fr,{CLASS_NAME_FAILED:()=>Ar,CLASS_NAME_HIDDEN:()=>go,CLASS_NAME_PENDING:()=>Sr,CLASS_NAME_RESOLVED:()=>Tr,CheckoutWorkflow:()=>No,CheckoutWorkflowStep:()=>q,Commitment:()=>Ae,ERROR_MESSAGE_BAD_REQUEST:()=>_r,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Lo,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Pr,EVENT_AEM_ERROR:()=>yr,EVENT_AEM_LOAD:()=>Er,EVENT_MAS_ERROR:()=>wr,EVENT_MAS_READY:()=>Co,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>_o,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>gr,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>rt,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>br,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>it,EVENT_MERCH_CARD_COLLECTION_SORT:()=>xr,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>To,EVENT_MERCH_OFFER_READY:()=>vo,EVENT_MERCH_OFFER_SELECT_READY:()=>Eo,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>So,EVENT_MERCH_SEARCH_CHANGE:()=>Po,EVENT_MERCH_SIDENAV_SELECT:()=>vr,EVENT_MERCH_STOCK_CHANGE:()=>wo,EVENT_MERCH_STORAGE_CHANGE:()=>Ao,EVENT_OFFER_SELECTED:()=>yo,EVENT_TYPE_FAILED:()=>Cr,EVENT_TYPE_READY:()=>It,EVENT_TYPE_RESOLVED:()=>Lr,Env:()=>le,FF_DEFAULTS:()=>ve,HEADER_X_REQUEST_ID:()=>nt,LOG_NAMESPACE:()=>Rr,Landscape:()=>be,MARK_DURATION_SUFFIX:()=>Br,MARK_START_SUFFIX:()=>Dr,MODAL_TYPE_3_IN_1:()=>Se,NAMESPACE:()=>fo,PARAM_AOS_API_KEY:()=>Ro,PARAM_ENV:()=>Nr,PARAM_LANDSCAPE:()=>Or,PARAM_MAS_PREVIEW:()=>Mr,PARAM_WCS_API_KEY:()=>Mo,PROVIDER_ENVIRONMENT:()=>Hr,SELECTOR_MAS_CHECKOUT_LINK:()=>Ui,SELECTOR_MAS_ELEMENT:()=>fr,SELECTOR_MAS_INLINE_PRICE:()=>te,SELECTOR_MAS_SP_BUTTON:()=>bo,SELECTOR_MAS_UPT_LINK:()=>Fi,SORT_ORDER:()=>oe,STATE_FAILED:()=>ae,STATE_PENDING:()=>xe,STATE_RESOLVED:()=>de,TAG_NAME_SERVICE:()=>xo,TEMPLATE_PRICE:()=>Oo,TEMPLATE_PRICE_ANNUAL:()=>ko,TEMPLATE_PRICE_LEGAL:()=>Ur,TEMPLATE_PRICE_STRIKETHROUGH:()=>Io,Term:()=>ee,WCS_PROD_URL:()=>Ir,WCS_STAGE_URL:()=>kr});var Ae=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),ee=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),fo="merch",go="hidden",It="wcms:commerce:ready",xo="mas-commerce-service",te='span[is="inline-price"][data-wcs-osi]',Ui='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',bo="sp-button[data-wcs-osi]",Fi='a[is="upt-link"]',fr=`${te},${Ui},${Fi}`,vo="merch-offer:ready",Eo="merch-offer-select:ready",gr="merch-card:action-menu-toggle",yo="merch-offer:selected",wo="merch-stock:change",Ao="merch-storage:change",So="merch-quantity-selector:change",To="merch-card-quantity:change",_o="merch-modal:addon-and-quantity-update",Po="merch-search:change",xr="merch-card-collection:sort",rt="merch-card-collection:literals-changed",it="merch-card-collection:sidenav-attached",br="merch-card-collection:showmore",vr="merch-sidenav:select",Er="aem:load",yr="aem:error",Co="mas:ready",wr="mas:error",Ar="placeholder-failed",Sr="placeholder-pending",Tr="placeholder-resolved",_r="Bad WCS request",Pr="Commerce offer not found",Lo="Literals URL not provided",Cr="mas:failed",Lr="mas:resolved",Rr="mas/commerce",Mr="mas.preview",Nr="commerce.env",Or="commerce.landscape",Ro="commerce.aosKey",Mo="commerce.wcsKey",Ir="https://www.adobe.com/web_commerce_artifact",kr="https://www.stage.adobe.com/web_commerce_artifact_stage",ae="failed",xe="pending",de="resolved",be={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},nt="X-Request-Id",q=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),No="UCv3",le=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),Hr={PRODUCTION:"PRODUCTION"},Se={TWP:"twp",D2P:"d2p",CRM:"crm"},Dr=":start",Br=":duration",Oo="price",Io="price-strikethrough",ko="annual",Ur="legal",ve="mas-ff-defaults",oe={alphabetical:"alphabetical",authored:"authored"};var Ho="mas-commerce-service";var at=(e,t)=>e?.querySelector(`[slot="${t}"]`)?.textContent?.trim();function Te(e,t={},r=null,i=null){let n=i?document.createElement(e,{is:i}):document.createElement(e);r instanceof HTMLElement?n.appendChild(r):n.innerHTML=r;for(let[a,o]of Object.entries(t))n.setAttribute(a,o);return n}function kt(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function $i(){return window.matchMedia("(max-width: 1024px)").matches}function ot(){return document.getElementsByTagName(Ho)?.[0]}function st(e){let t=window.getComputedStyle(e);return e.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}import{html as Ht,nothing as Do}from"../../deps/lit-all.min.js";var He,ct=class ct{constructor(t){g(this,"card");$(this,He);this.card=t,this.insertVariantStyle()}getContainer(){return z(this,He,T(this,He)??this.card.closest('[class*="-merch-cards"]')??this.card.parentElement),T(this,He)}insertVariantStyle(){if(!ct.styleMap[this.card.variant]){ct.styleMap[this.card.variant]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(t,r){if(!t)return;let i=`--consonant-merch-card-${this.card.variant}-${r}-height`,n=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),a=parseInt(this.getContainer().style.getPropertyValue(i))||0;n>a&&this.getContainer().style.setProperty(i,`${n}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Ht`
            <div
                id="badge"
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return Gi}setAriaExpanded(r,i){r.setAttribute("aria-expanded",i)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};g(De,"variantStyle",Bo`
    ...
    `);import{html as lt}from"../../deps/lit-all.min.js";var Vi=`
:root {
...
`;var Bt=class extends I{constructor(t){super(t)}getGlobalCSS(){return Vi}renderLayout(){return lt`${this.cardImage}
            ...
            ${this.evergreen?lt`
                  ...
                  `:lt`
                      <hr />
                      ${this.secureLabelFooter}
                  `}`}};import{html as qi}from"../../deps/lit-all.min.js";var ji=`
:root {
...
`;var Ut=class extends I{constructor(t){super(t)}getGlobalCSS(){return ji}renderLayout(){return qi` ${this.badge}
            ...
            ${this.card.customHr?"":qi`<hr />`} ${this.secureLabelFooter}`}};import{html as Be,css as Uo,unsafeCSS as Yi}from"../../deps/lit-all.min.js";var Wi=`
  :root {
...
`;var Fo=32,Ue=class extends I{constructor(r){super(r);g(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);g(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?Be`<slot name="secure-transaction-label">
            ...
            <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(r=>r.onceSettled())),await this.adjustAddon(),Nt()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};g(Ue,"variantStyle",Uo`
    ...
    `);import{html as dt,css as $o,nothing as Ft}from"../../deps/lit-all.min.js";var Xi=`
:root {
...
`;var $t={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ki={...function(){let{whatsIncluded:e,size:t,...r}=$t;return r}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Qi={...function(){let{subtitle:e,whatsIncluded:t,size:r,quantitySelect:i,...n}=$t;return n}()},Zi={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},G=class extends I{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,r){t.dataset.template===Ur&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Xi}adjustSlotPlacement(t,r,i){let n=this.card.shadowRoot,a=n.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let s=n.querySelector(`footer slot[name="${t}"]`),c=n.querySelector(`.body slot[name="${t}"]`),l=n.querySelector(".body");if(o.includes("wide")||(a?.classList.remove("wide-footer"),s&&s.remove()),!!r.includes(o)){if(a?.classList.toggle("wide-footer",Ot()),!i&&s){if(c)s.remove();else{let d=l.querySelector(`[data-placeholder-for="${t}"]`);d?d.replaceWith(s):l.appendChild(s)}return}if(i&&c){let d=document.createElement("div");if(d.setAttribute("data-placeholder-for",t),d.classList.add("slot-placeholder"),!s){let m=c.cloneNode(!0);a.prepend(m)}c.replaceWith(d)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],Ot()),this.adjustSlotPlacement("callout-content",["super-wide"],Ot())}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let i=r.querySelector("ul");if(!i)return;let n=i.previousElementSibling,a=document.createElement("div");a.classList.add("spacer"),r.insertBefore(a,n);let o=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let c=0,l=this.card.querySelector('[slot="heading-s"]');l&&(c+=st(l));let d=this.card.querySelector('[slot="subtitle"]');d&&(c+=st(d));let m=this.card.querySelector('[slot="heading-m"]');m&&(c+=8+st(m));for(let h of r.childNodes){if(h.classList.contains("spacer"))break;c+=st(h)}let p=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");c>(parseFloat(p)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${c}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${c}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists())}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${te}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?dt`<div class="divider"></div>`:Ft}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],r=this.card.querySelector(`[slot="heading-m"] ${te}[data-template="price"]`);r&&t.push(r);let i=t.map(async n=>{let a=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),n.parentNode.insertBefore(a,n.nextSibling),await a.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let i=r.value?.[0]?.planType;i&&(t.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?dt`<label id="stock-checkbox">
    ...
    `),g(G,"collectionOptions",{customHeaderArea:t=>t.sidenav?dt`<slot name="resultsText"></slot>`:Ft,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as Gr,css as Go}from"../../deps/lit-all.min.js";var Ji=`
:root {
...
`;var Fe=class extends I{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ji}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return Gr` ${this.badge}
    ...
    `);import{html as zr,css as zo}from"../../deps/lit-all.min.js";var en=`
:root {
...
`;var $e=class extends I{constructor(t){super(t)}getGlobalCSS(){return en}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return zr` ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as Vr,css as Vo}from"../../deps/lit-all.min.js";var tn=`
:root {
...
`;var rn={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Ge=class extends I{constructor(t){super(t)}getGlobalCSS(){return tn}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return Vr`${this.cardImage}
            <div class="body">
    ...
    `);import{html as jo,css as qo}from"../../deps/lit-all.min.js";var nn=`
:root {
...
`;var Gt=()=>window.matchMedia(ne).matches,jr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},ze=class extends I{getGlobalCSS(){return nn}get aemFragmentMapping(){return jr}get headingSelector(){return'[slot="heading-xs"]'}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),requestAnimationFrame(()=>{this.card?.hasAttribute("data-default-card")&&Gt()&&this.card.setAttribute("data-expanded","true")}))}setupAccordion(){let t=this.card;if(!t)return;let r=()=>{if(Gt()){let n=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",n?"true":"false")}else t.removeAttribute("data-expanded")};r();let i=window.matchMedia(ne);this.mediaQueryListener=()=>{r()},i.addEventListener("change",this.mediaQueryListener),this.attributeObserver=new MutationObserver(n=>{n.forEach(a=>{a.type==="attributes"&&a.attributeName==="data-default-card"&&this.card.hasAttribute("data-default-card")&&Gt()&&this.card.setAttribute("data-expanded","true")})}),this.attributeObserver.observe(this.card,{attributes:!0,attributeOldValue:!0})}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(ne).removeEventListener("change",this.mediaQueryListener),this.attributeObserver&&this.attributeObserver.disconnect()}handleChevronClick(t){t.preventDefault(),t.stopPropagation();let r=this.card;if(!r||!Gt())return;let a=r.getAttribute("data-expanded")==="true"?"false":"true";r.setAttribute("data-expanded",a)}renderLayout(){return jo`
    ...
    `);import{css as Wo,html as Yo}from"../../deps/lit-all.min.js";var an=`
...
`,Me.MISSING_INTL_API,o);var S=r.getPluralRules(t,{type:d.pluralType}).select(p-(d.offset||0));E=d.options[S]||d.options.other}if(!E)throw new wi(d.value,p,Object.keys(d.options),o);s.push.apply(s,yt(E.value,t,r,i,n,p-(d.offset||0)));continue}}return ic(s)}function ac(e,t){return t?w(w(w({},e||{}),t||{}),Object.keys(e).reduce(function(r,i){return r[i]=w(w({},e[i]),t[i]||{}),r},{})):e}function oc(e,t){return t?Object.keys(e).reduce(function(r,i){return r[i]=ac(e[i],t[i]),r},w({},e)):e}function Ai(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function sc(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:vt(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.NumberFormat).bind.apply(t,er([void 0],r,!1)))},{cache:Ai(e.number),strategy:cr.variadic}),getDateTimeFormat:vt(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.DateTimeFormat).bind.apply(t,er([void 0],r,!1)))},{cache:Ai(e.dateTime),strategy:cr.variadic}),getPluralRules:vt(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.PluralRules).bind.apply(t,er([void 0],r,!1)))},{cache:Ai(e.pluralRules),strategy:cr.variadic})}}var ha=function(){function e(t,r,i,n){var a=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=a.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==V.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return yt(a.ast,a.locales,a.formatters,a.formats,o,void 0,a.message)},this.resolvedOptions=function(){return{locale:a.resolvedLocale.toString()}},this.getAst=function(){return a.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:n?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=oc(e.formats,i),this.formatters=n&&n.formatters||sc(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=oa,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var pa=ha;var cc=/[0-9\-+#]/,lc=/[^\d\-+#]/g;function ma(e){return e.search(cc)}function dc(e="#.##"){let t={},r=e.length,i=ma(e);t.prefix=i>0?e.substring(0,i):"";let n=ma(e.split("").reverse().join("")),a=r-n,o=e.substring(a,a+1),s=a+(o==="."||o===","?1:0);t.suffix=n>0?e.substring(s,r):"",t.mask=e.substring(i,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let c=t.mask.match(lc);return t.decimal=c&&c[c.length-1]||".",t.separator=c&&c[1]&&c[0]||",",c=t.mask.split(t.decimal),t.integer=c[0],t.fraction=c[1],t}function hc(e,t,r){let i=!1,n={value:e};e<0&&(i=!0,n.value=-n.value),n.sign=i?"-":"",n.value=Number(n.value).toFixed(t.fraction&&t.fraction.length),n.value=Number(n.value).toString();let a=t.fraction&&t.fraction.lastIndexOf("0"),[o="0",s=""]=n.value.split(".");return(!s||s&&s.length<=a)&&(s=a<0?"":(+("0."+s)).toFixed(a+1).replace("0.","")),n.integer=o,n.fraction=s,pc(n,t),(n.result==="0"||n.result==="")&&(i=!1,n.sign=""),!i&&t.maskHasPositiveSign?n.sign="+":i&&t.maskHasPositiveSign?n.sign="-":i&&(n.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),n}function pc(e,t){e.result="";let r=t.integer.split(t.separator),i=r.join(""),n=i&&i.indexOf("0");if(n>-1)for(;e.integer.length<i.length-n;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let a=r[1]&&r[r.length-1].length;if(a){let o=e.integer.length,s=o%a;for(let c=0;c<o;c++)e.result+=e.integer.charAt(c),!((c-s+1)%a)&&c<o-a&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function mc(e,t,r={}){if(!e||isNaN(Number(t)))return t;let i=dc(e),n=hc(t,i,r);return i.prefix+n.sign+n.result+i.suffix}var ua=mc;var fa=".",uc=",",xa=/^\s+/,ba=/\s+$/,ga="&nbsp;",Si=e=>e*12,va=(e,t)=>{let{start:r,end:i,displaySummary:{amount:n,duration:a,minProductQuantity:o,outcomeType:s}={}}=e;if(!(n&&a&&s&&o))return!1;let c=t?new Date(t):new Date;if(!r||!i)return!1;let l=new Date(r),d=new Date(i);return c>=l&&c<=d},Ne={MONTH:"MONTH",YEAR:"YEAR"},fc={[ee.ANNUAL]:12,[ee.MONTHLY]:1,[ee.THREE_YEARS]:36,[ee.TWO_YEARS]:24},Ti=(e,t)=>({accept:e,round:t}),gc=[Ti(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),Ti(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.round(t/e*100)/100),Ti(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],_i={[Ae.YEAR]:{[ee.MONTHLY]:Ne.MONTH,[ee.ANNUAL]:Ne.YEAR},[Ae.MONTH]:{[ee.MONTHLY]:Ne.MONTH}},xc=(e,t)=>e.indexOf(`'${t}'`)===0,bc=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),i=ya(r);return!!i?t||(r=r.replace(/[,\.]0+/,i)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+Ec(e)),r},vc=e=>{let t=yc(e),r=xc(e,t),i=e.replace(/'.*?'/,""),n=xa.test(i)||ba.test(i);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:n}},Ea=e=>e.replace(xa,ga).replace(ba,ga),Ec=e=>e.match(/#(.?)#/)?.[1]===fa?uc:fa,yc=e=>e.match(/'(.*?)'/)?.[1]??"",ya=e=>e.match(/0(.?)0/)?.[1]??"";function Ye({formatString:e,price:t,usePrecision:r,isIndianPrice:i=!1},n,a=o=>o){let{currencySymbol:o,isCurrencyFirst:s,hasCurrencySpace:c}=vc(e),l=r?ya(e):"",d=bc(e,r),m=r?2:0,p=a(t,{currencySymbol:o}),h=i?p.toLocaleString("hi-IN",{minimumFractionDigits:m,maximumFractionDigits:m}):ua(d,p),f=r?h.lastIndexOf(l):h.length,u=h.substring(0,f),v=h.substring(f+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,h).replace(/SYMBOL/,o),currencySymbol:o,decimals:v,decimalsDelimiter:l,hasCurrencySpace:c,integer:u,isCurrencyFirst:s,recurrenceTerm:n}}var wa=e=>{let{commitment:t,term:r,usePrecision:i}=e,n=fc[r]??1;return Ye(e,n>1?Ne.MONTH:_i[t]?.[r],a=>{let o={divisor:n,price:a,usePrecision:i},{round:s}=gc.find(({accept:c})=>c(o));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(o)}`);return s(o)})},Aa=({commitment:e,term:t,...r})=>Ye(r,_i[e]?.[t]),Sa=e=>{let{commitment:t,instant:r,price:i,originalPrice:n,priceWithoutDiscount:a,promotion:o,quantity:s=1,term:c}=e;if(t===Ae.YEAR&&c===ee.MONTHLY){if(!o)return Ye(e,Ne.YEAR,Si);let{displaySummary:{outcomeType:l,duration:d,minProductQuantity:m=1}={}}=o;switch(l){case"PERCENTAGE_DISCOUNT":if(s>=m&&va(o,r)){let p=parseInt(d.replace("P","").replace("M",""));if(isNaN(p))return Si(i);let h=s*n*p,f=s*a*(12-p),u=Math.round((h+f)*100)/100;return Ye({...e,price:u},Ne.YEAR)}default:return Ye(e,Ne.YEAR,()=>Si(a??i))}}return Ye(e,_i[t]?.[c])};var Pi={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},wc=mn("ConsonantTemplates/price"),Ac=/<\/?[^>]+(>|$)/g,D={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},ye={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Ci="TAX_EXCLUSIVE",Sc=e=>dn(e)?Object.entries(e).filter(([,t])=>je(t)||Vt(t)||t===!0).reduce((t,[r,i])=>t+` ${r}${i===!0?"":'="'+ln(i)+'"'}`,""):"",U=(e,t,r,i=!1)=>`<span class="${e}${t?"":" "+D.disabled}"${Sc(r)}>${i?Ea(t):t??""}</span>`;function pe(e,t,r,i){let n=e[r];if(n==null)return"";try{return new pa(n.replace(Ac,""),t).format(i)}catch{return wc.error("Failed to format literal:",n),""}}function Tc(e,{accessibleLabel:t,altAccessibleLabel:r,currencySymbol:i,decimals:n,decimalsDelimiter:a,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:m},p={}){let h=U(D.currencySymbol,i),f=U(D.currencySpace,o?"&nbsp;":""),u="";return t?u=`<sr-only class="strikethrough-aria-label">${t}</sr-only>`:r&&(u=`<sr-only class="alt-aria-label">${r}</sr-only>`),c&&(u+=h+f),u+=U(D.integer,s),u+=U(D.decimalsDelimiter,a),u+=U(D.decimals,n),c||(u+=f+h),u+=U(D.recurrence,l,null,!0),u+=U(D.unitType,d,null,!0),u+=U(D.taxInclusivity,m,!0),U(e,u,{...p})}var Y=({isAlternativePrice:e=!1,displayOptical:t=!1,displayStrikethrough:r=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:a,displayFormatted:o=!0,displayRecurrence:s=!0,displayPerUnit:c=!1,displayTax:l=!1,language:d,literals:m={},quantity:p=1,space:h=!1}={},{commitment:f,offerSelectorIds:u,formatString:v,price:_,priceWithoutDiscount:y,taxDisplay:E,taxTerm:S,term:C,usePrecision:M,promotion:B}={},j={})=>{Object.entries({country:a,formatString:v,language:d,price:_}).forEach(([lo,ho])=>{if(ho==null)throw new Error(`Argument "${lo}" is missing for osi ${u?.toString()}, country ${a}, language ${d}`)});let k={...Pi,...m},L=`${d.toLowerCase()}-${a.toUpperCase()}`,F=r&&y?y:_,J=t?wa:Aa;i&&(J=Sa);let{accessiblePrice:fe,recurrenceTerm:ce,...Oe}=J({commitment:f,formatString:v,instant:n,isIndianPrice:a==="IN",originalPrice:_,priceWithoutDiscount:y,price:t?_:F,promotion:B,quantity:p,term:C,usePrecision:M}),hr="",pr="",mr="";b(s)&&ce&&(mr=pe(k,L,ye.recurrenceLabel,{recurrenceTerm:ce}));let Pt="";b(c)&&(h&&(Pt+=" "),Pt+=pe(k,L,ye.perUnitLabel,{perUnit:"LICENSE"}));let Ct="";b(l)&&S&&(h&&(Ct+=" "),Ct+=pe(k,L,E===Ci?ye.taxExclusiveLabel:ye.taxInclusiveLabel,{taxTerm:S})),r&&(hr=pe(k,L,ye.strikethroughAriaLabel,{strikethroughPrice:hr})),e&&(pr=pe(k,L,ye.alternativePriceAriaLabel,{alternativePrice:pr}));let Ie=D.container;if(t&&(Ie+=" "+D.containerOptical),r&&(Ie+=" "+D.containerStrikethrough),e&&(Ie+=" "+D.containerAlternative),i&&(Ie+=" "+D.containerAnnual),b(o))return Tc(Ie,{...Oe,accessibleLabel:hr,altAccessibleLabel:pr,recurrenceLabel:mr,perUnitLabel:Pt,taxInclusivityLabel:Ct},j);let{currencySymbol:Oi,decimals:no,decimalsDelimiter:ao,hasCurrencySpace:Ii,integer:oo,isCurrencyFirst:so}=Oe,ke=[oo,ao,no];so?(ke.unshift(Ii?"\xA0":""),ke.unshift(Oi)):(ke.push(Ii?"\xA0":""),ke.push(Oi)),ke.push(mr,Pt,Ct);let co=ke.join("");return U(Ie,co,j)},Ta=()=>(e,t,r)=>{let n=(e.displayOldPrice===void 0||b(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${n?Y({displayStrikethrough:!0})(e,t,r)+"&nbsp;":""}${Y({isAlternativePrice:n})(e,t,r)}`},_a=()=>(e,t,r)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let n={...e,displayTax:!1,displayPerUnit:!1},o=(e.displayOldPrice===void 0||b(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${o?Y({displayStrikethrough:!0})(n,t,r)+"&nbsp;":""}${Y({isAlternativePrice:o})(e,t,r)}${U(D.containerAnnualPrefix,"&nbsp;(")}${Y({displayAnnual:!0,instant:i})(n,t,r)}${U(D.containerAnnualSuffix,")")}`},Pa=()=>(e,t,r)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${Y({isAlternativePrice:e.displayOldPrice})(e,t,r)}${U(D.containerAnnualPrefix,"&nbsp;(")}${Y({displayAnnual:!0})(i,t,r)}${U(D.containerAnnualSuffix,")")}`};var wt={...D,containerLegal:"price-legal",planType:"price-plan-type"},lr={...ye,planTypeLabel:"planTypeLabel"};function _c(e,{perUnitLabel:t,taxInclusivityLabel:r,planTypeLabel:i},n={}){let a="";return a+=U(wt.unitType,t,null,!0),r&&i&&(r+=". "),a+=U(wt.taxInclusivity,r,!0),a+=U(wt.planType,i,null),U(e,a,{...n})}var Ca=({country:e,displayPerUnit:t=!1,displayTax:r=!1,displayPlanType:i=!1,language:n,literals:a={}}={},{taxDisplay:o,taxTerm:s,planType:c}={},l={})=>{let d={...Pi,...a},m=`${n.toLowerCase()}-${e.toUpperCase()}`,p="";b(t)&&(p=pe(d,m,lr.perUnitLabel,{perUnit:"LICENSE"}));let h="";e==="US"&&n==="en"&&(r=!1),b(r)&&s&&(h=pe(d,m,o===Ci?lr.taxExclusiveLabel:lr.taxInclusiveLabel,{taxTerm:s}));let f="";b(i)&&c&&(f=pe(d,m,lr.planTypeLabel,{planType:c}));let u=wt.container;return u+=" "+wt.containerLegal,_c(u,{perUnitLabel:p,taxInclusivityLabel:h,planTypeLabel:f},l)};var La=Y(),Ra=Ta(),Ma=Y({displayOptical:!0}),Na=Y({displayStrikethrough:!0}),Oa=Y({displayAnnual:!0}),Ia=Y({displayOptical:!0,isAlternativePrice:!0}),ka=Y({isAlternativePrice:!0}),Ha=Pa(),Da=_a(),Ba=Ca;var Pc=(e,t)=>{if(!(!ht(e)||!ht(t)))return Math.floor((t-e)/t*100)},Ua=()=>(e,t)=>{let{price:r,priceWithoutDiscount:i}=t,n=Pc(r,i);return n===void 0?'<span class="no-discount"></span>':`<span class="discount">${n}%</span>`};var Fa=Ua();var Ga="INDIVIDUAL_COM",Li="TEAM_COM",za="INDIVIDUAL_EDU",Ri="TEAM_EDU",$a=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],Cc={[Ga]:["MU_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","SG_en","KR_ko"],[Li]:["MU_en","LT_lt","LV_lv","NG_en","CO_es","KR_ko"],[za]:["LT_lt","LV_lv","SA_en","SG_en"],[Ri]:["SG_en","KR_ko"]},Lc={MU_en:[!1,!1,!1,!1],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],CO_es:[!1,!0,!1,!1],AT_de:[!1,!1,!1,!0],SG_en:[!1,!1,!1,!0]},Rc=[Ga,Li,za,Ri],Mc=e=>[Li,Ri].includes(e),Nc=(e,t,r,i)=>{let n=`${e}_${t}`,a=`${r}_${i}`,o=Lc[n];if(o){let s=Rc.indexOf(a);return o[s]}return Mc(a)},Oc=(e,t,r,i)=>{let n=`${e}_${t}`;if($a.includes(e)||$a.includes(n))return!0;let a=Cc[`${r}_${i}`];return a?a.includes(e)||a.includes(n)?!0:P.displayTax:P.displayTax},Ic=async(e,t,r,i)=>{let n=Oc(e,t,r,i);return{displayTax:n,forceTaxExclusive:n?Nc(e,t,r,i):P.forceTaxExclusive}},At=class At extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Ee(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi"]}static createInlinePrice(r){let i=W();if(!i)return null;let{displayOldPrice:n,displayPerUnit:a,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:m,promotionCode:p,quantity:h,alternativePrice:f,template:u,wcsOsi:v}=i.collectPriceOptions(r);return Jt(At,{displayOldPrice:n,displayPerUnit:a,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:m,promotionCode:p,quantity:h,alternativePrice:f,template:u,wcsOsi:v})}get isInlinePrice(){return!0}attributeChangedCallback(r,i,n){this.masElement.attributeChangedCallback(r,i,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ae}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}async render(r={}){if(!this.isConnected)return!1;let i=W();if(!i)return!1;let n=i.collectPriceOptions(r,this),a={...i.settings,...n};if(!a.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let[s]=await i.resolveOfferSelectors(a),c=mt(await s,a),[l]=c;if(i.featureFlags[ve]){if(n.displayPerUnit===void 0&&(a.displayPerUnit=l.customerSegment!=="INDIVIDUAL"),n.displayTax===void 0||n.forceTaxExclusive===void 0){let{country:d,language:m}=a,[p=""]=l.marketSegments,h=await Ic(d,m,l.customerSegment,p);n.displayTax===void 0&&(a.displayTax=h?.displayTax||a.displayTax),n.forceTaxExclusive===void 0&&(a.forceTaxExclusive=h?.forceTaxExclusive||a.forceTaxExclusive),a.forceTaxExclusive&&(c=mt(c,a))}}else n.displayOldPrice===void 0&&(a.displayOldPrice=!0);return this.renderOffers(c,a,o)}catch(o){throw this.innerHTML="",o}}renderOffers(r,i,n=void 0){if(!this.isConnected)return;let a=W();if(!a)return!1;if(n??(n=this.masElement.togglePending()),r.length){if(this.masElement.toggleResolved(n,r,i)){this.innerHTML=a.buildPriceHTML(r,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=a.buildPriceHTML(r,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(n,o,this.options))return this.innerHTML="",!0}return!1}};g(At,"is","inline-price"),g(At,"tag","span");var me=At;window.customElements.get(me.is)||window.customElements.define(me.is,me,{extends:me.tag});function Va({literals:e,providers:t,settings:r}){function i(o,s=null){let c={country:r.country,language:r.language,locale:r.locale,literals:{...e.price}};if(s&&t?.price)for(let M of t.price)M(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:m,displayTax:p,displayPlanType:h,forceTaxExclusive:f,perpetual:u,displayAnnual:v,promotionCode:_,quantity:y,alternativePrice:E,wcsOsi:S,...C}=Object.assign(c,s?.dataset??{},o??{});return c=jt(Object.assign({...c,...C,displayOldPrice:b(l),displayPerUnit:b(d),displayRecurrence:b(m),displayTax:b(p),displayPlanType:b(h),forceTaxExclusive:b(f),perpetual:b(u),displayAnnual:b(v),promotionCode:Wt(_).effectivePromoCode,quantity:qe(y,P.quantity),alternativePrice:b(E),wcsOsi:Kt(S)})),c}function n(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=Fa;break;case"strikethrough":l=Na;break;case"annual":l=Oa;break;case"legal":l=Ba;break;default:s.template==="optical"&&s.alternativePrice?l=Ia:s.template==="optical"?l=Ma:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode?Da:Ha:s.alternativePrice?l=ka:l=s.promotionCode?Ra:La}let[d]=o;return d={...d,...d.priceDetails},l({...r,...s},d)}let a=me.createInlinePrice;return{InlinePrice:me,buildPriceHTML:n,collectPriceOptions:i,createInlinePrice:a}}function kc({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||P.language),t??(t=e?.split("_")?.[1]||P.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function ja(e={},t){let r=t.featureFlags[ve],{commerce:i={}}=e,n=le.PRODUCTION,a=Ir,o=O("checkoutClientId",i)??P.checkoutClientId,s=pt(O("checkoutWorkflowStep",i),q,P.checkoutWorkflowStep),c=P.displayOldPrice,l=P.displayPerUnit,d=b(O("displayRecurrence",i),P.displayRecurrence),m=b(O("displayTax",i),P.displayTax),p=b(O("displayPlanType",i),P.displayPlanType),h=b(O("entitlement",i),P.entitlement),f=b(O("modal",i),P.modal),u=b(O("forceTaxExclusive",i),P.forceTaxExclusive),v=O("promotionCode",i)??P.promotionCode,_=qe(O("quantity",i)),y=O("wcsApiKey",i)??P.wcsApiKey,E=i?.env==="stage",S=be.PUBLISHED;["true",""].includes(i.allowOverride)&&(E=(O(Nr,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",S=pt(O(Or,i),be,S)),E&&(n=le.STAGE,a=kr);let M=O(Mr)??e.preview,B=typeof M<"u"&&M!=="off"&&M!=="false",j={};B&&(j={preview:B});let k=O("mas-io-url")??e.masIOUrl??`https://www${n===le.STAGE?".stage":""}.adobe.com/mas/io`,L=O("preselect-plan")??void 0;return{...kc(e),...j,displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:m,displayPlanType:p,entitlement:h,extraOptions:P.extraOptions,modal:f,env:n,forceTaxExclusive:u,promotionCode:v,quantity:_,alternativePrice:P.alternativePrice,wcsApiKey:y,wcsURL:a,landscape:S,masIOUrl:k,...L&&{preselectPlan:L}}}async function qa(e,t={},r=2,i=100){let n;for(let a=0;a<=r;a++)try{let o=await fetch(e,t);return o.retryCount=a,o}catch(o){if(n=o,n.retryCount=a,a>r)break;await new Promise(s=>setTimeout(s,i*(a+1)))}throw n}var Mi="wcs";function Wa({settings:e}){let t=ie.module(Mi),{env:r,wcsApiKey:i}=e,n=new Map,a=new Map,o,s=new Map;async function c(h,f,u=!0){let v=W(),_=Pr;t.debug("Fetching:",h);let y="",E;if(h.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let S=new Map(f),[C]=h.offerSelectorIds,M=Date.now()+Math.random().toString(36).substring(2,7),B=`${Mi}:${C}:${M}${Dr}`,j=`${Mi}:${C}:${M}${Br}`,k;try{if(performance.mark(B),y=new URL(e.wcsURL),y.searchParams.set("offer_selector_ids",C),y.searchParams.set("country",h.country),y.searchParams.set("locale",h.locale),y.searchParams.set("landscape",r===le.STAGE?"ALL":e.landscape),y.searchParams.set("api_key",i),h.language&&y.searchParams.set("language",h.language),h.promotionCode&&y.searchParams.set("promotion_code",h.promotionCode),h.currency&&y.searchParams.set("currency",h.currency),E=await qa(y.toString(),{credentials:"omit"}),E.ok){let L=[];try{let F=await E.json();t.debug("Fetched:",h,F),L=F.resolvedOffers??[]}catch(F){t.error(`Error parsing JSON: ${F.message}`,{...F.context,...v?.duration})}L=L.map(Yt),f.forEach(({resolve:F},J)=>{let fe=L.filter(({offerSelectorIds:ce})=>ce.includes(J)).flat();fe.length&&(S.delete(J),f.delete(J),F(fe))})}else _=_r}catch(L){_=`Network error: ${L.message}`}finally{k=performance.measure(j,B),performance.clearMarks(B),performance.clearMeasures(j)}if(u&&f.size){t.debug("Missing:",{offerSelectorIds:[...f.keys()]});let L=bn(E);f.forEach(F=>{F.reject(new We(_,{...h,...L,response:E,measure:kt(k),...v?.duration}))})}}function l(){clearTimeout(o);let h=[...a.values()];a.clear(),h.forEach(({options:f,promises:u})=>c(f,u))}function d(h){if(!h||typeof h!="object")throw new TypeError("Cache must be a Map or similar object");let f=r===le.STAGE?"stage":"prod",u=h[f];if(!u||typeof u!="object"){t.warn(`No cache found for environment: ${r}`);return}for(let[v,_]of Object.entries(u))n.set(v,Promise.resolve(_.map(Yt)));t.debug(`Prefilled WCS cache with ${u.size} entries`)}function m(){let h=n.size;s=new Map(n),n.clear(),t.debug(`Moved ${h} cache entries to stale cache`)}function p({country:h,language:f,perpetual:u=!1,promotionCode:v="",wcsOsi:_=[]}){let y=`${f}_${h}`;h!=="GB"&&!u&&(f="MULT");let E=[h,f,v].filter(S=>S).join("-").toLowerCase();return _.map(S=>{let C=`${S}-${E}`;if(n.has(C))return n.get(C);let M=new Promise((B,j)=>{let k=a.get(E);if(!k){let L={country:h,locale:y,offerSelectorIds:[]};h!=="GB"&&!u&&(L.language=f),k={options:L,promises:new Map},a.set(E,k)}v&&(k.options.promotionCode=v),k.options.offerSelectorIds.push(S),k.promises.set(S,{resolve:B,reject:j}),l()}).catch(B=>{if(s.has(C))return s.get(C);throw B});return n.set(C,M),M})}return{Commitment:Ae,PlanType:fn,Term:ee,applyPlanType:Yt,resolveOfferSelectors:p,flushWcsCacheInternal:m,prefillWcsCache:d}}var Ya="mas-commerce-service",Xa="mas-commerce-service:start",Ka="mas-commerce-service:ready",St,Xe,Ke,Qa,Za,Ni=class extends HTMLElement{constructor(){super(...arguments);$(this,Ke);$(this,St);$(this,Xe);g(this,"lastLoggingTime",0)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(i,n,a)=>{let o=await r?.(i,n,this.imsSignedInPromise,a);return o||null})}get featureFlags(){return T(this,Xe)||z(this,Xe,{[ve]:Lt(this,Ke,Za).call(this,ve)}),T(this,Xe)}activate(){let r=T(this,Ke,Qa),i=ja(r,this);Qt(r.lana);let n=ie.init(r.hostEnv).module("service");n.debug("Activating:",r);let o={price:Un(i)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...Hn(c),...Dn(c),...Va(c),...Wa(c),...Fr,Log:ie,get defaults(){return P},get log(){return ie},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return i}})),n.debug("Activated:",{literals:o,settings:i});let l=new CustomEvent(It,{bubbles:!0,cancelable:!1,detail:this});performance.mark(Ka),z(this,St,performance.measure(Ka,Xa)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(Xa),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(fr).forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":kt(T(this,St))}}logFailedRequests(){let r=[...performance.getEntriesByType("resource")].filter(({startTime:n})=>n>this.lastLoggingTime).filter(({transferSize:n,duration:a,responseStatus:o})=>n===0&&a===0&&o<200||o>=400),i=Array.from(new Map(r.map(n=>[n.name,n])).values());if(i.some(({name:n})=>/(\/fragment\?|web_commerce_artifact)/.test(n))){let n=i.map(({name:a})=>a);this.log.error("Failed requests:",{failedUrls:n,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};St=new WeakMap,Xe=new WeakMap,Ke=new WeakSet,Qa=function(){let r=this.getAttribute("env")??"prod",i={commerce:{env:r},hostEnv:{name:r},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:r==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview"].forEach(n=>{let a=this.getAttribute(n);a&&(i[n]=a)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(n=>{let a=this.getAttribute(n);if(a!=null){let o=n.replace(/-([a-z])/g,s=>s[1].toUpperCase());i.commerce[o]=a}}),i},Za=function(r){return["on","true",!0].includes(this.getAttribute(`data-${r}`)||O(r))};window.customElements.get(Ya)||window.customElements.define(Ya,Ni);var ro="merch-card-collection",Hc=2e4,Dc={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansThreeColumns:["three-merch-cards"]},Bc={plans:!0},Uc=(e,{filter:t})=>e.filter(r=>r?.filters&&r?.filters.hasOwnProperty(t)),Fc=(e,{types:t})=>t?(t=t.split(","),e.filter(r=>t.some(i=>r.types.includes(i)))):e,$c=e=>e.sort((t,r)=>(t.title??"").localeCompare(r.title??"","en",{sensitivity:"base"})),Gc=(e,{filter:t})=>e.sort((r,i)=>i.filters[t]?.order==null||isNaN(i.filters[t]?.order)?-1:r.filters[t]?.order==null||isNaN(r.filters[t]?.order)?1:r.filters[t].order-i.filters[t].order),zc=(e,{search:t})=>t?.length?(t=t.toLowerCase(),e.filter(r=>(r.title??"").toLowerCase().includes(t))):e,we,Ze,_t,dr,io,Qe=class extends eo{constructor(){super();$(this,dr);$(this,we,{});$(this,Ze);$(this,_t);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1}render(){return ue` <slot></slot>
    ...
    `);Qe.SortOrder=oe;customElements.define(ro,Qe);var Vc={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},jc=(e,t,r)=>{e.querySelectorAll(`[data-placeholder="${t}"]`).forEach(n=>{n.innerText=r||""})},qc={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},Wc={catalog:"l"},X,Je,Tt=class extends eo{constructor(){super();$(this,X);$(this,Je);g(this,"tablet",new et(this,H));g(this,"desktop",new et(this,N));this.collection=null,z(this,X,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(rt,this.updateLiterals),this.collection?.addEventListener(it,this.handleSidenavAttached),z(this,Je,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(rt,this.updateLiterals),this.collection?.removeEventListener(it,this.handleSidenavAttached)}willUpdate(){T(this,X).search=this.getVisibility("search"),T(this,X).filter=this.getVisibility("filter"),T(this,X).sort=this.getVisibility("sort"),T(this,X).result=this.getVisibility("result"),T(this,X).custom=this.getVisibility("custom")}parseVisibilityOptions(r,i){if(!r||!Object.hasOwn(r,i))return null;let n=r[i];return n===!1?!1:n===!0?!0:n.includes(this.currentMedia)}getVisibility(r){let i=T(this,Je).getCollectionOptions(this.collection?.variant)?.headerVisibility,n=this.parseVisibilityOptions(i,r);return n!==null?n:this.parseVisibilityOptions(qc,r)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!T(this,X).search)return se;let r=at(this,"searchText");return r?ue`
        ...
        `}get resultSlotName(){let r=`${this.search?"search":"filters"}${this.isMobile||this.isTablet?"Mobile":""}`;return Vc[r][Math.min(this.resultCount,2)]}get resultLabel(){if(!T(this,X).result)return se;if(!this.sidenav)return se;let r=this.search?"search":"filter",i=this.resultCount?this.resultCount===1?"single":"multiple":"none";return ue` <div
            id="result"
            aria-live="polite"
            type=${r}
            quantity=${i}
        ...
        </div>`}get customArea(){if(!T(this,X).custom)return se;let r=T(this,Je).getCollectionOptions(this.collection?.variant)?.customHeaderArea;if(!r)return se;let i=r(this.collection);return!i||i===se?se:ue`<div id="custom" role="heading" aria-level="2">
            ${i}
        </div>`}openFilters(r){this.sidenav.showModal(r)}updateLiterals(r){Object.keys(r.detail).forEach(i=>{jc(this,i,r.detail[i])}),this.requestUpdate()}handleSidenavAttached(){this.requestUpdate()}render(){return ue`
            <sp-theme color="light" scale="medium">
                <div id="header">
                    ${this.searchAction}${this.filterAction}${this.sortAction}${this.resultLabel}${this.customArea}
                </div>
            </sp-theme>
        `}get placeholderKeys(){return["searchText","filtersText","sortText","popularityText","alphabeticallyText","noResultText","resultText","resultsText","resultMobileText","resultsMobileText","noSearchResultsText","searchResultText","searchResultsText","noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]}};X=new WeakMap,Je=new WeakMap,g(Tt,"styles",to`
        :host {
