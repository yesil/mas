...
var ho = (e, t, r) =>
    t in e
        ...
        : (e[t] = r);
var po = (e, t) => {
    for (var r in t) ki(e, r, { get: t[r], enumerable: !0 });
};
var g = (e, t, r) => ho(e, typeof t != 'symbol' ? t + '' : t, r),
    ur = (e, t, r) => t.has(e) || Hi('Cannot ' + r);
var T = (e, t, r) => (
        ur(e, t, 'read from private field'), r ? r.call(e) : t.get(e)
    ),
    $ = (e, t, r) =>
        t.has(e)
            ? Hi('Cannot add the same private member more than once')
            : t instanceof WeakSet
              ? t.add(e)
              : t.set(e, r),
    G = (e, t, r, i) => (
        ur(e, t, 'write to private field'), i ? i.call(e, r) : t.set(e, r), r
    ),
    Lt = (e, t, r) => (ur(e, t, 'access private method'), r);
import {
    html as ue,
    LitElement as Ja,
    css as eo,
...
var et = class {
    constructor(t, r) {
        (this.key = Symbol('match-media-key')),
            ...
            (this.media = window.matchMedia(r)),
    ...
    hostDisconnected() {
        var t;
        (t = this.media) == null ||
            t.removeEventListener('change', this.onChange);
    }
    onChange(t) {
...
var Di = 'hashchange';
function mo(e = window.location.hash) {
    let t = [],
        r = e.replace(/^#/, '').split('&');
    for (let i of r) {
        let [n, a = ''] = i.split('=');
        n && t.push([n, decodeURIComponent(a.replace(/\+/g, ' '))]);
    }
...
function tt(e) {
    ...
    Object.entries(e).forEach(([n, a]) => {
        a ? t.set(n, a) : t.delete(n);
    }),
        t.sort();
    let r = t.toString();
    if (r === window.location.hash) return;
    let i = window.scrollY || document.documentElement.scrollTop;
    (window.location.hash = r), window.scrollTo(0, i);
}
function Bi(e) {
    let t = () => {
        if (window.location.hash && !window.location.hash.includes('=')) return;
        let r = mo(window.location.hash);
        e(r);
    };
    return (
        t(),
        window.addEventListener(Di, t),
        () => {
            window.removeEventListener(Di, t);
        }
    );
}
var Fr = {};
po(Fr, {
    ...
    EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED: () => rt,
    EVENT_MERCH_CARD_COLLECTION_SHOWMORE: () => br,
    EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED: () => it,
    EVENT_MERCH_CARD_COLLECTION_SORT: () => xr,
    ...
    EVENT_TYPE_READY: () => It,
    EVENT_TYPE_RESOLVED: () => Lr,
    Env: () => le,
    FF_DEFAULTS: () => ve,
    HEADER_X_REQUEST_ID: () => nt,
    LOG_NAMESPACE: () => Rr,
    Landscape: () => be,
    MARK_DURATION_SUFFIX: () => Br,
    MARK_START_SUFFIX: () => Dr,
    MODAL_TYPE_3_IN_1: () => Se,
    NAMESPACE: () => uo,
    PARAM_AOS_API_KEY: () => Lo,
    PARAM_ENV: () => Nr,
    PARAM_LANDSCAPE: () => Or,
    PARAM_MAS_PREVIEW: () => Mr,
    PARAM_WCS_API_KEY: () => Ro,
    PROVIDER_ENVIRONMENT: () => Hr,
    SELECTOR_MAS_CHECKOUT_LINK: () => Ui,
    SELECTOR_MAS_ELEMENT: () => fr,
    SELECTOR_MAS_INLINE_PRICE: () => ee,
    SELECTOR_MAS_SP_BUTTON: () => xo,
    SELECTOR_MAS_UPT_LINK: () => Fi,
    SORT_ORDER: () => oe,
    STATE_FAILED: () => ae,
    STATE_PENDING: () => xe,
    STATE_RESOLVED: () => he,
    TAG_NAME_SERVICE: () => go,
    TEMPLATE_PRICE: () => No,
    TEMPLATE_PRICE_ANNUAL: () => Io,
    TEMPLATE_PRICE_LEGAL: () => Ur,
    TEMPLATE_PRICE_STRIKETHROUGH: () => Oo,
    Term: () => J,
    WCS_PROD_URL: () => Ir,
    WCS_STAGE_URL: () => kr,
});
var Ae = Object.freeze({
    ...
    uo = 'merch',
    fo = 'hidden',
    It = 'wcms:commerce:ready',
    go = 'mas-commerce-service',
    ee = 'span[is="inline-price"][data-wcs-osi]',
    Ui =
        'a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',
    xo = 'sp-button[data-wcs-osi]',
    Fi = 'a[is="upt-link"]',
    fr = `${ee},${Ui},${Fi}`,
    bo = 'merch-offer:ready',
    vo = 'merch-offer-select:ready',
    ...
    xr = 'merch-card-collection:sort',
    rt = 'merch-card-collection:literals-changed',
    it = 'merch-card-collection:sidenav-attached',
    br = 'merch-card-collection:showmore',
    vr = 'merch-sidenav:select',
    Er = 'aem:load',
    yr = 'aem:error',
    Po = 'mas:ready',
    wr = 'mas:error',
    ...
    _r = 'Bad WCS request',
    Pr = 'Commerce offer not found',
    Co = 'Literals URL not provided',
    Cr = 'mas:failed',
    Lr = 'mas:resolved',
    Rr = 'mas/commerce',
    Mr = 'mas.preview',
    Nr = 'commerce.env',
    Or = 'commerce.landscape',
    Lo = 'commerce.aosKey',
    Ro = 'commerce.wcsKey',
    Ir = 'https://www.adobe.com/web_commerce_artifact',
    ...
    Hr = { PRODUCTION: 'PRODUCTION' },
    Se = { TWP: 'twp', D2P: 'd2p', CRM: 'crm' },
    Dr = ':start',
    Br = ':duration',
    No = 'price',
    Oo = 'price-strikethrough',
    Io = 'annual',
    Ur = 'legal',
    ve = 'mas-ff-defaults',
    oe = { alphabetical: 'alphabetical', authored: 'authored' };
var ko = 'mas-commerce-service';
var at = (e, t) => e?.querySelector(`[slot="${t}"]`)?.textContent?.trim();
function Te(e, t = {}, r = null, i = null) {
    let n = i
...
function ot() {
    return document.getElementsByTagName(ko)?.[0];
}
function st(e) {
...
import { html as Ht, nothing as Ho } from '/deps/lit-all.min.js';
var He,
    ct = class ct {
        constructor(t) {
            g(this, 'card');
        ...
        insertVariantStyle() {
            if (!ct.styleMap[this.card.variant]) {
                ct.styleMap[this.card.variant] = !0;
        ...
        get secureLabel() {
            return this.card.secureLabel
                ? Ht`<span class="secure-transaction-label"
        ...
        get aemFragmentMapping() {
            return Dt(this.card.variant);
        }
    };
(He = new WeakMap()), g(ct, 'styleMap', {});
var I = ct;
import { html as $r, css as Do } from '/deps/lit-all.min.js';
var Gi = `
:root {
...
var zi = {
    ...
    De = class extends I {
        constructor(r) {
            super(r);
            g(this, 'dispatchActionMenuToggle', () => {
            ...
            g(this, 'toggleActionMenuFromCard', (r) => {
...
import { html as lt } from '/deps/lit-all.min.js';
var Vi = `
:root {
    ...
    renderLayout() {
        return lt`${this.cardImage}
            <div class="body">
                ...
                ${
                    this.promoBottom
                        ? lt`<slot name="body-xs"></slot
                          ><slot name="promo-text"></slot>`
                        : lt`<slot name="promo-text"></slot
                          ><slot name="body-xs"></slot>`
                }
            </div>
            ${
...
import { html as qi } from '/deps/lit-all.min.js';
var ji = `
:root {
...
var Ut = class extends I {
    ...
    renderLayout() {
        return qi` ${this.badge}
            ...
            ${this.card.customHr ? '' : qi`<hr />`} ${this.secureLabelFooter}`;
    }
};
import { html as Be, css as Bo, unsafeCSS as Yi } from '/deps/lit-all.min.js';
var Wi = `
  :root {
...
var Uo = 32,
    Ue = class extends I {
        constructor(r) {
            ...
            g(this, 'getMiniCompareFooter', () => {
                let r = this.card.secureLabel
                    ? Be`<slot name="secure-transaction-label">
                  <span class="secure-transaction-label"
                      >${this.card.secureLabel}</span
                  ></slot
              >`
                    : Be`<slot name="secure-transaction-label"></slot>`;
                return Be`<footer>${r}<slot name="footer"></slot></footer>`;
            });
        }
        getGlobalCSS() {
            return Wi;
        ...
        get mainPrice() {
            return this.card.querySelector(
                `[slot="heading-m-price"] ${ee}[data-template="price"]`,
            );
        }
        ...
        renderLayout() {
            return Be` <div class="top-section${this.badge ? ' badge' : ''}">
                <slot name="icons"></slot> ${this.badge}
            </div>
            <slot name="heading-m"></slot>
            ${
                this.card.classList.contains('bullet-list')
                    ? Be`<slot name="heading-m-price"></slot>
                      <slot name="price-commitment"></slot>
                      <slot name="body-xxs"></slot>
                      <slot name="promo-text"></slot>
                      <slot name="body-m"></slot>
                      <slot name="offers"></slot>`
                    : Be`<slot name="body-m"></slot>
...
import { html as ht, css as Fo, nothing as Ft } from '/deps/lit-all.min.js';
var Xi = `
:root {
...
var $t = {
    ...
    Ki = {
        ...(function () {
            let { whatsIncluded: e, size: t, ...r } = $t;
            return r;
        })(),
    ...
    q = class extends I {
        ...
        adjustSlotPlacement(t, r, i) {
            ...
            if (
                ...
                if ((a?.classList.toggle('wide-footer', Ot()), !i && s)) {
                    if (c) s.remove();
                    else {
                        let h = l.querySelector(
                            `[data-placeholder-for="${t}"]`,
                        );
                        h ? h.replaceWith(s) : l.appendChild(s);
                    }
                    return;
                }
                if (i && c) {
                    ...
                    if (
                        (h.setAttribute('data-placeholder-for', t),
                        h.classList.add('slot-placeholder'),
                        !s)
                    ) {
                        let m = c.cloneNode(!0);
                        a.prepend(m);
        ...
        adaptForMedia() {
            ...
            this.adjustSlotPlacement('addon', ['super-wide'], Ot()),
        ...
        async adjustEduLists() {
            ...
            let o = new IntersectionObserver(([s]) => {
                ...
                l && (c += st(l));
                let h = this.card.querySelector('[slot="subtitle"]');
                h && (c += st(h));
                let m = this.card.querySelector('[slot="heading-m"]');
                m && (c += 8 + st(m));
                for (let d of r.childNodes) {
                    if (d.classList.contains('spacer')) break;
                    c += st(d);
                }
                let p = this.card.parentElement.style.getPropertyValue(
        ...
        get mainPrice() {
            return this.headingM.querySelector(`${ee}[data-template="price"]`);
        }
        get divider() {
            return this.card.variant === 'plans-education'
                ? ht`<div class="divider"></div>`
                : Ft;
        }
        async adjustLegal() {
                ...
                try {
                    ...
                    let t = [],
                        r = this.card.querySelector(
                            `[slot="heading-m"] ${ee}[data-template="price"]`,
                        );
                    r && t.push(r);
                    let i = t.map(async (n) => {
                        let a = n.cloneNode(!0);
...
g(
    ...
    g(q, 'collectionOptions', {
        customHeaderArea: (t) =>
            t.sidenav ? ht`<slot name="resultsText"></slot>` : Ft,
        headerVisibility: {
            search: !1,
            sort: !1,
...
var Fe = class extends I {
    ...
    postCardUpdateHook() {
        this.card.isConnected &&
            (this.adjustAddon(),
            Nt() || this.adjustProductBodySlots(),
            this.adjustTitleWidth());
    }
    get headingXSSlot() {
        return this.card.shadowRoot
    ...
    get mainPrice() {
        return this.card.querySelector(
            `[slot="heading-xs"] ${ee}[data-template="price"]`,
        );
    }
    toggleAddon(t) {
        let r = this.mainPrice,
...
import { html as zr, css as Go } from '/deps/lit-all.min.js';
var Ji = `
:root {
...
import { html as Vr, css as zo } from '/deps/lit-all.min.js';
var en = `
:root {
...
import { html as Vo, css as jo } from '/deps/lit-all.min.js';
var rn = `
:root {
...
`;
var Gt = () => window.matchMedia(ne).matches,
    jr = {
        ...
        setupAccordion() {
            ...
            (this.mediaQueryListener = () => {
                ...
                (this.attributeObserver = new MutationObserver((n) => {
                    n.forEach((a) => {
                        a.type === 'attributes' &&
                            a.attributeName === 'data-default-card' &&
                            this.card.hasAttribute('data-default-card') &&
                            Gt() &&
                            this.card.setAttribute('data-expanded', 'true');
                    });
...
import { css as qo, html as Wo } from '/deps/lit-all.min.js';
var nn = `
...
var an = {
    ...
    Ve = class extends I {
        ...
        adjustLegal() {
            ...
            let r = this.card.querySelector(`${ee}[data-template="price"]`);
            if (!r) return;
            let i = r.cloneNode(!0);
            (this.legal = i),
...
te('catalog', De, zi, De.variantStyle);
te('image', Bt);
...
te('special-offers', Ge, tn, Ge.variantStyle);
te('simplified-pricing-express', ze, jr, ze.variantStyle);
te('mini', Ve, an, Ve.variantStyle);
function Dt(e) {
    return on.get(e)?.fragmentMapping;
}
var sn = 'tacocat.js';
var qr = (e, t) =>
...
function mt(e, { country: t, forceTaxExclusive: r }) {
    let i;
    if (e.length < 2) i = e;
    else {
        let n = t === 'GB' ? 'EN' : 'MULT';
    ...
    return r && (i = i.map(gn)), i;
}
var Xt = (e) => window.setTimeout(e);
function qe(e, t = 1) {
    if (e == null) return [t];
    let r = (Array.isArray(e) ? e : String(e).split(',')).map(dn).filter(dt);
    return r.length || (r = [t]), r;
}
function Kt(e) {
    return e == null
        ? []
        : (Array.isArray(e) ? e : String(e).split(',')).filter(hn);
}
function W() {
    return document.getElementsByTagName(ss)?.[0];
}
function xn(e) {
    let t = {};
    if (!e?.headers) return t;
    let r = e.headers;
    for (let [i, n] of Object.entries(cs)) {
        let a = r.get(n);
        a &&
            ((a = a.replace(/[,;]/g, '|')),
            (a = a.replace(/[| ]+/g, '|')),
...
function vn(e) {
    ...
    if (t === 'object') {
        ...
        if (!_e.serializableTypes.includes(r)) return r;
    }
    return e;
}
function hs(e, t) {
    if (!_e.ignoredProperties.includes(e)) return vn(t);
}
var ni = {
    append(e) {
        ...
        let { message: t, params: r } = e,
            ...
            a = t;
        r.forEach((l) => {
            l != null && (ls(l) ? i : n).push(l);
        }),
            i.length && (a += ' ' + i.map(vn).join(' '));
        let { pathname: o, search: s } = window.location,
            c = `${_e.delimiter}page=${o}${s}`;
        c.length > bn && (c = `${c.slice(0, bn)}<trunc>`),
            (a += c),
            n.length &&
                ((a += `${_e.delimiter}facts=`), (a += JSON.stringify(n, hs))),
...
var En = { LOCAL: 'local', PROD: 'prod', STAGE: 'stage' },
    ai = { DEBUG: 'debug', ERROR: 'error', INFO: 'info', WARN: 'warn' },
    oi = new Set(),
    si = new Set(),
    yn = new Map(),
    wn = {
...
function ms(e) {
    [...si].every((t) => t(e)) && oi.forEach((t) => t(e));
}
function Sn(e) {
    let t = (yn.get(e) ?? 0) + 1;
    yn.set(e, t);
...
var We = class e extends Error {
    constructor(t, r, i) {
        if ((super(t, { cause: i }), (this.name = 'MasError'), r.response)) {
            let n = r.response.headers?.get(nt);
            n && (r.requestId = n),
                r.response.status &&
...
var gs = { [ae]: Ar, [xe]: Sr, [he]: Tr },
    ...
    Ee = class {
        constructor(t) {
            ...
            g(this, 'value');
            g(this, 'version', 0);
            g(this, 'wrapperElement');
            (this.wrapperElement = t), (this.log = ie.module('mas-element'));
        }
        update() {
            [ae, xe, he].forEach((t) => {
                this.wrapperElement.classList.toggle(gs[t], t === this.state);
            });
        }
        notify() {
            (this.state === he || this.state === ae) &&
                (this.state === he
                ...
                (this.promises = []));
            let t = this.error;
            this.error instanceof We &&
                (t = { message: this.error.message, ...this.error.context }),
                this.wrapperElement.dispatchEvent(
                    new CustomEvent(xs[this.state], { bubbles: !0, detail: t }),
                );
        }
        ...
        connectedCallback() {
            G(this, ut, W()), this.requestUpdate(!0);
        }
        ...
        requestUpdate(t = !1) {
            if (!this.wrapperElement.isConnected || !W() || this.timer) return;
...
function Jt(e, t = {}) {
    ...
    return n.setAttribute('is', i), Object.assign(n.dataset, Tn(t)), n;
}
function _n(e, t = {}) {
    return e instanceof HTMLElement
        ? (Object.assign(e.dataset, Tn(t)), e)
        : null;
}
function bs(e) {
...
var Le,
    Pe = class Pe extends HTMLAnchorElement {
        constructor() {
            super();
            g(this, 'masElement', new Ee(this));
            $(this, Le);
            this.setAttribute('is', Pe.is);
        }
        get isUptLink() {
            return !0;
        }
        ...
        connectedCallback() {
            this.masElement.connectedCallback(),
                G(this, Le, ot()),
                T(this, Le) && (this.log = T(this, Le).log.module('upt-link'));
        }
        disconnectedCallback() {
            this.masElement.disconnectedCallback(), G(this, Le, void 0);
        }
        requestUpdate(r = !1) {
        ...
        async render() {
            ...
            try {
                let [[o]] = await Promise.all(a),
                    ...
                    h = `locale=${c}_${s}&country=${s}&offer_id=${o.offerId}`,
                    m = this.getAttribute('data-promotion-code');
                m && (h += `&promotion_code=${encodeURIComponent(m)}`),
                    (this.href = `${bs(l)}?${h}`),
...
(Le = new WeakMap()),
    g(Pe, 'is', 'upt-link'),
    g(Pe, 'tag', 'a'),
    g(Pe, 'observedAttributes', [
        'data-wcs-osi',
        'data-promotion-code',
        'data-ims-country',
    ]);
var Ce = Pe;
window.customElements.get(Ce.is) ||
    window.customElements.define(Ce.is, Ce, { extends: Ce.tag });
function Pn(e) {
    return e && (e.startsWith('plans') ? 'plans' : e);
}
var Cn = 'download',
    Ln = 'upgrade',
    Rn = { e: 'EDU', t: 'TEAM' };
function Mn(e, t = {}, r = '') {
    ...
    return (
        r && (v.innerHTML = `<span style="pointer-events: none;">${r}</span>`),
        v
    );
}
function Nn(e) {
    return class extends e {
        ...
        get is3in1Modal() {
            return Object.values(Se).includes(this.getAttribute('data-modal'));
        }
        get isOpen3in1Modal() {
        ...
        async render(i = {}) {
            ...
            if (!n) return !1;
            this.dataset.imsCountry ||
                n.imsCountryPromise.then((m) => {
                    m && (this.dataset.imsCountry = m);
                }),
                (i.imsCountry = null);
            ...
            let h = await n.buildCheckoutAction?.(
                l.flat(),
                { ...o, ...a },
                this,
            );
            return this.renderOffers(l.flat(), a, {}, h, s);
        }
        renderOffers(i, n, a = {}, o = void 0, s = void 0) {
            ...
            if (
                ...
                this.classList.remove(Cn, Ln),
                    this.masElement.toggleResolved(s, i, n);
                let { url: h, text: m, className: p, handler: d } = o;
                h && this.setCheckoutUrl(h),
                    m && (this.firstElementChild.innerHTML = m),
                    p && this.classList.add(...p.split(' ')),
                    d &&
                        (this.setCheckoutUrl('#'),
                        (this.checkoutActionHandler = d.bind(this)));
            }
            if (i.length) {
                if (this.masElement.toggleResolved(s, i, n)) {
                    if (
                        !this.classList.contains(Cn) &&
                        !this.classList.contains(Ln)
                    ) {
                        let h = c.buildCheckoutURL(i, n);
                        this.setCheckoutUrl(n.modal === 'true' ? '#' : h);
                    }
                    return !0;
                }
            } else {
                let h = new Error(`Not provided: ${n?.wcsOsi ?? '-'}`);
                if (this.masElement.toggleFailed(s, h, n))
...
var ft = class ft extends Nn(HTMLAnchorElement) {
...
function Ts({ url: e, modal: t, is3in1: r }) {
    ...
    return (
        ...
        e.searchParams.get('cli') !== 'doc_cloud' &&
            e.searchParams.set('cli', t === Se.CRM ? 'creative' : 'mini_plans'),
        e
    );
}
function In(e) {
    ...
    if (
        ((d.pathname = `${Es}${i}`),
        i !== j.SEGMENTATION &&
            i !== j.CHANGE_PLAN_TEAM_PLANS &&
            Ss(r, d.searchParams),
        li({ ...p }, d.searchParams, ci),
        c === be.DRAFT && li({ af: vs }, d.searchParams, ci),
        i === j.SEGMENTATION)
    ) {
        let f = {
            marketSegment: n,
            ...
            addonProductArrangementCode: s
                ? r?.find((u) => u.productArrangementCode !== s)
                      ?.productArrangementCode
                : r?.[1]?.productArrangementCode,
        };
        m?.toLowerCase() === 'edu'
            ? d.searchParams.set('ms', 'EDU')
            : m?.toLowerCase() === 'team' && d.searchParams.set('cs', 'TEAM'),
            li(f, d.searchParams, ci),
            d.searchParams.get('ot') === 'PROMOTION' &&
                d.searchParams.delete('ot'),
            (d = Ts({ url: d, modal: l, is3in1: h }));
    }
    return d.toString();
}
function _s(e) {
    ...
    if (
        e.workflowStep !== j.SEGMENTATION &&
        e.workflowStep !== j.CHANGE_PLAN_TEAM_PLANS &&
        !e.items
    )
...
function kn({ settings: e, providers: t }) {
    function r(a, o) {
        let {
                checkoutClientId: s,
        ...
        return (
            (u = jt({
                ...
                modal: V,
                perpetual: b(k),
                promotionCode: Wt(L).effectivePromoCode,
                wcsOsi: Kt(F),
                preselectPlan: d,
            })),
            u
    ...
    function i(a, o) {
        ...
        let { env: s, landscape: c } = e,
            ...
            S =
                Object.values(Se).includes(o.modal) &&
                (!E || E.content !== 'off'),
            C = window.frameElement || S ? 'if' : 'fp',
            [
                {
                    productArrangementCode: M,
                    marketSegments: [B],
                    customerSegment: V,
                    offerType: k,
                },
...
function Ps({ interval: e = 200, maxAttempts: t = 25 } = {}) {
    let r = ie.module('ims');
...
var Dn = window.masPriceLiterals;
function Bn(e) {
    if (Array.isArray(Dn)) {
...
function qn(e) {
    ...
    for (
        var t = e.split(Gn).filter(function (p) {
                return p.length > 0;
            }),
            r = [],
            i = 0,
        ...
        for (var s = o[0], c = o.slice(1), l = 0, h = c; l < h.length; l++) {
            var m = h[l];
...
function Kn(e) {
    for (var t = {}, r = 0, i = e; r < i.length; r++) {
        ...
        switch (n.stem) {
            ...
            case 'measure-unit':
            case 'unit':
                (t.style = 'unit'), (t.unit = Ms(n.options[0]));
                continue;
            case 'compact-short':
            case 'K':
            ...
            case 'integer-width':
                ...
                n.options[0].replace(Ns, function (c, l, h, m, p, d) {
                    if (l) t.minimumIntegerDigits = h.length;
                    else {
                        if (m && p)
                            throw new Error(
        ...
        if (zn.test(n.stem)) {
            ...
            n.stem.replace(zn, function (c, l, h, m, p, d) {
                return (
                    h === '*'
                        ...
                        : m && m[0] === '#'
                          ...
                          : p && d
                            ? ((t.minimumFractionDigits = p.length),
                              (t.maximumFractionDigits = p.length + d.length))
                            : ((t.minimumFractionDigits = l.length),
...
function Is(e) {
    ...
    var n = bt[i || ''] || bt[r || ''] || bt[''.concat(r, '-001')] || bt['001'];
    return n[0];
}
var mi,
...
var xi;
    ...
    ? ((ui = ra('([^\\p{White_Space}\\p{Pattern_Syntax}]*)', 'yu')),
      (xi = function (t, r) {
          var i;
          ui.lastIndex = r;
          var n = ui.exec(t);
    ...
    : (xi = function (t, r) {
          for (var i = []; ; ) {
              var n = ta(t, r);
              if (n === void 0 || na(n) || Xs(n)) break;
              i.push(n), (r += n >= 65536 ? 2 : 1);
          }
          return gi.apply(void 0, i);
      });
var ui,
    ia = (function () {
        function e(t, r) {
        ...
        return (
            ...
            (e.prototype.tryParsePluralOrSelectOptions = function (t, r, i, n) {
                for (
                    ...
                    if (f.err) return f;
                    var u = this.tryParseArgumentClose(d);
                    if (u.err) return u;
                    s.push([
                        l,
            ...
            (e.prototype.bumpSpace = function () {
                for (; !this.isEOF() && na(this.char()); ) this.bump();
            }),
...
function vi(e) {
    e.forEach(function (t) {
        if ((delete t.location, nr(t) || ar(t)))
            for (var r in t.options)
                delete t.options[r].location, vi(t.options[r].value);
        else
            (tr(t) && sr(t.style)) || ((rr(t) || ir(t)) && xt(t.style))
...
function aa(e, t) {
    ...
    return t?.captureLocation || vi(r.val), r.val;
}
function vt(e, t) {
...
function Js(e, t) {
    return Ei(e, this, oa, t.cache.create(), t.serializer);
}
var ec = function () {
...
function rc(e) {
    return e.length < 2
        ...
        : e.reduce(function (t, r) {
              var i = t[t.length - 1];
              return (
                  !i || i.type !== z.literal || r.type !== z.literal
                      ? t.push(r)
                      : (i.value += r.value),
                  t
              );
...
function yt(e, t, r, i, n, a, o) {
    if (e.length === 1 && di(e[0]))
        return [{ type: z.literal, value: e[0].value }];
    for (var s = [], c = 0, l = e; c < l.length; c++) {
        var h = l[c];
        if (di(h)) {
            s.push({ type: z.literal, value: h.value });
            continue;
        }
        if (Fn(h)) {
            typeof a == 'number' &&
    ...
    function e(t, r, i, n) {
        ...
        if (
            ...
            (this.format = function (o) {
                ...
                var c = s.reduce(function (l, h) {
                    return (
                        !l.length ||
                        h.type !== z.literal ||
                        typeof l[l.length - 1] != 'string'
                            ? l.push(h.value)
                            : (l[l.length - 1] += h.value),
                        l
                    );
                }, []);
        ...
        (this.formats = ac(e.formats, i)),
            (this.formatters = (n && n.formatters) || oc(this.formatterCache));
    }
    return (
...
var ua = '.',
    ...
    bc = (e) => {
        let t = Ec(e),
            r = gc(e, t),
            i = e.replace(/'.*?'/, ''),
            n = ga.test(i) || xa.test(i);
        return { currencySymbol: t, isCurrencyFirst: r, hasCurrencySpace: n };
    },
    va = (e) => e.replace(ga, fa).replace(xa, fa),
    vc = (e) => (e.match(/#(.?)#/)?.[1] === ua ? mc : ua),
    Ec = (e) => e.match(/'(.*?)'/)?.[1] ?? '',
    Ea = (e) => e.match(/0(.?)0/)?.[1] ?? '';
function Ye(
    ...
    let { currencySymbol: o, isCurrencyFirst: s, hasCurrencySpace: c } = bc(e),
        l = r ? Ea(e) : '',
        h = xc(e, r),
        m = r ? 2 : 0,
        p = a(t, { currencySymbol: o }),
        d = i
...
var ya = (e) => {
        let { commitment: t, term: r, usePrecision: i } = e,
            n = uc[r] ?? 1;
        return Ye(e, n > 1 ? Ne.MONTH : _i[t]?.[r], (a) => {
            let o = { divisor: n, price: a, usePrecision: i },
                { round: s } = fc.find(({ accept: c }) => c(o));
            if (!s)
                throw new Error(
        ...
        if (t === Ae.YEAR && c === J.MONTHLY) {
            ...
            let {
                displaySummary: {
                    outcomeType: l,
                    duration: h,
                    minProductQuantity: m = 1,
                } = {},
            } = o;
            switch (l) {
                case 'PERCENTAGE_DISCOUNT':
                    if (s >= m && ba(o, r)) {
                        let p = parseInt(h.replace('P', '').replace('M', ''));
                        if (isNaN(p)) return Si(i);
                        let d = s * n * p,
                            f = s * a * (12 - p),
                            u = Math.round((d + f) * 100) / 100;
                        return Ye({ ...e, price: u }, Ne.YEAR);
                    }
                default:
                    return Ye(e, Ne.YEAR, () => Si(a ?? i));
            }
        }
        return Ye(e, _i[t]?.[c]);
    };
...
function Sc(
    ...
    let d = U(D.currencySymbol, i),
        f = U(D.currencySpace, o ? '&nbsp;' : ''),
        u = '';
    return (
        t
            ? (u = `<sr-only class="strikethrough-aria-label">${t}</sr-only>`)
            : r && (u = `<sr-only class="alt-aria-label">${r}</sr-only>`),
        c && (u += d + f),
        (u += U(D.integer, s)),
        (u += U(D.decimalsDelimiter, a)),
        (u += U(D.decimals, n)),
        c || (u += f + d),
        (u += U(D.recurrence, l, null, !0)),
        (u += U(D.unitType, h, null, !0)),
        (u += U(D.taxInclusivity, m, !0)),
        U(e, u, { ...p })
    );
}
var Y =
        ...
        (
            ...
            Object.entries({
                ...
                if (lo == null)
                    throw new Error(
                        `Argument "${co}" is missing for osi ${u?.toString()}, country ${a}, language ${h}`,
                    );
            });
            let k = { ...Pi, ...m },
            ...
            b(s) &&
                ce &&
                (mr = pe(k, L, ye.recurrenceLabel, { recurrenceTerm: ce }));
            let Pt = '';
            b(c) &&
                (d && (Pt += ' '),
                (Pt += pe(k, L, ye.perUnitLabel, { perUnit: 'LICENSE' })));
            let Ct = '';
            b(l) &&
                S &&
                (d && (Ct += ' '),
                (Ct += pe(
                    k,
                    L,
                    E === Ci ? ye.taxExclusiveLabel : ye.taxInclusiveLabel,
                    { taxTerm: S },
                ))),
                r &&
                    (dr = pe(k, L, ye.strikethroughAriaLabel, {
                        strikethroughPrice: dr,
                    })),
                e &&
                    (pr = pe(k, L, ye.alternativePriceAriaLabel, {
                        alternativePrice: pr,
                    }));
            let Ie = D.container;
            if (
                (t && (Ie += ' ' + D.containerOptical),
                r && (Ie += ' ' + D.containerStrikethrough),
                e && (Ie += ' ' + D.containerAlternative),
                i && (Ie += ' ' + D.containerAnnual),
                b(o))
            )
                return Sc(
                    Ie,
                    {
                        ...Oe,
                        accessibleLabel: dr,
                        altAccessibleLabel: pr,
                        recurrenceLabel: mr,
                        perUnitLabel: Pt,
                        taxInclusivityLabel: Ct,
                    },
                    V,
                );
            let {
                ...
                ke = [ao, no, io];
            oo
                ? (ke.unshift(Ii ? '\xA0' : ''), ke.unshift(Oi))
                : (ke.push(Ii ? '\xA0' : ''), ke.push(Oi)),
                ke.push(mr, Pt, Ct);
            let so = ke.join('');
            return U(Ie, so, V);
        },
    Sa = () => (e, t, r) => {
        let n =
            (e.displayOldPrice === void 0 || b(e.displayOldPrice)) &&
            t.priceWithoutDiscount &&
            t.priceWithoutDiscount != t.price;
        return `${n ? Y({ displayStrikethrough: !0 })(e, t, r) + '&nbsp;' : ''}${Y({ isAlternativePrice: n })(e, t, r)}`;
    },
    Ta = () => (e, t, r) => {
        let { instant: i } = e;
        try {
        ...
        let n = { ...e, displayTax: !1, displayPerUnit: !1 },
            o =
                ...
                t.priceWithoutDiscount &&
                t.priceWithoutDiscount != t.price;
        return `${o ? Y({ displayStrikethrough: !0 })(n, t, r) + '&nbsp;' : ''}${Y({ isAlternativePrice: o })(e, t, r)}${U(D.containerAnnualPrefix, '&nbsp;(')}${Y({ displayAnnual: !0, instant: i })(n, t, r)}${U(D.containerAnnualSuffix, ')')}`;
    },
    _a = () => (e, t, r) => {
...
var Pa = (
    ...
    let h = { ...Pi, ...a },
        ...
        p = '';
    b(t) && (p = pe(h, m, lr.perUnitLabel, { perUnit: 'LICENSE' }));
    let d = '';
    e === 'US' && n === 'en' && (r = !1),
        b(r) &&
            s &&
            (d = pe(
                h,
                m,
                o === Ci ? lr.taxExclusiveLabel : lr.taxInclusiveLabel,
                { taxTerm: s },
            ));
    let f = '';
...
var Ca = Y(),
    La = Sa(),
    Ra = Y({ displayOptical: !0 }),
    Ma = Y({ displayStrikethrough: !0 }),
    Na = Y({ displayAnnual: !0 }),
    Oa = Y({ displayOptical: !0, isAlternativePrice: !0 }),
    Ia = Y({ isAlternativePrice: !0 }),
    ka = _a(),
    Ha = Ta(),
    Da = Pa;
var _c = (e, t) => {
        if (!(!dt(e) || !dt(t))) return Math.floor(((t - e) / t) * 100);
    },
    Ba = () => (e, t) => {
...
var $a = 'INDIVIDUAL_COM',
    ...
    Pc = {
        ...
        [Li]: ['MU_en', 'LT_lt', 'LV_lv', 'NG_en', 'CO_es', 'KR_ko'],
        [Ga]: ['LT_lt', 'LV_lv', 'SA_en', 'SG_en'],
        [Ri]: ['SG_en', 'KR_ko'],
    },
    Cc = {
        MU_en: [!1, !1, !1, !1],
    ...
    Nc = (e, t, r, i) => {
        let n = `${e}_${t}`;
        if (Fa.includes(e) || Fa.includes(n)) return !0;
        let a = Pc[`${r}_${i}`];
        return a
    ...
    At = class At extends HTMLSpanElement {
        ...
        get isFailed() {
            return this.masElement.state === ae;
        }
        requestUpdate(r = !1) {
            ...
            try {
                ...
                if (i.featureFlags[ve]) {
                    if (
                        ...
                        let { country: h, language: m } = a,
                            [p = ''] = l.marketSegments,
                            d = await Oc(h, m, l.customerSegment, p);
                        n.displayTax === void 0 &&
                            (a.displayTax = d?.displayTax || a.displayTax),
                            n.forceTaxExclusive === void 0 &&
                                (a.forceTaxExclusive =
                                    d?.forceTaxExclusive ||
                                    a.forceTaxExclusive),
                            a.forceTaxExclusive && (c = mt(c, a));
                    }
...
function za({ literals: e, providers: t, settings: r }) {
    function i(o, s = null) {
        ...
        if (s && t?.price) for (let M of t.price) M(s, c);
        let {
            displayOldPrice: l,
            displayPerUnit: h,
            displayRecurrence: m,
                ...
                s.template === 'optical' && s.alternativePrice
                    ...
                    : s.template === 'optical'
                      ...
                      : s.displayAnnual && o[0].planType === 'ABM'
                        ? (l = s.promotionCode ? Ha : ka)
                        : s.alternativePrice
                          ? (l = Ia)
                          : (l = s.promotionCode ? La : Ca);
        }
        let [h] = o;
        return (h = { ...h, ...h.priceDetails }), l({ ...r, ...s }, h);
    }
    let a = me.createInlinePrice;
    return {
        InlinePrice: me,
        buildPriceHTML: n,
...
function Va(e = {}, t) {
    ...
    ['true', ''].includes(i.allowOverride) &&
        ((E =
            (O(Nr, i, { metadata: !1 })?.toLowerCase() ?? i?.env) === 'stage'),
        (S = pt(O(Or, i), be, S))),
        E && ((n = le.STAGE), (a = kr));
    let M = O(Mr) ?? e.preview,
        B = typeof M < 'u' && M !== 'off' && M !== 'false',
        V = {};
    B && (V = { preview: B });
    let k =
            O('mas-io-url') ??
...
async function ja(e, t = {}, r = 2, i = 100) {
    let n;
    for (let a = 0; a <= r; a++)
        try {
...
function qa({ settings: e }) {
    ...
    async function c(d, f, u = !0) {
        ...
        try {
            if (
                (performance.mark(B),
                (y = new URL(e.wcsURL)),
                y.searchParams.set('offer_selector_ids', C),
                y.searchParams.set('country', d.country),
                y.searchParams.set('locale', d.locale),
                y.searchParams.set(
                    'landscape',
                    r === le.STAGE ? 'ALL' : e.landscape,
                ),
                y.searchParams.set('api_key', i),
                d.language && y.searchParams.set('language', d.language),
                d.promotionCode &&
                    y.searchParams.set('promotion_code', d.promotionCode),
                d.currency && y.searchParams.set('currency', d.currency),
                (E = await ja(y.toString(), { credentials: 'omit' })),
                E.ok)
            ) {
                let L = [];
                try {
                    let F = await E.json();
                    t.debug('Fetched:', d, F), (L = F.resolvedOffers ?? []);
                } catch (F) {
                    t.error(`Error parsing JSON: ${F.message}`, {
                        ...F.context,
                        ...v?.duration,
                    });
                }
        ...
        if (u && f.size) {
            t.debug('Missing:', { offerSelectorIds: [...f.keys()] });
            let L = xn(E);
            f.forEach((F) => {
                F.reject(
                    new We(_, {
    ...
    function l() {
        clearTimeout(o);
        let d = [...a.values()];
        a.clear(), d.forEach(({ options: f, promises: u }) => c(f, u));
    }
    function h(d) {
        if (!d || typeof d != 'object')
            throw new TypeError('Cache must be a Map or similar object');
        let f = r === le.STAGE ? 'stage' : 'prod',
            u = d[f];
    ...
    function m() {
        ...
        (s = new Map(n)),
            n.clear(),
            t.debug(`Moved ${d} cache entries to stale cache`);
    }
    function p({
        country: d,
        language: f,
        ...
        return _.map((S) => {
            ...
            let M = new Promise((B, V) => {
                let k = a.get(E);
                if (!k) {
                    let L = { country: d, locale: y, offerSelectorIds: [] };
                    d !== 'GB' && !u && (L.language = f),
                        (k = { options: L, promises: new Map() }),
                        a.set(E, k);
                }
                v && (k.options.promotionCode = v),
                    k.options.offerSelectorIds.push(S),
                    k.promises.set(S, { resolve: B, reject: V }),
                    l();
            }).catch((B) => {
    ...
    return {
        ...
        Term: J,
        applyPlanType: Yt,
        resolveOfferSelectors: p,
        flushWcsCacheInternal: m,
        prefillWcsCache: h,
    };
}
var Wa = 'mas-commerce-service',
    Ya = 'mas-commerce-service:start',
    Xa = 'mas-commerce-service:ready',
    St,
    Xe,
    Ke,
    Ka,
    ...
    Ni = class extends HTMLElement {
        ...
        activate() {
                ...
                Object.getOwnPropertyDescriptors({
                    ...
                    get providers() {
                        return {
                            ...
                            price(h) {
                                return s.price.add(h), () => s.price.delete(h);
                            },
                            has: (h) => s.price.has(h) || s.checkout.has(h),
                        };
                    },
                    get settings() {
                        return i;
            ...
            let l = new CustomEvent(It, {
                bubbles: !0,
                cancelable: !1,
                detail: this,
            });
            performance.mark(Xa),
                G(this, St, performance.measure(Xa, Ya)),
        ...
        connectedCallback() {
            performance.mark(Ya), this.activate();
        }
        flushWcsCache() {
        ...
        get duration() {
            return { 'mas-commerce-service:measure': kt(T(this, St)) };
        }
        logFailedRequests() {
    ...
    $c = (e, { filter: t }) =>
        e.sort((r, i) =>
            i.filters[t]?.order == null || isNaN(i.filters[t]?.order)
                ? -1
                : r.filters[t]?.order == null || isNaN(r.filters[t]?.order)
                  ? 1
    ...
    Qe = class extends Ja {
        constructor() {
            ...
            (this.id = null),
                ...
                (this.literalsHandlerAttached = !1);
        }
        render() {
            return ue` <slot></slot>
            ${this.footer}`;
        ...
        updated(r) {
            ...
            let i = window.scrollY || document.documentElement.scrollTop,
                n = [...this.children].filter(
                    (l) => l.tagName === 'MERCH-CARD',
                );
            ...
            if (((this.resultCount = s.length), this.page && this.limit)) {
                let l = this.page * this.limit;
                (this.hasMore = s.length > l), (s = s.filter(([, h]) => h < l));
            }
            let c = new Map(s.reverse());
            for (let l of c.keys()) this.prepend(l);
            n.forEach((l) => {
                c.has(l)
                    ? ((l.size = l.filters[this.filter]?.size),
                      l.style.removeProperty('display'),
                      l.requestUpdate())
                    : ((l.style.display = 'none'), (l.size = void 0));
            }),
                window.scrollTo(0, i),
                this.updateComplete.then(() => {
                    this.dispatchLiteralsChanged(),
                        this.sidenav &&
                            !this.literalsHandlerAttached &&
                            (this.sidenav.addEventListener(vr, () => {
                                this.dispatchLiteralsChanged();
                            }),
                            (this.literalsHandlerAttached = !0));
                });
        }
        ...
        async init() {
            await this.hydrate(),
                (this.sidenav =
                    this.parentElement.querySelector('merch-sidenav')),
                this.filtered
                    ? ((this.filter = this.filtered), (this.page = 1))
                    : this.startDeeplink(),
                this.initializePlaceholders();
        }
        disconnectedCallback() {
            super.disconnectedCallback(), this.stopDeeplink?.();
        }
        initializeHeader() {
            let r = document.createElement('merch-card-collection-header');
            (r.collection = this),
                r.classList.add(this.variant),
                this.parentElement.insertBefore(r, this),
                (this.header = r),
                this.querySelectorAll('[placeholder]').forEach((n) => {
                    let a = n.getAttribute('slot');
                    this.header.placeholderKeys.includes(a) &&
                        this.header.append(n);
                });
        }
        initializePlaceholders() {
            let r = this.data?.placeholders || {};
            for (let i of Object.keys(r)) {
                let n = r[i],
                    a = n.includes('<p>') ? 'div' : 'p',
        ...
        attachSidenav(r, i = !0) {
            r &&
                (i && this.parentElement.prepend(r),
                (this.sidenav = r),
        ...
        async hydrate() {
            if (this.hydrating) return !1;
            let r = this.querySelector('aem-fragment');
            if (!r) return;
            (this.id = r.getAttribute('fragment')), (this.hydrating = !0);
            let i;
            this.hydrationReady = new Promise((o) => {
                i = o;
            });
            let n = this;
            function a(o, s) {
                    ...
                    for (let p of m) {
                        if (p.fieldName === 'cards') {
                            if (
                                ...
                                continue;
                            c.cards.push(o.references[p.identifier].value);
                            continue;
                        }
                        let { fields: d } = o.references[p.identifier].value,
                            f = {
                                label: d.label || '',
                                icon: d.icon,
                                iconLight: d.iconLight,
                                queryLabel: d.queryLabel,
                                cards: d.cards
                                    ? d.cards.map((u) => s[u] || u)
                                    : [],
                                collections: [],
                        ...
                        d.defaultchild &&
                            (f.defaultchild =
                                s[d.defaultchild] || d.defaultchild),
                            h.push(f),
                            l(f.collections, p.referencesTree);
                    }
                }
                return (
                    l(c.hierarchy, o.referencesTree),
                    c.hierarchy.length === 0 && (n.filtered = 'all'),
                    c
                );
            }
            r.addEventListener(yr, (o) => {
                Lt(this, hr, ro).call(
                    this,
                    'Error loading AEM fragment',
                    o.detail,
                ),
                    (this.hydrating = !1),
                    r.remove();
                ...
                r.addEventListener(Er, async (o) => {
                    ...
                    let h = (d, f) => {
                        for (let u of d)
                            if (
                                u.defaultchild === f ||
                                (u.collections && h(u.collections, f))
                            )
                                return !0;
                        return !1;
                    };
                    ...
                    let m = '',
                        p = Pn(s[0]?.fields?.variant);
                    (this.variant = p),
                        p === 'plans' &&
                            s.length === 3 &&
                            !s.some((d) => d.fields?.size?.includes('wide')) &&
                            (m = 'ThreeColumns'),
                        p &&
                            this.classList.add(
        ...
        sortChanged(r) {
            r.target.value === oe.authored
                ? tt({ sort: void 0 })
                : tt({ sort: r.target.value }),
                this.dispatchEvent(
                    new CustomEvent(xr, {
                        bubbles: !0,
                        composed: !0,
                        detail: { value: r.target.value },
                    }),
                );
        }
        async showMore() {
            this.dispatchEvent(
                new CustomEvent(br, { bubbles: !0, composed: !0 }),
            );
            let r = this.page + 1;
            tt({ page: r }), (this.page = r), await this.updateComplete;
        }
        startDeeplink() {
            this.stopDeeplink = Bi(
                ({
                    category: r,
                    filter: i,
                    types: n,
                    ...
                    (i = i || r),
                        !this.filtered &&
                            ...
                            i !== this.filter &&
                            setTimeout(() => {
                                tt({ page: void 0 }), (this.page = 1);
                            }, 1),
                        this.filtered || (this.filter = i ?? this.filter),
                        (this.types = n ?? ''),
                        (this.search = o ?? ''),
                        (this.singleApp = s),
                        (this.sort = a),
                        (this.page = Number(c) || 1);
                },
            );
        }
        openFilters(r) {
...
(we = new WeakMap()),
    ...
    (hr = new WeakSet()),
    (ro = function (r, i = {}, n = !0) {
        T(this, _t).error(`merch-card-collection: ${r}`, i),
            (this.failed = !0),
            n &&
                this.dispatchEvent(
                    new CustomEvent(wr, {
    ...
    g(Qe, 'properties', {
        ...
        filtered: { type: String, attribute: 'filtered', reflect: !0 },
        hasMore: { type: Boolean },
        limit: { type: Number, attribute: 'limit' },
        overrides: { type: String },
        page: { type: Number, attribute: 'page', reflect: !0 },
        resultCount: { type: Number },
        search: { type: String, attribute: 'search', reflect: !0 },
        sidenav: { type: Object },
        singleApp: { type: String, attribute: 'single-app', reflect: !0 },
        sort: {
            type: String,
            attribute: 'sort',
            default: oe.authored,
...
var zc = {
    ...
    Tt = class extends Ja {
        constructor() {
            ...
            $(this, X);
            $(this, Je);
            g(this, 'tablet', new et(this, H));
            g(this, 'desktop', new et(this, N));
            (this.collection = null),
                ...
                (this.handleSidenavAttached =
                    this.handleSidenavAttached.bind(this));
        }
        connectedCallback() {
            super.connectedCallback(),
                this.collection?.addEventListener(rt, this.updateLiterals),
                this.collection?.addEventListener(
                    it,
                    this.handleSidenavAttached,
                ),
                G(this, Je, customElements.get('merch-card'));
        }
        disconnectedCallback() {
            super.disconnectedCallback(),
                this.collection?.removeEventListener(rt, this.updateLiterals),
        ...
        willUpdate() {
            (T(this, X).search = this.getVisibility('search')),
                (T(this, X).filter = this.getVisibility('filter')),
                (T(this, X).sort = this.getVisibility('sort')),
                (T(this, X).result = this.getVisibility('result')),
                (T(this, X).custom = this.getVisibility('custom'));
        }
        parseVisibilityOptions(r, i) {
            if (!r || !Object.hasOwn(r, i)) return null;
            let n = r[i];
            return n === !1
                ? !1
                : n === !0
                  ? !0
                  : n.includes(this.currentMedia);
        }
        getVisibility(r) {
            let i = T(this, Je).getCollectionOptions(
        ...
        get searchAction() {
            if (!T(this, X).search) return se;
            let r = at(this, 'searchText');
            return r
                ? ue`
        ...
        get sortAction() {
            if (!T(this, X).sort) return se;
            let r = at(this, 'sortText');
            if (!r) return;
            let i = at(this, 'popularityText'),
                n = at(this, 'alphabeticallyText');
            if (!(i && n)) return;
            let a = this.collection?.sort === oe.alphabetical;
            return ue`
            <sp-action-menu
                id="sort"
                size="m"
        ...
        get resultLabel() {
            ...
            if (!this.sidenav) return se;
            let r = this.search ? 'search' : 'filter',
                i = this.resultCount
                    ? this.resultCount === 1
                        ? 'single'
                        : 'multiple'
        ...
        get customArea() {
            if (!T(this, X).custom) return se;
            let r = T(this, Je).getCollectionOptions(
                this.collection?.variant,
            )?.customHeaderArea;
            if (!r) return se;
            let i = r(this.collection);
            return !i || i === se
                ? se
                : ue`<div id="custom" role="heading" aria-level="2">
            ${i}
        </div>`;
        }
        openFilters(r) {
