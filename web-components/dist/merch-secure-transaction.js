...
var a = (e, t, o) =>
    t in e
        ? c(e, t, { enumerable: !0, configurable: !0, writable: !0, value: o })
        : (e[t] = o);
var n = (e, t, o) => a(e, typeof t != 'symbol' ? t + '' : t, o);
import { LitElement as m, html as l } from '/deps/lit-all.min.js';
import { css as x } from '/deps/lit-all.min.js';
var p = x`
    #label {
        align-items: center;
        cursor: pointer;
...
`;
var d = 'merch-secure-transaction',
    i = class extends m {
        constructor() {
            super(),
                (this.labelText = ''),
        ...
        render() {
            let { labelText: t, showIcon: o, tooltipText: r } = this,
                s = l`
...
n(i, 'properties', {
    ...
    n(i, 'styles', [p]);
window.customElements.define(d, i);
export { i as default };
