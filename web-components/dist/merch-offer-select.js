...
var g = (t, o, e) =>
    o in t
        ? S(t, o, { enumerable: !0, configurable: !0, writable: !0, value: e })
        : (t[o] = e);
var n = (t, o, e) => g(t, typeof o != 'symbol' ? o + '' : o, e),
    f = (t, o, e) => o.has(t) || m('Cannot ' + e);
var E = (t, o, e) => (
        f(t, o, 'read from private field'), e ? e.call(t) : o.get(t)
    ),
    _ = (t, o, e) =>
        o.has(t)
            ...
            : o instanceof WeakSet
              ...
              : o.set(t, e),
    T = (t, o, e, r) => (
        f(t, o, 'write to private field'), r ? r.call(t, e) : o.set(t, e), e
    );
import { html as R, LitElement as v } from '/deps/lit-all.min.js';
import { css as N, html as y, LitElement as L } from '/deps/lit-all.min.js';
var I = Object.freeze({
        MONTH: 'MONTH',
        YEAR: 'YEAR',
        TWO_YEARS: 'TWO_YEARS',
...
var O = 'span[is="inline-price"][data-wcs-osi]',
    h =
        'a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';
var C = 'a[is="upt-link"]',
    w = `${O},${h},${C}`,
    c = 'merch-offer:ready',
    A = 'merch-offer-select:ready';
var b = 'merch-offer:selected';
var u = 'merch-quantity-selector:change';
var Y = Object.freeze({
...
var a,
    l = class extends L {
        ...
        saveContainerDefaultValues() {
            let e = this.closest(this.getAttribute('container')),
                r = e
                    ...
                    ?.cloneNode(!0),
                i = e?.badgeText;
            return { description: r, badgeText: i };
        }
        getSlottedElement(e, r) {
            return (
                r || this.closest(this.getAttribute('container'))
            ).querySelector(`[slot="${e}"]:not(merch-offer > *)`);
        }
        updateSlot(e, r) {
            let i = this.getSlottedElement(e, r);
            if (!i) return;
            let s = this.selectedOffer.getOptionValue(e)
                ? this.selectedOffer.getOptionValue(e)
                : this.defaults[e];
            s && i.replaceWith(s.cloneNode(!0));
        }
        ...
        handleOfferSelectionByQuantity(e) {
            let r = e.detail.option,
                i = Number.parseInt(r),
                s = this.findAppropriateOffer(i);
            this.selectOffer(s),
                this.getSlottedElement('cta').setAttribute('data-quantity', i);
        }
        selectOffer(e) {
            if (!e) return;
            let r = this.selectedOffer;
            r && (r.selected = !1),
                (e.selected = !0),
                ...
                this.updateComplete.then(() => {
                    this.dispatchEvent(
                        new CustomEvent(b, { detail: this, bubbles: !0 }),
                    );
                });
        }
        findAppropriateOffer(e) {
            ...
            return (
                this.offers.find((s) => {
                    let d = Number.parseInt(s.getAttribute('value'));
                    if (d === e) return !0;
                    if (d > e) return !1;
                    r = s;
                }) || r
        ...
        render() {
            return y`<fieldset><slot class="${this.variant}"></slot></fieldset>`;
        }
        connectedCallback() {
            ...
            (this.manageableMode = e),
                ...
                T(this, a, this.handleOfferSelectionByQuantity.bind(this)),
                this.manageableMode
                    ? e.addEventListener(u, E(this, a))
        ...
        disconnectedCallback() {
            super.disconnectedCallback(),
                this.removeEventListener(u, E(this, a)),
        ...
        async handleOfferSelectReady() {
            this.planType ||
                ...
                this.dispatchEvent(new CustomEvent(A, { bubbles: !0 })));
        }
    };
(a = new WeakMap()),
    n(
...
customElements.define('merch-offer-select', l);
import { css as M } from '/deps/lit-all.min.js';
var x = M`
    :host {
...
var P = 'merch-offer',
    p = class extends v {
        ...
        get asRadioOption() {
            return R` <div class="merch-Radio">
        ...
        get asSubscriptionOption() {
            return R`<slot name="commitment"></slot>
        ...
        async initOffer() {
            ...
            this.prices.forEach((r) => r.setAttribute('slot', 'price')),
                await this.updateComplete,
                await Promise.all([...this.prices].map((r) => r.onceSettled()));
            let {
                value: [e],
            } = this.price;
            (this.planType = e.planType),
