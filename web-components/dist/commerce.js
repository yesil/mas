...
var z = (e, t, r) => (
    ...
    Nr = (e, t, r) => (At(e, t, 'access private method'), r);
var Bt = {};
Hi(Bt, {
    CLASS_NAME_FAILED: () => yt,
    CLASS_NAME_HIDDEN: () => Di,
    CLASS_NAME_PENDING: () => bt,
    CLASS_NAME_RESOLVED: () => St,
    CheckoutWorkflow: () => Mr,
    CheckoutWorkflowStep: () => B,
    Commitment: () => le,
    ERROR_MESSAGE_BAD_REQUEST: () => Pt,
    ERROR_MESSAGE_MISSING_LITERALS_URL: () => io,
    ERROR_MESSAGE_OFFER_NOT_FOUND: () => vt,
    EVENT_AEM_ERROR: () => to,
    EVENT_AEM_LOAD: () => eo,
    EVENT_MAS_ERROR: () => no,
    EVENT_MAS_READY: () => ro,
    ...
    EVENT_MERCH_STOCK_CHANGE: () => $i,
    EVENT_MERCH_STORAGE_CHANGE: () => Yi,
    EVENT_OFFER_SELECTED: () => Vi,
    EVENT_TYPE_FAILED: () => Ct,
    EVENT_TYPE_READY: () => Xe,
    EVENT_TYPE_RESOLVED: () => Lt,
    Env: () => K,
    FF_DEFAULTS: () => se,
    ...
    SELECTOR_MAS_ELEMENT: () => Tt,
    SELECTOR_MAS_INLINE_PRICE: () => Or,
    SELECTOR_MAS_SP_BUTTON: () => Bi,
    SELECTOR_MAS_UPT_LINK: () => Hr,
    SORT_ORDER: () => ho,
    STATE_FAILED: () => X,
    STATE_PENDING: () => ie,
    STATE_RESOLVED: () => Q,
    ...
    TEMPLATE_PRICE_LEGAL: () => uo,
    TEMPLATE_PRICE_STRIKETHROUGH: () => co,
    Term: () => W,
    WCS_PROD_URL: () => It,
    WCS_STAGE_URL: () => Ht,
});
var le = Object.freeze({
    ...
    Mi = 'merch',
    Di = 'hidden',
    Xe = 'wcms:commerce:ready',
    Ui = 'mas-commerce-service',
    Or = 'span[is="inline-price"][data-wcs-osi]',
    Ir =
        'a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',
    Bi = 'sp-button[data-wcs-osi]',
    Hr = 'a[is="upt-link"]',
    Tt = `${Or},${Ir},${Hr}`,
    ...
    Wi = 'merch-quantity-selector:change',
    ji = 'merch-card-quantity:change',
    Xi = 'merch-modal:addon-and-quantity-update',
    ...
    ro = 'mas:ready',
    no = 'mas:error',
    yt = 'placeholder-failed',
    bt = 'placeholder-pending',
    St = 'placeholder-resolved',
    Pt = 'Bad WCS request',
    vt = 'Commerce offer not found',
    ...
    oo = 'commerce.aosKey',
    so = 'commerce.wcsKey',
    It = 'https://www.adobe.com/web_commerce_artifact',
    ...
    Mt = { PRODUCTION: 'PRODUCTION' },
    ue = { TWP: 'twp', D2P: 'd2p', CRM: 'crm' },
    Dt = ':start',
    Ut = ':duration',
    ao = 'price',
    co = 'price-strikethrough',
    lo = 'annual',
    uo = 'legal',
    se = 'mas-ff-defaults',
    ho = { alphabetical: 'alphabetical', authored: 'authored' };
var Dr = 'tacocat.js';
var kt = (e, t) =>
...
function R(
    ...
    if (i && o == null) {
        let s = Ae(i) ? i : e;
        o = window.sessionStorage.getItem(s) ?? window.localStorage.getItem(s);
    }
    if (r && o == null) {
        let s = po(Ae(r) ? r : e);
...
var jt = 'ABM',
    ...
    la = {
        ...
        [zt]: { commitment: V.PERPETUAL, term: void 0 },
        [Kt]: { commitment: V.THREE_MONTHS, term: j.P3Y },
    },
    Yr = 'Value is not an offer',
    Ne = (e) => {
        if (typeof e != 'object') return Yr;
...
var Po = (e, t) => {
    switch (e) {
        ...
        case '':
            return '';
        case V.YEAR:
            return t === j.MONTHLY ? jt : t === j.ANNUAL ? Xt : '';
        case V.MONTH:
            return t === j.MONTHLY ? qt : '';
        case V.PERPETUAL:
            return zt;
        case V.TERM_LICENSE:
            return t === j.P3Y ? Kt : '';
...
function Wr(e) {
    ...
    let a = {
        ...
        priceDetails: {
            ...t,
            price: i ?? r,
            priceWithoutDiscount: o ?? n,
            taxDisplay: So,
        },
    };
    return (
        a.offerType === 'TRIAL' &&
            a.priceDetails.price === 0 &&
            (a.priceDetails.price = a.priceDetails.priceWithoutDiscount),
        a
    );
}
var vo = 'mas-commerce-service',
    Co = {
        requestId: Le,
        etag: 'Etag',
...
function Oe(e, { country: t, forceTaxExclusive: r }) {
    let n;
    if (e.length < 2) n = e;
    else {
        let i = t === 'GB' ? 'EN' : 'MULT';
        e.sort((o, s) => (o.language === i ? -1 : s.language === i ? 1 : 0)),
            e.sort((o, s) =>
                !o.term && s.term ? -1 : o.term && !s.term ? 1 : 0,
            ),
            (n = [e[0]]);
    }
    return r && (n = n.map(Wr)), n;
}
...
function jr(e) {
    ...
    let r = e.headers;
    for (let [n, i] of Object.entries(Co)) {
        let o = r.get(i);
        o &&
            ((o = o.replace(/[,;]/g, '|')),
            (o = o.replace(/[| ]+/g, '|')),
...
function qr(e) {
    ...
    if (t === 'object') {
        ...
        if (typeof e.originatingRequest == 'string') {
            let { message: n, originatingRequest: i, status: o } = e;
            return [n, o, i].filter(Boolean).join(' ');
        }
        let r =
            e[Symbol.toStringTag] ?? Object.getPrototypeOf(e).constructor.name;
        if (!he.serializableTypes.includes(r)) return r;
    }
    return e;
}
function wo(e, t) {
...
var Qt = {
    append(e) {
        ...
        let { message: t, params: r } = e,
            ...
            o = t;
        r.forEach((u) => {
            u != null && (Lo(u) ? n : i).push(u);
        }),
            n.length && (o += ' ' + n.map(qr).join(' '));
        let { pathname: s, search: a } = window.location,
            c = `${he.delimiter}page=${s}${a}`;
...
function Oo(e) {
    [...er].every((t) => t(e)) && Jt.forEach((t) => t(e));
}
function Jr(e) {
    let t = (Kr.get(e) ?? 0) + 1;
    Kr.set(e, t);
...
function rt(...e) {
    e.forEach((t) => {
        let { append: r, filter: n } = t;
        qe(n) && er.add(n), qe(r) && Jt.add(r);
    });
}
function Io(e = {}) {
    let { name: t } = e,
...
var ye = class e extends Error {
    constructor(t, r, n) {
        if ((super(t, { cause: n }), (this.name = 'MasError'), r.response)) {
            let i = r.response.headers?.get(Le);
            i && (r.requestId = i),
                r.response.status &&
    ...
    ae = class {
        ...
        notify() {
            (this.state === Q || this.state === X) &&
                ...
                (this.promises = []));
            let t = this.error;
            this.error instanceof ye &&
                (t = { message: this.error.message, ...this.error.context }),
                this.wrapperElement.dispatchEvent(
                    new CustomEvent(Do[this.state], { bubbles: !0, detail: t }),
                );
        }
        ...
        onceSettled() {
            ...
            return Q === n
                ...
                : X === n
                  ? Promise.reject(t)
                  : new Promise((i, o) => {
                        r.push({ resolve: i, reject: o });
                    });
        }
        toggleResolved(t, r, n) {
        ...
        toggleFailed(t, r, n) {
            ...
            n !== void 0 && (this.options = n),
                ...
                (this.state = X),
                this.update();
            let i = this.wrapperElement.getAttribute('is');
            return (
                this.log?.error(`${i}: Failed to render: ${r.message}`, {
                    element: this.wrapperElement,
                    ...r.context,
                    ...z(this, Ie)?.duration,
                }),
        ...
        requestUpdate(t = !1) {
            ...
            (this.state = ie),
                (this.timer = Je(async () => {
                    ...
                    if (
                        (this.changes.size &&
                            ((a = Object.fromEntries(this.changes.entries())),
                            this.changes.clear()),
                        this.connected
                        ...
                        try {
                            ...
                            this.toggleFailed(this.version, c, n);
                        }
                }));
        }
    };
...
function nt(e, t = {}) {
    let { tag: r, is: n } = e,
        i = document.createElement(r, { is: n });
    return i.setAttribute('is', n), Object.assign(i.dataset, en(t)), i;
}
function tn(e, t = {}) {
    return e instanceof HTMLElement
        ? (Object.assign(e.dataset, en(t)), e)
        : null;
}
var rn = 'download',
    nn = 'upgrade',
...
function ot(e) {
    return class extends e {
        ...
        get marketSegment() {
            let n = this.options?.ms ?? this.value?.[0].marketSegments?.[0];
            return on[n] ?? n;
        }
        get customerSegment() {
            let n = this.options?.cs ?? this.value?.[0]?.customerSegment;
            return on[n] ?? n;
        }
        get is3in1Modal() {
            return Object.values(ue).includes(this.getAttribute('data-modal'));
        }
        get isOpen3in1Modal() {
            let n = document.querySelector('meta[name=mas-ff-3in1]');
            return this.is3in1Modal && (!n || n.content !== 'off');
        }
        requestUpdate(n = !1) {
            return this.masElement.requestUpdate(n);
        }
        ...
        async render(n = {}) {
            ...
            this.dataset.imsCountry ||
                i.imsCountryPromise.then((f) => {
                    f && (this.dataset.imsCountry = f);
                }),
                (n.imsCountry = null);
            let o = i.collectCheckoutOptions(n, this);
            if (!o.wcsOsi.length) return !1;
            let s;
            try {
                s = JSON.parse(o.extraOptions ?? '{}');
            } catch (f) {
            ...
            let a = this.masElement.togglePending(o);
            this.setCheckoutUrl('');
            let c = i.resolveOfferSelectors(o),
                u = await Promise.all(c);
            (u = u.map((f) => Oe(f, o))),
                (o.country = this.dataset.imsCountry || o.country);
            let l = await i.buildCheckoutAction?.(
                u.flat(),
                { ...s, ...o },
                this,
            );
        ...
        renderOffers(n, i, o = {}, s = void 0, a = void 0) {
            ...
            if (
                ...
                a ?? (a = this.masElement.togglePending(i)),
                this.checkoutActionHandler &&
                    (this.checkoutActionHandler = void 0),
                s)
            ) {
                this.classList.remove(rn, nn),
                    this.masElement.toggleResolved(a, n, i);
                let { url: l, text: f, className: p, handler: h } = s;
                l && this.setCheckoutUrl(l),
                    f && (this.firstElementChild.innerHTML = f),
                    p && this.classList.add(...p.split(' ')),
                    h &&
                        (this.setCheckoutUrl('#'),
                        (this.checkoutActionHandler = h.bind(this)));
            }
            if (n.length) {
                if (this.masElement.toggleResolved(a, n, i)) {
                    if (
                        !this.classList.contains(rn) &&
                        !this.classList.contains(nn)
                    ) {
                        let l = c.buildCheckoutURL(n, i);
                        this.setCheckoutUrl(i.modal === 'true' ? '#' : l);
                    }
                    return !0;
                }
            } else {
                let l = new Error(`Not provided: ${i?.wcsOsi ?? '-'}`);
                if (this.masElement.toggleFailed(a, l, i))
...
var He = class He extends ot(HTMLAnchorElement) {
...
function $o({ url: e, modal: t, is3in1: r }) {
    if (!r || !e?.searchParams) return e;
    e.searchParams.set('rtc', 't'), e.searchParams.set('lo', 'sl');
    let n = e.searchParams.get('af');
    return (
        e.searchParams.set(
            'af',
            [n, 'uc_new_user_iframe', 'uc_new_system_close']
                .filter(Boolean)
                .join(','),
        ),
        e.searchParams.get('cli') !== 'doc_cloud' &&
            e.searchParams.set('cli', t === ue.CRM ? 'creative' : 'mini_plans'),
        e
    );
}
function an(e) {
    ...
    if (
        ((h.pathname = `${Bo}${n}`),
        n !== B.SEGMENTATION &&
            n !== B.CHANGE_PLAN_TEAM_PLANS &&
            Vo(r, h.searchParams),
        rr({ ...p }, h.searchParams, tr),
        c === oe.DRAFT && rr({ af: Uo }, h.searchParams, tr),
        n === B.SEGMENTATION)
    ) {
        let d = {
            marketSegment: i,
            ...
            addonProductArrangementCode: a
                ? r?.find((m) => m.productArrangementCode !== a)
                      ?.productArrangementCode
                : r?.[1]?.productArrangementCode,
        };
        f?.toLowerCase() === 'edu'
            ? h.searchParams.set('ms', 'EDU')
            : f?.toLowerCase() === 'team' && h.searchParams.set('cs', 'TEAM'),
            rr(d, h.searchParams, tr),
            h.searchParams.get('ot') === 'PROMOTION' &&
                h.searchParams.delete('ot'),
            (h = $o({ url: h, modal: u, is3in1: l }));
    }
    return h.toString();
}
function Yo(e) {
    ...
    if (
        e.workflowStep !== B.SEGMENTATION &&
        e.workflowStep !== B.CHANGE_PLAN_TEAM_PLANS &&
        !e.items
    )
...
var S = Object.freeze({
    ...
    landscape: oe.PUBLISHED,
});
function cn({ settings: e, providers: t }) {
    function r(o, s) {
        let {
                checkoutClientId: a,
    ...
    function n(o, s) {
        ...
        let { env: a, landscape: c } = e,
            {
                checkoutClientId: u,
                checkoutMarketSegment: l,
                checkoutWorkflowStep: f,
                country: p,
                promotionCode: h,
                quantity: d,
                preselectPlan: m,
        ...
        if (o.length === 1) {
            let { offerId: q } = o[0];
            Y.items.push({ id: q, quantity: te });
        } else
            Y.items.push(
                ...o.map(({ offerId: q, productArrangementCode: ge }) => ({
                    id: q,
                    quantity: te,
                    ...(v ? { productArrangementCode: ge } : {}),
                })),
            );
        return an(Y);
    }
    ...
    return {
        ...
        createCheckoutLink: i,
    };
}
function Wo({ interval: e = 200, maxAttempts: t = 25 } = {}) {
    let r = $.module('ims');
    ...
    return e.then((r) =>
        r
            ? window.adobeIMS.getProfile().then(
                  ({ countryCode: n }) => (t.debug('Got user country:', n), n),
                  (n) => {
                      t.error('Unable to get user country:', n);
                  },
              )
            : null,
    );
...
var un = window.masPriceLiterals;
function hn(e) {
    if (Array.isArray(un)) {
    ...
    for (var t = {}, r = 0, n = e; r < n.length; r++) {
        ...
        switch (i.stem) {
            ...
            case 'integer-width':
                ...
                i.options[0].replace(Ko, function (c, u, l, f, p, h) {
                    if (u) t.minimumIntegerDigits = l.length;
                    else {
                        if (f && p)
                            throw new Error(
        ...
        if (En.test(i.stem)) {
            ...
            i.stem.replace(En, function (c, u, l, f, p, h) {
                return (
                    l === '*'
                        ...
                        : f && f[0] === '#'
                          ...
                          : p && h
                            ? ((t.minimumFractionDigits = p.length),
                              (t.maximumFractionDigits = p.length + h.length))
                            : ((t.minimumFractionDigits = u.length),
...
var sr,
    Jo = new RegExp('^'.concat(or.source, '*')),
    es = new RegExp(''.concat(or.source, '*$'));
function A(e, t) {
    return { start: e, end: t };
}
var ts = !!String.prototype.startsWith,
    rs = !!String.fromCodePoint,
    ns = !!Object.fromEntries,
    is = !!String.prototype.codePointAt,
    os = !!String.prototype.trimStart,
    ss = !!String.prototype.trimEnd,
    as = !!Number.isSafeInteger,
    cs = as
        ...
        return (
            ...
            (e.prototype.parseArgument = function (t, r) {
                ...
                if (this.char() === 125)
                    return (
                        this.bump(),
                        this.error(E.EMPTY_ARGUMENT, A(n, this.clonePosition()))
                    );
            ...
            (e.prototype.parseArgumentOptions = function (t, r, n, i) {
                ...
                switch (a) {
                    case '':
                        return this.error(E.EXPECT_ARGUMENT_TYPE, A(s, c));
                    case 'number':
                    case 'date':
                    case 'time': {
                        this.bumpSpace();
                        ...
                        if (this.bumpIf(',')) {
                            ...
                            var h = A(l, this.clonePosition());
                            u = { style: p, styleLocation: h };
                        }
                    ...
                    default:
                        return this.error(E.INVALID_ARGUMENT_TYPE, A(s, c));
                }
            }),
            ...
            (e.prototype.tryParsePluralOrSelectOptions = function (t, r, n, i) {
                for (
                    ...
                    a.push([
                        u,
                        { value: d.val, location: A(h, this.clonePosition()) },
                    ]),
                        c.add(u),
                        this.bumpSpace(),
            ...
            (e.prototype.tryParseDecimalInteger = function (t, r) {
                ...
                return o
                    ? ((s *= n),
                      cs(s) ? { val: s, err: null } : this.error(r, c))
                    : this.error(t, c);
            }),
...
function fr(e) {
    e.forEach(function (t) {
        if ((delete t.location, ut(t) || ht(t)))
            ...
            (at(t) && pt(t.style)) || ((ct(t) || lt(t)) && De(t.style))
...
function ds(e, t) {
    var r = e.length === 1 ? In : Hn;
    return pr(e, this, r, t.cache.create(), t.serializer);
}
function Es(e, t) {
    return pr(e, this, Hn, t.cache.create(), t.serializer);
}
function gs(e, t) {
...
function As(e) {
    return e.length < 2
        ...
        : e.reduce(function (t, r) {
              var n = t[t.length - 1];
              return (
                  !n || n.type !== U.literal || r.type !== U.literal
                      ? t.push(r)
                      : (n.value += r.value),
                  t
              );
...
function Fe(e, t, r, n, i, o, s) {
    ...
    for (var a = [], c = 0, u = e; c < u.length; c++) {
        var l = u[c];
        if (ir(l)) {
            a.push({ type: U.literal, value: l.value });
            continue;
        }
        if (pn(l)) {
            typeof o == 'number' &&
            ...
            (!p || typeof p == 'string' || typeof p == 'number') &&
                (p =
                    typeof p == 'string' || typeof p == 'number'
                        ...
                        : ''),
                a.push({
                    type: typeof p == 'string' ? U.literal : U.object,
                    value: p,
                });
            continue;
        }
        if (ct(l)) {
            ...
            a.push({
                type: U.literal,
                value: r.getDateTimeFormat(t, h).format(p),
            });
            continue;
        }
        if (lt(l)) {
            ...
            var h =
                typeof l.style == 'string'
                    ...
                    : pt(l.style)
                      ? l.style.parsedOptions
                      : void 0;
            h && h.scale && (p = p * (h.scale || 1)),
                a.push({
                    type: U.literal,
                    value: r.getNumberFormat(t, h).format(p),
                });
            continue;
        }
        if (ft(l)) {
    ...
    return (
        e === void 0 && (e = { number: {}, dateTime: {}, pluralRules: {} }),
        {
            getNumberFormat: Be(
                ...
                { cache: Er(e.number), strategy: mt.variadic },
            ),
            getDateTimeFormat: Be(
                ...
                { cache: Er(e.dateTime), strategy: mt.variadic },
            ),
            getPluralRules: Be(
                function () {
                    for (var t, r = [], n = 0; n < arguments.length; n++)
                ...
                { cache: Er(e.pluralRules), strategy: mt.variadic },
            ),
        }
    );
}
    ...
    function e(t, r, n, i) {
        ...
        if (
            ...
            (this.format = function (s) {
                ...
                var c = a.reduce(function (u, l) {
                    return (
                        !u.length ||
                        l.type !== U.literal ||
                        typeof u[u.length - 1] != 'string'
                            ? u.push(l.value)
                            : (u[u.length - 1] += l.value),
                        u
                    );
                }, []);
        ...
        (this.formats = bs(e.formats, n)),
            (this.formatters = (i && i.formatters) || Ss(this.formatterCache));
    }
    return (
...
function Cs(e = '#.##') {
    let t = {},
        r = e.length,
        n = kn(e);
    t.prefix = n > 0 ? e.substring(0, n) : '';
    let i = kn(e.split('').reverse().join('')),
        o = r - i,
        s = e.substring(o, o + 1),
        a = o + (s === '.' || s === ',' ? 1 : 0);
    (t.suffix = i > 0 ? e.substring(a, r) : ''),
        (t.mask = e.substring(n, a)),
        (t.maskHasNegativeSign = t.mask.charAt(0) === '-'),
        (t.maskHasPositiveSign = t.mask.charAt(0) === '+');
    let c = t.mask.match(vs);
    return (
...
function Ls(e, t, r) {
    let n = !1,
        i = { value: e };
    e < 0 && ((n = !0), (i.value = -i.value)),
        (i.sign = n ? '-' : ''),
        (i.value = Number(i.value).toFixed(t.fraction && t.fraction.length)),
        (i.value = Number(i.value).toString());
...
function ws(e, t) {
    ...
    let r = t.integer.split(t.separator),
        ...
        i = n && n.indexOf('0');
    if (i > -1)
        for (; e.integer.length < n.length - i; ) e.integer = '0' + e.integer;
    else Number(e.integer) === 0 && (e.integer = '');
    let o = r[1] && r[r.length - 1].length;
    if (o) {
        let s = e.integer.length,
            a = s % o;
        for (let c = 0; c < s; c++)
            (e.result += e.integer.charAt(c)),
                !((c - a + 1) % o) && c < s - o && (e.result += t.separator);
...
var Gn = '.',
    ...
    Xn = (e) => e.match(/0(.?)0/)?.[1] ?? '';
function be(
    { formatString: e, price: t, usePrecision: r, isIndianPrice: n = !1 },
    i,
    o = (s) => s,
) {
    let { currencySymbol: s, isCurrencyFirst: a, hasCurrencySpace: c } = Ds(e),
        u = r ? Xn(e) : '',
        l = Ms(e, r),
        f = r ? 2 : 0,
        p = o(t, { currencySymbol: s }),
        h = n
...
var qn = (e) => {
        ...
        return be(e, i > 1 ? me.MONTH : _r[t]?.[r], (o) => {
            ...
            if (!a)
                throw new Error(
                    `Missing rounding rule for: ${JSON.stringify(s)}`,
                );
            return a(s);
        });
    },
    ...
    Kn = (e) => {
        ...
        if (t === le.YEAR && c === W.MONTHLY) {
            if (!s) return be(e, me.YEAR, gr);
            let {
                displaySummary: {
                    outcomeType: u,
                    duration: l,
                    minProductQuantity: f = 1,
                } = {},
            } = s;
            switch (u) {
                case 'PERCENTAGE_DISCOUNT':
                    if (a >= f && Wn(s, r)) {
                        let p = parseInt(l.replace('P', '').replace('M', ''));
                        if (isNaN(p)) return gr(n);
                        let h = a * i * p,
                            d = a * o * (12 - p),
                            m = Math.round((h + d) * 100) / 100;
                        return be({ ...e, price: m }, me.YEAR);
                    }
                default:
...
function Vs(
    e,
    {
        ...
        recurrenceLabel: u,
        perUnitLabel: l,
        taxInclusivityLabel: f,
    },
    p = {},
) {
    let h = M(I.currencySymbol, n),
        d = M(I.currencySpace, s ? '&nbsp;' : ''),
        m = '';
    return (
        t
            ? (m = `<sr-only class="strikethrough-aria-label">${t}</sr-only>`)
            : r && (m = `<sr-only class="alt-aria-label">${r}</sr-only>`),
        c && (m += h + d),
        (m += M(I.integer, a)),
        (m += M(I.decimalsDelimiter, o)),
        (m += M(I.decimals, i)),
        c || (m += d + h),
        (m += M(I.recurrence, u, null, !0)),
        (m += M(I.unitType, l, null, !0)),
        (m += M(I.taxInclusivity, f, !0)),
        M(e, m, { ...p })
    );
}
var G =
        ...
        (
            {
                country: o,
                displayFormatted: s = !0,
                displayRecurrence: a = !0,
                displayPerUnit: c = !1,
                displayTax: u = !1,
                language: l,
                literals: f = {},
            ...
            Object.entries({
                ...
                if (Oi == null)
                    throw new Error(
                        `Argument "${Ni}" is missing for osi ${m?.toString()}, country ${o}, language ${l}`,
                    );
            });
            let O = { ...Ar, ...f },
            ...
            g(c) &&
                (h && (We += ' '),
                (We += J(O, L, ce.perUnitLabel, { perUnit: 'LICENSE' })));
            let je = '';
            g(u) &&
                v &&
                (h && (je += ' '),
                ...
                r &&
                    (gt = J(O, L, ce.strikethroughAriaLabel, {
    ...
    Zn = () => (e, t, r) => {
        ...
        try {
            n ||
                (n = new URLSearchParams(document.location.search).get(
                    'instant',
                )),
                n && (n = new Date(n));
        } catch {
...
function $s(
    e,
    { perUnitLabel: t, taxInclusivityLabel: r, planTypeLabel: n },
    i = {},
) {
    let o = '';
    return (
...
var ei = (
    ...
    { taxDisplay: s, taxTerm: a, planType: c } = {},
    u = {},
) => {
    let l = { ...Ar, ...o },
        f = `${i.toLowerCase()}-${e.toUpperCase()}`,
        p = '';
    g(t) && (p = J(l, f, dt.perUnitLabel, { perUnit: 'LICENSE' }));
    let h = '';
    e === 'US' && i === 'en' && (r = !1),
        g(r) &&
            a &&
            (h = J(
                l,
                f,
                s === Tr ? dt.taxExclusiveLabel : dt.taxInclusiveLabel,
                { taxTerm: a },
            ));
    let d = '';
...
var mi = 'INDIVIDUAL_COM',
    ...
    Ws = {
        ...
        [yr]: ['MU_en', 'LT_lt', 'LV_lv', 'NG_en', 'CO_es', 'KR_ko'],
        [di]: ['LT_lt', 'LV_lv', 'SA_en', 'SG_en'],
        [br]: ['SG_en', 'KR_ko'],
    },
    js = {
        MU_en: [!1, !1, !1, !1],
    ...
    Ks = (e, t, r, n) => {
        let i = `${e}_${t}`;
        if (pi.includes(e) || pi.includes(i)) return !0;
        let o = Ws[`${r}_${n}`];
        return o
    ...
    Ve = class Ve extends HTMLSpanElement {
        ...
        attributeChangedCallback(r, n, i) {
            this.masElement.attributeChangedCallback(r, n, i);
        }
        connectedCallback() {
            this.masElement.connectedCallback(),
        ...
        get isFailed() {
            return this.masElement.state === X;
        }
        requestUpdate(r = !1) {
        ...
        async render(r = {}) {
            ...
            if (!o.wcsOsi.length) return !1;
            try {
                let s = this.masElement.togglePending({});
                this.innerHTML = '';
                let [a] = await n.resolveOfferSelectors(o),
                    c = Oe(await a, o),
                    [u] = c;
                if (n.featureFlags[se]) {
                    if (
                        (i.displayPerUnit === void 0 &&
                            (o.displayPerUnit =
                                u.customerSegment !== 'INDIVIDUAL'),
                        i.displayTax === void 0 ||
                            i.forceTaxExclusive === void 0)
                    ) {
                        let { country: l, language: f } = o,
                            [p = ''] = u.marketSegments,
                            h = await Ei(l, f, u.customerSegment, p);
                        i.displayTax === void 0 &&
                            (o.displayTax = h?.displayTax || o.displayTax),
                            i.forceTaxExclusive === void 0 &&
                                (o.forceTaxExclusive =
                                    h?.forceTaxExclusive ||
                                    o.forceTaxExclusive),
                            o.forceTaxExclusive && (c = Oe(c, o));
                    }
                } else i.displayOldPrice === void 0 && (o.displayOldPrice = !0);
                return this.renderOffers(c, o, s);
            } catch (s) {
                throw ((this.innerHTML = ''), s);
            }
        }
        renderOffers(r, n, i = void 0) {
            ...
            if ((i ?? (i = this.masElement.togglePending()), r.length)) {
                if (this.masElement.toggleResolved(i, r, n)) {
                    ...
                    let s = this.closest('p, h3, div');
                    if (
                        !s ||
                        !s.querySelector(
                            'span[data-template="strikethrough"]',
                        ) ||
                        s.querySelector('.alt-aria-label')
                    )
                        return !0;
                    let a = s?.querySelectorAll('span[is="inline-price"]');
                    return (
                        a.length > 1 &&
                            a.length ===
                                s.querySelectorAll(
                ...
                if (this.masElement.toggleFailed(i, s, this.options))
...
function gi({ literals: e, providers: t, settings: r }) {
    function n(s, a = null) {
        let c = {
            country: r.country,
            language: r.language,
        ...
        if (a && t?.price) for (let N of t.price) N(a, c);
        let {
            displayOldPrice: u,
            displayPerUnit: l,
            displayRecurrence: f,
    ...
    function i(s, a) {
        if (!Array.isArray(s) || !s.length || !a) return '';
        let { template: c } = a,
            u;
        switch (c) {
            case 'discount':
            ...
            case 'legal':
                ...
                break;
            default:
                a.template === 'optical' && a.alternativePrice
                    ? (u = si)
                    : a.template === 'optical'
                      ? (u = ni)
                      : a.displayAnnual && s[0].planType === 'ABM'
                        ? (u = a.promotionCode ? li : ci)
                        : a.alternativePrice
                          ? (u = ai)
                          : (u = a.promotionCode ? ri : ti);
        }
        let [l] = s;
        return (l = { ...l, ...l.priceDetails }), u({ ...r, ...a }, l);
    }
    let o = ee.createInlinePrice;
    return {
        InlinePrice: ee,
        buildPriceHTML: i,
        collectPriceOptions: n,
        createInlinePrice: o,
    };
}
function Qs({
...
async function _i(e, t = {}, r = 2, n = 100) {
    ...
    for (let o = 0; o <= r; o++)
        try {
            ...
            return (s.retryCount = o), s;
        } catch (s) {
            if (((i = s), (i.retryCount = o), o > r)) break;
            await new Promise((a) => setTimeout(a, n * (o + 1)));
        }
    throw i;
}
...
function Ai({ settings: e }) {
    ...
    async function c(h, d, m = !0) {
        ...
        let v = new Map(d),
            ...
            N = Date.now() + Math.random().toString(36).substring(2, 7),
            H = `${Pr}:${C}:${N}${Dt}`,
            k = `${Pr}:${C}:${N}${Ut}`,
            O;
        try {
            if (
                ...
                (L = L.map(Ne)),
                    d.forEach(({ resolve: D }, Y) => {
                        let te = L.filter(({ offerSelectorIds: q }) =>
                            q.includes(Y),
                        ).flat();
                        te.length && (v.delete(Y), d.delete(Y), D(te));
                    });
            } else P = Pt;
        } catch (L) {
            P = `Network error: ${L.message}`;
        } finally {
            (O = performance.measure(k, H)),
                performance.clearMarks(H),
                performance.clearMeasures(k);
        }
        if (m && d.size) {
    ...
    function u() {
        clearTimeout(s);
        let h = [...o.values()];
        o.clear(), h.forEach(({ options: d, promises: m }) => c(d, m));
    }
    function l(h) {
        if (!h || typeof h != 'object')
            throw new TypeError('Cache must be a Map or similar object');
        let d = r === K.STAGE ? 'stage' : 'prod',
            m = h[d];
    ...
    function f() {
        ...
        (a = new Map(i)),
            i.clear(),
            t.debug(`Moved ${h} cache entries to stale cache`);
    }
    function p({
        country: h,
        language: d,
    ...
    return {
        ...
        flushWcsCacheInternal: f,
        prefillWcsCache: l,
    };
}
var Ti = 'mas-commerce-service',
    yi = 'mas-commerce-service:start',
    bi = 'mas-commerce-service:ready',
    $e,
    Se,
    Pe,
    Si,
    Pi,
    vr = class extends HTMLElement {
        constructor() {
            super(...arguments);
            re(this, Pe);
            re(this, $e);
        ...
        async registerCheckoutAction(r) {
            typeof r == 'function' &&
                (this.buildCheckoutAction = async (n, i, o) => {
                    let s = await r?.(n, i, this.imsSignedInPromise, o);
                    return s || null;
                });
        }
        get featureFlags() {
            return (
                z(this, Se) ||
                    ne(this, Se, { [se]: Nr(this, Pe, Pi).call(this, se) }),
                z(this, Se)
            );
        }
        activate() {
            ...
            let s = { price: hn(n) },
                a = { checkout: new Set(), price: new Set() },
                c = { literals: s, providers: a, settings: n };
            Object.defineProperties(
                ...
                Object.getOwnPropertyDescriptors({
                    ...
                    get providers() {
                        return {
                            ...
                            price(l) {
                                return a.price.add(l), () => a.price.delete(l);
                            },
                            has: (l) => a.price.has(l) || a.checkout.has(l),
                        };
                    },
                    get settings() {
                        return n;
                ...
                i.debug('Activated:', { literals: s, settings: n });
            let u = new CustomEvent(Xe, {
                bubbles: !0,
                cancelable: !1,
                detail: this,
            });
            performance.mark(bi),
                ne(this, $e, performance.measure(bi, yi)),
        ...
        connectedCallback() {
            performance.mark(yi), this.activate();
        }
        flushWcsCache() {
        ...
        get duration() {
            return { 'mas-commerce-service:measure': Et(z(this, $e)) };
        }
        logFailedRequests() {
            let r = [...performance.getEntriesByType('resource')]
                    .filter(({ startTime: i }) => i > this.lastLoggingTime)
                    .filter(
                        ({ transferSize: i, duration: o, responseStatus: s }) =>
                            (i === 0 && o === 0 && s < 200) || s >= 400,
                    ),
                n = Array.from(new Map(r.map((i) => [i.name, i])).values());
            if (
                n.some(({ name: i }) =>
                    /(\/fragment\?|web_commerce_artifact)/.test(i),
                )
            ) {
                let i = n.map(({ name: o }) => o);
...
($e = new WeakMap()),
    ...
    (Si = function () {
        ...
        return (
            ['locale', 'country', 'language', 'preview'].forEach((i) => {
                let o = this.getAttribute(i);
                o && (n[i] = o);
            }),
            [
                ...
                let o = this.getAttribute(i);
                if (o != null) {
                    let s = i.replace(/-([a-z])/g, (a) => a[1].toUpperCase());
                    n.commerce[s] = o;
                }
            }),
            n
...
var Ye = class Ye extends ot(HTMLButtonElement) {
...
var Ee,
    de = class de extends HTMLAnchorElement {
        ...
        initializeWcsData(r, n) {
            this.setAttribute('data-wcs-osi', r),
                n && this.setAttribute('data-promotion-code', n);
        }
        attributeChangedCallback(r, n, i) {
            this.masElement.attributeChangedCallback(r, n, i);
        }
        connectedCallback() {
            this.masElement.connectedCallback(),
                ne(this, Ee, Sr()),
                z(this, Ee) && (this.log = z(this, Ee).log.module('upt-link'));
        }
        disconnectedCallback() {
            this.masElement.disconnectedCallback(), ne(this, Ee, void 0);
        }
        requestUpdate(r = !1) {
        ...
        async render() {
            ...
            if (!r) return !1;
            this.dataset.imsCountry ||
                r.imsCountryPromise.then((s) => {
                    s && (this.dataset.imsCountry = s);
                });
            let n = r.collectCheckoutOptions({}, this);
            if (!n.wcsOsi)
                return (
                    this.log.error(
            ...
            let i = this.masElement.togglePending(n),
                o = r.resolveOfferSelectors(n);
            try {
                let [[s]] = await Promise.all(o),
                    { country: a, language: c, env: u } = n,
                ...
                let a = new Error(
                    `Could not resolve offer selectors for id: ${n.wcsOsi}.`,
                    s.message,
                );
                return this.masElement.toggleFailed(i, a, n), !1;
            }
        }
        static createFrom(r) {
            let n = new de();
            for (let i of r.attributes)
                i.name !== 'is' &&
                    (i.name === 'class' && i.value.includes('upt-link')
                        ? n.setAttribute(
                              'class',
                              i.value.replace('upt-link', '').trim(),
                          )
                        : n.setAttribute(i.name, i.value));
            return (
                (n.innerHTML = r.innerHTML), n.setAttribute('tabindex', 0), n
            );
        }
    };
(Ee = new WeakMap()),
