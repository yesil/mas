...
`;var It="mas-compare-chart",ve=3e4,tt=4,Ae=900,we=64,Ce=40,_e=["icons","header","badge","price","description","detail","cta"],M={included:["\u2713","\u2714","\u2705"],excluded:["\u2717","\u2718","\u2716","\xD7"],notApplicable:["\u2014","-"]},Te=p=>M.included.includes(p),Se=p=>M.excluded.includes(p),ke=p=>!p||M.notApplicable.includes(p)||/^-+$/.test(p),F,E,S,k,R,_,$,O,v,Y,T,w,C,G,V,N,I,P,q,H,D,j,K,W,Z,X,Q,r,mt,ut,gt,Pt,$t,Ht,Dt,Ut,Ft,Yt,B,Gt,Vt,zt,et,Bt,ft,qt,jt,xt,yt,Kt,rt,bt,Re,ot,Et,vt,Wt,Zt,Xt,At,Qt,Jt,at,it,wt,Ct,te,ee,re,oe,U,ae,L,ie,se,ne,ce,le,pe,_t,z=class extends Ee{constructor(){super();u(this,r);u(this,F);u(this,E,[]);u(this,S,[]);u(this,k,new Map);u(this,R,new Map);u(this,_,[]);u(this,$,[]);u(this,O,new Map);u(this,v,new Set);u(this,Y);u(this,T,!1);u(this,w,0);u(this,C,1);u(this,G,!1);u(this,V,!1);u(this,N,0);u(this,I,null);u(this,P,null);u(this,q,!1);u(this,H,null);u(this,D,null);u(this,j,!1);u(this,K,!1);u(this,W,t=>{let e=t.target;if(e?.parentElement===this){s(this,r,Ft).call(this,t.detail,e);return}e?.closest?.("merch-card")?.parentElement===this&&s(this,r,mt).call(this)});u(this,Z,t=>{var e;t.target?.parentElement===this&&(d(this,_,[]),d(this,$,[]),d(this,S,[]),d(this,E,[]),a(this,k).clear(),a(this,R).clear(),a(this,O).clear(),d(this,v,new Set),this.requestUpdate(),(e=a(this,P))==null||e.call(this,!1),d(this,I,null),d(this,P,null))});u(this,X,()=>s(this,r,B).call(this));u(this,Q,t=>{t.target?.parentElement===this&&s(this,r,mt).call(this)});d(this,F,this.attachInternals?.()),a(this,F)&&(a(this,F).role="table")}connectedCallback(){super.connectedCallback(),this.addEventListener(dt,a(this,X)),this.addEventListener(ct,a(this,W)),this.addEventListener(lt,a(this,Z)),this.addEventListener(pt,a(this,Q)),d(this,Y,new ResizeObserver(()=>s(this,r,bt).call(this))),a(this,Y).observe(this),s(this,r,At).call(this),s(this,r,at).call(this)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(dt,a(this,X)),this.removeEventListener(ct,a(this,W)),this.removeEventListener(lt,a(this,Z)),this.removeEventListener(pt,a(this,Q)),a(this,Y)?.disconnect(),a(this,N)&&(cancelAnimationFrame(a(this,N)),d(this,N,0)),s(this,r,wt).call(this)}firstUpdated(){s(this,r,B).call(this),s(this,r,it).call(this)}willUpdate(t){t.has("expandedGroups")&&s(this,r,ft).call(this)}updated(t){(t.has("consonant")||t.has("spectrum"))&&s(this,r,gt).call(this),(t.has("stickyOffset")||t.has("mobileStickyOffset")||t.has("stickyTop")||t.has("collapsed")||t.has("nonSticky"))&&(s(this,r,at).call(this),s(this,r,it).call(this))}checkReady(){if(!this.querySelector(":scope > aem-fragment"))return Promise.resolve(!0);s(this,r,ut).call(this);let e=new Promise(o=>setTimeout(()=>o(!1),ve));return Promise.race([a(this,I),e])}render(){return this.collapsed?b:A`
            <div
        ...
        </span>`:b},st(z,"properties",{expandedGroups:{type:String,attribute:"expanded-groups",reflect:!0},collapsed:{type:Boolean,attribute:"collapsed",reflect:!0},consonant:{type:Boolean,attribute:"consonant"},spectrum:{type:String,attribute:"spectrum"},stickyOffset:{type:String,attribute:"sticky-offset"},mobileStickyOffset:{type:String,attribute:"mobile-sticky-offset"},stickyTop:{type:String,attribute:"sticky-top"},nonSticky:{type:Boolean,attribute:"non-sticky"}}),st(z,"styles",Mt);customElements.get(It)||customElements.define(It,z);export{z as MasCompareChart};
