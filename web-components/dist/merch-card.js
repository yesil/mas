...
var ti = (i, t, e) =>
    t in i
        ? Ht(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
        : (i[t] = e);
var ri = (i, t) => () => (i && (t = i((i = 0))), t);
var ii = (i, t) => {
    for (var e in t) Ht(i, e, { get: t[e], enumerable: !0 });
};
var d = (i, t, e) => ti(i, typeof t != 'symbol' ? t + '' : t, e),
    ut = (i, t, e) => t.has(i) || Ut('Cannot ' + e);
var c = (i, t, e) => (
        ut(i, t, 'read from private field'), e ? e.call(i) : t.get(i)
    ),
    g = (i, t, e) =>
        t.has(i)
            ? Ut('Cannot add the same private member more than once')
            : t instanceof WeakSet
              ? t.add(i)
              : t.set(i, e),
    h = (i, t, e, r) => (
        ut(i, t, 'write to private field'), r ? r.call(i, e) : t.set(i, e), e
    ),
    w = (i, t, e) => (ut(i, t, 'access private method'), e);
var qt = (i, t, e, r) => ({
    set _(a) {
        h(i, t, a, e);
    },
...
var ft = {};
ii(ft, { default: () => Y });
import { LitElement as ai, html as Ve, css as ni } from '/deps/lit-all.min.js';
function oi() {
    return (
...
var Y,
    ...
    `,
        ...
        customElements.define('mas-mnemonic', Y);
    });
import { LitElement as La } from '/deps/lit-all.min.js';
import { css as Gt, unsafeCSS as jt } from '/deps/lit-all.min.js';
var L = '(max-width: 767px)',
    P = '(max-width: 1199px)',
    x = '(min-width: 768px)',
    u = '(min-width: 1200px)',
    N = '(min-width: 1600px)';
function Ue() {
    return window.matchMedia(L);
}
function qe() {
...
import { LitElement as si, html as Kt, css as ci } from '/deps/lit-all.min.js';
function di() {
    return (
        customElements.get('sp-tooltip') !== void 0 ||
        document.querySelector('sp-theme') !== null
    ...
    handleTooltips() {
        ...
        this.querySelectorAll('sp-tooltip, overlay-trigger').forEach((e) => {
            ...
            if (e.tagName === 'SP-TOOLTIP')
                (r = e.textContent), (a = e.getAttribute('placement') || 'top');
            else if (e.tagName === 'OVERLAY-TRIGGER') {
                let n = e.querySelector('sp-tooltip');
                n &&
                    ((r = n.textContent),
                    (a =
                        n.getAttribute('placement') ||
                        e.getAttribute('placement') ||
                        'top'));
            }
            if (r) {
                let n = document.createElement('mas-mnemonic');
                n.setAttribute('content', r), n.setAttribute('placement', a);
                let o = this.querySelector('img'),
                    s = this.querySelector('a');
                s && s.contains(o) ? n.appendChild(s) : o && n.appendChild(o),
                    (this.innerHTML = ''),
                    this.appendChild(n),
                    Promise.resolve().then(() => xt());
            }
            e.remove();
        });
    }
...
customElements.define('merch-icon', oe);
...
var b = 'span[is="inline-price"][data-wcs-osi]',
    H =
        'a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';
var li = 'a[is="upt-link"]',
    Wt = `${b},${H},${li}`;
var Qt = 'merch-offer-select:ready',
    Xt = 'merch-card:action-menu-toggle';
var bt = 'merch-quantity-selector:change',
    Zt = 'merch-card-quantity:change',
    vt = 'merch-modal:addon-and-quantity-update';
var se = 'aem:load',
    ce = 'aem:error',
    Jt = 'mas:ready',
    er = 'mas:error',
    tr = 'placeholder-failed',
    rr = 'placeholder-pending',
    ir = 'placeholder-resolved';
var ar = 'mas:failed',
    Te = 'mas:resolved',
    nr = 'mas/commerce';
var U = 'failed',
...
var Ke = ':start',
    We = ':duration';
var or = 'legal';
var hi = 'mas-commerce-service';
function sr(i, t) {
    let e;
    return function () {
        let r = this,
            a = arguments;
        clearTimeout(e), (e = setTimeout(() => i.apply(r, a), t));
    };
}
function S(i, t = {}, e = null, r = null) {
    let a = r
        ? document.createElement(i, { is: r })
        : document.createElement(i);
    e instanceof HTMLElement ? a.appendChild(e) : (a.innerHTML = e);
    for (let [n, o] of Object.entries(t)) a.setAttribute(n, o);
    return a;
}
function de(i) {
    return `startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`;
}
function cr() {
    return window.matchMedia('(max-width: 1024px)').matches;
}
function W() {
    return document.getElementsByTagName(hi)?.[0];
}
function Le(i) {
    let t = window.getComputedStyle(i);
    return (
        i.offsetHeight + parseFloat(t.marginTop) + parseFloat(t.marginBottom)
    );
}
var _e,
    Q,
    ...
    Qe = class extends HTMLElement {
            ...
            h(
                ...
                sr(() => {
                    this.isConnected &&
                        ...
                        c(this, Q)
                            ? (this.parentElement.style.borderRadius = c(
                                  this,
                                  Q,
                              ))
                            : c(this, Q) === '' &&
        ...
        get value() {
            let e = c(this, Pe)
                ...
                .join(', ');
            return `linear-gradient(${c(this, _e)}, ${e})`;
        }
        connectedCallback() {
            c(this, le).call(this);
        }
        attributeChangedCallback(e, r, a) {
            e === 'border-radius' && h(this, Q, a?.trim()),
                e === 'colors' && a
                    ? h(this, Pe, a?.split(',').map((n) => n.trim()) ?? [])
                    : e === 'positions' && a
                      ? h(this, Re, a?.split(',').map((n) => n.trim()) ?? [])
                      : e === 'angle' && h(this, _e, a?.trim() ?? ''),
                c(this, le).call(this);
        }
    };
(_e = new WeakMap()),
    ...
    (Re = new WeakMap()),
    (le = new WeakMap());
customElements.define('merch-gradient', Qe);
import { LitElement as pi, html as mi, css as gi } from '/deps/lit-all.min.js';
var he = class extends pi {
    constructor() {
        super(),
    ...
    getOsi(t, e) {
        let n = (
            ...
            .join(', ');
        return this.querySelector(n)?.dataset?.wcsOsi;
    }
    connectedCallback() {
        super.connectedCallback(),
            this.addEventListener(Te, this.updatePlanType);
    }
    disconnectedCallback() {
        super.disconnectedCallback(),
            this.removeEventListener(Te, this.updatePlanType);
    }
    updatePlanType(t) {
        ...
        let e = t.target,
            r = e?.value?.[0];
        r &&
            (e.setAttribute('data-offer-type', r.offerType),
            e.closest('p').setAttribute('data-plan-type', r.planType));
    }
    handleChange(t) {
...
customElements.define('merch-addon', he);
import { html as Xe, nothing as ui } from '/deps/lit-all.min.js';
var pe,
    Me = class Me {
        constructor(t) {
            d(this, 'card');
        ...
        insertVariantStyle() {
            if (!Me.styleMap[this.card.variant]) {
                Me.styleMap[this.card.variant] = !0;
                let t = document.createElement('style');
                (t.innerHTML = this.getGlobalCSS()),
                    document.head.appendChild(t);
            }
        }
        updateCardElementMinHeight(t, e) {
            if (!t) return;
            let r = `--consonant-merch-card-${this.card.variant}-${e}-height`,
                a = Math.max(
                    0,
                    parseInt(window.getComputedStyle(t).height) || 0,
                ),
                n =
                    parseInt(this.getContainer().style.getPropertyValue(r)) ||
                    0;
            a > n && this.getContainer().style.setProperty(r, `${a}px`);
        }
        get badge() {
            let t;
            if (
        ...
        get secureLabel() {
            return this.card.secureLabel
                ? Xe`<span class="secure-transaction-label"
        ...
        async adjustTitleWidth() {
            let t = this.card.getBoundingClientRect().width,
                e = this.card.badgeElement?.getBoundingClientRect().width || 0;
            t === 0 ||
                e === 0 ||
                this.card.style.setProperty(
                    '--consonant-merch-card-heading-xs-max-width',
                    `${Math.round(t - e - 16)}px`,
                );
        }
        ...
        get aemFragmentMapping() {
            return Ze(this.card.variant);
        }
    };
(pe = new WeakMap()), d(Me, 'styleMap', {});
var v = Me;
import { html as yt, css as fi } from '/deps/lit-all.min.js';
var dr = `
:root {
...
var lr = {
    ...
    me = class extends v {
        constructor(e) {
            super(e);
            d(this, 'dispatchActionMenuToggle', () => {
            ...
            d(this, 'toggleActionMenu', (e) => {
                ...
                let r = this.actionMenuContentSlot.classList.contains('hidden');
                r || this.dispatchActionMenuToggle(),
                    this.setAriaExpanded(this.actionMenu, (!r).toString());
            });
            d(this, 'toggleActionMenuFromCard', (e) => {
                let r = e?.type === 'mouseleave' ? !0 : void 0;
                this.card.blur(),
...
import { html as ze } from '/deps/lit-all.min.js';
var hr = `
:root {
    ...
    renderLayout() {
        return ze`${this.cardImage}
            <div class="body">
                ...
                ${
                    this.promoBottom
                        ? ze`<slot name="body-xs"></slot
                          ><slot name="promo-text"></slot>`
                        : ze`<slot name="promo-text"></slot
                          ><slot name="body-xs"></slot>`
                }
            </div>
            ${
...
import { html as mr } from '/deps/lit-all.min.js';
var pr = `
:root {
...
var et = class extends v {
    ...
    renderLayout() {
        return mr` ${this.badge}
            ...
            ${this.card.customHr ? '' : mr`<hr />`} ${this.secureLabelFooter}`;
    }
};
import { html as ge, css as xi, unsafeCSS as ur } from '/deps/lit-all.min.js';
var gr = `
  :root {
    ...
    ue = class extends v {
        constructor(e) {
            ...
            d(
                ...
                (e) => `--consonant-merch-card-footer-row-${e}-min-height`,
            );
            d(this, 'getMiniCompareFooter', () => {
                let e = this.card.secureLabel
                    ? ge`<slot name="secure-transaction-label">
                  <span class="secure-transaction-label"
                      >${this.card.secureLabel}</span
                  ></slot
              >`
                    : ge`<slot name="secure-transaction-label"></slot>`;
                return ge`<footer>${e}<slot name="footer"></slot></footer>`;
            });
        }
        getGlobalCSS() {
            return gr;
        ...
        adjustMiniCompareBodySlots() {
            ...
            this.card.classList.contains('bullet-list') &&
                ...
                e.forEach((a) =>
                    this.updateCardElementMinHeight(
                        this.card.shadowRoot.querySelector(`slot[name="${a}"]`),
                        a,
                    ),
                ),
                this.updateCardElementMinHeight(
        ...
        adjustMiniCompareFooterRows() {
            ...
            let e = this.card.querySelector('[slot="footer-rows"] ul');
            !e ||
                !e.children ||
                [...e.children].forEach((r, a) => {
                    let n = Math.max(
                            bi,
                            parseFloat(window.getComputedStyle(r).height) || 0,
                        ),
                        o =
                            parseFloat(
                                this.getContainer().style.getPropertyValue(
                                    this.getRowMinHeightPropertyName(a + 1),
                                ),
                            ) || 0;
                    n > o &&
                        this.getContainer().style.setProperty(
        ...
        removeEmptyRows() {
            this.card.querySelectorAll('.footer-row-cell').forEach((r) => {
                let a = r.querySelector('.footer-row-cell-description');
                a && !a.textContent.trim() && r.remove();
            });
        }
        get mainPrice() {
        ...
        toggleAddon(e) {
            let r = this.mainPrice,
                a = this.headingMPriceSlot;
            if (!r && a) {
                let n = e?.getAttribute('plan-type'),
                    o = null;
                if (
                    (e &&
                        n &&
        ...
        async adjustAddon() {
            ...
            let e = this.card.addon;
            if (!e) return;
            let r = this.mainPrice,
                a = this.card.planType;
            if (
                (r && (await r.onceSettled(), (a = r.value?.[0]?.planType)), !a)
            )
                return;
            (e.planType = a),
                this.card
        ...
        renderLayout() {
            return ge` <div class="top-section${this.badge ? ' badge' : ''}">
                <slot name="icons"></slot> ${this.badge}
            </div>
            <slot name="heading-m"></slot>
            ${
                this.card.classList.contains('bullet-list')
                    ? ge`<slot name="heading-m-price"></slot>
                      <slot name="price-commitment"></slot>
                      <slot name="body-xxs"></slot>
                      <slot name="promo-text"></slot>
                      <slot name="body-m"></slot>
                      <slot name="offers"></slot>`
                    : ge`<slot name="body-m"></slot>
        ...
        async postCardUpdateHook() {
            await Promise.all(this.card.prices.map((e) => e.onceSettled())),
...
import { html as Oe, css as vi, nothing as tt } from '/deps/lit-all.min.js';
var fr = `
:root {
...
var rt = {
    ...
    xr = {
        ...(function () {
            let { whatsIncluded: i, size: t, ...e } = rt;
            return e;
        })(),
    ...
    A = class extends v {
        ...
        priceOptionsProvider(t, e) {
            t.dataset.template === or &&
                (e.displayPlanType =
        ...
        adjustSlotPlacement(t, e, r) {
            let a = this.card.shadowRoot,
                n = a.querySelector('footer'),
                o = this.card.getAttribute('size');
            if (!o) return;
            let s = a.querySelector(`footer slot[name="${t}"]`),
                l = a.querySelector(`.body slot[name="${t}"]`),
                p = a.querySelector('.body');
            if (
                (o.includes('wide') ||
                    (n?.classList.remove('wide-footer'), s && s.remove()),
                !!e.includes(o))
            ) {
                if ((n?.classList.toggle('wide-footer', Ge()), !r && s)) {
                    if (l) s.remove();
                    else {
                        let m = p.querySelector(
                            `[data-placeholder-for="${t}"]`,
                        );
                        m ? m.replaceWith(s) : p.appendChild(s);
                    }
                    return;
                }
                if (r && l) {
                    ...
                    if (
                        (m.setAttribute('data-placeholder-for', t),
                        m.classList.add('slot-placeholder'),
                        !s)
                    ) {
                        let f = l.cloneNode(!0);
                        n.prepend(f);
        ...
        adaptForMedia() {
            ...
            this.adjustSlotPlacement('addon', ['super-wide'], Ge()),
            ...
            t &&
                ...
                document.addEventListener('touchstart', (e) => {
                    e.preventDefault(),
                        e.target !== t
                            ? t.classList.add('hide-tooltip')
                            : e.target.classList.toggle('hide-tooltip');
                }),
                document.addEventListener('mouseover', (e) => {
                    e.preventDefault(),
                        e.target !== t
                            ? t.classList.add('hide-tooltip')
                            : e.target.classList.remove('hide-tooltip');
                }));
        }
        async adjustEduLists() {
            if (
                ...
                return;
            let e = this.card.querySelector('[slot="body-xs"]');
            if (!e) return;
            let r = e.querySelector('ul');
            if (!r) return;
            let a = r.previousElementSibling,
                n = document.createElement('div');
            n.classList.add('spacer'), e.insertBefore(n, a);
            let o = new IntersectionObserver(([s]) => {
                if (s.boundingClientRect.height === 0) return;
                let l = 0,
                    p = this.card.querySelector('[slot="heading-s"]');
                p && (l += Le(p));
                let m = this.card.querySelector('[slot="subtitle"]');
                m && (l += Le(m));
                let f = this.card.querySelector('[slot="heading-m"]');
                f && (l += 8 + Le(f));
                for (let ne of e.childNodes) {
                    if (ne.classList.contains('spacer')) break;
                    l += Le(ne);
                }
                let T = this.card.parentElement.style.getPropertyValue(
            ...
            if (!this.legalAdjusted)
                try {
                    ...
                    let r = t.map(async (a) => {
                        ...
                        await a.onceSettled(),
                            a?.options &&
                                (a.options.displayPerUnit &&
                                    (a.dataset.displayPerUnit = 'false'),
                                a.options.displayTax &&
                                    (a.dataset.displayTax = 'false'),
                                a.options.displayPlanType &&
                                    (a.dataset.displayPlanType = 'false'),
                                n.setAttribute('data-template', 'legal'),
        ...
        async adjustAddon() {
            ...
            let e = this.mainPrice;
            if (!e) return;
            await e.onceSettled();
            let r = e.value?.[0]?.planType;
            r && (t.planType = r);
        }
        get stockCheckbox() {
            return this.card.checkboxLabel
                ? Oe`<label id="stock-checkbox">
        ...
        connectedCallbackHook() {
            ...
            let e = qe();
            e?.addEventListener &&
                e.addEventListener('change', this.adaptForMedia);
        }
        disconnectedCallbackHook() {
            let t = Ue();
            ...
            e?.removeEventListener &&
                e.removeEventListener('change', this.adaptForMedia);
        }
        renderLayout() {
...
d(
    ...
    d(A, 'collectionOptions', {
        customHeaderArea: (t) =>
            t.sidenav ? Oe`<slot name="resultsText"></slot>` : tt,
        headerVisibility: {
            search: !1,
            sort: !1,
...
import { html as Et, css as yi } from '/deps/lit-all.min.js';
var vr = `
:root {
...
var fe = class extends v {
    ...
    adjustProductBodySlots() {
        ...
        [
            ...
            this.updateCardElementMinHeight(
                this.card.shadowRoot.querySelector(`slot[name="${e}"]`),
                e,
            ),
        );
    }
    renderLayout() {
        return Et` ${this.badge}
    ...
    postCardUpdateHook() {
        this.card.isConnected &&
            (this.adjustAddon(),
            je() || this.adjustProductBodySlots(),
            this.adjustTitleWidth());
    }
    get headingXSSlot() {
        return this.card.shadowRoot
    ...
    toggleAddon(t) {
        let e = this.mainPrice,
            r = this.headingXSSlot;
        if (!e && r) {
            let a = t?.getAttribute('plan-type'),
                n = null;
            if (
                (t &&
                    a &&
    ...
    async adjustAddon() {
        ...
        if (!t) return;
        let e = this.mainPrice,
            r = this.card.planType;
        e && (await e.onceSettled(), (r = e.value?.[0]?.planType)),
            r && (t.planType = r);
    }
};
d(
...
import { html as wt, css as Ei } from '/deps/lit-all.min.js';
var yr = `
:root {
...
import { html as St, css as wi } from '/deps/lit-all.min.js';
var Er = `
:root {
...
import { html as Si, css as Ai } from '/deps/lit-all.min.js';
var Sr = `
:root {
...
`;
var it = () => window.matchMedia(P).matches,
    At = {
    ...
    ve = class extends v {
        ...
        setupAccordion() {
            ...
            let e = () => {
                if (it()) {
                    let a = t.hasAttribute('data-default-card');
                    t.setAttribute('data-expanded', a ? 'true' : 'false');
                } else t.removeAttribute('data-expanded');
            };
            e();
            let r = window.matchMedia(P);
            (this.mediaQueryListener = () => {
                e();
            }),
                r.addEventListener('change', this.mediaQueryListener),
                (this.attributeObserver = new MutationObserver((a) => {
                    a.forEach((n) => {
                        n.type === 'attributes' &&
                            n.attributeName === 'data-default-card' &&
                            this.card.hasAttribute('data-default-card') &&
                            it() &&
                            this.card.setAttribute('data-expanded', 'true');
                    });
        ...
        handleChevronClick(t) {
            ...
            if (!e || !it()) return;
            let n =
                e.getAttribute('data-expanded') === 'true' ? 'false' : 'true';
...
import { css as ki, html as Ci } from '/deps/lit-all.min.js';
var Ar = `
    ...
    ye = class extends v {
        ...
        priceOptionsProvider(e, r) {
            (r.literals = {
                ...
                (r.space = !0),
                (r.displayAnnual = this.card.settings?.displayAnnual ?? !1);
        }
        adjustLegal() {
            if (this.legal !== void 0) return;
            let e = this.card.querySelector(`${b}[data-template="price"]`);
            if (!e) return;
            let r = e.cloneNode(!0);
            (this.legal = r),
                (e.dataset.displayTax = 'false'),
                (r.dataset.template = 'legal'),
                (r.dataset.displayPlanType =
                    this.card?.settings?.displayPlanType ?? !0),
                r.setAttribute('slot', 'legal'),
...
k('catalog', me, lr, me.variantStyle);
k('image', Je);
k('inline-heading', et);
k('mini-compare-chart', ue, null, ue.variantStyle);
k('plans', A, rt, A.variantStyle, A.collectionOptions);
k('plans-students', A, br, A.variantStyle, A.collectionOptions);
k('plans-education', A, xr, A.variantStyle, A.collectionOptions);
k('product', fe, null, fe.variantStyle);
k('segment', xe, null, xe.variantStyle);
k('special-offers', be, wr, be.variantStyle);
k('simplified-pricing-express', ve, At, ve.variantStyle);
k('mini', ye, kr, ye.variantStyle);
var kt = (i) => {
    let t = at.get(i.variant);
    if (!t) return;
    let { class: e, style: r } = t;
    if (r)
        try {
            let a = new CSSStyleSheet();
            a.replaceSync(r.cssText), i.shadowRoot.adoptedStyleSheets.push(a);
        } catch {
            let n = document.createElement('style');
            (n.textContent = r.cssText), i.shadowRoot.appendChild(n);
        }
    return new e(i);
};
function Ze(i) {
    return at.get(i)?.fragmentMapping;
}
function Cr(i) {
    return at.get(i)?.collectionOptions;
}
var Tr = document.createElement('style');
Tr.innerHTML = `
:root {
...
function nt(
    i,
    t = {},
    { metadata: e = !0, search: r = !0, storage: a = !0 } = {},
) {
    let n;
    if (r && n == null) {
    ...
    if (a && n == null) {
        let o = Ct(a) ? a : i;
        n = window.sessionStorage.getItem(o) ?? window.localStorage.getItem(o);
    }
    if (e && n == null) {
        let o = Li(Ct(e) ? e : i);
        n = document.documentElement.querySelector(
            `meta[name="${o}"]`,
        )?.content;
    }
    return n ?? t[i];
}
var Ti = (i) => typeof i == 'boolean',
    ot = (i) => typeof i == 'function';
var Ct = (i) => typeof i == 'string';
function Lr(i, t) {
    if (Ti(i)) return i;
    let e = String(i);
    return e === '1' || e === 'true' ? !0 : e === '0' || e === 'false' ? !1 : t;
}
function Li(i = '') {
    return String(i)
        .replace(
...
var X = class i extends Error {
    constructor(t, e, r) {
        if ((super(t, { cause: r }), (this.name = 'MasError'), e.response)) {
            let a = e.response.headers?.get(Ye);
            a && (e.requestId = a),
                e.response.status &&
                    ((e.status = e.response.status),
                    (e.statusText = e.response.statusText)),
                e.response.url && (e.url = e.response.url);
        }
        delete e.response,
            (this.context = e),
...
var st = (i) => window.setTimeout(i);
function Tt() {
    return document.getElementsByTagName(_i)?.[0];
}
function _r(i) {
    let t = {};
    if (!i?.headers) return t;
    let e = i.headers;
    for (let [r, a] of Object.entries(Pi)) {
        let n = e.get(a);
        n &&
            ((n = n.replace(/[,;]/g, '|')),
            (n = n.replace(/[| ]+/g, '|')),
...
async function Pr(i, t = {}, e = 2, r = 100) {
    let a;
    for (let n = 0; n <= e; n++)
        try {
            let o = await fetch(i, t);
            return (o.retryCount = n), o;
        } catch (o) {
            if (((a = o), (a.retryCount = n), n > e)) break;
            await new Promise((s) => setTimeout(s, r * (n + 1)));
        }
    throw a;
}
var Rr = 'fragment',
    ...
    _t = class {
        ...
        clear() {
            c(this, $).clear(), c(this, Z).clear(), c(this, R).clear();
        }
        add(t, e = !0) {
            if (!this.has(t.id) && !this.has(t.fields?.originalId)) {
                if (
                    (c(this, $).set(t.id, t),
                    t.fields?.originalId &&
                        c(this, $).set(t.fields.originalId, t),
                    c(this, R).has(t.id))
                ) {
                    let [, r] = c(this, R).get(t.id);
                    r();
                }
                if (c(this, R).has(t.fields?.originalId)) {
                    let [, r] = c(this, R).get(t.fields?.originalId);
                    r();
                }
                if (
                    !(
                    ...
                    for (let r in t.references) {
                        let { type: a, value: n } = t.references[r];
                        a === 'content-fragment' &&
                            ((n.settings = { ...t?.settings, ...n.settings }),
                            (n.placeholders = {
                                ...t?.placeholders,
                                ...n.placeholders,
                            }),
        ...
        remove(t) {
            c(this, $).delete(t), c(this, Z).delete(t), c(this, R).delete(t);
        }
    };
($ = new WeakMap()), (Z = new WeakMap()), (R = new WeakMap());
var j = new _t(),
    Ee,
    I,
    F,
    ...
    ct = class extends HTMLElement {
        ...
        static get observedAttributes() {
            return [Rr, Or, Nr, Mr, zr];
        }
        attributeChangedCallback(e, r, a) {
            e === Rr && (h(this, C, a), h(this, y, j.getFetchInfo(a))),
                e === Or && Ri.includes(a) && h(this, Ne, a),
                e === Nr && h(this, $e, parseInt(a, 10)),
                e === Mr && h(this, Ie, ['', 'true'].includes(a)),
                e === zr && h(this, we, a);
        }
        connectedCallback() {
            if (!c(this, M)) {
                if (
                    (c(this, _) ?? h(this, _, W(this)),
                    h(this, we, c(this, _).settings?.preview),
                    c(this, Ee) ??
                        h(
                            this,
                            Ee,
                            c(this, _).log.module(`${Lt}[${c(this, C)}]`),
                        ),
                    !c(this, C) || c(this, C) === '#')
                ) {
                    c(this, y) ??
                        h(this, y, j.getFetchInfo('missing-fragment-id')),
                        w(this, z, Pt).call(this, 'Missing fragment id');
                    return;
                }
                this.refresh(!1);
            }
        ...
        get fetchInfo() {
            return Object.fromEntries(
                Object.entries(c(this, y))
                    .filter(([e, r]) => r != null)
                    .map(([e, r]) => [`aem-fragment:${e}`, r]),
            );
        }
        async refresh(e = !0) {
            if (
                c(this, M) &&
                !(await Promise.race([c(this, M), Promise.resolve(!1)]))
            )
                return;
            e && j.remove(c(this, C)),
                c(this, Ne) === Ir &&
                    (await Promise.race([
                        j.getAsPromise(c(this, C)),
                        new Promise((s) => setTimeout(s, c(this, $e))),
                    ]));
            try {
                h(this, M, w(this, z, Br).call(this)), await c(this, M);
            } catch (s) {
                return w(this, z, Pt).call(this, s.message), !1;
            }
            let {
                references: r,
                referencesTree: a,
            ...
            return (
                o &&
                    !nt('mas.disableWcsCache') &&
                    c(this, _).prefillWcsCache(o),
                this.dispatchEvent(
                    new CustomEvent(se, {
                        detail: {
                            ...this.data,
        ...
        transformAuthorData() {
            ...
            h(
                ...
                F,
                e.reduce(
                    (p, { name: m, multiple: f, values: T }) => (
                        (p.fields[m] = f ? T : T[0]), p
                    ),
                    {
                        fields: {},
                        id: r,
        ...
        transformPublishData() {
            ...
            h(
                ...
                Object.entries(e).reduce(
                    (p, [m, f]) => (
                        (p.fields[m] = f?.mimeType ? f.value : (f ?? '')), p
                    ),
                    {
                        fields: {},
                        id: r,
        ...
        getFragmentClientUrl() {
            let r = new URLSearchParams(window.location.search).get('maslibs');
            if (!r || r.trim() === '')
                return 'https://mas.adobe.com/studio/libs/fragment-client.js';
            let a = r.trim().toLowerCase();
            if (a === 'local')
                return 'http://localhost:3030/studio/libs/fragment-client.js';
            let { hostname: n } = window.location,
                o = n.endsWith('.page') ? 'page' : 'live';
            return a.includes('--')
                ? `https://${a}.aem.${o}/studio/libs/fragment-client.js`
                : `https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`;
        }
        async generatePreview() {
            let e = this.getFragmentClientUrl(),
                { previewFragment: r } = await import(e);
            return await r(c(this, C), {
                locale: c(this, _).settings.locale,
                apiKey: c(this, _).settings.wcsApiKey,
            });
        }
    };
(Ee = new WeakMap()),
    ...
    (Dr = async function (e) {
        qt(this, De)._++;
        let r = `${Lt}:${c(this, C)}:${c(this, De)}`,
            a = `${r}${Ke}`,
            n = `${r}${We}`;
        if (c(this, we)) return await this.generatePreview();
        performance.mark(a);
        let o;
        try {
            if (
                ((c(this, y).stale = !1),
                (c(this, y).url = e),
                (o = await Pr(e, { cache: 'default', credentials: 'omit' })),
                w(this, z, Fr).call(this, o),
                (c(this, y).status = o?.status),
                (c(this, y).measure = de(performance.measure(n, a))),
                (c(this, y).retryCount = o.retryCount),
                !o?.ok)
            )
                throw new X('Unexpected fragment response', {
                    response: o,
                    ...c(this, _).duration,
                });
            return await o.json();
            ...
            if (
                ((c(this, y).measure = de(performance.measure(n, a))),
                (c(this, y).retryCount = s.retryCount),
                c(this, I))
            )
                return (
                    (c(this, y).stale = !0),
                    c(this, Ee).error('Serving stale data', c(this, y)),
                    c(this, I)
                );
            let l = s.message ?? 'unknown';
            throw new X(`Failed to fetch fragment: ${l}`, {});
        }
    }),
    (Fr = function (e) {
        Object.assign(c(this, y), _r(e));
    }),
    (Pt = function (e) {
        h(this, M, null), (c(this, y).message = e), this.classList.add('error');
        let r = { ...c(this, y), ...c(this, _).duration };
        c(this, Ee).error(e, r),
            this.dispatchEvent(
                new CustomEvent(ce, { detail: r, bubbles: !0, composed: !0 }),
            );
    }),
    (Br = async function () {
        var l;
        this.classList.remove('error'), h(this, F, null);
        let e = j.get(c(this, C));
        if (e) return h(this, I, e), !0;
        let {
                masIOUrl: r,
                wcsApiKey: a,
                country: n,
            ...
            s = `${r}/fragment?id=${c(this, C)}&api_key=${a}&locale=${o}`;
        return (
            n && !o.endsWith(`_${n}`) && (s += `&country=${n}`),
            (e = await w(this, z, Dr).call(this, s)),
            (l = e.fields).originalId ?? (l.originalId = c(this, C)),
            j.add(e),
            h(this, I, e),
            !0
        );
    ...
    d(ct, 'cache', j);
customElements.define(Lt, ct);
import { LitElement as Mi, html as zi, css as Oi } from '/deps/lit-all.min.js';
var Se = class extends Mi {
    constructor() {
        super(),
            (this.color = ''),
            (this.variant = ''),
    ...
    render() {
        return zi`<div class="badge">${this.text}</div>`;
    }
};
d(Se, 'properties', {
    color: { type: String },
...
customElements.define('merch-badge', Se);
import { html as Ni, css as $i, LitElement as Ii } from '/deps/lit-all.min.js';
var Fe = class extends Ii {
    constructor() {
        super();
    }
    render() {
...
d(
    ...
    d(Fe, 'properties', { description: { type: String, attribute: !0 } });
customElements.define('merch-mnemonic-list', Fe);
import { html as Rt, css as Di, LitElement as Fi } from '/deps/lit-all.min.js';
var Be = class extends Fi {
    updated() {
        this.hideSeeMoreEls();
    }
    hideSeeMoreEls() {
        this.isMobile &&
            this.rows.forEach((t, e) => {
                e >= 5 && (t.style.display = this.showAll ? 'flex' : 'none');
            });
    }
    constructor() {
        super(),
    ...
    render() {
        return Rt`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${
                this.isMobile && this.rows.length > this.mobileRows
                    ? Rt`<div @click=${this.toggle} class="see-more">
...
customElements.define('merch-whats-included', Be);
var J = {
    ...
    Hr = 1e3;
function Bi(i) {
    return i instanceof Error || typeof i?.originatingRequest == 'string';
}
function Ur(i) {
    if (i == null) return;
    let t = typeof i;
    if (t === 'function') return i.name ? `function ${i.name}` : 'function';
    if (t === 'object') {
        if (i instanceof Error) return i.message;
        if (typeof i.originatingRequest == 'string') {
            let { message: r, originatingRequest: a, status: n } = i;
            return [r, n, a].filter(Boolean).join(' ');
        }
        let e =
            i[Symbol.toStringTag] ?? Object.getPrototypeOf(i).constructor.name;
        if (!J.serializableTypes.includes(e)) return e;
    }
    return i;
}
function Hi(i, t) {
    if (!J.ignoredProperties.includes(i)) return Ur(t);
}
var Mt = {
    append(i) {
        if (i.level !== 'error') return;
        let { message: t, params: e } = i,
            r = [],
            a = [],
            n = t;
        e.forEach((p) => {
            p != null && (Bi(p) ? r : a).push(p);
        }),
            r.length && (n += ' ' + r.map(Ur).join(' '));
        let { pathname: o, search: s } = window.location,
            l = `${J.delimiter}page=${o}${s}`;
        l.length > Hr && (l = `${l.slice(0, Hr)}<trunc>`),
            (n += l),
            a.length &&
                ((n += `${J.delimiter}facts=`), (n += JSON.stringify(a, Hi))),
            window.lana?.log(n, J);
    },
};
function qr(i) {
...
var jr = { LOCAL: 'local', PROD: 'prod', STAGE: 'stage' },
    zt = { DEBUG: 'debug', ERROR: 'error', INFO: 'info', WARN: 'warn' },
    Ot = new Set(),
    Nt = new Set(),
    Gr = new Map(),
    Vr = {
        append({ level: i, message: t, params: e, timestamp: r, source: a }) {
            console[i](`${r}ms [${a}] %c${t}`, 'font-weight: bold;', ...e);
        },
    },
    Yr = { filter: ({ level: i }) => i !== zt.DEBUG },
    Ui = { filter: () => !1 };
function qi(i, t, e, r, a) {
    return {
        level: i,
        message: t,
        namespace: e,
...
function ji(i) {
    [...Nt].every((t) => t(i)) && Ot.forEach((t) => t(i));
}
function Kr(i) {
    let t = (Gr.get(i) ?? 0) + 1;
    Gr.set(i, t);
    let e = `${i} #${t}`,
        r = {
            id: e,
            namespace: i,
            module: (a) => Kr(`${r.namespace}/${a}`),
            updateConfig: qr,
        };
    return (
        Object.values(zt).forEach((a) => {
            r[a] = (n, ...o) => ji(qi(a, n, i, o, e));
        }),
        Object.seal(r)
    );
}
function dt(...i) {
    i.forEach((t) => {
        let { append: e, filter: r } = t;
        ot(r) && Nt.add(r), ot(e) && Ot.add(e);
    });
}
function Gi(i = {}) {
    let { name: t } = i,
        e = Lr(
            nt('commerce.debug', { search: !0, storage: !0 }),
            t === jr.LOCAL,
        );
    return dt(e ? Vr : Yr), t === jr.PROD && dt(Mt), $t;
}
function Vi() {
    Ot.clear(), Nt.clear();
}
...
var Yi = { [U]: tr, [K]: rr, [q]: ir },
    Ki = { [U]: ar, [q]: Te },
    He,
    lt = class {
        constructor(t) {
            g(this, He);
            d(this, 'changes', new Map());
            d(this, 'connected', !1);
            d(this, 'error');
            d(this, 'log');
            d(this, 'options');
            ...
            d(this, 'value');
            d(this, 'version', 0);
            d(this, 'wrapperElement');
            (this.wrapperElement = t), (this.log = $t.module('mas-element'));
        }
        update() {
            [U, K, q].forEach((t) => {
                this.wrapperElement.classList.toggle(Yi[t], t === this.state);
            });
        }
        notify() {
            (this.state === q || this.state === U) &&
                (this.state === q
                    ? this.promises.forEach(({ resolve: e }) =>
                          e(this.wrapperElement),
                      )
                    : this.state === U &&
                      this.promises.forEach(({ reject: e }) => e(this.error)),
                (this.promises = []));
            let t = this.error;
            this.error instanceof X &&
                (t = { message: this.error.message, ...this.error.context }),
                this.wrapperElement.dispatchEvent(
                    new CustomEvent(Ki[this.state], { bubbles: !0, detail: t }),
                );
        }
        attributeChangedCallback(t, e, r) {
            this.changes.set(t, r), this.requestUpdate();
        }
        connectedCallback() {
            h(this, He, Tt()), this.requestUpdate(!0);
        }
        disconnectedCallback() {
            this.connected &&
                ((this.connected = !1),
        ...
        onceSettled() {
            let { error: t, promises: e, state: r } = this;
            return q === r
                ? Promise.resolve(this.wrapperElement)
                : U === r
                  ? Promise.reject(t)
                  : new Promise((a, n) => {
                        e.push({ resolve: a, reject: n });
                    });
        }
        toggleResolved(t, e, r) {
            return t !== this.version
                ? !1
                : (r !== void 0 && (this.options = r),
                  (this.state = q),
                  (this.value = e),
                  this.update(),
        ...
        toggleFailed(t, e, r) {
            ...
            r !== void 0 && (this.options = r),
                ...
                (this.state = U),
                this.update();
            let a = this.wrapperElement.getAttribute('is');
            return (
                this.log?.error(`${a}: Failed to render: ${e.message}`, {
                    element: this.wrapperElement,
                    ...e.context,
                    ...c(this, He)?.duration,
                }),
        ...
        requestUpdate(t = !1) {
            if (!this.wrapperElement.isConnected || !Tt() || this.timer) return;
            let { error: e, options: r, state: a, value: n, version: o } = this;
            (this.state = K),
                (this.timer = st(async () => {
                    this.timer = null;
                    let s = null;
                    if (
                        ...
                        try {
                            ...
                            this.toggleFailed(this.version, l, r);
                        }
                }));
        }
    };
He = new WeakMap();
function Wi(i) {
    return `https://${i === 'PRODUCTION' ? 'www.adobe.com' : 'www.stage.adobe.com'}/offers/promo-terms.html`;
}
var te,
    ee = class ee extends HTMLAnchorElement {
        constructor() {
            super();
            d(this, 'masElement', new lt(this));
            g(this, te);
            this.setAttribute('is', ee.is);
        }
        get isUptLink() {
            return !0;
        }
        initializeWcsData(e, r) {
            this.setAttribute('data-wcs-osi', e),
                r && this.setAttribute('data-promotion-code', r);
        }
        attributeChangedCallback(e, r, a) {
            this.masElement.attributeChangedCallback(e, r, a);
        }
        connectedCallback() {
            this.masElement.connectedCallback(),
                h(this, te, W()),
                c(this, te) && (this.log = c(this, te).log.module('upt-link'));
        }
        disconnectedCallback() {
            this.masElement.disconnectedCallback(), h(this, te, void 0);
        }
        requestUpdate(e = !1) {
            this.masElement.requestUpdate(e);
        }
        onceSettled() {
        ...
        async render() {
            ...
            this.dataset.imsCountry ||
                e.imsCountryPromise.then((o) => {
                    o && (this.dataset.imsCountry = o);
                });
            let r = e.collectCheckoutOptions({}, this);
            if (!r.wcsOsi)
                return (
                    this.log.error(
            ...
            let a = this.masElement.togglePending(r),
                n = e.resolveOfferSelectors(r);
            try {
                let [[o]] = await Promise.all(n),
                    { country: s, language: l, env: p } = r,
                    m = `locale=${l}_${s}&country=${s}&offer_id=${o.offerId}`,
                    f = this.getAttribute('data-promotion-code');
                f && (m += `&promotion_code=${encodeURIComponent(f)}`),
                    (this.href = `${Wi(p)}?${m}`),
                    this.masElement.toggleResolved(a, o, r);
            } catch (o) {
                let s = new Error(
                    `Could not resolve offer selectors for id: ${r.wcsOsi}.`,
                    o.message,
                );
                return this.masElement.toggleFailed(a, s, r), !1;
            }
        }
        static createFrom(e) {
            let r = new ee();
            for (let a of e.attributes)
                a.name !== 'is' &&
                    (a.name === 'class' && a.value.includes('upt-link')
                        ? r.setAttribute(
                              'class',
                              a.value.replace('upt-link', '').trim(),
                          )
                        : r.setAttribute(a.name, a.value));
            return (
                (r.innerHTML = e.innerHTML), r.setAttribute('tabindex', 0), r
            );
        }
    };
(te = new WeakMap()),
    d(ee, 'is', 'upt-link'),
    d(ee, 'tag', 'a'),
    d(ee, 'observedAttributes', [
        'data-wcs-osi',
        'data-promotion-code',
        'data-ims-country',
    ]);
var G = ee;
window.customElements.get(G.is) ||
    window.customElements.define(G.is, G, { extends: G.tag });
var Qi = '#000000',
    It = '#F8D904',
    Xi = '#EAEAEA',
    Zi = '#31A547',
    Ji = /(accent|primary|secondary)(-(outline|link))?/,
    ea = 'mas:product_code/',
    ta = 'daa-ll',
    pt = 'daa-lh',
    ra = ['XL', 'L', 'M', 'S'],
...
function O(i, t, e, r) {
    ...
    if (t[i] && a) {
        let n = { slot: a?.slot },
            o = t[i];
        if (a.maxCount && typeof o == 'string') {
            let [l, p] = va(o, a.maxCount, a.withSuffix);
            l !== o && ((n.title = p), (o = l));
        }
        let s = S(a.tag, n, o);
        e.append(s);
...
function ia(i, t, e) {
    let r = i.mnemonicIcon?.map((n, o) => ({
        icon: n,
        alt: i.mnemonicAlt[o] ?? '',
        link: i.mnemonicLink[o] ?? '',
    }));
    r?.forEach(({ icon: n, alt: o, link: s }) => {
        if (s && !/^https?:/.test(s))
            try {
        ...
        o && (l.alt = o), s && (l.href = s);
        let p = S('merch-icon', l);
        t.append(p);
    });
    let a = t.shadowRoot.querySelector('slot[name="icons"]');
    !r?.length && a && a.remove();
}
function aa(i, t, e) {
    if (e.badge?.slot) {
        if (i.badge?.length && !i.badge?.startsWith('<merch-badge')) {
            let r = It,
                a = !1;
            e.allowedBadgeColors?.includes(e.badge?.default) &&
                ((r = e.badge?.default), i.borderColor || (a = !0));
            let n = i.badgeBackgroundColor || r,
                o = i.borderColor || '';
            a && ((o = e.badge?.default), (i.borderColor = e.badge?.default)),
                (i.badge = `<merch-badge variant="${i.variant}" background-color="${n}" border-color="${o}">${i.badge}</merch-badge>`);
        }
        O('badge', i, t, e);
    } else
        i.badge
            ? (t.setAttribute('badge-text', i.badge),
              e.disabledAttributes?.includes('badgeColor') ||
                  t.setAttribute('badge-color', i.badgeColor || Qi),
              e.disabledAttributes?.includes('badgeBackgroundColor') ||
                  t.setAttribute(
                      'badge-background-color',
                      i.badgeBackgroundColor || It,
                  ),
              t.setAttribute('border-color', i.badgeBackgroundColor || It))
            : t.setAttribute('border-color', i.borderColor || Xi);
}
function na(i, t, e) {
    if (e.trialBadge && i.trialBadge) {
        if (!i.trialBadge.startsWith('<merch-badge')) {
            let r =
                (!e.disabledAttributes?.includes('trialBadgeBorderColor') &&
                    i.trialBadgeBorderColor) ||
                Zi;
            i.trialBadge = `<merch-badge variant="${i.variant}" border-color="${r}">${i.trialBadge}</merch-badge>`;
        }
        O('trialBadge', i, t, e);
    }
}
function oa(i, t, e) {
    e?.includes(i.size) && t.setAttribute('size', i.size);
}
function sa(i, t) {
    i.cardName && t.setAttribute('name', i.cardName);
}
function ca(i, t, e) {
    O('cardTitle', i, t, { cardTitle: e });
}
function da(i, t, e) {
    O('subtitle', i, t, e);
}
function la(i, t, e, r) {
    if (!i.backgroundColor || i.backgroundColor.toLowerCase() === 'default') {
    ...
    e?.[i.backgroundColor]
        ? (t.style.setProperty(
          ...
          t.setAttribute('background-color', i.backgroundColor))
        : r?.attribute &&
          i.backgroundColor &&
          (t.setAttribute(r.attribute, i.backgroundColor),
          t.style.removeProperty('--merch-card-custom-background-color'));
}
function ha(i, t, e) {
    let r = e?.borderColor,
        a = '--consonant-merch-card-border-color';
    if (i.borderColor?.toLowerCase() === 'transparent')
        t.style.setProperty(a, 'transparent');
    else if (i.borderColor && r)
        if (
            r?.specialValues?.[i.borderColor]?.includes('gradient') ||
            /-gradient/.test(i.borderColor)
        ) {
            t.setAttribute('gradient-border', 'true');
            let s = i.borderColor;
            if (r?.specialValues) {
                for (let [l, p] of Object.entries(r.specialValues))
                    if (p === i.borderColor) {
                        s = l;
                        break;
                    }
            }
            t.setAttribute('border-color', s), t.style.removeProperty(a);
        } else t.style.setProperty(a, `var(--${i.borderColor})`);
}
function pa(i, t, e) {
    if (i.backgroundImage) {
        let r = { loading: t.loading ?? 'lazy', src: i.backgroundImage };
        if (
            ...
            return;
        if (e?.attribute) {
            t.setAttribute(e.attribute, i.backgroundImage);
            return;
        }
        t.append(S(e.tag, { slot: e.slot }, S('img', r)));
    }
}
function ht(i) {
    return (
...
function ma(i, t, e) {
    i.prices && (i.prices = ht(i.prices)), O('prices', i, t, e);
}
function Qr(i, t, e) {
    let r = i.hasAttribute('data-wcs-osi') && !!i.getAttribute('data-wcs-osi'),
        a = i.className || '',
        n = Ji.exec(a)?.[0] ?? 'accent',
        o = n.includes('accent'),
        s = n.includes('primary'),
        l = n.includes('secondary'),
        p = n.includes('-outline'),
        m = n.includes('-link');
    i.classList.remove('accent', 'primary', 'secondary');
    let f;
    if (t.consonant) f = Sa(i, o, r, m, s);
    else if (m) f = i;
    else {
        let T;
        o ? (T = 'accent') : s ? (T = 'primary') : l && (T = 'secondary'),
            (f = t.spectrum === 'swc' ? wa(i, e, p, T, r) : Ea(i, e, p, T, r));
    }
    return f;
}
function ga(i, t) {
    let { slot: e } = t?.description,
        r = i.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);
    r.length &&
        r.forEach((a) => {
            let n = Qr(a, i, t);
            a.replaceWith(n);
...
function ua(i, t, e) {
    i.description && (i.description = ht(i.description)),
        i.promoText && (i.promoText = ht(i.promoText)),
        O('promoText', i, t, e),
        O('description', i, t, e),
        ga(t, e),
        O('callout', i, t, e),
        O('quantitySelect', i, t, e),
        O('whatsIncluded', i, t, e);
}
function fa(i, t, e) {
    if (!e.addon) return;
    let r = i.addon?.replace(/[{}]/g, '');
    if (!r || /disabled/.test(r)) return;
    let a = S('merch-addon', { slot: 'addon' }, r);
    [...a.querySelectorAll(b)].forEach((n) => {
...
function xa(i, t, e) {
    i.addonConfirmation && O('addonConfirmation', i, t, e);
}
function ba(i, t, e, r) {
    r?.secureLabel &&
        e?.secureLabel &&
        t.setAttribute('secure-label', r.secureLabel);
}
function va(i, t, e = !0) {
    try {
        let r = typeof i != 'string' ? '' : i,
            a = Wr(r);
        if (a.length <= t) return [r, a];
        let n = 0,
            o = !1,
            s = e ? (t - Dt.length < 1 ? 1 : t - Dt.length) : t,
            l = [];
        for (let f of r) {
            if ((n++, f === '<'))
                if (((o = !0), r[n] === '/')) l.pop();
        ...
        let p = r.substring(0, n).trim();
        if (l.length > 0) {
            l[0] === 'p' && l.shift();
            for (let f of l.reverse()) p += `</${f}>`;
        }
        return [`${p}${e ? Dt : ''}`, a];
    } catch {
        let a = typeof i == 'string' ? i : '',
            n = Wr(a);
        return [a, n];
    }
}
...
function ya(i, t) {
    t.querySelectorAll('a.upt-link').forEach((r) => {
        let a = G.createFrom(r);
        r.replaceWith(a), a.initializeWcsData(i.osi, i.promoCode);
    });
}
function Ea(i, t, e, r, a) {
    let n = i;
    a
        ? (n = customElements
              .get('checkout-button')
              .createCheckoutButton({}, i.innerHTML))
        : (n.innerHTML = `<span>${n.textContent}</span>`),
        n.setAttribute('tabindex', 0);
    for (let m of i.attributes)
        ['class', 'is'].includes(m.name) || n.setAttribute(m.name, m.value);
    n.firstElementChild?.classList.add('spectrum-Button-label');
    let o = t?.ctas?.size ?? 'M',
        s = `spectrum-Button--${r}`,
        l = ra.includes(o)
            ? `spectrum-Button--size${o}`
            : 'spectrum-Button--sizeM',
        p = ['spectrum-Button', s, l];
    return e && p.push('spectrum-Button--outline'), n.classList.add(...p), n;
}
function wa(i, t, e, r, a) {
    let n = i;
    a &&
        ((n = customElements
            .get('checkout-button')
            .createCheckoutButton(i.dataset)),
        n.connectedCallback(),
        n.render());
    let o = 'fill';
    e && (o = 'outline');
    let s = S(
        'sp-button',
        {
            ...
            tabIndex: 0,
            size: t?.ctas?.size ?? 'm',
            ...(i.dataset.analyticsId && {
                'data-analytics-id': i.dataset.analyticsId,
            }),
        },
        i.innerHTML,
    );
    return (
        (s.source = n),
        (a ? n.onceSettled() : Promise.resolve(n)).then((l) => {
            s.setAttribute('data-navigation-url', l.href);
        }),
        s.addEventListener('click', (l) => {
            l.defaultPrevented || n.click();
        }),
        s
    );
}
function Sa(i, t, e, r, a) {
    let n = i;
    return (
        e &&
            (n = customElements
                .get('checkout-link')
                .createCheckoutLink(i.dataset, i.innerHTML)),
        r ||
            (n.classList.add('button', 'con-button'),
            t && n.classList.add('blue'),
            a && n.classList.add('primary')),
        n
    );
}
function Aa(i, t, e, r) {
    if (i.ctas) {
        i.ctas = ht(i.ctas);
        let { slot: a } = e.ctas,
            n = S('div', { slot: a }, i.ctas),
            o = [...n.querySelectorAll('a')].map((s) => Qr(s, t, e));
        (n.innerHTML = ''), n.append(...o), t.append(n);
    }
}
function ka(i, t) {
    let { tags: e } = i,
        r = e
            ?.find((n) => n.startsWith(ea))
            ?.split('/')
            .pop();
    if (!r) return;
    t.setAttribute(pt, r),
        [
            ...
            n.setAttribute(ta, `${n.dataset.analyticsId}-${o + 1}`);
        });
}
function Ca(i) {
    i.spectrum === 'css' &&
        [
            ...
            i.querySelectorAll(`a.${t}`).forEach((r) => {
                r.classList.remove(t),
                    r.classList.add('spectrum-Link', `spectrum-Link--${e}`);
            });
        });
}
function Ta(i) {
    i.querySelectorAll('[slot]').forEach((r) => {
        r.remove();
    }),
        (i.variant = void 0),
        [
            ...
            'size',
            pt,
        ].forEach((r) => i.removeAttribute(r));
    let e = ['wide-strip', 'thin-strip'];
    i.classList.remove(...e);
}
async function Xr(i, t) {
    if (!i) {
        let l = t?.id || 'unknown';
        throw (
            (console.error(
                `hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${l}).`,
            ),
            new Error(
                `hydrate: Fragment is undefined for card (merchCard id: ${l}).`,
            ))
        );
    }
    if (!i.fields) {
        ...
        throw (
            (console.error(
                `hydrate: Fragment for card ID '${l}' (merchCard id: ${p}) is missing 'fields'. Cannot hydrate.`,
            ),
            new Error(
                `hydrate: Fragment for card ID '${l}' (merchCard id: ${p}) is missing 'fields'.`,
            ))
        );
    }
    let { id: e, fields: r, settings: a = {}, priceLiterals: n } = i,
        { variant: o } = r;
    if (!o) throw new Error(`hydrate: no variant found in payload ${e}`);
    Ta(t),
        (t.settings = a),
        n && (t.priceLiterals = n),
        t.id ?? (t.id = i.id),
    ...
    if (!s) throw new Error(`hydrate: variant mapping not found for ${e}`);
...
function Jr(i, t) {
    ...
    e.priceLiterals &&
        ...
        Object.assign(t.literals, e.priceLiterals)),
        e.variantLayout?.priceOptionsProvider?.(i, t);
}
function _a(i) {
    i.providers.has(Jr) || i.providers.price(Jr);
}
var Pa = 0,
    Ae,
    ke,
    ...
    V = class extends La {
        constructor() {
            ...
            d(this, 'customerSegment');
            d(this, 'marketSegment');
            d(this, 'variantLayout');
            (this.id = null),
                (this.failed = !1),
                (this.filters = {}),
                (this.types = ''),
        ...
        firstUpdated() {
            (this.variantLayout = kt(this)),
                this.variantLayout?.connectedCallbackHook();
        }
        willUpdate(e) {
            (e.has('variant') || !this.variantLayout) &&
                ((this.variantLayout = kt(this)),
                this.variantLayout?.connectedCallbackHook());
        }
        updated(e) {
            (e.has('badgeBackgroundColor') || e.has('borderColor')) &&
                this.style.setProperty(
            ...
            try {
                this.variantLayoutPromise =
                    this.variantLayout?.postCardUpdateHook(e);
            } catch (r) {
                w(this, E, re).call(
                    this,
                    `Error in postCardUpdateHook: ${r.message}`,
                    {},
                    !1,
                );
            }
        ...
        get checkoutLinks() {
            return [...(this.footerSlot?.querySelectorAll(H) ?? [])];
        }
        get checkoutLinksDescription() {
            return [...(this.descriptionSlot?.querySelectorAll(H) ?? [])];
        }
        get checkoutLinkDescriptionCompare() {
            return [
                ...(this.descriptionSlotCompare?.querySelectorAll(H) ?? []),
            ];
        }
        ...
        async toggleStockOffer({ target: e }) {
            if (!this.stockOfferOsis) return;
            let r = this.checkoutLinks;
            if (r.length !== 0)
                for (let a of r) {
                    await a.onceSettled();
                    let n = a.value?.[0]?.planType;
                    if (!n) return;
                    let o = this.stockOfferOsis[n];
                    if (!o) return;
                    let s = a.dataset.wcsOsi.split(',').filter((l) => l !== o);
                    e.checked && s.push(o), (a.dataset.wcsOsi = s.join(','));
                }
        }
        changeHandler(e) {
            e.target.tagName === 'MERCH-ADDON' && this.toggleAddon(e.target);
        }
        toggleAddon(e) {
            this.variantLayout?.toggleAddon?.(e);
            let r = [
                ...this.checkoutLinks,
            ...
            let a = (n) => {
                let { offerType: o, planType: s } = n.value?.[0] ?? {};
                if (!o || !s) return;
                let l = e.getOsi(s, o),
                    p = (n.dataset.wcsOsi || '')
                        .split(',')
                        .filter((m) => m && m !== l);
                e.checked && p.push(l), (n.dataset.wcsOsi = p.join(','));
            };
            r.forEach(a);
        }
        handleQuantitySelection(e) {
            ...
            if (r.length !== 0)
                for (let a of r) a.dataset.quantity = e.detail.option;
        }
        get titleElement() {
        ...
        updateFilters(e) {
            ...
            Object.keys(r).forEach((a) => {
                if (e) {
                    r[a].order = Math.min(r[a].order || 2, 2);
                    return;
                }
                let n = r[a].order;
                n === 1 || isNaN(n) || (r[a].order = Number(n) + 1);
            }),
                (this.filters = r);
        }
        includes(e) {
            return this.textContent.match(new RegExp(e, 'i')) !== null;
        }
        connectedCallback() {
            var r;
            super.connectedCallback(),
                c(this, ke) || h(this, ke, Pa++),
                this.aemFragment ||
                    ((r = c(this, D)) == null || r.call(this),
                    h(this, D, void 0)),
                this.id ??
                    (this.id =
                        this.getAttribute('id') ??
                        this.aemFragment?.getAttribute('fragment'));
            let e = this.id ?? c(this, ke);
            h(this, ie, `${Zr}${e}${Ke}`),
                h(this, Ae, `${Zr}${e}${We}`),
                performance.mark(c(this, ie)),
                h(this, B, W()),
                _a(c(this, B)),
                h(this, Ce, c(this, B).Log.module(Bt)),
                this.addEventListener(bt, this.handleQuantitySelection),
                this.addEventListener(vt, this.handleAddonAndQuantityUpdate),
                this.addEventListener(Qt, this.handleMerchOfferSelectReady),
                this.addEventListener(ce, this.handleAemFragmentEvents),
                this.addEventListener(se, this.handleAemFragmentEvents),
        ...
        disconnectedCallback() {
            super.disconnectedCallback(),
                ...
                this.removeEventListener(bt, this.handleQuantitySelection),
                this.removeEventListener(ce, this.handleAemFragmentEvents),
                this.removeEventListener(se, this.handleAemFragmentEvents),
                this.removeEventListener('change', this.changeHandler),
                this.removeEventListener(vt, this.handleAddonAndQuantityUpdate);
        }
        async handleAemFragmentEvents(e) {
            ...
            if (
                this.isConnected &&
                (e.type === ce &&
                    w(this, E, re).call(this, 'AEM fragment cannot be loaded'),
                e.type === se &&
                    ((this.failed = !1), e.target.nodeName === 'AEM-FRAGMENT'))
            ) {
                let a = e.detail;
                try {
                    c(this, D) ||
                    ...
                    w(this, E, re).call(
                        this,
                        `hydration has failed: ${n.message}`,
                    );
                } finally {
                    (r = c(this, D)) == null || r.call(this),
                        h(this, D, void 0);
        ...
        async checkReady() {
            ...
            c(this, ae) && (await c(this, ae), h(this, ae, void 0)),
                this.variantLayoutPromise &&
                    (await this.variantLayoutPromise,
                    (this.variantLayoutPromise = void 0));
            let e = new Promise((o) => setTimeout(() => o('timeout'), Ft));
            if (this.aemFragment) {
                ...
                if (o === !1 || o === 'timeout') {
                    let s =
                        o === 'timeout'
                            ? `AEM fragment was not resolved within ${Ft} timeout`
                            : 'AEM fragment cannot be loaded';
                    w(this, E, re).call(this, s, {}, !1);
                    return;
                }
            }
            let r = [...this.querySelectorAll(Wt)],
                a = Promise.all(
                    r.map((o) => o.onceSettled().catch(() => o)),
                ).then((o) =>
                    o.every((s) =>
                        s.classList.contains('placeholder-resolved'),
                    ),
                ),
                n = await Promise.race([a, e]);
            if (n === !0) {
                this.measure = performance.measure(c(this, Ae), c(this, ie));
                let o = {
                    ...this.aemFragment?.fetchInfo,
                    ...c(this, B).duration,
                    measure: de(this.measure),
                };
                return (
                    this.dispatchEvent(
                        new CustomEvent(Jt, {
                ...
                this.measure = performance.measure(c(this, Ae), c(this, ie));
                let o = { measure: de(this.measure), ...c(this, B).duration };
                n === 'timeout'
                    ? w(this, E, re).call(
                          this,
                          `Contains offers that were not resolved within ${Ft} timeout`,
                          o,
                      )
                    : w(this, E, re).call(
                          this,
        ...
        displayFooterElementsInColumn() {
            ...
            let e = this.shadowRoot.querySelector('.secure-transaction-label');
            (this.footerSlot?.querySelectorAll(H)).length === 2 &&
                e &&
                e.parentElement.classList.add('footer-column');
        }
        ...
        handleAddonAndQuantityUpdate({ detail: { id: e, items: r } }) {
            if (
                !e ||
                !r?.length ||
                ...
                return;
            let n = this.checkoutLinks.find(
                (m) => m.getAttribute('data-modal-id') === e,
            );
            if (!n) return;
            let s = new URL(n.getAttribute('href')).searchParams.get('pa'),
                l = r.find((m) => m.productArrangementCode === s)?.quantity,
                p = !!r.find((m) => m.productArrangementCode !== s);
            if (
                (l &&
                ...
                this.addonCheckbox && this.addonCheckbox.checked !== p)
            ) {
                this.toggleStockOffer({ target: this.addonCheckbox });
                let m = new Event('change', { bubbles: !0, cancelable: !0 });
                Object.defineProperty(m, 'target', {
                    writable: !1,
                    value: { checked: p },
                }),
                    this.addonCheckbox.handleChange(m);
            }
        }
        get prices() {
        ...
        get promoPrice() {
            ...
            let e = this.querySelector('.price.price-alternative');
            if (
                (e ||
                ...
                return (e = e.innerText), e;
        }
        get regularPrice() {
            return c(this, E, mt)?.innerText;
        }
        get promotionCode() {
            let e = [
                    ...this.querySelectorAll(
                        `${b}[data-promotion-code],${H}[data-promotion-code]`,
                    ),
                ].map((a) => a.dataset.promotionCode),
                r = [...new Set(e)];
            return (
                r.length > 1 &&
                    c(this, Ce)?.warn(
                        `Multiple different promotion codes found: ${r.join(', ')}`,
                    ),
                e[0]
            );
        }
        ...
        get seeTermsInfo() {
            let e = this.querySelector('a[is="upt-link"]');
            if (e) return w(this, E, gt).call(this, e);
        }
        get renewalText() {
        ...
        get ctas() {
            ...
            )?.querySelectorAll(`${H}, a`);
            return Array.from(e ?? []);
        }
        get primaryCta() {
            return w(this, E, gt).call(
                this,
                this.ctas.find(
                    (e) =>
                        e.variant === 'accent' ||
                        e.matches('.spectrum-Button--accent,.con-button.blue'),
                ),
            );
        }
        get secondaryCta() {
...
(Ae = new WeakMap()),
    ...
    (re = function (e, r = {}, a = !0) {
        ...
        c(this, Ce).error(`merch-card${o}: ${e}`, s),
            (this.failed = !0),
            a &&
                this.dispatchEvent(
                    new CustomEvent(er, {
    ...
    (gt = function (e) {
        if (e)
            return {
                ...
                analyticsId: e.dataset.analyticsId,
                href: e.getAttribute('href') ?? e.dataset.href,
            };
    }),
    d(V, 'properties', {
        ...
        filters: {
            ...
            converter: {
                ...
                toAttribute: (e) =>
                    Object.entries(e)
                        .map(([r, { order: a, size: n }]) =>
                            [r, a, n].filter((o) => o != null).join(':'),
                        )
                        .join(','),
            },
        },
        ...
        analyticsId: { type: String, attribute: pt, reflect: !0 },
        loading: { type: String },
        priceLiterals: { type: Object },
    }),
    d(V, 'styles', [Vt, ...Yt()]),
    d(V, 'registerVariant', k),
    d(V, 'getCollectionOptions', Cr),
    d(V, 'getFragmentMapping', Ze);
customElements.define(Bt, V);
export { V as MerchCard };
