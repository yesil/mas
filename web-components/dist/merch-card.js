var Ur=Object.defineProperty;var jr=a=>{throw TypeError(a)};var ji=(a,r,e)=>r in a?Ur(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var Vi=(a,r,e)=>()=>{if(e)throw e[0];try{return a&&(r=a(a=0)),r}catch(t){throw e=[t],t}};var Gi=(a,r)=>{for(var e in r)Ur(a,e,{get:r[e],enumerable:!0})};var h=(a,r,e)=>ji(a,typeof r!="symbol"?r+"":r,e),dr=(a,r,e)=>r.has(a)||jr("Cannot "+e);var l=(a,r,e)=>(dr(a,r,"read from private field"),e?e.call(a):r.get(a)),f=(a,r,e)=>r.has(a)?jr("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(a):r.set(a,e),m=(a,r,e,t)=>(dr(a,r,"write to private field"),t?t.call(a,e):r.set(a,e),e),k=(a,r,e)=>(dr(a,r,"access private method"),e);var Vr=(a,r,e,t)=>({set _(i){m(a,r,i,e)},get _(){return l(a,r,t)}});var hr={};Gi(hr,{default:()=>nt});import{LitElement as Wi,html as Le,css as Ki,nothing as Yi}from"./lit-all.min.js";import{unsafeHTML as Zr}from"./lit-all.min.js";import{ifDefined as Qi}from"./lit-all.min.js";function Zi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var N,nt,pr=Vi(()=>{N=class N extends Wi{constructor(){super(),this.content="",this.placement="top",this.variant="",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(r){let e=r.composedPath();N.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let r=this.shadowRoot?.querySelector(".css-tooltip");if(!r)return;let e=r.getBoundingClientRect(),t=window.innerWidth,i=window.innerHeight,n=14,o=200,s=60,c=this.shadowRoot?.querySelector(".css-tooltip-body"),d=c?c.offsetWidth:o,p=c?c.offsetHeight:s,g=this.effectivePlacement;g==="top"&&e.top-p-n<0?g="bottom":g==="bottom"&&e.bottom+p+n>i?g="top":g==="left"&&e.left-d-n<0?g="right":g==="right"&&e.right+d+n>t&&(g="left");let x=e.left+e.width/2,A=e.top+e.height/2,D=6,ge=(Bi,qi,Ui)=>Math.max(Bi,Math.min(qi,Ui)),Ot,Dt,lr;g==="top"||g==="bottom"?(Ot=g==="top"?e.top-p-n:e.bottom+n,Dt=ge(0,t-d,x-d/2),lr=ge(D,d-D*2,x-Dt-D)):(Dt=g==="left"?e.left-d-n:e.right+n,Ot=ge(0,i-p,A-p/2),lr=ge(D,p-D*2,A-Ot-D)),this._tooltipTop=Ot,this._tooltipLeft=Dt,this._arrowOffset=lr,this._computedPlacement=g}showTooltip(){N.activeTooltip&&N.activeTooltip!==this&&(N.activeTooltip.closeOverlay(),N.activeTooltip.tooltipVisible=!1,N.activeTooltip.requestUpdate()),N.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){N.activeTooltip===this&&(N.activeTooltip=null),this.tooltipVisible=!1}handleTap(r){r.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let r=this.shadowRoot?.querySelector("overlay-trigger");r?.open!==void 0&&(r.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||this.textContent?.trim()||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Le`<merch-icon
            src="${this.src}"
            size="${this.size}"
        ></merch-icon>`:Le`<slot></slot>`}render(){let r=this.effectiveContent,e=this.effectivePlacement;if(!r)return Le`<span class="icon-only">${this.renderIcon()}</span>`;if(Zi())return Le`
                <overlay-trigger
                    placement="${e}"
            ...
            `;let i=r.replace(/<[^>]*>/g,""),n=this.tooltipVisible?"tooltip-visible":"",o={pointerdown:u=>{this.lastPointerType=u.pointerType},pointerenter:u=>u.pointerType!=="touch"&&this.showTooltip(),pointerleave:u=>u.pointerType!=="touch"&&this.hideTooltip(),click:u=>{this.lastPointerType==="touch"&&this.handleTap(u),this.lastPointerType=null}},s=this._computedPlacement,c=s==="top"||s==="bottom",d=this.smartPlacement?`top:${this._tooltipTop}px;left:${this._tooltipLeft}px;`:void 0,p=c?`left:${this._arrowOffset}px`:`top:${this._arrowOffset}px`;return Le`
            <span
            ...
            >
                ${this.renderIcon()}
                <span class="css-tooltip-body" style=${Qi(d)}>
                    ${Zr(r)}
    ...
    `);nt=N;customElements.define("mas-mnemonic",nt)});import{LitElement as Zo}from"./lit-all.min.js";import{css as Kr,unsafeCSS as Wr}from"./lit-all.min.js";var C="(max-width: 767px)",L="(max-width: 1199px)",w="(min-width: 768px)",b="(min-width: 1200px)",_="(min-width: 1600px)",it="(min-width: 1280px)",Gr={matchMobile:window.matchMedia(C),matchDesktop:window.matchMedia(`${b} and (not ${_})`),matchDesktopOrUp:window.matchMedia(b),matchLargeDesktop:window.matchMedia(_),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},y=Gr;function Nt(){return Gr.isDesktop}var Yr=Kr`
    :host {
...
`,Qr=()=>[Kr`
        ...
        `];import{LitElement as Xi,html as Xr,css as Ji}from"./lit-all.min.js";function en(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var ze=class extends Xi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(en())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let t="",i="top";if(e.tagName==="SP-TOOLTIP")t=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(t=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(t){let n=document.createElement("mas-mnemonic");n.setAttribute("content",t),n.setAttribute("placement",i);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>pr())}e.remove()})}render(){let{href:r}=this;return r?Xr`<a href="${r}">
                  <img
                      src="${this.src}"
                      alt="${this.alt}"
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};h(ze,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),h(ze,"styles",Ji`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",ze);var pc=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),mc=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var Pe=2e4;var E='span[is="inline-price"][data-wcs-osi]',te='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var tn='a[is="upt-link"]',Jr=`${E},${te},${tn}`;var ea="merch-offer-select:ready",ta="merch-card:action-menu-toggle";var R="merch-quantity-selector:change",ot="merch-card-quantity:change",mr="merch-modal:addon-and-quantity-update";var Me="merch-card-collection:literals-changed";var _e="aem:load",Re="aem:error",ue="mas:ready",ra="mas:error";var aa="placeholder-failed",ia="placeholder-pending",na="placeholder-resolved";var oa="mas:failed",I="mas:resolved",ca="mas/commerce";var ce="failed",fe="pending",se="resolved";var Ft="X-Request-Id",gc=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var uc=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var It=":start",$t=":duration";var O="legal",sa="mas-ff-defaults";var rn="mas-commerce-service";function la(a,r){let e;return function(){let t=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(t,i),r)}}function z(a,r={},e=null,t=null){let i=t?document.createElement(a,{is:t}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function Oe(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function gr(){return window.matchMedia("(max-width: 1024px)").matches}function ve(){return document.getElementsByTagName(rn)?.[0]}function ct(a){let r=window.getComputedStyle(a);return a.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}function da(a){let r=a.nextElementSibling?.nodeName==="BR"?a.nextElementSibling.nextElementSibling:a.nextElementSibling;return a.dataset.template==="strikethrough"&&(a.nextSibling?.nodeName!=="#text"||a.nextSibling.textContent.trim().length<2)&&r?.isInlinePrice&&r?.dataset?.template==="price"}var an=/^([a-z0-9]+(-[a-z0-9]+)*)(--([a-z0-9]+(-[a-z0-9]+)*)){0,2}$/,nn=100,on=["live","page"];function ha(a,r="live"){if(!a||a.trim()===""||!on.includes(r))return null;let e=a.trim().toLowerCase();if(e==="local")return"http://localhost:3000";if(e.length>nn||!an.test(e))return null;let t=e.includes("--")?e:`${e}--mas--adobecom`,i;try{i=new URL(`https://${t}.aem.${r}`)}catch{return null}return i.hostname.endsWith(`.aem.${r}`)?i.origin:null}var st,be,lt,dt,De,Ht=class extends HTMLElement{constructor(){super();f(this,st,"");f(this,be);f(this,lt,[]);f(this,dt,[]);f(this,De);m(this,De,la(()=>{this.isConnected&&(this.parentElement.style.background=this.value,l(this,be)?this.parentElement.style.borderRadius=l(this,be):l(this,be)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=l(this,lt).map((t,i)=>{let n=l(this,dt)[i]||"";return`${t} ${n}`}).join(", ");return`linear-gradient(${l(this,st)}, ${e})`}connectedCallback(){l(this,De).call(this)}attributeChangedCallback(e,t,i){e==="border-radius"&&m(this,be,i?.trim()),e==="colors"&&i?m(this,lt,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,dt,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,st,i?.trim()??""),l(this,De).call(this)}};st=new WeakMap,be=new WeakMap,lt=new WeakMap,dt=new WeakMap,De=new WeakMap;customElements.define("merch-gradient",Ht);import{LitElement as cn,html as sn,css as ln}from"./lit-all.min.js";var Ne=class extends cn{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(r,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${r}"] ${E}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(I,this.updatePlanType),this.background&&this.style.setProperty("--merch-addon-background",this.background)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(I,this.updatePlanType)}updatePlanType(r){if(r.target.tagName!=="SPAN")return;let e=r.target,t=e?.value?.[0];if(!t)return;e.setAttribute("data-offer-type",t.offerType);let i=e.closest("p");if(i.getAttribute("data-plan-type"))return;let n=this.querySelector(`p[data-plan-type="${t.planType}"]`);n&&n!==i||i.setAttribute("data-plan-type",t.planType)}handleChange(r){this.checked=r.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(r){r.key===" "&&(r.preventDefault(),this.handleCustomClick())}render(){return sn` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};h(Ne,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0},background:{type:String,attribute:"background"}}),h(Ne,"styles",ln`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",Ne);import{html as Bt,nothing as dn}from"./lit-all.min.js";var Fe,ht=class ht{constructor(r){h(this,"card");f(this,Fe);this.card=r,this.insertVariantStyle()}getContainer(){return m(this,Fe,l(this,Fe)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),l(this,Fe)}insertVariantStyle(){let r=this.constructor.name;if(!ht.styleMap[r]){ht.styleMap[r]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(r,e){if(!r||this.card.heightSync===!1)return;let t=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(t))||0;i>o&&n.style.setProperty(t,`${i}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let e=this.getContainer();if(!e)return;let t=this.card.variant,i=Array.from(e.querySelectorAll(`merch-card[variant="${t}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${t}-${o}-height`;e.style.getPropertyValue(s)&&e.style.removeProperty(s)}let n=new Map;for(let o of i){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),d=n.get(c);d||(d=[],n.set(c,d)),d.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of r){let d=`--consonant-merch-card-${t}-${s}-height`,p=o.map(g=>g.style.getPropertyValue(d)),u=0;for(let g of o){g.style.removeProperty(d);let x=c(g);if(!x)continue;let A=Math.max(0,parseInt(window.getComputedStyle(x).height)||0);A>u&&(u=A)}o.forEach((g,x)=>{u>0?g.style.setProperty(d,`${u}px`):p[x]&&g.style.setProperty(d,p[x])})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Bt`
            <div
                id="badge"
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as pt,css as pn}from"./lit-all.min.js";var ga=`
:root {
...
`;var Ut=class extends v{constructor(r){super(r)}getGlobalCSS(){return fa}renderLayout(){return va` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":va`<hr />`} ${this.secureLabelFooter}`}};import{html as le,css as mn,unsafeCSS as xa}from"./lit-all.min.js";var ba=`
  :root {
...
`;var gn=32,ya={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},$e=class extends v{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?le`<slot name="secure-transaction-label">
    ...
    `);import{html as jt,css as un,unsafeCSS as fr,nothing as fn}from"./lit-all.min.js";var wa=`
  :root {
...
`;var vn=32,Ea={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Q,He=class extends v{constructor(e){super(e);f(this,Q);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>jt` <footer>
    ...
    `);import{html as mt,css as bn,nothing as Vt}from"./lit-all.min.js";var ka=`
:root {
...
`;var Gt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ca={...(function(){let{whatsIncluded:a,size:r,...e}=Gt;return e})(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Sa={...(function(){let{subtitle:a,whatsIncluded:r,size:e,quantitySelect:t,...i}=Gt;return i})()},Z,X,F=class extends v{constructor(e){super(e);f(this,Z);f(this,X);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,t){e.dataset.template===O&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return ka}adjustSlotPlacement(e,t,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!t.includes(s)){if(o?.classList.toggle("wide-footer",y.isDesktopOrUp),!i&&c){if(d)c.remove();else{let u=p.querySelector(`[data-placeholder-for="${e}"]`);u?u.replaceWith(c):p.appendChild(c)}return}if(i&&d){let u=document.createElement("div");if(u.setAttribute("data-placeholder-for",e),u.classList.add("slot-placeholder"),!c){let g=d.cloneNode(!0);o.prepend(g)}d.replaceWith(u)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],y.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],y.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){l(this,Z)||(m(this,Z,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(l(this,Z)?.disconnect(),m(this,Z,null),this.syncHeights())})),l(this,Z).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(t=>({name:t,getElement:i=>i.querySelector(`[slot="${t}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let t=this.card.querySelector('[slot="body-xs"]');if(!t)return;let i=t.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),t.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let d=0,p=this.card.querySelector('[slot="heading-s"]');p&&(d+=ct(p));let u=this.card.querySelector('[slot="subtitle"]');u&&(d+=ct(u));let g=this.card.querySelector('[slot="heading-m"]');g&&(d+=8+ct(g));for(let A of t.childNodes){if(A.classList.contains("spacer"))break;d+=ct(A)}let x=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(x)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${E}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?mt`<div class="divider"></div>`:Vt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],t=this.card.querySelector(`[slot="heading-m"] ${E}[data-template="price"]`);t&&e.push(t);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?mt`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};Z=new WeakMap,X=new WeakMap,h(F,"variantStyle",bn`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),h(F,"collectionOptions",{customHeaderArea:e=>e.sidenav?mt`<slot name="resultsText"></slot>`:Vt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:e=>{let t=()=>{let i=e.querySelectorAll("merch-card");for(let o of i)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!y.isDesktop)return;let n=0;for(let o of i){if(o.style.display==="none")continue;let s=o.getAttribute("size"),c=s==="wide"?2:s==="super-wide"?3:1;c===2&&n%3===2&&(o.setAttribute("data-size",s),o.removeAttribute("size"),c=1),n+=c}};y.matchDesktop.addEventListener("change",t),e.addEventListener(Me,t),e.onUnmount.push(()=>{y.matchDesktop.removeEventListener("change",t),e.removeEventListener(Me,t)})}});import{html as re,css as xn,unsafeCSS as Ta,nothing as Wt}from"./lit-all.min.js";var Aa=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let e=r.querySelector("strong, b, p");e&&(y.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?y.isMobile?re`
        ...
        `:re`
            ...
            `:Wt}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?re`<slot name="icons"></slot>`:Wt}get secureLabelFooter(){return re`<footer>
            ...
            <slot></slot>`}};h(de,"variantStyle",xn`
    ...
    `),h(de,"collectionOptions",{customHeaderArea:r=>r.sidenav?re`<slot name="resultsText"></slot>`:Wt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:r=>{let e=()=>{let t=r.querySelectorAll("merch-card");if(t.forEach(n=>{n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"))}),!y.isDesktop)return;let i=0;t.forEach(n=>{if(n.style.display==="none")return;let o=n.getAttribute("size"),s=o==="wide"?2:o==="super-wide"?3:1;s===2&&i%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),s=1),i+=s})};y.matchDesktop.addEventListener("change",e),r.addEventListener(Me,e),r.onUnmount.push(()=>{y.matchDesktop.removeEventListener("change",e),r.removeEventListener(Me,e)})}});import{html as ae,css as yn,nothing as Be,unsafeCSS as gt}from"./lit-all.min.js";var za=`
:root {
...
`;var[Bs,qs,Pa,Ma,_a,Ra]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Yt="pro",vr=`--consonant-merch-card-${Yt}-top-card-height`,Kt=[{prop:`--consonant-merch-card-${Yt}-mnemonic-height`,selector:".mnemonic"},{prop:`--consonant-merch-card-${Yt}-name-description-height`,selector:".name-description"}],Oa=`--consonant-merch-card-${Yt}-strike-reserve`,br='[slot="heading-m"] :is(.price-strikethrough, .price-promo-strikethrough, [data-template="strikethrough"])',wn="(min-width: 768px)",Da={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},eduDisclaimer:{tag:"div",slot:"edu-disclaimer"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"},hideTransparent:!0,disableWhenBackgroundColor:"dark"},allowedBorderColors:[],style:"consonant"},ie,ye,bt,xt,P,Na,ut,Fa,ft,xr,Qt,Zt=class Zt extends v{constructor(e){super(e);f(this,P);h(this,"expanded",!1);h(this,"licenseOpen",!1);h(this,"licenseQty",null);h(this,"licenseHighlightedIndex",0);f(this,ie,null);f(this,ye,null);f(this,bt,()=>this.resyncOnReflow());h(this,"lastSyncKey",null);f(this,xt,({detail:e})=>{let t=e?.quantity==null?null:String(e.quantity);t==null||t===this.licenseQty||this.licenseOptions?.includes(t)&&(this.licenseQty=t,this.card.requestUpdate())});h(this,"toggleExpanded",e=>{e.preventDefault();let t=!this.expanded;for(let i of k(this,P,Na).call(this)){let n=i.variantLayout;n instanceof Zt&&(n.expanded=t,i._proExpanded=t,i.requestUpdate())}});h(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen?k(this,P,xr).call(this):k(this,P,ft).call(this),this.card.requestUpdate()});f(this,Qt,e=>{let t=this.licenseOptions;if(!t?.length)return;let i=t.length-1;switch(e.key){case Ma:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%t.length:k(this,P,ft).call(this);break;case Pa:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+t.length)%t.length:k(this,P,ft).call(this);break;case"Home":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=i;break;case _a:case" ":if(e.preventDefault(),this.licenseOpen){this.selectLicenseQty(t[this.licenseHighlightedIndex]);return}k(this,P,ft).call(this);break;case"Escape":if(!this.licenseOpen)return;e.preventDefault(),k(this,P,xr).call(this);break;case Ra:this.licenseOpen&&this.selectLicenseQty(t[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});h(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,k(this,P,ut).call(this);let t=this.quantitySelectEl;t&&(t.selectedValue=Number(e),t.dispatchEvent(new CustomEvent(R,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=e._proExpanded??!1}getGlobalCSS(){return za}priceOptionsProvider(e,t){e.dataset.template===O&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),t.dataset.displayPerUnit="false",e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),t.addEventListener(I,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let e=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!e)return;let t=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),i=t?.querySelector(".price-plan-type");if(!i)return;i.textContent=e;let n=t.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get hasEduDisclaimer(){return!this.card?.settings?.hideEduDisclaimer}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${E}[data-template="price"]`)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){this.adjustEduWhatsIncluded(),await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}adjustEduWhatsIncluded(){if(this.card.size!=="edu")return;let e=this.card.querySelector('[slot="whats-included"]');if(!e||e.querySelector(".whats-included-title"))return;let t=e.querySelector(".whats-included-label");if(!t)return;let i=document.createElement("h4");i.className="whats-included-title",i.innerHTML=t.innerHTML,t.replaceWith(i);let{whatsIncludedLabel:n,eduDisclaimer:o}=this.card.placeholders??{},s=document.createElement("p");if(s.className="whats-included-label",s.textContent=n??"",i.after(s),e.querySelectorAll(".section h4:not(.whats-included-title)").forEach(c=>{let d=document.createElement("p");d.innerHTML=c.innerHTML,c.replaceWith(d)}),o){let c=document.createElement("div");c.className="whats-included-disclaimer",c.innerHTML=o,e.append(c)}}async waitForContentFonts(){let e=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(e.map(t=>{let i=window.getComputedStyle(t),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,t.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1){this.clearSyncedHeights(this.card);return}await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let e=this.getContainer();if(!e||this.card.getBoundingClientRect().width<=2)return;let t=this.card.variant,i=vr,n=[...e.querySelectorAll(`merch-card[variant="${t}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1);if(!window.matchMedia(wn).matches){n.forEach(c=>this.clearSyncedHeights(c));return}let o=new Map;for(let c of n){let d=o.get(c.offsetTop)??[];d.push(c),o.set(c.offsetTop,d)}let s=(c,d)=>c.reduce((p,u)=>{let g=d(u);return g?Math.max(p,parseInt(getComputedStyle(g).height)||0):p},0);for(let c of o.values()){if(c.forEach(g=>this.clearSyncedHeights(g)),c.length<2)continue;let d=c.map(g=>g.querySelector(br)&&parseInt(getComputedStyle(g.querySelector(br)).height)||0),p=Math.max(0,...d);p>0&&c.forEach((g,x)=>{let A=p-d[x];A>0&&g.style.setProperty(Oa,`${A}px`)});for(let g of Kt){let x=s(c,A=>A.shadowRoot?.querySelector(g.selector));x>0&&c.forEach(A=>A.style.setProperty(g.prop,`${x}px`))}let u=s(c,g=>g.shadowRoot?.querySelector(".top-card"));u>0&&c.forEach(g=>g.style.setProperty(i,`${u}px`))}}clearSyncedHeights(e){e.style.removeProperty(vr),e.style.removeProperty(Oa),Kt.forEach(t=>e.style.removeProperty(t.prop))}resyncOnReflow(){let e=this.card.getBoundingClientRect().width;if(e<=2)return;let t=(n,o=this.card)=>Math.round(o?.querySelector(n)?.getBoundingClientRect().height||0),i=[Math.round(e),t('[slot="body-xs"]'),t(br),t('[slot="heading-m"] span[is="inline-price"]'),t('[slot="heading-m"] :is(.price-legal, [data-template="legal"])'),t(".license-zone",this.card.shadowRoot),t(".add-on",this.card.shadowRoot)].join(":");i!==this.lastSyncKey&&(this.lastSyncKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(ot,l(this,xt)),this.card.addEventListener(R,this.updatePriceQuantity),this.card.addEventListener(I,l(this,bt)),typeof ResizeObserver>"u"))return;m(this,ye,new ResizeObserver(()=>this.resyncOnReflow())),l(this,ye).observe(this.card);let e=this.card.querySelector('[slot="body-xs"]');e&&l(this,ye).observe(e)}disconnectedCallbackHook(){this.card?.removeEventListener(R,this.updatePriceQuantity),this.card?.removeEventListener(I,l(this,bt)),k(this,P,ut).call(this),l(this,ye)?.disconnect(),this.card?.removeEventListener(ot,l(this,xt))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let t=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(t)||Number.isNaN(i)||i<t||n<1)return null;let o=[];for(let s=t;s<=i;s+=n)o.push(String(s));return o}licenseLabel(e){let t=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=t.split("|").map(o=>o.trim());return Number(e)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let t=this.quantitySelectEl?.getAttribute("default-value");return t!=null&&e.includes(t)?t:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return ae`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,t=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(t));return ae`
            <div class="license-select" ?data-open=${i}>
                <div
                    ...
                    aria-activedescendant=${i?`license-option-${this.licenseHighlightedIndex}`:Be}
        ...
        `}renderLayout(){let e=!!this.expanded;return ae`
            <div class="top-card">
                <div class="mnemonic">
                    <slot name="icons"></slot>
                    <slot name="subtitle"></slot>
                ...
                ${this.hasLicenseSelector||this.hasCallout||this.hasQuantitySelect?ae`<div class="license-zone">
                          ${this.renderLicenseSelector()}
                          ${this.hasCallout?ae`<div class="callout">
                                    <slot name="callout-content"></slot>
                                </div>`:Be}
                      </div>`:Be}
                ${this.hasAddOn?ae`<div class="add-on">
                          <slot name="addon"></slot>
                      </div>`:Be}
                <footer>
                    <slot name="footer"></slot>
            ...
            ${this.hasWhatsIncluded?ae`
                  ...
                  `:Be}
            ${this.hasEduDisclaimer?ae`<div class="edu-disclaimer">
                      <slot name="edu-disclaimer"></slot>
                  </div>`:Be}
            <slot></slot>
        `}};ie=new WeakMap,ye=new WeakMap,bt=new WeakMap,xt=new WeakMap,P=new WeakSet,Na=function(){let e=this.card.offsetTop,t=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===e);return t.length?t:[this.card]},ut=function(){l(this,ie)&&(document.removeEventListener("mousedown",l(this,ie)),m(this,ie,null))},Fa=function(){let e=this.licenseOptions?.indexOf(this.currentLicenseValue);return e>0?e:0},ft=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=k(this,P,Fa).call(this),l(this,ie)||(m(this,ie,e=>{e.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),k(this,P,ut).call(this))}),document.addEventListener("mousedown",l(this,ie)))},xr=function(){this.licenseOpen=!1,k(this,P,ut).call(this)},Qt=new WeakMap,h(Zt,"variantStyle",yn`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
        ...
        :host([variant='pro']) .mnemonic {
            ...
            align-items: center;
            gap: 12px;
            min-height: var(${gt(Kt[0].prop)}, auto);
        }
    ...
    `);var vt=Zt;import{html as yr,css as En}from"./lit-all.min.js";var Ia=`
:root {
...
`;var $a={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},J,qe=class extends v{constructor(e){super(e);f(this,J);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Ia}priceOptionsProvider(e,t){e.dataset.template===O&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(t.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return yr` ${this.badge}
    ...
    `);import{html as wr,css as kn}from"./lit-all.min.js";var Ha=`
:root {
...
`;var Ba={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ue=class extends v{constructor(r){super(r)}priceOptionsProvider(r,e){r.dataset.template===O&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Ha}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${E}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let e=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),r.parentNode.insertBefore(e,r.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return wr`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
...
`;var Ua={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},je=class extends v{constructor(r){super(r)}getGlobalCSS(){return qa}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Cn`
    ...
    `);import{html as Er,css as An}from"./lit-all.min.js";var ja=`
:root {
...
`;var Va={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Ve=class extends v{constructor(e){super(e);h(this,"legal")}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return ja}priceOptionsProvider(e,t){t.displayPlanType=this.card?.settings?.displayPlanType??!1}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${E}[data-template="price"]`);if(!e)return;let t=e.cloneNode(!0);this.legal=t,e.dataset.displayPlanType="false",t.dataset.template="legal",t.dataset.displayPerUnit="false",t.setAttribute("slot","legal"),this.card.appendChild(t)}renderLayout(){return Er`${this.cardImage}
            <div class="body">
            ...
            ${this.evergreen?Er`
                  ...
                  `:Er`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};h(Ve,"variantStyle",An`
    ...
    `);import{html as Tn,css as Ln}from"./lit-all.min.js";var Ga=`
:root {
...
`;var kr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Ge=class extends v{getGlobalCSS(){return Ga}get aemFragmentMapping(){return kr}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let r=this.card.shadowRoot;if(!r)return;["header","price-container","cta"].forEach(i=>this.updateCardElementMinHeight(r.querySelector(`.${i}`),i));let e=this.card.querySelector('[slot="body-xs"]');e&&this.updateCardElementMinHeight(e,"description");let t=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');t&&this.updateCardElementMinHeight(t,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(!r)return;let e=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),t=34;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>t;o.classList.toggle("small-font-size-button",s)})}),y.isDesktopOrUp&&e.forEach(i=>i.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!Nt()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let r=this.getContainer();r&&r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(e=>e.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let r=this.card.getBoundingClientRect().width;r<=2||r===this.lastSyncedWidth||(this.lastSyncedWidth=r,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let r=this.card;if(!r)return;let e=()=>{if(Nt())r.removeAttribute("data-expanded");else{let i=r.hasAttribute("data-default-card");r.setAttribute("data-expanded",i?"true":"false")}};e();let t=window.matchMedia(C);this.mediaQueryListener=()=>{e()},t.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(C).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(r){r.preventDefault(),r.stopPropagation(),this.toggleExpanded()}handleCardClick(r){r.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(r.preventDefault(),this.toggleExpanded())}toggleExpanded(){let r=this.card;if(!r||Nt())return;let i=r.getAttribute("data-expanded")==="true"?"false":"true";r.setAttribute("data-expanded",i)}renderLayout(){return Tn`
    ...
    `);import{html as Ka,css as zn}from"./lit-all.min.js";var Wa=`
:root {
...
`;var Cr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},yt=class yt extends v{getGlobalCSS(){return Wa}get aemFragmentMapping(){return Cr}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return Ka`
        ...
        `}async waitForTitleFont(){let r=this.card.querySelector(this.headingSelector);if(r&&document.fonts?.load){let e=window.getComputedStyle(r),t=`${e.fontWeight} ${e.fontSize} ${e.fontFamily}`;await document.fonts.load(t,r.textContent).catch(()=>null)}await document.fonts.ready}async syncHeights(){if(await this.waitForTitleFont(),await new Promise(s=>requestAnimationFrame(s)),await new Promise(s=>requestAnimationFrame(s)),this.card.getBoundingClientRect().width<=2)return;let r=yt.SYNCED_SECTIONS.map(s=>({name:s,getElement:c=>c.shadowRoot?.querySelector(`.${s}`)})),e=this.getContainer(),t=e?e.querySelectorAll(`merch-card[variant="${this.card.variant}"]`):[this.card],i='[slot="body-s"] > *',n=Math.max(0,...Array.from(t,s=>s.querySelectorAll(i).length)),o=Array.from({length:n},(s,c)=>({name:`description-row-${c}`,getElement:d=>d.querySelectorAll(i)[c]}));this.syncRowHeights([...r,...o])}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(r){let e=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),t=49;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>t;o.classList.toggle("small-font-size-button",s)})})}window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}resyncOnReflow(){let r=this.card.getBoundingClientRect().width;if(r<=2)return;let e=this.card.querySelector(this.headingSelector),t=e?Math.round(e.getBoundingClientRect().height):0,i=`${Math.round(r)}:${t}`;i!==this.lastSyncedKey&&(this.lastSyncedKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||typeof ResizeObserver>"u")return;this.lastSyncedKey="",this.sizeObserver=new ResizeObserver(()=>this.resyncOnReflow()),this.sizeObserver.observe(this.card);let r=this.card.querySelector(this.headingSelector);r&&this.sizeObserver.observe(r)}disconnectedCallbackHook(){this.sizeObserver?.disconnect(),this.sizeObserver=null}renderLayout(){return Ka`
            ...
            <slot></slot>
        `}};h(yt,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),h(yt,"variantStyle",zn`
    ...
    `);var wt=yt;import{html as Et,css as Pn,nothing as Qa}from"./lit-all.min.js";var Ya=`
...
`;var Za={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"},customFields:{tag:"div",slot:"custom-fields"}},Mn=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],We=class extends v{constructor(r){super(r)}getGlobalCSS(){return Ya}renderLayout(){let r=[...this.card.querySelectorAll('[slot^="custom-field-"]')];return Et`
    ...
    `);import{css as _n,html as Rn}from"./lit-all.min.js";var Xa=`
...
`;var Ja={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ke=class extends v{constructor(){super(...arguments);h(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return Xa}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,t){t.literals={...t.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},t.space=!0,t.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${E}[data-template="price"]`);if(!e)return;let t=e.cloneNode(!0);this.legal=t,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",t.dataset.template="legal",t.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,t.setAttribute("slot","legal"),this.card.appendChild(t)}renderLayout(){return Rn`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as On,css as Dn}from"./lit-all.min.js";var ei=`
...
`;var Sr={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Nn=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Xt,ti,Ye=class extends v{constructor(e){super(e);f(this,Xt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return ei}get aemFragmentMapping(){return Sr}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,k(this,Xt,ti).call(this))}renderLayout(){return On`
            <div class="card">
            ...
            <slot></slot>
        `}};Xt=new WeakSet,ti=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;Nn.forEach(({key:t,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),t))},h(Ye,"variantStyle",Dn`
    ...
    `);import{html as Fn,css as In}from"./lit-all.min.js";var ri=`
...
`;var Ar={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Qe=class extends v{getGlobalCSS(){return ri}get aemFragmentMapping(){return Ar}renderLayout(){return Fn`
    ...
    `);var Jt=new Map,ai=new WeakMap,ii=new Map,S=(a,r,e=null,t=null,i)=>{Jt.set(a,{class:r,fragmentMapping:e,style:t,collectionOptions:i})};S("catalog",Ie,ma,Ie.variantStyle);S("image",xe);S("inline-heading",Ut);S("mini-compare-chart",$e,ya,$e.variantStyle);S("mini-compare-chart-mweb",He,Ea,He.variantStyle);S("plans",F,Gt,F.variantStyle,F.collectionOptions);S("plans-students",F,Sa,F.variantStyle,F.collectionOptions);S("plans-education",F,Ca,F.variantStyle,F.collectionOptions);S("plans-v2",de,La,de.variantStyle,de.collectionOptions);S("pro",vt,Da,vt.variantStyle);S("product",qe,$a,qe.variantStyle);S("segment",Ue,Ba,Ue.variantStyle);S("media",je,Ua,je.variantStyle);S("headless",We,Za,We.variantStyle);S("special-offers",Ve,Va,Ve.variantStyle);S("simplified-pricing-express",Ge,kr,Ge.variantStyle);S("full-pricing-express",wt,Cr,wt.variantStyle);S("mini",Ke,Ja,Ke.variantStyle);S("image",xe,ua,xe.variantStyle);S("compare-chart-column",Ye,Sr,Ye.variantStyle);S("fries",Qe,Ar,Qe.variantStyle);var $n=(a,r,e)=>{try{let t=ii.get(a.variant);if(t||(t=new CSSStyleSheet,t.replaceSync(r.cssText),ii.set(a.variant,t)),e?.styleSheet&&e.styleSheet!==t){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(t)||a.shadowRoot.adoptedStyleSheets.push(t),{styleSheet:t}}catch{let i=document.createElement("style");i.textContent=r.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Tr=a=>{let r=Jt.get(a.variant);if(!r)return;let{class:e,style:t}=r,i=ai.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=t?$n(a,t,i):{};return ai.set(a,{appliedVariant:a.variant,...n}),new e(a)};function qt(a){return Jt.get(a)?.fragmentMapping}function ni(a){return Jt.get(a)?.collectionOptions}var oi=document.createElement("style");oi.innerHTML=`
:root {
...
`;document.head.appendChild(oi);function er(a,r={},{metadata:e=!0,search:t=!0,storage:i=!0}={}){let n;if(t&&n==null){let o=new URLSearchParams(window.location.search),s=Lr(t)?t:a;n=o.get(s)}if(i&&n==null){let o=Lr(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Bn(Lr(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[a]}var Hn=a=>typeof a=="boolean",tr=a=>typeof a=="function";var Lr=a=>typeof a=="string";function ci(a,r){if(Hn(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:r}function Bn(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,e,t)=>`${e}-${t}`).replace(/\W+/gu,"-").toLowerCase()}var he=class a extends Error{constructor(r,e,t){if(super(r,{cause:t}),this.name="MasError",e.response){let i=e.response.headers?.get(Ft);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let r=Object.entries(this.context||{}).map(([t,i])=>`${t}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return r&&(e+=` (${r})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var we={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},si=1e3;function qn(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function li(a){if(a==null)return;let r=typeof a;if(r==="function")return a.name?`function ${a.name}`:"function";if(r==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:t,originatingRequest:i,status:n}=a;return[t,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!we.serializableTypes.includes(e))return e}return a}function Un(a,r){if(!we.ignoredProperties.includes(a))return li(r)}var zr={append(a){if(a.level!=="error")return;let{message:r,params:e}=a,t=[],i=[],n=r;e.forEach(d=>{d!=null&&(qn(d)?t:i).push(d)}),t.length&&(n+=` ${t.map(li).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${we.delimiter}page=${o}${s}`;c.length>si&&(c=`${c.slice(0,si)}<trunc>`),n+=c,i.length&&(n+=`${we.delimiter}facts=`,n+=JSON.stringify(i,Un)),window.lana?.log(n,we)}};function di(a){Object.assign(we,Object.fromEntries(Object.entries(a).filter(([r,e])=>r in we&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var hi={LOCAL:"local",PROD:"prod",STAGE:"stage"},Pr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Mr=new Set,_r=new Set,pi=new Map,mi={append({level:a,message:r,params:e,timestamp:t,source:i}){console[a](`${t}ms [${i}] %c${r}`,"font-weight: bold;",...e)}},gi={filter:({level:a})=>a!==Pr.DEBUG},jn={filter:()=>!1};function Vn(a,r,e,t,i){return{level:a,message:r,namespace:e,get params(){return t.length===1&&tr(t[0])&&(t=t[0](),Array.isArray(t)||(t=[t])),t},source:i,timestamp:performance.now().toFixed(3)}}function Gn(a){[..._r].every(r=>r(a))&&Mr.forEach(r=>r(a))}function ui(a){let r=(pi.get(a)??0)+1;pi.set(a,r);let e=`${a} #${r}`,t={id:e,namespace:a,module:i=>ui(`${t.namespace}/${i}`),updateConfig:di};return Object.values(Pr).forEach(i=>{t[i]=(n,...o)=>Gn(Vn(i,n,a,o,e))}),Object.seal(t)}function rr(...a){a.forEach(r=>{let{append:e,filter:t}=r;tr(t)&&_r.add(t),tr(e)&&Mr.add(e)})}function Wn(a={}){let{name:r}=a,e=ci(er("commerce.debug",{search:!0,storage:!0}),r===hi.LOCAL);return rr(e?mi:gi),r===hi.PROD&&rr(zr),kt}function Kn(){Mr.clear(),_r.clear()}var kt={...ui(ca),Level:Pr,Plugins:{consoleAppender:mi,debugFilter:gi,quietFilter:jn,lanaAppender:zr},init:Wn,reset:Kn,use:rr};var Yn="mas-commerce-service",Wd=kt.module("utilities"),Qn={requestId:Ft,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var ar=a=>window.setTimeout(a);function Rr(){return document.getElementsByTagName(Yn)?.[0]}function fi(a){let r={};if(!a?.headers)return r;let e=a.headers;for(let[t,i]of Object.entries(Qn)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[t]=n)}return r}async function vi(a,r={},e=2,t=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,t*(n+1)))}throw i}var bi="fragment",xi="author",yi="preview",wi="loading",Ei="mask",ki="pzn",Ci="timeout",Or="aem-fragment",Si="eager",Ai="cache",Zn=[Si,Ai],j,Ee,$,Dr=class{constructor(){f(this,j,new Map);f(this,Ee,new Map);f(this,$,new Map)}clear(){l(this,j).clear(),l(this,Ee).clear(),l(this,$).clear()}add(r,e=!0){if(!this.has(r.id)&&!this.has(r.fields?.originalId)){if(l(this,j).set(r.id,r),r.fields?.originalId&&l(this,j).set(r.fields.originalId,r),l(this,$).has(r.id)){let[,t]=l(this,$).get(r.id);t()}if(l(this,$).has(r.fields?.originalId)){let[,t]=l(this,$).get(r.fields?.originalId);t()}if(!(!e||typeof r.references!="object"||Array.isArray(r.references)))for(let t in r.references){let{type:i,value:n}=r.references[t];i==="content-fragment"&&(n.settings={...r?.settings,...n.settings},n.placeholders={...r?.placeholders,...n.placeholders},n.dictionary={...r?.dictionary,...n.dictionary},n.priceLiterals={...r?.priceLiterals,...n.priceLiterals},this.add(n,r))}}}has(r){return l(this,j).has(r)}entries(){return l(this,j).entries()}get(r){return l(this,j).get(r)}getAsPromise(r){let[e]=l(this,$).get(r)??[];if(e)return e;let t;return e=new Promise(i=>{t=i,this.has(r)&&i()}),l(this,$).set(r,[e,t]),e}getFetchInfo(r){let e=l(this,Ee).get(r);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},l(this,Ee).set(r,e)),e}set(r,e){if(l(this,j).set(r,e),l(this,$).has(r)){let[,t]=l(this,$).get(r);t()}}remove(r){l(this,j).delete(r),l(this,Ee).delete(r),l(this,$).delete(r)}};j=new WeakMap,Ee=new WeakMap,$=new WeakMap;var ne=new Dr,Ze,B,oe,H,V,M,Ct,G,W,St,K,At,Tt,Xe,Y,Ti,Li,Nr,zi,ir=class extends HTMLElement{constructor(){super(...arguments);f(this,Y);h(this,"cache",ne);f(this,Ze);f(this,B,null);f(this,oe,null);f(this,H,null);f(this,V);f(this,M);f(this,Ct,Si);f(this,G);f(this,W);f(this,St,5e3);f(this,K);f(this,At,!1);f(this,Tt,0);f(this,Xe)}static get observedAttributes(){return[bi,wi,Ci,xi,yi,Ei,ki]}cacheKey(){return`${l(this,V)}${l(this,W)?`-p_${l(this,W)}`:""}${l(this,G)?`-m_${l(this,G)}`:""}`}attributeChangedCallback(e,t,i){e===bi&&(m(this,V,i),m(this,M,ne.getFetchInfo(this.cacheKey()))),e===Ei&&m(this,G,i),e===ki&&m(this,W,i),e===wi&&Zn.includes(i)&&m(this,Ct,i),e===Ci&&m(this,St,parseInt(i,10)),e===xi&&m(this,At,["","true"].includes(i)),e===yi&&m(this,Xe,i)}connectedCallback(){if(!l(this,K)){if(l(this,H)??m(this,H,ve(this)),m(this,Xe,l(this,H).settings?.preview),l(this,Ze)??m(this,Ze,l(this,H).log.module(`${Or}[${l(this,V)}]`)),!l(this,V)||l(this,V)==="#"){l(this,M)??m(this,M,ne.getFetchInfo("missing-fragment-id")),k(this,Y,Nr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(l(this,M)).filter(([e,t])=>t!=null).map(([e,t])=>[`aem-fragment:${e}`,t]))}async refresh(e=!0){if(l(this,K)&&!await Promise.race([l(this,K),Promise.resolve(!1)]))return;e&&ne.remove(this.cacheKey()),l(this,Ct)===Ai&&await Promise.race([ne.getAsPromise(this.cacheKey()),new Promise(s=>setTimeout(s,l(this,St)))]);try{m(this,K,k(this,Y,zi).call(this)),await l(this,K)}catch(s){return k(this,Y,Nr).call(this,s.message),!1}let{references:t,referencesTree:i,placeholders:n,wcs:o}=l(this,B)||{};return o&&!er("mas.disableWcsCache")&&l(this,H).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(_e,{detail:{...this.data,references:t,referencesTree:i,placeholders:n,...l(this,M)},bubbles:!0,composed:!0})),l(this,K)}get updateComplete(){return l(this,K)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return l(this,oe)?l(this,oe):(l(this,At)?this.transformAuthorData():this.transformPublishData(),l(this,oe))}get rawData(){return l(this,B)}transformAuthorData(){let{fields:e,id:t,maskId:i,tags:n,variationId:o,promoProject:s,promoVariationProject:c,settings:d={},priceLiterals:p={},dictionary:u={},placeholders:g={}}=l(this,B);m(this,oe,e.reduce((x,{name:A,multiple:D,values:ge})=>(x.fields[A]=D?ge:ge[0],x),{fields:{},id:t,tags:n,settings:d,priceLiterals:p,dictionary:u,maskId:i,placeholders:g,variationId:o,promoProject:s,promoVariationProject:c}))}transformPublishData(){if(!l(this,B))return;let{fields:e,id:t,tags:i,settings:n={},priceLiterals:o={},dictionary:s={},maskId:c,placeholders:d={},variationId:p,promoProject:u,promoVariationProject:g}=l(this,B);m(this,oe,Object.entries(e).reduce((x,[A,D])=>(x.fields[A]=D?.mimeType?D.value:D??"",x),{fields:{},id:t,tags:i,settings:n,priceLiterals:o,dictionary:s,maskId:c,placeholders:d,variationId:p,promoProject:u,promoVariationProject:g}))}getFragmentClientUrl(){let e=new URLSearchParams(window.location.search),{hostname:t}=window.location,i=t.endsWith(".page")?"page":"live";return`${ha(e.get("maslibs"),i)??"https://mas.adobe.com"}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:t}=await import(e),i={locale:l(this,H).settings.locale,apiKey:l(this,H).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??l(this,H).settings.instant,o={...i,...n!=null?{instant:n}:{},...l(this,G)!=null?{mask:l(this,G)}:{},...l(this,W)!=null?{pzn:l(this,W)}:{}};return await t(l(this,V),o)}};Ze=new WeakMap,B=new WeakMap,oe=new WeakMap,H=new WeakMap,V=new WeakMap,M=new WeakMap,Ct=new WeakMap,G=new WeakMap,W=new WeakMap,St=new WeakMap,K=new WeakMap,At=new WeakMap,Tt=new WeakMap,Xe=new WeakMap,Y=new WeakSet,Ti=async function(e){Vr(this,Tt)._++;let t=`${Or}:${this.cacheKey()}:${l(this,Tt)}`,i=`${t}${It}`,n=`${t}${$t}`;if(l(this,Xe)){let s=await this.generatePreview();if(s.status===200)return s.body;throw new he(`Failed to generate preview: ${s.message}`,{})}performance.mark(i);let o;try{if(l(this,M).stale=!1,l(this,M).url=e,o=await vi(e,{cache:"default",credentials:"omit"}),k(this,Y,Li).call(this,o),l(this,M).status=o?.status,l(this,M).measure=Oe(performance.measure(n,i)),l(this,M).retryCount=o.retryCount,!o?.ok)throw new he("Unexpected fragment response",{response:o,...l(this,H).duration});return await o.json()}catch(s){if(l(this,M).measure=Oe(performance.measure(n,i)),l(this,M).retryCount=s.retryCount,l(this,B))return l(this,M).stale=!0,l(this,Ze).error("Serving stale data",l(this,M)),l(this,B);let c=s.message??"unknown";throw new he(`Failed to fetch fragment: ${c}`,{})}},Li=function(e){Object.assign(l(this,M),fi(e))},Nr=function(e){m(this,K,null),l(this,M).message=e,this.classList.add("error");let t={...l(this,M),...l(this,H).duration};l(this,Ze).error(e,t),this.dispatchEvent(new CustomEvent(Re,{detail:t,bubbles:!0,composed:!0}))},zi=async function(){var d;this.classList.remove("error"),m(this,oe,null);let e=ne.get(this.cacheKey());if(e)return m(this,B,e),!0;let{masIOUrl:t,wcsApiKey:i,country:n,locale:o,instant:s}=l(this,H).settings,c=`${t}/fragment?id=${l(this,V)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),s&&(c+=`&instant=${s}`),l(this,G)&&(c+=`&mask=${l(this,G)}`),l(this,W)&&(c+=`&pzn=${l(this,W)}`),e=await k(this,Y,Ti).call(this,c),(d=e.fields).originalId??(d.originalId=l(this,V)),l(this,G)||l(this,W)?ne.set(this.cacheKey(),e):ne.add(e),m(this,B,e),!0},h(ir,"cache",ne);customElements.define(Or,ir);import{LitElement as Xn,html as Fr,css as Jn,nothing as eo}from"./lit-all.min.js";import{unsafeHTML as to}from"./lit-all.min.js";var ro=a=>a?a.startsWith("sp-icon-")?Fr`${to(`<${a} class="badge-icon"></${a}>`)}`:Fr`<img src="${a}" class="badge-icon" />`:eo,Je=class extends Xn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Fr`<div class="badge">
    ...
    `);customElements.define("merch-badge",Je);import{html as ao,css as io,LitElement as no}from"./lit-all.min.js";var Lt=class extends no{constructor(){super()}render(){return ao`
            <slot name="icon"></slot>
    ...
    `),h(Lt,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Lt);import{html as Ir,css as oo,LitElement as co,nothing as Pi}from"./lit-all.min.js";var zt=class extends co{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((r,e)=>{e>=5&&(r.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Ir`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?Ir`<slot name="content"></slot>`:Pi}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?Ir`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Pi}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};h(zt,"styles",oo`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),h(zt,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",zt);var so={[ce]:aa,[fe]:ia,[se]:na},lo={[ce]:oa,[se]:I},Pt,nr=class{constructor(r){f(this,Pt);h(this,"changes",new Map);h(this,"connected",!1);h(this,"error");h(this,"log");h(this,"options");h(this,"promises",[]);h(this,"state",fe);h(this,"timer",null);h(this,"value");h(this,"version",0);h(this,"wrapperElement");this.wrapperElement=r,this.log=kt.module("mas-element")}update(){[ce,fe,se].forEach(r=>{this.wrapperElement.classList.toggle(so[r],r===this.state)})}notify(){(this.state===se||this.state===ce)&&(this.state===se?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===ce&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let r=this.error;this.error instanceof he&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(lo[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,e,t){this.changes.set(r,t),this.requestUpdate()}connectedCallback(){m(this,Pt,Rr()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:e,state:t}=this;return se===t?Promise.resolve(this.wrapperElement):ce===t?Promise.reject(r):new Promise((i,n)=>{e.push({resolve:i,reject:n})})}toggleResolved(r,e,t){return r!==this.version?!1:(t!==void 0&&(this.options=t),this.state=se,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),ar(()=>this.notify()),!0)}toggleFailed(r,e,t){if(r!==this.version)return!1;t!==void 0&&(this.options=t),this.error=e,this.state=ce,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...l(this,Pt)?.duration}),ar(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=fe,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!Rr()||this.timer)return;let{error:e,options:t,state:i,value:n,version:o}=this;this.state=fe,this.timer=ar(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||r)try{await this.wrapperElement.render?.()===!1&&this.state===fe&&this.version===o&&(this.state=i,this.error=e,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,t)}})}};Pt=new WeakMap;function ho(a){return`https://${a==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var Ce,ke=class ke extends HTMLAnchorElement{constructor(){super();h(this,"masElement",new nr(this));f(this,Ce);this.setAttribute("is",ke.is)}get isUptLink(){return!0}initializeWcsData(e,t){this.setAttribute("data-wcs-osi",e),t&&this.setAttribute("data-promotion-code",t)}attributeChangedCallback(e,t,i){this.masElement.attributeChangedCallback(e,t,i)}connectedCallback(){this.masElement.connectedCallback(),m(this,Ce,ve()),l(this,Ce)&&(this.log=l(this,Ce).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),m(this,Ce,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=ve();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let t=e.collectCheckoutOptions({},this);if(!t.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(t),n=e.resolveOfferSelectors(t);try{let[[o]]=await Promise.all(n),{country:s,language:c,env:d}=t,p=`locale=${c}_${s}&country=${s}&offer_id=${o.offerId}`,u=this.getAttribute("data-promotion-code");u&&(p+=`&promotion_code=${encodeURIComponent(u)}`),this.href=`${ho(d)}?${p}`,this.masElement.toggleResolved(i,o,t)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${t.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,s,t),!1}}static createFrom(e){let t=new ke;for(let i of e.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?t.setAttribute("class",i.value.replace("upt-link","").trim()):t.setAttribute(i.name,i.value));return t.innerHTML=e.innerHTML,t.setAttribute("tabindex",0),t}};Ce=new WeakMap,h(ke,"is","upt-link"),h(ke,"tag","a"),h(ke,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var pe=ke;window.customElements.get(pe.is)||window.customElements.define(pe.is,pe,{extends:pe.tag});var po="#000000",$r="#F8D904",mo="#EAEAEA",go="#31A547",uo=/(accent|primary|secondary)(-(outline|link))?/,fo="mas:product_code/",vo="daa-ll",or="daa-lh",bo=["XL","L","M","S"],Hr="...",xo=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]);function q(a,r,e,t){let i=t[a];if(r[a]&&i){let n={slot:i?.slot,...i?.attributes},o=r[a];if(i.maxCount&&typeof o=="string"){let[c,d]=qo(o,i.maxCount,i.withSuffix);c!==o&&(n.title=d,o=c)}let s=z(i.tag,n,o);e.append(s)}}function yo(a,r,e){let i=(a.mnemonicIcon||[]).filter(o=>o).map((o,s)=>({icon:o,alt:a.mnemonicAlt?.[s]??"",link:a.mnemonicLink?.[s]??""}));i?.forEach(({icon:o,alt:s,link:c})=>{if(c&&!/^https?:/.test(c))try{c=new URL(`https://${c}`).href.toString()}catch{c="#"}let d={slot:"icons",src:o,loading:r.loading,size:e?.size??"l"};s&&(d.alt=s),c&&(d.href=c);let p=z("merch-icon",d);r.append(p)});let n=r.shadowRoot.querySelector('slot[name="icons"]');n&&(n.style.display=i?.length?null:"none")}function wo(a,r,e){if(e.badge?.slot){if(a.badge?.length&&!a.badge?.startsWith("<merch-badge")){let t=$r,i=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(t=e.badge?.default,a.borderColor||(i=!0));let n=a.badgeBackgroundColor||t,o=a.borderColor||"";i&&(o=e.badge?.default,a.borderColor=e.badge?.default),a.badge=`<merch-badge variant="${a.variant}" background-color="${n}" border-color="${o}">${a.badge}</merch-badge>`}q("badge",a,r,e)}else a.badge?(r.setAttribute("badge-text",a.badge),e.disabledAttributes?.includes("badgeColor")||r.setAttribute("badge-color",a.badgeColor||po),e.disabledAttributes?.includes("badgeBackgroundColor")||r.setAttribute("badge-background-color",a.badgeBackgroundColor||$r),r.setAttribute("border-color",a.badgeBackgroundColor||$r)):r.setAttribute("border-color",a.borderColor||mo)}function Eo(a,r,e){if(e.trialBadge&&a.trialBadge){if(!a.trialBadge.startsWith("<merch-badge")){let t=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&a.trialBadgeBorderColor||go;a.trialBadge=`<merch-badge variant="${a.variant}" border-color="${t}">${a.trialBadge}</merch-badge>`}q("trialBadge",a,r,e)}}function ko(a,r,e){e?.includes(a.size)&&r.setAttribute("size",a.size)}function Co(a,r){a.cardName&&r.setAttribute("name",a.cardName)}function So(a,r,e){a.cardTitle&&(a.cardTitle=et(a.cardTitle)),q("cardTitle",a,r,{cardTitle:e})}function Ao(a,r,e){q("subtitle",a,r,e)}function To(a,r,e,t){if(!a.backgroundColor||a.backgroundColor.toLowerCase()==="default"){r.style.removeProperty("--merch-card-custom-background-color"),r.removeAttribute("background-color");return}e?.[a.backgroundColor]?(r.style.setProperty("--merch-card-custom-background-color",`var(${e[a.backgroundColor]})`),r.setAttribute("background-color",a.backgroundColor)):t?.attribute&&a.backgroundColor&&(r.setAttribute(t.attribute,a.backgroundColor),r.style.removeProperty("--merch-card-custom-background-color"))}function Lo(a,r,e){let t=e?.borderColor,i="--consonant-merch-card-border-color";if(a.borderColor?.toLowerCase()==="transparent")r.style.setProperty(i,"transparent");else if(a.borderColor&&t){let o=t?.specialValues?.[a.borderColor]?.includes("gradient")||/-gradient/.test(a.borderColor),s=/^spectrum-.*-(plans|special-offers)$/.test(a.borderColor);if(o){r.setAttribute("gradient-border","true");let c=a.borderColor;if(t?.specialValues){for(let[d,p]of Object.entries(t.specialValues))if(p===a.borderColor){c=d;break}}r.setAttribute("border-color",c),r.style.removeProperty(i)}else s?(r.setAttribute("border-color",a.borderColor),r.style.setProperty(i,`var(--${a.borderColor})`)):r.style.setProperty(i,`var(--${a.borderColor})`)}}var zo=new Set(["","default"]);function Po(a,r,e){let t=e?.whatsIncludedDividerColor,i="--consonant-merch-card-whats-included-divider-color";if(!t)return;let o=(r.querySelector('[slot="footer-rows"] merch-whats-included')??r.querySelector("merch-whats-included"))?.getAttribute("whats-included-divider-color")?.trim(),s=a.whatsIncludedDividerColor!=null?String(a.whatsIncludedDividerColor).trim():"",c=o||s;if(c==null||zo.has(String(c).trim().toLowerCase())){r.removeAttribute("whats-included-divider-color"),r.style.removeProperty(i);return}let d=String(c).trim();if(d.toLowerCase()==="transparent"){r.removeAttribute("whats-included-divider-color"),r.style.setProperty(i,"transparent");return}let u=t.specialValues?.[d]?.includes("gradient")||/-gradient/.test(d)||/^gradient-/.test(d),g=/^spectrum-.*-(plans|special-offers)$/.test(d);if(u){let x=d;if(t.specialValues){for(let[A,D]of Object.entries(t.specialValues))if(D===d){x=A;break}}r.setAttribute("whats-included-divider-color",x),r.style.removeProperty(i)}else g?(r.setAttribute("whats-included-divider-color",d),r.style.setProperty(i,`var(--${d})`)):(r.removeAttribute("whats-included-divider-color"),r.style.setProperty(i,`var(--${d})`))}function Mo(a,r,e){if(a.backgroundImage){let t={loading:r.loading??"lazy",src:a.backgroundImage};if(a.backgroundImageAltText?t.alt=a.backgroundImageAltText:t.role="none",!e)return;if(e?.attribute){r.setAttribute(e.attribute,a.backgroundImage);return}r.append(z(e.tag,{slot:e.slot},z("img",t)))}}function et(a){return!a||typeof a!="string"||a.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(pr(),hr)).catch(console.error),a}function _o(a,r,e){a.prices&&(a.prices=et(a.prices)),q("prices",a,r,e)}function Br(a){if(a==null||a==="")return[];if(typeof a=="string")return a.trim()?[a]:[];if(Array.isArray(a))return a.flatMap(Br);if(typeof a=="object"){if(typeof a.value=="string")return a.value.trim()?[a.value]:[];if(Array.isArray(a.value))return a.value.flatMap(Br);if(typeof a.content=="string")return a.content.trim()?[a.content]:[];if(typeof a.html=="string")return a.html.trim()?[a.html]:[]}return[]}function Ro(a,r,e){let t=Br(a.features).filter(n=>n.trim());if(!t.length)return;let i=z("div",{slot:e?.features?.slot??"features",hidden:"","data-compare-chart-features":""});t.forEach(n=>{let o;try{o=new DOMParser().parseFromString(n,"text/html")}catch{return}let s=o.body.querySelector("p[name]");if(s){i.append(s);return}i.insertAdjacentHTML("beforeend",n)}),i.children.length&&r.append(i),Do(r,e)}function _i(a,r,e){let t=a.hasAttribute("data-wcs-osi")&&!!a.getAttribute("data-wcs-osi"),i=a.className||"",n=uo.exec(i)?.[0]??"accent",o=n.includes("accent"),s=n.includes("primary"),c=n.includes("secondary"),d=n.includes("-outline"),p=n.includes("-link");a.classList.remove("accent","primary","secondary");let u;if(r.consonant)u=Go(a,o,t,p,s,c,e?.ctas?.size);else if(p)u=a;else{let g;o?g="accent":s?g="primary":c&&(g="secondary"),u=r.spectrum==="swc"?Vo(a,e,d,g,t):jo(a,e,d,g,t)}return u}function Oo(a,r){let{slot:e}=r?.description;Ri(a,r,e)}function Do(a,r){let e=r?.features?.slot;e&&Ri(a,r,e)}function Ri(a,r,e){let t=a.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);t.length&&t.forEach(i=>{let n=_i(i,a,r);i.replaceWith(n)})}function No(a,r,e,t){a.description&&(a.description=et(a.description)),a.promoText&&(a.promoText=et(a.promoText)),a.shortDescription&&(a.shortDescription=et(a.shortDescription)),q("promoText",a,r,e),q("description",a,r,e),q("shortDescription",a,r,e),a.shortDescription&&(r.setAttribute("action-menu","true"),a.actionMenuLabel||r.setAttribute("action-menu-label","More options")),Oo(r,e),q("callout",a,r,e),Fo(a,r,e,t),q("whatsIncluded",a,r,e)}function Fo(a,r,e,t={}){e.quantitySelect&&(a.quantitySelect||(a.quantitySelect=t.quantitySelect),q("quantitySelect",a,r,e))}function Io(a,r,e,t={}){if(!e.addon)return;let n=(a.addon??t.addon)?.replace(/[{}]/g,"");if(!n||/disabled/.test(n))return;let o,s=n,c=document.createElement("div");c.innerHTML=n;let d=c.firstElementChild;d?.tagName?.toLowerCase()==="merch-addon"&&(o=d.getAttribute("background")||void 0,s=d.innerHTML);let p={slot:"addon"};o&&(p.background=o);let u=z("merch-addon",p,s);[...u.querySelectorAll(E)].forEach(g=>{let x=g.parentElement;x?.nodeName==="P"&&(x.hasAttribute("data-plan-type")||x.setAttribute("data-plan-type",""))}),r.append(u)}function $o(a,r,e){a.addonConfirmation&&q("addonConfirmation",a,r,e)}function Ho(a,r,e){let t=e?.customFields;if(!t)return;let i=Array.isArray(a.customFields)?a.customFields:a.customFields?[a.customFields]:[],n=Array.isArray(a.customFieldLabels)?a.customFieldLabels:a.customFieldLabels?[a.customFieldLabels]:[];i.filter(Boolean).forEach((o,s)=>{let c=n[s],d=z(t.tag,{slot:`custom-field-${s}`,"data-label":c||""},o);r.append(d)})}function Bo(a,r,e,t){t?.secureLabel&&e?.secureLabel&&r.setAttribute("secure-label",t.secureLabel)}function qo(a,r,e=!0){try{let t=typeof a!="string"?"":a,i=Mi(t);if(i.length<=r)return[t,i];let n=0,o=!1,s=e?r-Hr.length<1?1:r-Hr.length:r,c=[];for(let u of t){if(n++,u==="<")if(o=!0,t[n]==="/")c.pop();else{let g="";for(let x of t.substring(n)){if(x===" "||x===">")break;g+=x}c.push(g)}if(u==="/"&&t[n]===">"&&c.pop(),u===">"){o=!1;continue}if(!o&&(s--,s===0))break}let d=t.substring(0,n).trim();if(c.length>0){c[0]==="p"&&c.shift();for(let u of c.reverse())d+=`</${u}>`}return[`${d}${e?Hr:""}`,i]}catch{let i=typeof a=="string"?a:"",n=Mi(i);return[i,n]}}function Mi(a){if(!a)return"";let r="",e=!1;for(let t of a){if(t==="<"&&(e=!0),t===">"){e=!1;continue}e||(r+=t)}return r}function Uo(a,r){r.querySelectorAll("a.upt-link").forEach(t=>{let i=pe.createFrom(t);t.replaceWith(i),i.initializeWcsData(a.osi,a.promoCode)})}function jo(a,r,e,t,i){let n=a;i?n=customElements.get("checkout-button").createCheckoutButton({},a.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let p of a.attributes)["class","is"].includes(p.name)||n.setAttribute(p.name,p.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=r?.ctas?.size??"M",s=`spectrum-Button--${t}`,c=bo.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",d=["spectrum-Button",s,c];return e&&d.push("spectrum-Button--outline"),n.classList.add(...d),n}function Vo(a,r,e,t,i){let n=a;i&&(n=customElements.get("checkout-button").createCheckoutButton(a.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let s=z("sp-button",{treatment:o,variant:t,tabIndex:0,size:r?.ctas?.size??"m",...a.dataset.analyticsId&&{"data-analytics-id":a.dataset.analyticsId}},a.innerHTML);return s.source=n,(i?n.onceSettled():Promise.resolve(n)).then(c=>{s.setAttribute("data-navigation-url",c.href)}),s.addEventListener("click",c=>{c.defaultPrevented||n.click()}),s}function Go(a,r,e,t,i,n,o){let s=a;if(e)try{let c=customElements.get("checkout-link");c&&(s=c.createCheckoutLink(a.dataset,a.innerHTML)??a)}catch{}return t||(s.classList.add("button","con-button"),o&&o!=="m"&&s.classList.add(`button-${o}`),r&&s.classList.add("blue"),i&&s.classList.add("primary"),n&&s.classList.add("secondary")),s}function Wo(a,r,e,t,i){if(a.ctas){a.ctas=et(a.ctas);let{slot:n}=e.ctas,o=z("div",{slot:n},a.ctas),s=[...o.querySelectorAll("a")],c=i?.hideTrialCTAs?s.filter(p=>!xo.has(p.dataset.analyticsId)):s,d=(c.length>0?c:s).map(p=>_i(p,r,e));o.textContent="",o.append(...d),r.append(o),i?.hideTrialCTAs&&c.length>0&&d.forEach(p=>{let u=p.source??p;u.onceSettled&&(p.hidden=!0,u.onceSettled().then(()=>{u.value?.[0]?.offerType==="TRIAL"&&d.some(x=>x!==p&&!x.hidden)?p.remove():p.hidden=!1}).catch(()=>{p.hidden=!1}))})}}function Ko(a,r){let{tags:e}=a,t=e?.find(n=>typeof n=="string"&&n.startsWith(fo))?.split("/").pop();if(!t)return;r.setAttribute(or,t),[...r.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...r.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(vo,`${n.dataset.analyticsId}-${o+1}`)})}function Yo(a){a.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([r,e])=>{a.querySelectorAll(`a.${r}`).forEach(t=>{t.classList.remove(r),t.classList.add("spectrum-Link",`spectrum-Link--${e}`)})})}function Qo(a){a.querySelectorAll("[slot]").forEach(t=>{t.remove()}),a.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","whats-included-divider-color","badge-background-color","badge-color","badge-text","gradient-border","size",or].forEach(t=>a.removeAttribute(t));let e=["wide-strip","thin-strip"];a.classList.remove(...e)}async function Oi(a,r){if(!a){let d=r?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${d}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${d}).`)}if(!a.fields){let d=a.id||"unknown",p=r?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${d}' (merchCard id: ${p}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${d}' (merchCard id: ${p}) is missing 'fields'.`)}let{id:e,fields:t,settings:i={},priceLiterals:n,placeholders:o}=a;t.variant==="bizpro"&&(t.variant="pro");let{variant:s}=t;if(!s)throw new Error(`hydrate: no template found in payload ${e}`);Qo(r),r.compatVersion=t.compatVersion,r.contextPromotionCode=t.promoCode,r.settings=i,n&&(r.priceLiterals=n),o&&(r.placeholders=o),r.id??(r.id=a.id),a.variationId&&r.setAttribute("variation-id",a.variationId),a.maskId&&r.setAttribute("mask-id",a.maskId),a.promoProject&&r.setAttribute("data-promotion-project",a.promoProject),a.promoVariationProject&&r.setAttribute("data-promotion-variation-project",a.promoVariationProject),r.variant=s,await r.updateComplete;let{aemFragmentMapping:c}=r.variantLayout;if(!c)throw new Error(`hydrate: variant mapping not found for ${e}`);c.style==="consonant"&&r.setAttribute("consonant",!0),yo(t,r,c.mnemonics),Eo(t,r,c),ko(t,r,c.size),Co(t,r),So(t,r,c.title),wo(t,r,c),Ao(t,r,c),_o(t,r,c),Mo(t,r,c.backgroundImage),To(t,r,c.allowedColors,c.backgroundColor),Lo(t,r,c),No(t,r,c,i),Ro(t,r,c),Po(t,r,c),Io(t,r,c,i),$o(t,r,c),Ho(t,r,c),Bo(t,r,c,i);try{Uo(t,r)}catch{}Wo(t,r,c,s,i),Ko(t,r),Yo(r)}var sr="merch-card",Di="merch-card:",$i=["full-pricing-express","simplified-pricing-express"],Hi=["segment","product","plans-education","mini-compare-chart-mweb"];function Ni(a,r){let e=a.closest(sr);if(!e)return r;e.priceLiterals&&(r.literals??(r.literals={}),Object.assign(r.literals,e.priceLiterals)),da(a)&&(r.displayPerUnit=!1,r.displayTax=!1),!r.promotionCode&&(e.compatVersion>=1||e.hasAttribute("data-promotion-project"))&&(r.promotionCode=e.contextPromotionCode),e.aemFragment&&(r[sa]=!0),e.variantLayout?.priceOptionsProvider?.(a,r),a.dataset.template===O&&(r.displayDot??(r.displayDot=e.variantLayout?.legalDisplayDot??!0))}function Fi(a,r){let e=a.closest(sr);if(!e)return r;!r.promotionCode&&(e.compatVersion>=1||e.hasAttribute("data-promotion-project"))&&(r.promotionCode=e.contextPromotionCode)}function Xo(a){a.providers.has(Ni)||a.providers.price(Ni),a.providers.has(Fi)||a.providers.checkout(Fi)}var Mt=new IntersectionObserver(a=>{a.forEach(r=>{let e=r.target;if($i.includes(e.variant)){if(e.clientHeight===0)return;Mt.unobserve(e),e.requestUpdate();return}if(Hi.includes(e.variant)){if(r.boundingClientRect.width===0)return;if((e.variant==="product"||e.variant==="mini-compare-chart-mweb"||e.variant==="plans-education")&&e.querySelector('merch-icon[slot="icons"]')){Mt.unobserve(e);return}let t=e.getBoundingClientRect().width,i=e.querySelector('[slot="badge"] > merch-badge'),n=i?.getBoundingClientRect().width||0;if(t===0||!i){Mt.unobserve(e);return}e.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-n-16)}px`),Mt.unobserve(e)}})}),Jo=0,Rt,tt,rt,at,ee,Ae,U,Te,T,Se,_t,qr,cr,me=class extends Zo{constructor(){super();f(this,T);f(this,Rt);f(this,tt);f(this,rt);f(this,at);f(this,ee);f(this,Ae);f(this,U);f(this,Te,new Promise(e=>{m(this,U,e)}));h(this,"compatVersion");h(this,"customerSegment");h(this,"marketSegment");h(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMasReady=this.handleMasReady.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}get contextPromotionCode(){return l(this,Rt)}set contextPromotionCode(e){m(this,Rt,e),e?this.setAttribute("data-promotion-code",e):this.removeAttribute("data-promotion-code")}firstUpdated(){this.variantLayout=Tr(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout?.disconnectedCallbackHook(),this.variantLayout=Tr(this),this.variantLayout?.connectedCallbackHook())}updated(e){!this.style.getPropertyValue("--consonant-merch-card-border-color")&&this.computedBorderColor&&(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border-color",this.computedBorderColor),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(t){k(this,T,Se).call(this,`Error in postCardUpdateHook: ${t.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderColor(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":this.borderColor?this.borderColor:this.badgeBackgroundColor}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get iconButton(){return this.querySelector('[slot="callout-content"] .icon-button')}get price(){return this.headingmMSlot?.querySelector(E)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(te)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(te)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(te)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"||this.variant==="mini-compare-chart-mweb"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let t=this.checkoutLinks;if(t.length!==0)for(let i of t){await i.onceSettled();let n=i.value?.[0]?.planType;if(!n)return;let o=this.stockOfferOsis[n];if(!o)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==o);e.checked&&s.push(o),i.dataset.wcsOsi=s.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let t=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(t.length===0)return;let i=n=>{let{offerType:o,planType:s}=n.value?.[0]??{};if(!o||!s)return;let c=e.getOsi(s,o),d=(n.dataset.wcsOsi||"").split(",").filter(p=>p&&p!==c);e.checked&&d.push(c),n.dataset.wcsOsi=d.join(",")};t.forEach(i)}handleQuantitySelection(e){let t=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(t.length!==0)for(let i of t)i.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let t={...this.filters};Object.keys(t).forEach(i=>{if(e){t[i].order=Math.min(t[i].order||2,2);return}let n=t[i].order;n===1||isNaN(n)||(t[i].order=Number(n)+1)}),this.filters=t}showInfoTooltip(e,t){let i="tooltip-left",n="tooltip-right";window.screen.width<600&&e.getAttribute("data-tooltip")?.length>12&&(this.iconButton.classList.remove(i),this.iconButton.classList.remove(n),e.getBoundingClientRect().x<100&&this.iconButton.classList.add(i),e.getBoundingClientRect().x>window.screen.width-100&&this.iconButton.classList.add(n)),this.iconButton.classList.add(t)}handleInfoIconEvents(){let e="tooltip-visible";this.iconButton&&(["mouseenter","focus"].forEach(t=>this.iconButton.addEventListener(t,i=>this.showInfoTooltip(i.target,e),!1)),["mouseleave","blur"].forEach(t=>this.iconButton.addEventListener(t,()=>this.iconButton.classList.remove(e),!1)),this.iconButton.addEventListener("keydown",t=>{t.key==="Escape"&&this.iconButton.classList.remove(e)}))}additionalModalTriggers(){if(!this.settings?.additionalModalTriggers)return;let e=this.variantLayout.aemFragmentMapping.title;this.makeElementModalTrigger(e?.tag,e?.slot),this.makeElementModalTrigger("merch-icon","icons")}handleMasReady(){this.handleInfoIconEvents(),this.additionalModalTriggers()}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var t;super.connectedCallback(),l(this,rt)||m(this,rt,Jo++),this.aemFragment||((t=l(this,U))==null||t.call(this),m(this,U,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??l(this,rt);m(this,Ae,`${Di}${e}${It}`),m(this,tt,`${Di}${e}${$t}`),performance.mark(l(this,Ae)),m(this,ee,ve()),Xo(l(this,ee)),m(this,at,l(this,ee).Log.module(sr)),this.addEventListener(R,this.handleQuantitySelection),this.addEventListener(mr,this.handleAddonAndQuantityUpdate),this.addEventListener(ea,this.handleMerchOfferSelectReady),this.addEventListener(Re,this.handleAemFragmentEvents),this.addEventListener(_e,this.handleAemFragmentEvents),this.addEventListener(ue,this.handleMasReady),this.addEventListener("change",this.changeHandler),this.variantLayout&&this.variantLayout.connectedCallbackHook(),this.aemFragment||setTimeout(()=>this.checkReady(),0)}makeElementModalTrigger(e,t){let i=e==="merch-icon",n=this.querySelector(`${e}[slot="${t}"]:not(.modal-trigger)`);if(!n)return;let o=this.querySelector("a.button.placeholder-resolved[data-modal]");if(!o)return;n.setAttribute("tabindex","0"),n.addEventListener("click",d=>{o.checkoutActionHandler?.(d)}),n.addEventListener("keypress",d=>{d.code==="Enter"&&o.checkoutActionHandler?.(d)}),n.classList.add("modal-trigger");let c=`${this.title.replace(/\s+/g,"-").toLowerCase()}${i?"-icon":""}--${this.analyticsId}--card`;n.setAttribute("daa-ll",c),n.setAttribute("role","link"),i&&n.setAttribute("alt",this.title)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(R,this.handleQuantitySelection),this.removeEventListener(Re,this.handleAemFragmentEvents),this.removeEventListener(_e,this.handleAemFragmentEvents),this.removeEventListener(ue,this.handleMasReady),this.removeEventListener("change",this.changeHandler),this.removeEventListener(mr,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var t;if(this.isConnected&&(e.type===Re&&k(this,T,Se).call(this,"AEM fragment cannot be loaded"),e.type===_e&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let i=e.detail;try{l(this,U)||m(this,Te,new Promise(n=>{m(this,U,n)})),await Oi(i,this)}catch(n){k(this,T,Se).call(this,`hydration has failed: ${n.message}`)}finally{(t=l(this,U))==null||t.call(this),m(this,U,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected||this.failed)return;l(this,Te)&&(await l(this,Te),($i.includes(this.variant)||Hi.includes(this.variant))&&Mt.observe(this),m(this,Te,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e=new Promise(c=>setTimeout(()=>c("timeout"),Pe));if(this.aemFragment){let c=await Promise.race([this.aemFragment.updateComplete,e]);if(c===!1||c==="timeout"){let d=c==="timeout"?`AEM fragment was not resolved within ${Pe} timeout`:"AEM fragment cannot be loaded";k(this,T,Se).call(this,d,{},!1);return}}let t=[...this.querySelectorAll(Jr)],i=Promise.all(t.map(c=>{let d=c.onceSettled?.();return d?d.catch(()=>c):Promise.resolve(c)})).then(c=>{let d=c.filter(p=>p.isConnected);return d.length===0||d.every(p=>p.classList.contains("placeholder-resolved"))}),n=await Promise.race([i,e]);if(!this.isConnected)return;let o=t.filter(c=>c.isConnected);if(o.length===0||o.every(c=>c.classList.contains("placeholder-resolved"))){this.measure=performance.measure(l(this,tt),l(this,Ae));let c={...this.aemFragment?.fetchInfo,...l(this,ee).duration,measure:Oe(this.measure)};return this.dispatchEvent(new CustomEvent(ue,{bubbles:!0,composed:!0,detail:c})),this}else{this.measure=performance.measure(l(this,tt),l(this,Ae));let c={measure:Oe(this.measure),...l(this,ee).duration};if(n==="timeout")k(this,T,Se).call(this,`Contains offers that were not resolved within ${Pe} timeout`,c);else{let d=o.some(p=>p.matches(te)&&p.classList.contains("placeholder-failed"));k(this,T,Se).call(this,d?"CTA has an invalid offer":"Contains unresolved offers",c)}}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(te)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:t}}){if(!e||!t?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let n=this.checkoutLinks.find(p=>p.getAttribute("data-modal-id")===e);if(!n)return;let s=new URL(n.getAttribute("href")).searchParams.get("pa"),c=t.find(p=>p.productArrangementCode===s)?.quantity,d=!!t.find(p=>p.productArrangementCode!==s);if(c&&this.quantitySelect?.dispatchEvent(new CustomEvent(ot,{detail:{quantity:c},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==d){this.toggleStockOffer({target:this.addonCheckbox});let p=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(p,"target",{writable:!1,value:{checked:d}}),this.addonCheckbox.handleChange(p)}}get prices(){return Array.from(this.querySelectorAll(E))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${E}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return l(this,T,_t)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${E}[data-promotion-code],${te}[data-promotion-code]`)].map(i=>i.dataset.promotionCode).filter(i=>![void 0,"cancel-context"].includes(i));if(e.length===0)return this.contextPromotionCode;let t=[...new Set(e)];return t.length>1&&l(this,at)?.warn(`Multiple different promotion codes found: ${t.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${E}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(l(this,T,qr)??l(this,T,_t))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return l(this,T,_t)?.querySelector("span.price-recurrence")?.textContent?.trim()}get unitText(){let e=".price-unit-type";return l(this,T,qr)?.querySelector(e)?.textContent?.trim()??l(this,T,_t)?.querySelector(e)?.textContent?.trim()??this.querySelector(e)?.textContent?.trim()??void 0}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return k(this,T,cr).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${te}, a`);return Array.from(e??[])}get primaryCta(){return k(this,T,cr).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return k(this,T,cr).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};Rt=new WeakMap,tt=new WeakMap,rt=new WeakMap,at=new WeakMap,ee=new WeakMap,Ae=new WeakMap,U=new WeakMap,Te=new WeakMap,T=new WeakSet,Se=function(e,t={},i=!0){var c;if(!this.isConnected)return;let n=this.aemFragment,o=n?.getAttribute("fragment");o=`[${o}]`;let s={...n?.fetchInfo,...l(this,ee).duration,...t,message:e};l(this,at).error(`merch-card${o}: ${e}`,s),this.failed=!0,(c=l(this,U))==null||c.call(this),m(this,U,void 0),l(this,ee).isPreview()||(this.style.display="none"),i&&this.dispatchEvent(new CustomEvent(ra,{bubbles:!0,composed:!0,detail:s}))},_t=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${E}[data-template="price"] > span`)},qr=function(){return this.querySelector(`${E}[data-template="legal"]`)},cr=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},h(me,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},heightSync:{type:Boolean,attribute:"height-sync"},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[t,i,n]=e.split(",");return{PUF:t,ABM:i,M2M:n}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(t=>{let[i,n,o]=t.split(":"),s=Number(n);return[i,{order:isNaN(s)?void 0:s,size:o}]})),toAttribute:e=>Object.entries(e).map(([t,{order:i,size:n}])=>[t,i,n].filter(o=>o!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:or,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),h(me,"styles",[Yr,...Qr()]),h(me,"registerVariant",S),h(me,"getCollectionOptions",ni),h(me,"getFragmentMapping",qt);customElements.define(sr,me);export{me as MerchCard};
