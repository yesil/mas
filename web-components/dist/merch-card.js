...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as dt,css as on}from"./lit-all.min.js";var sa=`
:root {
...
`;var Ht=class extends v{constructor(r){super(r)}getGlobalCSS(){return da}renderLayout(){return ha` ${this.badge}
            ...
            ${this.card.customHr?"":ha`<hr />`} ${this.secureLabelFooter}`}};import{html as se,css as cn,unsafeCSS as ma}from"./lit-all.min.js";var pa=`
  :root {
...
`;var hn=32,fa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},Q,He=class extends v{constructor(e){super(e);u(this,Q);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>Bt` <footer>
    ...
    `);import{html as ht,css as pn,nothing as qt}from"./lit-all.min.js";var va=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let e=r.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?re`
        ...
        `:re`
            ...
            <slot></slot>`}};h(le,"variantStyle",mn`
...
`;var Fa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Ue=class extends v{constructor(r){super(r)}getGlobalCSS(){return Na}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return xn`
    ...
    `);import{html as ur,css as wn}from"./lit-all.min.js";var Ia=`
:root {
...
`;var $a={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},je=class extends v{constructor(r){super(r)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Ia}renderLayout(){return ur`${this.cardImage}
            ...
            ${this.evergreen?ur`
                  ...
                  `:ur`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};h(je,"variantStyle",wn`
...
`;var br={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},_n=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Wt,Ya,Ke=class extends v{constructor(e){super(e);u(this,Wt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ka}get aemFragmentMapping(){return br}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,y(this,Wt,Ya).call(this))}renderLayout(){return zn`
            ...
            <slot></slot>
        `}};Wt=new WeakSet,Ya=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;_n.forEach(({key:t,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),t))},h(Ke,"variantStyle",Pn`
...
`;var xr={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Ye=class extends v{getGlobalCSS(){return Qa}get aemFragmentMapping(){return xr}renderLayout(){return Mn`
    ...
    `);var Kt=new Map,Za=new WeakMap,Xa=new Map,S=(a,r,e=null,t=null,i)=>{Kt.set(a,{class:r,fragmentMapping:e,style:t,collectionOptions:i})};S("catalog",Ie,ca,Ie.variantStyle);S("image",xe);S("inline-heading",Ht);S("mini-compare-chart",$e,ga,$e.variantStyle);S("mini-compare-chart-mweb",He,fa,He.variantStyle);S("plans",F,Ut,F.variantStyle,F.collectionOptions);S("plans-students",F,xa,F.variantStyle,F.collectionOptions);S("plans-education",F,ba,F.variantStyle,F.collectionOptions);S("plans-v2",le,Ea,le.variantStyle,le.collectionOptions);S("pro",ut,za,ut.variantStyle);S("product",Be,Ra,Be.variantStyle);S("segment",qe,Da,qe.variantStyle);S("media",Ue,Fa,Ue.variantStyle);S("headless",Ve,Ga,Ve.variantStyle);S("special-offers",je,$a,je.variantStyle);S("simplified-pricing-express",Ge,fr,Ge.variantStyle);S("full-pricing-express",bt,vr,bt.variantStyle);S("mini",We,Wa,We.variantStyle);S("image",xe,la,xe.variantStyle);S("compare-chart-column",Ke,br,Ke.variantStyle);S("fries",Ye,xr,Ye.variantStyle);var On=(a,r,e)=>{try{let t=Xa.get(a.variant);if(t||(t=new CSSStyleSheet,t.replaceSync(r.cssText),Xa.set(a.variant,t)),e?.styleSheet&&e.styleSheet!==t){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(t)||a.shadowRoot.adoptedStyleSheets.push(t),{styleSheet:t}}catch{let i=document.createElement("style");i.textContent=r.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},yr=a=>{let r=Kt.get(a.variant);if(!r)return;let{class:e,style:t}=r,i=Za.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=t?On(a,t,i):{};return Za.set(a,{appliedVariant:a.variant,...n}),new e(a)};function $t(a){return Kt.get(a)?.fragmentMapping}function Ja(a){return Kt.get(a)?.collectionOptions}var ei=document.createElement("style");ei.innerHTML=`
:root {
...
Caused by: ${this.cause}`),e}};var we={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ri=1e3;function Fn(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ai(a){if(a==null)return;let r=typeof a;if(r==="function")return a.name?`function ${a.name}`:"function";if(r==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:t,originatingRequest:i,status:n}=a;return[t,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!we.serializableTypes.includes(e))return e}return a}function In(a,r){if(!we.ignoredProperties.includes(a))return ai(r)}var Er={append(a){if(a.level!=="error")return;let{message:r,params:e}=a,t=[],i=[],n=r;e.forEach(d=>{d!=null&&(Fn(d)?t:i).push(d)}),t.length&&(n+=` ${t.map(ai).join(" ")}`);let{pathname:o,search:c}=window.location,l=`${we.delimiter}page=${o}${c}`;l.length>ri&&(l=`${l.slice(0,ri)}<trunc>`),n+=l,i.length&&(n+=`${we.delimiter}facts=`,n+=JSON.stringify(i,In)),window.lana?.log(n,we)}};function ii(a){Object.assign(we,Object.fromEntries(Object.entries(a).filter(([r,e])=>r in we&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var ni={LOCAL:"local",PROD:"prod",STAGE:"stage"},kr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Cr=new Set,Sr=new Set,oi=new Map,ci={append({level:a,message:r,params:e,timestamp:t,source:i}){console[a](`${t}ms [${i}] %c${r}`,"font-weight: bold;",...e)}},si={filter:({level:a})=>a!==kr.DEBUG},$n={filter:()=>!1};function Hn(a,r,e,t,i){return{level:a,message:r,namespace:e,get params(){return t.length===1&&Qt(t[0])&&(t=t[0](),Array.isArray(t)||(t=[t])),t},source:i,timestamp:performance.now().toFixed(3)}}function Bn(a){[...Sr].every(r=>r(a))&&Cr.forEach(r=>r(a))}function li(a){let r=(oi.get(a)??0)+1;oi.set(a,r);let e=`${a} #${r}`,t={id:e,namespace:a,module:i=>li(`${t.namespace}/${i}`),updateConfig:ii};return Object.values(kr).forEach(i=>{t[i]=(n,...o)=>Bn(Hn(i,n,a,o,e))}),Object.seal(t)}function Zt(...a){a.forEach(r=>{let{append:e,filter:t}=r;Qt(t)&&Sr.add(t),Qt(e)&&Cr.add(e)})}function qn(a={}){let{name:r}=a,e=ti(Yt("commerce.debug",{search:!0,storage:!0}),r===ni.LOCAL);return Zt(e?ci:si),r===ni.PROD&&Zt(Er),yt}function Un(){Cr.clear(),Sr.clear()}var yt={...li(ta),Level:kr,Plugins:{consoleAppender:ci,debugFilter:si,quietFilter:$n,lanaAppender:Er},init:qn,reset:Un,use:Zt};var jn="mas-commerce-service",$d=yt.module("utilities"),Gn={requestId:Ot,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Xt=a=>window.setTimeout(a);function Ar(){return document.getElementsByTagName(jn)?.[0]}function di(a){let r={};if(!a?.headers)return r;let e=a.headers;for(let[t,i]of Object.entries(Gn)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[t]=n)}return r}async function hi(a,r={},e=2,t=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,t*(n+1)))}throw i}var pi="fragment",mi="author",gi="preview",ui="loading",fi="mask",vi="pzn",bi="timeout",Tr="aem-fragment",xi="eager",yi="cache",Vn=[xi,yi],j,Ee,I,Lr=class{constructor(){u(this,j,new Map);u(this,Ee,new Map);u(this,I,new Map)}clear(){s(this,j).clear(),s(this,Ee).clear(),s(this,I).clear()}add(r,e=!0){if(!this.has(r.id)&&!this.has(r.fields?.originalId)){if(s(this,j).set(r.id,r),r.fields?.originalId&&s(this,j).set(r.fields.originalId,r),s(this,I).has(r.id)){let[,t]=s(this,I).get(r.id);t()}if(s(this,I).has(r.fields?.originalId)){let[,t]=s(this,I).get(r.fields?.originalId);t()}if(!(!e||typeof r.references!="object"||Array.isArray(r.references)))for(let t in r.references){let{type:i,value:n}=r.references[t];i==="content-fragment"&&(n.settings={...r?.settings,...n.settings},n.placeholders={...r?.placeholders,...n.placeholders},n.dictionary={...r?.dictionary,...n.dictionary},n.priceLiterals={...r?.priceLiterals,...n.priceLiterals},this.add(n,r))}}}has(r){return s(this,j).has(r)}entries(){return s(this,j).entries()}get(r){return s(this,j).get(r)}getAsPromise(r){let[e]=s(this,I).get(r)??[];if(e)return e;let t;return e=new Promise(i=>{t=i,this.has(r)&&i()}),s(this,I).set(r,[e,t]),e}getFetchInfo(r){let e=s(this,Ee).get(r);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,Ee).set(r,e)),e}set(r,e){if(s(this,j).set(r,e),s(this,I).has(r)){let[,t]=s(this,I).get(r);t()}}remove(r){s(this,j).delete(r),s(this,Ee).delete(r),s(this,I).delete(r)}};j=new WeakMap,Ee=new WeakMap,I=new WeakMap;var ie=new Lr,Qe,H,ne,$,G,P,wt,V,W,Et,K,kt,Ct,Ze,Y,wi,Ei,zr,ki,Jt=class extends HTMLElement{constructor(){super(...arguments);u(this,Y);h(this,"cache",ie);u(this,Qe);u(this,H,null);u(this,ne,null);u(this,$,null);u(this,G);u(this,P);u(this,wt,xi);u(this,V);u(this,W);u(this,Et,5e3);u(this,K);u(this,kt,!1);u(this,Ct,0);u(this,Ze)}static get observedAttributes(){return[pi,ui,bi,mi,gi,fi,vi]}cacheKey(){return`${s(this,G)}${s(this,W)?`-p_${s(this,W)}`:""}${s(this,V)?`-m_${s(this,V)}`:""}`}attributeChangedCallback(e,t,i){e===pi&&(m(this,G,i),m(this,P,ie.getFetchInfo(this.cacheKey()))),e===fi&&m(this,V,i),e===vi&&m(this,W,i),e===ui&&Vn.includes(i)&&m(this,wt,i),e===bi&&m(this,Et,parseInt(i,10)),e===mi&&m(this,kt,["","true"].includes(i)),e===gi&&m(this,Ze,i)}connectedCallback(){if(!s(this,K)){if(s(this,$)??m(this,$,ve(this)),m(this,Ze,s(this,$).settings?.preview),s(this,Qe)??m(this,Qe,s(this,$).log.module(`${Tr}[${s(this,G)}]`)),!s(this,G)||s(this,G)==="#"){s(this,P)??m(this,P,ie.getFetchInfo("missing-fragment-id")),y(this,Y,zr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,P)).filter(([e,t])=>t!=null).map(([e,t])=>[`aem-fragment:${e}`,t]))}async refresh(e=!0){if(s(this,K)&&!await Promise.race([s(this,K),Promise.resolve(!1)]))return;e&&ie.remove(this.cacheKey()),s(this,wt)===yi&&await Promise.race([ie.getAsPromise(this.cacheKey()),new Promise(c=>setTimeout(c,s(this,Et)))]);try{m(this,K,y(this,Y,ki).call(this)),await s(this,K)}catch(c){return y(this,Y,zr).call(this,c.message),!1}let{references:t,referencesTree:i,placeholders:n,wcs:o}=s(this,H)||{};return o&&!Yt("mas.disableWcsCache")&&s(this,$).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(Me,{detail:{...this.data,references:t,referencesTree:i,placeholders:n,...s(this,P)},bubbles:!0,composed:!0})),s(this,K)}get updateComplete(){return s(this,K)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,ne)?s(this,ne):(s(this,kt)?this.transformAuthorData():this.transformPublishData(),s(this,ne))}get rawData(){return s(this,H)}transformAuthorData(){let{fields:e,id:t,maskId:i,tags:n,variationId:o,promoProject:c,promoVariationProject:l,settings:d={},priceLiterals:p={},dictionary:g={},placeholders:f={}}=s(this,H);m(this,ne,e.reduce((E,{name:O,multiple:D,values:ge})=>(E.fields[O]=D?ge:ge[0],E),{fields:{},id:t,tags:n,settings:d,priceLiterals:p,dictionary:g,maskId:i,placeholders:f,variationId:o,promoProject:c,promoVariationProject:l}))}transformPublishData(){if(!s(this,H))return;let{fields:e,id:t,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},maskId:l,placeholders:d={},variationId:p,promoProject:g,promoVariationProject:f}=s(this,H);m(this,ne,Object.entries(e).reduce((E,[O,D])=>(E.fields[O]=D?.mimeType?D.value:D??"",E),{fields:{},id:t,tags:i,settings:n,priceLiterals:o,dictionary:c,maskId:l,placeholders:d,variationId:p,promoProject:g,promoVariationProject:f}))}getFragmentClientUrl(){let e=new URLSearchParams(window.location.search),{hostname:t}=window.location,i=t.endsWith(".page")?"page":"live";return`${na(e.get("maslibs"),i)??"https://mas.adobe.com"}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:t}=await import(e),i={locale:s(this,$).settings.locale,apiKey:s(this,$).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??s(this,$).settings.instant,o={...i,...n!=null?{instant:n}:{},...s(this,V)!=null?{mask:s(this,V)}:{},...s(this,W)!=null?{pzn:s(this,W)}:{}};return await t(s(this,G),o)}};Qe=new WeakMap,H=new WeakMap,ne=new WeakMap,$=new WeakMap,G=new WeakMap,P=new WeakMap,wt=new WeakMap,V=new WeakMap,W=new WeakMap,Et=new WeakMap,K=new WeakMap,kt=new WeakMap,Ct=new WeakMap,Ze=new WeakMap,Y=new WeakSet,wi=async function(e){Ir(this,Ct)._++;let t=`${Tr}:${this.cacheKey()}:${s(this,Ct)}`,i=`${t}${Dt}`,n=`${t}${Nt}`;if(s(this,Ze)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new he(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,P).stale=!1,s(this,P).url=e,o=await hi(e,{cache:"default",credentials:"omit"}),y(this,Y,Ei).call(this,o),s(this,P).status=o?.status,s(this,P).measure=Oe(performance.measure(n,i)),s(this,P).retryCount=o.retryCount,!o?.ok)throw new he("Unexpected fragment response",{response:o,...s(this,$).duration});return await o.json()}catch(c){if(s(this,P).measure=Oe(performance.measure(n,i)),s(this,P).retryCount=c.retryCount,s(this,H))return s(this,P).stale=!0,s(this,Qe).error("Serving stale data",s(this,P)),s(this,H);let l=c.message??"unknown";throw new he(`Failed to fetch fragment: ${l}`,{})}},Ei=function(e){Object.assign(s(this,P),di(e))},zr=function(e){m(this,K,null),s(this,P).message=e,this.classList.add("error");let t={...s(this,P),...s(this,$).duration};s(this,Qe).error(e,t),this.dispatchEvent(new CustomEvent(Re,{detail:t,bubbles:!0,composed:!0}))},ki=async function(){var l;this.classList.remove("error"),m(this,ne,null);let e=ie.get(this.cacheKey());if(e)return m(this,H,e),!0;let{masIOUrl:t,wcsApiKey:i,country:n,locale:o}=s(this,$).settings,c=`${t}/fragment?id=${s(this,G)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),s(this,V)&&(c+=`&mask=${s(this,V)}`),s(this,W)&&(c+=`&pzn=${s(this,W)}`),e=await y(this,Y,wi).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,G)),s(this,V)||s(this,W)?ie.set(this.cacheKey(),e):ie.add(e),m(this,H,e),!0},h(Jt,"cache",ie);customElements.define(Tr,Jt);import{LitElement as Wn,html as Pr,css as Kn,nothing as Yn}from"./lit-all.min.js";import{unsafeHTML as Qn}from"./lit-all.min.js";var Zn=a=>a?a.startsWith("sp-icon-")?Pr`${Qn(`<${a} class="badge-icon"></${a}>`)}`:Pr`<img src="${a}" class="badge-icon" />`:Yn,Xe=class extends Wn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Pr`<div class="badge">
    ...
    `);customElements.define("merch-badge",Xe);import{html as Xn,css as Jn,LitElement as eo}from"./lit-all.min.js";var St=class extends eo{constructor(){super()}render(){return Xn`
            <slot name="icon"></slot>
