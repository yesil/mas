...
`,re=()=>[te`
        ...
        `];import{LitElement as Fe,html as oe,css as qe}from"../lit-all.min.js";var q=class extends Fe{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:e}=this;return e?oe`<a href="${e}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};d(q,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(q,"styles",qe`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
...
`;var Ct=class extends f{constructor(e){super(e)}getGlobalCSS(){return ve}renderLayout(){return mt`${this.cardImage}
            <div class="body">
                ...
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
                ${this.promoBottom?mt`<slot name="body-xs"></slot
                          ><slot name="promo-text"></slot>`:mt`<slot name="promo-text"></slot
                          ><slot name="body-xs"></slot>`}
            </div>
            ${this.evergreen?mt`
                      <div
